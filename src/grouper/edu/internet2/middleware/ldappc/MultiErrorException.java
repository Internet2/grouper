...
/**
 * This Ldappc exception is thrown when multiple errors have occured. This exception
 * allows multiple exceptions to be collected then thrown as part of a single exception.
 * It is commonly used to maximize the amount of processing to be completed prior to
...
public class MultiErrorException extends LdappcException {
  ...
  /**
   * Constructs a new multiple error exception with null as its detail message. The cause
  ...
  /**
   * Constructs a new multiple error exception with the specified detail message. The
  ...
  /**
   * Constructs a new multiple error exception with the specified detail message and
   ...
   *          exception with the specified cause and a detail message of (cause==null ?
   *          null : cause.toString()) (which typically contains the class and detail
   *          message of cause).
   * @param errors
   *          Array of Exceptions
   */
