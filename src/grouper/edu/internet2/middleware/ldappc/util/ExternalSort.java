 ...
 * Collections.sort method. These batches are then merged into a single sorted
 * file.
 * 
...
public final class ExternalSort
{
    ...
    /**
     * Text to be appended to the original filename, followed by an integer,
    ...
    /**
     * Merge batch files together back into the original file. Delete the batch
     * files when finished.
     * 
     * @param filename
    ...
    /**
     * Given an array of current lines from the batch files, find the batch
     * index of the minimum line, ignoring files that have been exhausted.
     * 
     * Return -1 if all files have been exhausted.
     * 
     * @param currentLines
     *            the array of current lines from the batch files.
     * @return the index of the batch file with the minimum line, or -1 if all
