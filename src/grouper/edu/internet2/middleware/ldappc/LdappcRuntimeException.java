...
public class LdappcRuntimeException extends RuntimeException {
  ...
  /**
   * Constructs a new runtime exception with the specified detail message and cause. Note
   * that the detail message associated with cause is not automatically incorporated in
   ...
   * class and detail message of cause). This constructor is useful for runtime exceptions
   ...
   *          runtime exception with the specified cause and a detail message of
