/*
 * @author mchyzer
 * $Id: GrouperCheckConfig.java,v 1.32 2009-10-21 12:31:02 mchyzer Exp $
 */
...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("subject.jar", 93919, "edu.internet2.middleware.subject.InvalidQueryException", "0.4.6");
