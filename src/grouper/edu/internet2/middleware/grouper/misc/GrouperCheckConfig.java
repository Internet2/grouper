/*
 * @author mchyzer
 * $Id: GrouperCheckConfig.java,v 1.12 2008-11-18 10:05:41 mchyzer Exp $
 */
...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("subject.jar", 91912, "edu.internet2.middleware.subject.InvalidQueryException", "0.4.3");
