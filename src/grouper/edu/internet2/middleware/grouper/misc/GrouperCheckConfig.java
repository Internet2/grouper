/*
 * @author mchyzer
 * $Id: GrouperCheckConfig.java,v 1.31 2009-09-02 06:35:07 mchyzer Exp $
 */
...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("subject.jar", 93861, "edu.internet2.middleware.subject.InvalidQueryException", "0.4.6");
