 ...
 * @version $Id: TestPrivSTEM1.java,v 1.1 2006-03-10 19:36:36 blair Exp $
 */
public class TestPrivSTEM1 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestPrivSTEM1.class);
  private static final Privilege  PRIV  = NamingPrivilege.STEM;


  public TestPrivSTEM1(String name) {
    super(name);
  }
