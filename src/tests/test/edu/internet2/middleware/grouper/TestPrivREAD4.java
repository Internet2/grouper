 ...
 * @version $Id: TestPrivREAD4.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD4 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD4.class);
  ...
  public TestPrivREAD4(String name) {
    super(name);
  }
