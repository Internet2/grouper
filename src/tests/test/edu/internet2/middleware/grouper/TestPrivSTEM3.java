 ...
 * @version $Id: TestPrivSTEM3.java,v 1.1 2006-03-10 19:36:36 blair Exp $
 */
public class TestPrivSTEM3 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestPrivSTEM3.class);
  private static final Privilege  PRIV  = NamingPrivilege.STEM;


  public TestPrivSTEM3(String name) {
    super(name);
  }
