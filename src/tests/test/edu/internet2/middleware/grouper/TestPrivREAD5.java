 ...
 * @version $Id: TestPrivREAD5.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD5 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD5.class);
  ...
  public TestPrivREAD5(String name) {
    super(name);
  }
