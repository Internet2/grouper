 ...
 * @version $Id: TestMemberOf3.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf3 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf3.class); 
  ...
  public TestMemberOf3(String name) {
    super(name);
  }
