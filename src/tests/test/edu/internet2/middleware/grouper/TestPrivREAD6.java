 ...
 * @version $Id: TestPrivREAD6.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD6 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD6.class);
  ...
  public TestPrivREAD6(String name) {
    super(name);
  }
