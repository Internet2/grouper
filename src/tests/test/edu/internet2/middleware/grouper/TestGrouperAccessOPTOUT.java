 ...
 * @version $Id: TestGrouperAccessOPTOUT.java,v 1.12 2006-02-21 17:11:33 blair Exp $
 */
public class TestGrouperAccessOPTOUT extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestGrouperAccessOPTOUT.class);
  private static final Privilege  PRIV  = AccessPrivilege.OPTOUT;
  ...
  public TestGrouperAccessOPTOUT(String name) {
    super(name);
  }
