 ...
 * @version $Id: TestMemberOf5.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf5 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf5.class); 
  ...
  public TestMemberOf5(String name) {
    super(name);
  }
