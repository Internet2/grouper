 ...
 * @version $Id: TestPrivREAD3.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD3 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD3.class);
  ...
  public TestPrivREAD3(String name) {
    super(name);
  }
