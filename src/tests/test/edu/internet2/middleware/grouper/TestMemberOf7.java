 ...
 * @version $Id: TestMemberOf7.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf7 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf7.class); 
  ...
  public TestMemberOf7(String name) {
    super(name);
  }
