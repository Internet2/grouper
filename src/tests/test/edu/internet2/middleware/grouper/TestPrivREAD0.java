 ...
 * @version $Id: TestPrivREAD0.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD0 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD0.class);
  ...
  public TestPrivREAD0(String name) {
    super(name);
  }
