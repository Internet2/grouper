 ...
 * @version $Id: TestPrivREAD1.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD1 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD1.class);
  ...
  public TestPrivREAD1(String name) {
    super(name);
  }
