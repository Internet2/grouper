 ...
 * @version $Id: TestPrivREAD9.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD9 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD9.class);
  ...
  public TestPrivREAD9(String name) {
    super(name);
  }
