 ...
 * @version $Id: TestCompositeC8.java,v 1.7 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeC8 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeC8.class);

  public TestCompositeC8(String name) {
    super(name);
  }
