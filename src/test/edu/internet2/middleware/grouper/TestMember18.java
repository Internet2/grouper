 ...
 * @version $Id: TestMember18.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestMember18 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestMember18.class);

  public TestMember18(String name) {
    super(name);
  }
