 ...
 * @version $Id: TestComposite4.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestComposite4 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestComposite4.class);

  public TestComposite4(String name) {
    super(name);
  }
