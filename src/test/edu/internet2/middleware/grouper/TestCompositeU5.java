 ...
 * @version $Id: TestCompositeU5.java,v 1.4 2006-08-30 18:35:38 blair Exp $
 */
public class TestCompositeU5 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeU5.class);

  public TestCompositeU5(String name) {
    super(name);
  }
