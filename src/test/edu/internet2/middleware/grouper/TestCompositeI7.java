 ...
 * @version $Id: TestCompositeI7.java,v 1.7 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeI7 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeI7.class);

  public TestCompositeI7(String name) {
    super(name);
  }
