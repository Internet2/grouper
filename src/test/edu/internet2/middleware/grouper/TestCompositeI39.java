 ...
 * @version $Id: TestCompositeI39.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeI39 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeI39.class);

  public TestCompositeI39(String name) {
    super(name);
  }
