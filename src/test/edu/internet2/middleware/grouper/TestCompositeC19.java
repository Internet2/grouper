 ...
 * @version $Id: TestCompositeC19.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeC19 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeC19.class);

  public TestCompositeC19(String name) {
    super(name);
  }
