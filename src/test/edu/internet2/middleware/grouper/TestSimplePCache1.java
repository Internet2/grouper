 ...
 * @version $Id: TestSimplePCache1.java,v 1.2 2006-10-17 17:19:37 blair Exp $
 * @since   1.1.0
 */
public class TestSimplePCache1 extends GrouperTest {

  private static final Log LOG = LogFactory.getLog(TestSimplePCache1.class);

  public TestSimplePCache1(String name) {
    super(name);
  }
...
} // public class TestSimplePCache1
