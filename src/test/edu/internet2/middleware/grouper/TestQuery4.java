 ...
 * @version $Id: TestQuery4.java,v 1.3 2006-08-30 18:35:38 blair Exp $
 */
public class TestQuery4 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestQuery4.class);

  public TestQuery4(String name) {
    super(name);
  }
