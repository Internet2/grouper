 ...
 * @version $Id: TestCompositeC21.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeC21 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeC21.class);

  public TestCompositeC21(String name) {
    super(name);
  }
