 ...
 * @version $Id: TestQuery10.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestQuery10 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestQuery10.class);

  public TestQuery10(String name) {
    super(name);
  }
