 ...
 * @version $Id: TestCompositeC12.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeC12 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeC12.class);

  public TestCompositeC12(String name) {
    super(name);
  }
