 ...
 * @version $Id: TestPrivAdmin1.java,v 1.2 2006-09-21 16:10:23 blair Exp $
 * @since   1.1.0
 */
public class TestPrivAdmin1 extends TestCase {

  // TODO 20060921 relocate to `SuiteGAttrs`

  private static final Log LOG = LogFactory.getLog(TestPrivAdmin1.class);

  public TestPrivAdmin1(String name) {
    super(name);
  }
  ...
  public void testDeleteAttributesWithAdmin() {
    LOG.info("testDeleteAttributesWithAdmin");
    try {
