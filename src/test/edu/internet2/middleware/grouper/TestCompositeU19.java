 ...
 * @version $Id: TestCompositeU19.java,v 1.3 2006-08-30 18:35:38 blair Exp $
 */
public class TestCompositeU19 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeU19.class);

  public TestCompositeU19(String name) {
    super(name);
  }
