 ...
 * @version $Id: TestSetting0.java,v 1.9 2007-02-14 17:06:28 blair Exp $
 */
public class TestSetting0 extends GrouperTest {
  ...
  public TestSetting0(String name) {
    super(name);
  }
  ...
  public void testGetCurrentSchemaVersion() {
    ...
    T.amount("current schema version", 2, Settings.internal_getCurrentSchemaVersion());
  } // public void testGetCurrentSchemaVersion()
