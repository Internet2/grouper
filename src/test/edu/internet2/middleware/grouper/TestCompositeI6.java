 ...
 * @version $Id: TestCompositeI6.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeI6 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeI6.class);

  public TestCompositeI6(String name) {
    super(name);
  }
