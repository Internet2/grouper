...
public class AttributeDefAttributeSecurityTest extends GrouperTest {
  ...
  protected void setUp () {
    ...
    this.attributeDefToAssignTo.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ1, AttributeDefPrivilege.ATTR_ADMIN, true);
    ...
    this.attributeDefToAssignTo.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ4, AttributeDefPrivilege.ATTR_ADMIN, true);
    ...
    this.attributeDefToAssignTo.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ6, AttributeDefPrivilege.ATTR_ADMIN, true);
    this.attributeDef1.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ6, AttributeDefPrivilege.ATTR_UPDATE, true);

    this.attributeDefToAssignTo.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ7, AttributeDefPrivilege.ATTR_ADMIN, true);
  ...
  public void testGrouperSystem() throws Exception {
    ...
    //assign these
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName1_1));
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName2_1));
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName2_2));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName1_1));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName2_1));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().assignAttribute(attributeDefName2_2));
    ...
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName1_1));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName1_2));
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName2_1));
    assertTrue(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName2_2));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName1_1));
    assertFalse(this.attributeDefToAssignTo.getAttributeDelegate().removeAttribute(attributeDefName2_2));
