 ...
 * @version $Id: TestCompositeC40.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeC40 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeC40.class);

  public TestCompositeC40(String name) {
    super(name);
  }
