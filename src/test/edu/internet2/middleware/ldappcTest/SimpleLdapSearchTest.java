...
public class SimpleLdapSearchTest extends BaseLdappcTestCase {
  ...
  protected void setUp() {
    ...
    // example: env.put(Context.INITIAL_CONTEXT_FACTORY,
    ...
    // example: env.put(Context.SECURITY_PRINCIPAL,
  ...
  public void testSimpleSearch() {
    ...
    /*
     * Sample for search: NamingEnumeration answer = ctx.search("ou=NewHires",
     * "(&(mySpecialKey={0}) (cn=*{1}))", // Filter expression new Object[]{key, name}, //
     * Filter arguments null); // Default search controls
     * 
