 ...
 * 
 * The following is the structure of the data that is used for adding test data: testStem1
 * teststem2 teststem3 testgroup31 testmember31 testmember32 testmember33 testgroup21
 * testmember21 testmember22 testmember23
 * 
 * @author Gil Singer
 */
public class GrouperProvisionerTest extends BaseLdappcTestCase {
  ...
  public void testProvisionGroups() {
    ...
    /*
     * TODO: replace below with appropriate changes. try { testGroup31 =
     * GroupFinder.findByName(grouperSession,
     * "testStem1:testStem2:testStem3:testGroup31"); } catch (GroupNotFoundException gnfe)
     * { ErrorLog.error(this.getClass(), "Group not found: " + gnfe.getMessage());
     * System.out.println("DEBUG Group not found: " + gnfe.getMessage()); }
     * 
     * groupProcessor.addMember(testGroup31, testGroup21.toSubject()); String
     * testGroup21Uuid = testGroup21.getUuid();
     * 
     * // // Make sure the member exists. // try { //Member.findBySubject(grouperSession,
     * "testStem1"); Member testGroup31Member = MemberFinder.findByUuid(grouperSession,
     * testGroup21Uuid); } catch (MemberNotFoundException mnfe) {
