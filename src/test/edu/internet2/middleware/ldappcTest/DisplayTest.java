...
/**
 * Displays or logs JUnit test run titles. Objects calling the showClassName and
 * showRunTitle method should 1) call the showClassName once per test class in setup, 2)
 * call the showRunTitle(String method, String name) method, 3) then for additional tests
 * within the same method call showRunTitle(String name)
 * 
 * @author Gil Singer
 */
public class DisplayTest {
  ...
  /**
   * Displays or logs the name of a JUnit test case when enable by the value of
   * TestOptions.SHOW_NAMES
   * 
   * @param method
   *          Name of the method containing the test
   * @param name
  ...
  /**
   * Displays or logs the name of a JUnit test case when enable by the value of
   * TestOptions.SHOW_NAMES For each method calling this, use the two argument version
   * first.
   * 
   * @param name
   *          Title of the test run
  ...
  /**
   * Displays or logs the name of a JUnit test case when enable by the value of
   * TestOptions.SHOW_NAMES For each test class call this from setup.
   * 
   * @param className
