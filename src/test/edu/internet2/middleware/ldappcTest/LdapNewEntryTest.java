...
public class LdapNewEntryTest extends BaseLdappcTestCase {
  ...
  public void testLdapNewEntry() {
    ...
    try {
      NamingEnumeration listBindings = ctx.listBindings("ou=testOrgUnit2,"
          + AllLdappcJunitTests.DN_TEST_BASE);
  ...
  /**
   * Determine if an attribute exists Example call: doesAttributeExist("cn",
   * "Manager",AllJUnitTests.DN_TEST_BASE);
   * 
   * @param ctx
   *          The context
   * @param dn
