 ...
 */
            ...
            /**
            *  ExternalSubjectSave bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for WsExternalSubjectToSaves
                        * This was an Array!
                        */

                        
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[] localWsExternalSubjectToSaves ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localWsExternalSubjectToSavesTracker = false ;

                           public boolean isWsExternalSubjectToSavesSpecified(){
                               return localWsExternalSubjectToSavesTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[] getWsExternalSubjectToSaves(){
                               return localWsExternalSubjectToSaves;
                           }
                              ...
                              /**
                               * validate the array for WsExternalSubjectToSaves
                               */
                              protected void validateWsExternalSubjectToSaves(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param WsExternalSubjectToSaves
                              */
                              public void setWsExternalSubjectToSaves(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[] param){
                              
                                   validateWsExternalSubjectToSaves(param);

                               localWsExternalSubjectToSavesTracker = true;
                                      
                                      this.localWsExternalSubjectToSaves=param;
                              }
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave
                             */
                             public void addWsExternalSubjectToSaves(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave param){
                                   if (localWsExternalSubjectToSaves == null){
                                   localWsExternalSubjectToSaves = new edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localWsExternalSubjectToSaves);
                               list.add(param);
                               this.localWsExternalSubjectToSaves =
                             (edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":externalSubjectSave",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "externalSubjectSave",
                ...
                if (localClientVersionTracker){
                             ...
                             } if (localWsExternalSubjectToSavesTracker){
                                       if (localWsExternalSubjectToSaves!=null){
                                            for (int i = 0;i < localWsExternalSubjectToSaves.length;i++){
                                                if (localWsExternalSubjectToSaves[i] != null){
                                                 localWsExternalSubjectToSaves[i].serialize(new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","wsExternalSubjectToSaves"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd", "wsExternalSubjectToSaves", xmlWriter);
                             ...
                             if (localWsExternalSubjectToSaves!=null) {
                                 for (int i = 0;i < localWsExternalSubjectToSaves.length;i++){
                                    ...
                                    if (localWsExternalSubjectToSaves[i] != null){
                                         ...
                                         elementList.add(localWsExternalSubjectToSaves[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsExternalSubjectToSaves"));
                                        elementList.add(localWsExternalSubjectToSaves);
    ...
    public static class Factory{
        ...
        */
        public static ExternalSubjectSave parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExternalSubjectSave object =
                new ExternalSubjectSave();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"externalSubjectSave".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ExternalSubjectSave)edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","wsExternalSubjectToSaves").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","wsExternalSubjectToSaves").equals(reader.getName())){
                                                        ...
                                                        object.setWsExternalSubjectToSaves((edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectToSave.class,
                                                                list2));
