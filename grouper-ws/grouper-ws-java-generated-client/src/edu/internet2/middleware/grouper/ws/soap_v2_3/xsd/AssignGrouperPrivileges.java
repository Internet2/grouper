                ...
                if (localClientVersionTracker){
                             ...
                             if (localPrivilegeNames!=null) {
                                   ...
                                   for (int i = 0;i < localPrivilegeNames.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd", "privilegeNames", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"assignGrouperPrivileges".equals(type)){
                                ...
                                return (AssignGrouperPrivileges)edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list14 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsSubjectLookup.Factory.parse(reader));
                                                                }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","privilegeNames").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","privilegeNames").equals(reader.getName())){
