 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for WsStemToSaves
                        * This was an Array!
                        */

                        
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[] localWsStemToSaves ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localWsStemToSavesTracker = false ;

                           public boolean isWsStemToSavesSpecified(){
                               return localWsStemToSavesTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[] getWsStemToSaves(){
                               return localWsStemToSaves;
                           }
                              ...
                              /**
                               * validate the array for WsStemToSaves
                               */
                              protected void validateWsStemToSaves(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param WsStemToSaves
                              */
                              public void setWsStemToSaves(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[] param){
                              
                                   validateWsStemToSaves(param);

                               localWsStemToSavesTracker = true;
                                      
                                      this.localWsStemToSaves=param;
                              }
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave
                             */
                             public void addWsStemToSaves(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave param){
                                   if (localWsStemToSaves == null){
                                   localWsStemToSaves = new edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localWsStemToSaves);
                               list.add(param);
                               this.localWsStemToSaves =
                             (edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localClientVersionTracker){
                             ...
                             } if (localWsStemToSavesTracker){
                                       if (localWsStemToSaves!=null){
                                            for (int i = 0;i < localWsStemToSaves.length;i++){
                                                if (localWsStemToSaves[i] != null){
                                                 localWsStemToSaves[i].serialize(new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd","wsStemToSaves"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd", "wsStemToSaves", xmlWriter);
                             ...
                             if (localWsStemToSaves!=null) {
                                 for (int i = 0;i < localWsStemToSaves.length;i++){
                                    ...
                                    if (localWsStemToSaves[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsStemToSaves"));
                                         elementList.add(localWsStemToSaves[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsStemToSaves"));
                                        elementList.add(localWsStemToSaves);
    ...
    public static class Factory{
        ...
        */
        public static StemSave parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StemSave object =
                new StemSave();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"stemSave".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StemSave)edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd","wsStemToSaves").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd","wsStemToSaves").equals(reader.getName())){
                                                        ...
                                                        object.setWsStemToSaves((edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave.class,
                                                                list2));
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list5.add(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsParam.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
