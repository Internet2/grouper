                ...
                if (localAssignableTosTracker){
                             if (localAssignableTos!=null) {
                                   ...
                                   for (int i = 0;i < localAssignableTos.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd", "assignableTos", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsAttributeDef".equals(type)){
                                ...
                                return (WsAttributeDef)edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd","assignableTos").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd","assignableTos").equals(reader.getName())){
