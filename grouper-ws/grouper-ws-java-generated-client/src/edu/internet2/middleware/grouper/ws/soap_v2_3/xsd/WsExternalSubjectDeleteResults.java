...
/**
 * WsExternalSubjectDeleteResults.java
 *
 ...
 */
            ...
            /**
            *  WsExternalSubjectDeleteResults bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = WsExternalSubjectDeleteResults
                ...
                */
                        ...
                        */
                                    ...
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[] localResults ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[] getResults(){
                               return localResults;
                           }
                               ...
                               */
                              protected void validateResults(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[] param){
                              ...
                              * @param param Results
                              */
                              public void setResults(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[] param){
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult
                             */
                             public void addResults(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult param){
                                   if (localResults == null){
                                   localResults = new edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localResults);
                               list.add(param);
                               this.localResults =
                             (edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WsExternalSubjectDeleteResults",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localResults!=null){
                                            for (int i = 0;i < localResults.length;i++){
                                                if (localResults[i] != null){
                                                 localResults[i].serialize(new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","results"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd", "results", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static WsExternalSubjectDeleteResults parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WsExternalSubjectDeleteResults object =
                new WsExternalSubjectDeleteResults();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsExternalSubjectDeleteResults".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WsExternalSubjectDeleteResults)edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","results").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_3.ws.grouper.middleware.internet2.edu/xsd","results").equals(reader.getName())){
                                                        ...
                                                        object.setResults((edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsExternalSubjectDeleteResult.class,
                                                                list3));
