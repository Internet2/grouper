        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[] localWsOwnerAttributeAssignLookups ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[] getWsOwnerAttributeAssignLookups(){
                               ...
                               */
                              protected void validateWsOwnerAttributeAssignLookups(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[] param){
                              ...
                              */
                              public void setWsOwnerAttributeAssignLookups(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[] param){
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup
                             */
                             public void addWsOwnerAttributeAssignLookups(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup param){
                                   if (localWsOwnerAttributeAssignLookups == null){
                                   localWsOwnerAttributeAssignLookups = new edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[]{};
                                   }
                ...
                if (localClientVersionTracker){
                                       ...
                                       if (localWsOwnerAttributeAssignLookups!=null){
                                            for (int i = 0;i < localWsOwnerAttributeAssignLookups.length;i++){
                                                if (localWsOwnerAttributeAssignLookups[i] != null){
                                                 localWsOwnerAttributeAssignLookups[i].serialize(new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","wsOwnerAttributeAssignLookups"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd", "wsOwnerAttributeAssignLookups", xmlWriter);
                             ...
                             if (localAttributeDefTypesToReplace!=null) {
                                   ...
                                   for (int i = 0;i < localAttributeDefTypesToReplace.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd", "attributeDefTypesToReplace", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"assignAttributes".equals(type)){
                                ...
                                return (AssignAttributes)edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list27 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list5.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignValue.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list11.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list12.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsGroupLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list13.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsStemLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list14.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsSubjectLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list15.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsMembershipLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list16.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsMembershipAnyLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list17.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeDefLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","wsOwnerAttributeAssignLookups").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list18.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone18){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","wsOwnerAttributeAssignLookups").equals(reader.getName())){
                                                        ...
                                                        object.setWsOwnerAttributeAssignLookups((edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAttributeAssignLookup.class,
                                                                list18));
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list24.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsParam.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","attributeDefTypesToReplace").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone27){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","attributeDefTypesToReplace").equals(reader.getName())){
