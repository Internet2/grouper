                ...
                if (localClientVersionTracker){
                             ...
                             if (localSourceIds!=null) {
                                   ...
                                   for (int i = 0;i < localSourceIds.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd", "sourceIds", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMembers".equals(type)){
                                ...
                                return (GetMembers)edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list10 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsGroupLookup.Factory.parse(reader));
                                                                }
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list9.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsParam.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","sourceIds").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone10){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","sourceIds").equals(reader.getName())){
