        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[] localResults ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[] getResults(){
                               return localResults;
                           }
                               ...
                               */
                              protected void validateResults(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[] param){
                              ...
                              * @param param Results
                              */
                              public void setResults(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[] param){
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult
                             */
                             public void addResults(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult param){
                                   if (localResults == null){
                                   localResults = new edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localResults);
                               list.add(param);
                               this.localResults =
                             (edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[list.size()]);
                             ...
                             if (localSubjectAttributeNames!=null) {
                                   ...
                                   for (int i = 0;i < localSubjectAttributeNames.length;i++){
                                    ...
                                    if (localWsGroupAssigned==null){
                                        ...
                                        writeStartElement(null, "http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd", "wsGroupAssigned", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsAddMemberResults".equals(type)){
                                ...
                                return (WsAddMemberResults)edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult.Factory.parse(reader));
                                                                }
                                                        ...
                                                        object.setResults((edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.WsAddMemberResult.class,
                                                                list3));
