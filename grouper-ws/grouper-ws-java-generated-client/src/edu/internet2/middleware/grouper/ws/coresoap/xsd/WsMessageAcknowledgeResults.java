                ...
                if (localMessageIdsTracker){
                             if (localMessageIds!=null) {
                                   ...
                                   for (int i = 0;i < localMessageIds.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://coresoap.ws.grouper.middleware.internet2.edu/xsd", "messageIds", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsMessageAcknowledgeResults".equals(type)){
                                ...
                                return (WsMessageAcknowledgeResults)edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://coresoap.ws.grouper.middleware.internet2.edu/xsd","messageIds").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://coresoap.ws.grouper.middleware.internet2.edu/xsd","messageIds").equals(reader.getName())){
