                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsGetMembershipsResults".equals(type)){
                                ...
                                return (WsGetMembershipsResults)edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list8 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list4.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsAttributeDef.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list5.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsGroup.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list6.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsMembership.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list7.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsStem.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list8.add(edu.internet2.middleware.grouper.ws.soap_v2_3.xsd.WsSubject.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
