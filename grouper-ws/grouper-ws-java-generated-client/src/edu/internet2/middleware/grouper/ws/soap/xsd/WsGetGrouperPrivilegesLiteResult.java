       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       WsGetGrouperPrivilegesLiteResult.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsGetGrouperPrivilegesLiteResult".equals(type)){
                                ...
                                return (WsGetGrouperPrivilegesLiteResult)edu.internet2.middleware.grouper.ws.soap.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(edu.internet2.middleware.grouper.ws.soap.xsd.WsParam.Factory.parse(reader));
                                                                }
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap.xsd.WsGrouperPrivilegeResult.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
