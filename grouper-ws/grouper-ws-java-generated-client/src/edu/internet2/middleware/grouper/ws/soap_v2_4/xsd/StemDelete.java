 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[] localWsStemLookups ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[] getWsStemLookups(){
                               ...
                               */
                              protected void validateWsStemLookups(edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[] param){
                              ...
                              */
                              public void setWsStemLookups(edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[] param){
                             ...
                             */
                             public void addWsStemLookups(edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup param){
                                   if (localWsStemLookups == null){
                                   localWsStemLookups = new edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[]{};
                                   }
                                       ...
                                       if (localWsStemLookups!=null){
                                            for (int i = 0;i < localWsStemLookups.length;i++){
                                                if (localWsStemLookups[i] != null){
                                                 localWsStemLookups[i].serialize(new javax.xml.namespace.QName("http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd","wsStemLookups"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd", "wsStemLookups", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static StemDelete parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StemDelete object =
                new StemDelete();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"stemDelete".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StemDelete)edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd","wsStemLookups").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_4.ws.grouper.middleware.internet2.edu/xsd","wsStemLookups").equals(reader.getName())){
                                                        ...
                                                        object.setWsStemLookups((edu.internet2.middleware.grouper.ws.soap_v2_4.xsd.WsStemLookup[])
