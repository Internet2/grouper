...
/**
 * WsGetAuditEntriesLiteResult.java
 *
 ...
 */
            ...
            /**
            *  WsGetAuditEntriesLiteResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WsGetAuditEntriesLiteResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = WsGetAuditEntriesLiteResult
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for WsAuditEntries
                        * This was an Array!
                        */

                        
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[] localWsAuditEntries ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localWsAuditEntriesTracker = false ;

                           public boolean isWsAuditEntriesSpecified(){
                               return localWsAuditEntriesTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[] getWsAuditEntries(){
                               return localWsAuditEntries;
                           }
                              ...
                              /**
                               * validate the array for WsAuditEntries
                               */
                              protected void validateWsAuditEntries(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param WsAuditEntries
                              */
                              public void setWsAuditEntries(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[] param){
                              
                                   validateWsAuditEntries(param);

                               localWsAuditEntriesTracker = true;
                                      
                                      this.localWsAuditEntries=param;
                              }
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry
                             */
                             public void addWsAuditEntries(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry param){
                                   if (localWsAuditEntries == null){
                                   localWsAuditEntries = new edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localWsAuditEntries);
                               list.add(param);
                               this.localWsAuditEntries =
                             (edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WsGetAuditEntriesLiteResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WsGetAuditEntriesLiteResult",
                           xmlWriter);
                   }
                ...
                if (localResponseMetadataTracker){
                                ...
                                } if (localWsAuditEntriesTracker){
                                       if (localWsAuditEntries!=null){
                                            for (int i = 0;i < localWsAuditEntries.length;i++){
                                                if (localWsAuditEntries[i] != null){
                                                 localWsAuditEntries[i].serialize(new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAuditEntries"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd", "wsAuditEntries", xmlWriter);
                             ...
                             if (localWsAuditEntries!=null) {
                                 for (int i = 0;i < localWsAuditEntries.length;i++){
                                    ...
                                    if (localWsAuditEntries[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsAuditEntries"));
                                         elementList.add(localWsAuditEntries[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsAuditEntries"));
                                        elementList.add(localWsAuditEntries);
    ...
    public static class Factory{
        ...
        */
        public static WsGetAuditEntriesLiteResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WsGetAuditEntriesLiteResult object =
                new WsGetAuditEntriesLiteResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsGetAuditEntriesLiteResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WsGetAuditEntriesLiteResult)edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAuditEntries").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAuditEntries").equals(reader.getName())){
                                                        ...
                                                        object.setWsAuditEntries((edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAuditEntry.class,
                                                                list3));
