...
/**
 * AssignGrouperPrivilegesLite.java
 *
 ...
 */
            ...
            /**
            *  AssignGrouperPrivilegesLite bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AssignGrouperPrivilegesLite
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":assignGrouperPrivilegesLite",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "assignGrouperPrivilegesLite",
    ...
    public static class Factory{
        ...
        */
        public static AssignGrouperPrivilegesLite parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AssignGrouperPrivilegesLite object =
                new AssignGrouperPrivilegesLite();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"assignGrouperPrivilegesLite".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AssignGrouperPrivilegesLite)edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_2.ws.grouper.middleware.internet2.edu/xsd","subjectIdentifier").equals(reader.getName())){
