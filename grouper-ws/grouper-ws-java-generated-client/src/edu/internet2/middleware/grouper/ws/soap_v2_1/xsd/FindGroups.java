                                    ...
                                    if (localWsQueryFilter==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"wsQueryFilter", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"wsQueryFilter");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("wsQueryFilter");
                                        }
