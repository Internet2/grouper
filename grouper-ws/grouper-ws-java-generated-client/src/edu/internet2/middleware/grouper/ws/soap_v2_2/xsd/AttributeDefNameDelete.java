 ...
 */
            ...
            /**
            *  AttributeDefNameDelete bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AttributeDefNameDelete
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":attributeDefNameDelete",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "attributeDefNameDelete",
    ...
    public static class Factory{
        ...
        */
        public static AttributeDefNameDelete parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AttributeDefNameDelete object =
                new AttributeDefNameDelete();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"attributeDefNameDelete".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AttributeDefNameDelete)edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsAttributeDefNameLookup.Factory.parse(reader));
                                                                }
