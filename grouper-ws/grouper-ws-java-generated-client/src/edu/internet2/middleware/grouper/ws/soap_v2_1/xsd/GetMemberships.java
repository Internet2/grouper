                ...
                if (localClientVersionTracker){
                             ...
                             if (localMembershipIds!=null) {
                                   ...
                                   for (int i = 0;i < localMembershipIds.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd", "membershipIds", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMemberships".equals(type)){
                                ...
                                return (GetMemberships)edu.internet2.middleware.grouper.ws.soap_v2_1.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone16){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_1.ws.grouper.middleware.internet2.edu/xsd","membershipIds").equals(reader.getName())){
