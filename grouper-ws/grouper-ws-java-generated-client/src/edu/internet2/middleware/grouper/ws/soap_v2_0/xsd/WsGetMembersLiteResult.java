                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsGetMembersLiteResult".equals(type)){
                                ...
                                return (WsGetMembersLiteResult)edu.internet2.middleware.grouper.ws.soap_v2_0.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list5.add(edu.internet2.middleware.grouper.ws.soap_v2_0.xsd.WsSubject.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
