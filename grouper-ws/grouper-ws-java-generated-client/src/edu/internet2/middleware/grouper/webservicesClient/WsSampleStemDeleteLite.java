...
public class WsSampleStemDeleteLite implements WsSampleGenerated {
   ...
   */
  public static void stemDeleteLite(WsSampleGeneratedType wsSampleGeneratedType) {
    try {
      ...
      System.out.println(ToStringBuilder.reflectionToString(wsStemDeleteLiteResult));
    } catch (Exception e) {
