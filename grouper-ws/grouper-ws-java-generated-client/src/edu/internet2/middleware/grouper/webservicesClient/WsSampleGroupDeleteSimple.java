 ...
 *
 */
public class WsSampleGroupDeleteSimple implements WsSampleGenerated {
    /**
     * @param args
     */
    ...
    public static void groupDelete(WsSampleGeneratedType wsSampleGeneratedType) {
        try {
            ...
            groupDeleteSimple.setClientVersion(GeneratedClientSettings.VERSION);
            ...
            WsGroupDeleteResults wsGroupDeleteResults = stub.groupDeleteSimple(groupDeleteSimple)
                                                            .get_return();
