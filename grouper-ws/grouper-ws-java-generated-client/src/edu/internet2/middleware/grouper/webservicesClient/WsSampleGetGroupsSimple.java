 ...
 *
 */
public class WsSampleGetGroupsSimple implements WsSampleGenerated {
    /**
     * @param args
     */
    public static void main(String[] args) {
        getGroupsSimple(WsSampleGeneratedType.SOAP);
    }
    ...
    public void executeSample(WsSampleGeneratedType wsSampleGeneratedType) {
        getGroupsSimple(wsSampleGeneratedType);
    }
    ...
    public static void getGroupsSimple(
        ...
        try {
            ...
            getGroupsSimple.setClientVersion(GeneratedClientSettings.VERSION);
