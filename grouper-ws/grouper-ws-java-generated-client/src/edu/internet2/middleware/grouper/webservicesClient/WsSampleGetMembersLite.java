...
public class WsSampleGetMembersLite implements WsSampleGenerated {
   ...
   */
  public static void getMembersLite(WsSampleGeneratedType wsSampleGeneratedType) {
    try {
      ...
      System.out.println(ToStringBuilder.reflectionToString(wsGetMembersLiteResult));
