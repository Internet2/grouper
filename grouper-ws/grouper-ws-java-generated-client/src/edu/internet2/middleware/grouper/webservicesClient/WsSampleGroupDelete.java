...
public class WsSampleGroupDelete implements WsSampleGenerated {
  ...
  public static void groupDelete(WsSampleGeneratedType wsSampleGeneratedType) {
    try {
      ...
      System.out.println(ToStringBuilder.reflectionToString(wsGroupDeleteResults));

      WsGroupDeleteResult[] wsGroupDeleteResultArray = wsGroupDeleteResults.getResults();

      for (WsGroupDeleteResult wsGroupDeleteResult : GeneratedClientSettings
          .nonNull(wsGroupDeleteResultArray)) {
        System.out.println(ToStringBuilder.reflectionToString(wsGroupDeleteResult));
      }
    } catch (Exception e) {
