 ...
 *
 */
public class WsSampleGetMembershipsSimple implements WsSampleGenerated {
    /**
    ...
    public void executeSample(WsSampleGeneratedType wsSampleGeneratedType) {
        getMembershipsSimple(wsSampleGeneratedType);
    }
    ...
    public static void getMembershipsSimple(
        ...
        try {
            ...
            getMembershipsSimple.setClientVersion(GeneratedClientSettings.VERSION);
            ...
            getMembershipsSimple.setIncludeSubjectDetail("true");
    ...
    public static void main(String[] args) {
        getMembershipsSimple(WsSampleGeneratedType.SOAP);
    }
}
