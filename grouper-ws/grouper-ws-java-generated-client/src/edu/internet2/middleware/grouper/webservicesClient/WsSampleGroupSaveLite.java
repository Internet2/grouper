...
public class WsSampleGroupSaveLite implements WsSampleGenerated {
   ...
   */
  public static void groupSaveLite(WsSampleGeneratedType wsSampleGeneratedType) {
    try {
      ...
      System.out.println(ToStringBuilder.reflectionToString(wsGroupSaveLiteResults));
    } catch (Exception e) {
