...
public class WsSampleGroupDeleteLite implements WsSampleGenerated {
  ...
  public static void groupDelete(WsSampleGeneratedType wsSampleGeneratedType) {
    try {
      ...
      WsGroupDeleteLiteResult wsGroupDeleteLiteResult = stub.groupDeleteLite(
          groupDeleteLite).get_return();

      System.out.println(ToStringBuilder.reflectionToString(wsGroupDeleteLiteResult));
    } catch (Exception e) {
