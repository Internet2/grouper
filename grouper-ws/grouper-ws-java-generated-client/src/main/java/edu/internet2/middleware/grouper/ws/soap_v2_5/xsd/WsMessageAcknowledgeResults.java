...
/**
 * WsMessageAcknowledgeResults.java
 *
 ...
 */
            ...
            /**
            *  WsMessageAcknowledgeResults bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = WsMessageAcknowledgeResults
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WsMessageAcknowledgeResults",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localMessageIdsTracker){
                             if (localMessageIds!=null) {
                                   ...
                                   for (int i = 0;i < localMessageIds.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd", "messageIds", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static WsMessageAcknowledgeResults parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WsMessageAcknowledgeResults object =
                new WsMessageAcknowledgeResults();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WsMessageAcknowledgeResults".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WsMessageAcknowledgeResults)edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","messageIds").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","messageIds").equals(reader.getName())){
