 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for WsAttributeDefsToSave
                        * This was an Array!
                        */

                        
                                    protected edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[] localWsAttributeDefsToSave ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localWsAttributeDefsToSaveTracker = false ;

                           public boolean isWsAttributeDefsToSaveSpecified(){
                               return localWsAttributeDefsToSaveTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[]
                           */
                           public  edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[] getWsAttributeDefsToSave(){
                               return localWsAttributeDefsToSave;
                           }
                              ...
                              /**
                               * validate the array for WsAttributeDefsToSave
                               */
                              protected void validateWsAttributeDefsToSave(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param WsAttributeDefsToSave
                              */
                              public void setWsAttributeDefsToSave(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[] param){
                              
                                   validateWsAttributeDefsToSave(param);

                               localWsAttributeDefsToSaveTracker = true;
                                      
                                      this.localWsAttributeDefsToSave=param;
                              }
                             ...
                             * @param param edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave
                             */
                             public void addWsAttributeDefsToSave(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave param){
                                   if (localWsAttributeDefsToSave == null){
                                   localWsAttributeDefsToSave = new edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localWsAttributeDefsToSave);
                               list.add(param);
                               this.localWsAttributeDefsToSave =
                             (edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[])list.toArray(
                            new edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":attributeDefSave",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "attributeDefSave",
                ...
                if (localClientVersionTracker){
                             ...
                             } if (localWsAttributeDefsToSaveTracker){
                                       if (localWsAttributeDefsToSave!=null){
                                            for (int i = 0;i < localWsAttributeDefsToSave.length;i++){
                                                if (localWsAttributeDefsToSave[i] != null){
                                                 localWsAttributeDefsToSave[i].serialize(new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAttributeDefsToSave"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd", "wsAttributeDefsToSave", xmlWriter);
                             ...
                             if (localWsAttributeDefsToSave!=null) {
                                 for (int i = 0;i < localWsAttributeDefsToSave.length;i++){
                                    ...
                                    if (localWsAttributeDefsToSave[i] != null){
                                         ...
                                         elementList.add(localWsAttributeDefsToSave[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd",
                                                                          "wsAttributeDefsToSave"));
                                        elementList.add(localWsAttributeDefsToSave);
    ...
    public static class Factory{
        ...
        */
        public static AttributeDefSave parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AttributeDefSave object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"attributeDefSave".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AttributeDefSave)edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAttributeDefsToSave").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap_v2_5.ws.grouper.middleware.internet2.edu/xsd","wsAttributeDefsToSave").equals(reader.getName())){
                                                        ...
                                                        object.setWsAttributeDefsToSave((edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.internet2.middleware.grouper.ws.soap_v2_5.xsd.WsAttributeDefToSave.class,
                                                                list2));
