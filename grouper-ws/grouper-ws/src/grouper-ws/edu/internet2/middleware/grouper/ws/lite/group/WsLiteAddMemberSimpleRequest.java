/*
 * @author mchyzer
 * $Id: WsLiteAddMemberSimpleRequest.java,v 1.1 2008-03-24 20:19:49 mchyzer Exp $
 */
...
/**
 * simple bean that will be the data from rest request
 * @see GrouperServiceLogic#addMemberSimple(edu.internet2.middleware.grouper.ws.GrouperWsVersion, String, String, String, String, String, String, String, String, edu.internet2.middleware.grouper.Field, boolean, boolean, String, String, String, String, String)
 * for simple method
 */
public class WsLiteAddMemberSimpleRequest implements WsRequestBean {
  /** 
   * field
   */
