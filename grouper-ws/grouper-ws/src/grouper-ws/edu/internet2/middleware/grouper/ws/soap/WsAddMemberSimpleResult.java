 ...
 * @author mchyzer
 */
public class WsAddMemberSimpleResult implements WsResponseBean {

  /**
   * empty
   */
  public WsAddMemberSimpleResult() {
    //empty
  }
   ...
   */
  public WsAddMemberSimpleResult(WsAddMemberResults wsAddMemberResults) {
    ...
    if (wsAddMemberResult != null) {
      ...
      this.getResultMetadata().assignResultCode(
          wsAddMemberResult.resultCode().convertToSimpleCode());
  ...
  private static final Log LOG = LogFactory.getLog(WsAddMemberSimpleResult.class);
   ...
   */
  public enum WsAddMemberSimpleResultCode implements WsResultCode {
     ...
     * @param statusCode
     */
    private WsAddMemberSimpleResultCode(int statusCode) {
