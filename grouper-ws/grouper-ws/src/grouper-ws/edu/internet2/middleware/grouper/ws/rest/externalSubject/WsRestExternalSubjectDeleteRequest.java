 ...
 * for method
 */
@ApiModel(description = "bean that will be the data from rest request for deleting an external subject<br /><br /><b>actAsSubjectLookup</b>: If allowed to act as other users (e.g. if a UI uses the Grouper WS behind the scenes), specify the user to act as here<br />"
    + "<br /><br /><b>params</b>: optional params for this request<br />"
    + "<br /><br /><b>wsExternalSubjectLookups</b>: external subject to be deleted<br />")
public class WsRestExternalSubjectDeleteRequest implements WsRequestBean {
