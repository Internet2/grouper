...
public class GrouperServiceLogicTest extends GrouperTest {
  ...
  public void testGetGroups() {
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, WsMemberFilter.Immediate, 
        null, true, true, null, null, "updaters", null, null, null, null, null, null, null, null, 
    ...
    wsSubjectLookup0 = new WsSubjectLookup(SubjectTestHelper.SUBJ0.getId(), null, null);
    wsSubjectLookups = new WsSubjectLookup[] {wsSubjectLookup0};
    
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, WsMemberFilter.Immediate,
        null, true, true,
        null, null, null, null, null, null, null, 2, null, "theGroup.displayNameDb", true, 
        null, null, true, null,
        null, false);
    
//    GROUPER_VERSION, wsSubjectLookups, WsMemberFilter.Immediate,
//    null, true, true, 
//    null, null, null, null, null, null, null, 2, null, "theGroup.displayNameDb", null, 
...
//    Timestamp pointInTimeFrom, Timestamp pointInTimeTo
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, WsMemberFilter.Immediate,
        null, true, true, null, null, null, null, null, null, null, 2, null, "theGroup.displayNameDb", null, 
        null, null, true, wsGroup2.getDisplayName(), "string", false);
    ...
    assertEquals(2, GrouperUtil.length(wsGetGroupsResults.getResults()[0].getWsGroups()));
    WsGroup wsGroup3 = wsGetGroupsResults.getResults()[0].getWsGroups()[0];
    WsGroup wsGroup4 = wsGetGroupsResults.getResults()[0].getWsGroups()[1];
  ...
  public void testGetGroupsPIT() {
    ...
    WsGetGroupsResults wsGetGroupsResults = GrouperServiceLogic.getGroups(
        ...
        null, false, true, null, null, null, null, null, null, null, null, null, null, null, 
        null, new Timestamp(new Date().getTime()), false, null, null, null);
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null, 
        null, false, true, null, null, null, "test2:", null, null, null, null, null, null, null, 
        null, new Timestamp(new Date().getTime()), false, null, null, null);
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null, 
        null, false, true, null, null, null, null, new WsStemLookup(stem.getName(), null), StemScope.ALL_IN_SUBTREE, null, null, null, null, null, 
        null, new Timestamp(new Date().getTime()), false, null, null, null);
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null, 
        null, false, true, null, null, null, null, new WsStemLookup(stem.getName(), null), StemScope.ONE_LEVEL, null, null, null, null, null, 
        null, new Timestamp(new Date().getTime()), false, null, null, null);
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null, 
        null, false, true, null, null, "admins", "test:", null, null, null, null, null, null, null, 
        null, new Timestamp(new Date().getTime()), false, null, null, null);
  ...
  public void testGetMembers() {
    ...
    wsGetMembersResults = GrouperServiceLogic.getMembers(
        GROUPER_VERSION, wsGroupLookups, WsMemberFilter.Immediate, null, 
        FieldFinder.find("updaters", true), true, true, null, null, null, null, 
    ...
    wsGetMembersResults = GrouperServiceLogic.getMembers(
        GROUPER_VERSION, wsGroupLookups, WsMemberFilter.Immediate, null, 
        Group.getDefaultList(), true, true, null, null, null, null, null, 2, null, "subjectId", null,
    ...
    wsSubject = wsGetMembersResults.getResults()[0].getWsSubjects()[1];
    
    assertEquals(SubjectTestHelper.SUBJ1.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ1.getSourceId(), wsSubject.getSourceId());
    ...
    wsGetMembersResults = GrouperServiceLogic.getMembers(
        GROUPER_VERSION, wsGroupLookups, WsMemberFilter.Immediate, null, 
        Group.getDefaultList(), true, true, null, null, null, null, null, 2, null, "subjectId", null,
        false, true, wsSubject.getId(), "string", false);
    ...
    assertEquals(SubjectTestHelper.SUBJ3.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ3.getSourceId(), wsSubject.getSourceId());
  ...
  public void testGetMembersPIT() {
    ...
    //valid query
    {
      ...
      WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
          ...
          Group.getDefaultList(), false, true, null, null, null, null, 
          new Timestamp(new Date().getTime()), null, null, null, null,
          null, null, null, null, null);
...
//    group.addMember(subjectMember);
  ...
  public void testListServicesForUser() {
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
          ...
          null,
          null, null, null, new WsSubjectLookup(SubjectTestHelper.SUBJ0_ID, null, null), ServiceRole.user, null, null, null, null);
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNamesLite(
          ...
          null, null, SubjectTestHelper.SUBJ0_ID, null, null, ServiceRole.user, null, 
          null, null, null);
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
          GROUPER_VERSION, "%", null, null, null, null, null, null, null, null, 
          null, null, null, null, 
          new WsSubjectLookup(SubjectTestHelper.SUBJ0_ID, null, null), ServiceRole.user, null, null, null, null);
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
          GROUPER_VERSION, "%", null, null, null, null, null, null, null, null, 
          null, null, null, null, 
          new WsSubjectLookup(null, null, SubjectTestHelper.SUBJ7_IDENTIFIER), ServiceRole.admin, null, null, null, null);
  ...
  public void testFindAttributeDefNames() {
    ...
    //find no results
    WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "testabc3%", null, null, null, null, null, null, null, null, null,
        null, null, null, null,null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "testabc%", null, null, null, null, null, null, null, null, null, 
        null, null, null, null, null, null, null, null, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, null, null, null, null, null, null, null, null, null, 
        null, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        ...
        new WsAttributeDefNameLookup[]{new WsAttributeDefNameLookup(testAttributeDefName1.getName(), null), 
            new WsAttributeDefNameLookup(null, testAttributeDefName2.getId())}, null, null, null, null, 
        null, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        ...
        new WsAttributeDefNameLookup[]{new WsAttributeDefNameLookup(testAttributeDefName1.getName(), null), 
            new WsAttributeDefNameLookup(null, testAttributeDefName2.getId())}, 
        null, null, null, null, WsInheritanceSetRelation.IMPLIED_BY_THIS, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, null, null, null, null, 
        null, null, null, null, null,
        WsInheritanceSetRelation.IMPLIED_BY_THIS, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "testabc%", null, null, null, null, null, null, 1, null, null, 
        null, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, true, null, null, null, null, null, null, null, null, 
        null, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        ...
        1, 2, "name", false, null, null, null, null, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        ...
        1, 1, "name", false, null, null, null, null, null, null, null, null, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "testabc%", null, null, null, null, null, 1, null, null, null,
        null, null, null, null,
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "testabc%", null, null, null, null, null, 1, null, null, null,  
        null, null, null, null, null, true, testAttributeDefName1.getName(), "string", false);
...
//  //Cant pass in values when deleting attributes
  ...
  public void testGetMembersPaging() {
    ...
    WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
        GROUPER_VERSION, wsGroupLookups, WsMemberFilter.Immediate, null, 
        Group.getDefaultList(), true, true, null, null, null, null, 
        null, 2, 1, null, null, null, null, null, null, false);
  ...
  public void testGetMembersPITpaging() {
    ...
    //valid query
    {
      ...
      WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
          GROUPER_VERSION, wsGroupLookups, WsMemberFilter.All, null, 
          Group.getDefaultList(), false, true, null, null, null, 
          null, new Timestamp(new Date().getTime()), 2, 2, null, null,
          false, null, null, null, null);
  ...
  /**
    ...
    public void testGetMemberships() {
      ...
      String subjectIdNoPrivs = "test.subject.2";
      String subjectIdMember = "test.subject.3";
      String subjectIdPitMember = "test.subject.4";
      GrouperServiceUtils.testSession = GrouperSession.startRootSession();
      Stem stem = new StemSave(GrouperServiceUtils.testSession).assignName(stemName).assignCreateParentStemsIfNotExist(true).save();
      Stem stem2 = new StemSave(GrouperServiceUtils.testSession).assignName(stemName2).assignCreateParentStemsIfNotExist(true).save();
      ...
      Subject subjectNoPrivs = SubjectFinder.findByIdOrIdentifier(subjectIdNoPrivs, true);
      Subject subjectMember = SubjectFinder.findByIdOrIdentifier(subjectIdMember, true);
      Subject subjectPitMember = SubjectFinder.findByIdOrIdentifier(subjectIdPitMember, true);
      ...
      group.addMember(subjectPitMember);
      ChangeLogTempToEntity.convertRecords();
      group.deleteMember(subjectPitMember);
      group.addMember(subjectPitMember);
      ChangeLogTempToEntity.convertRecords();
      ...
      //#################################
      //## test that a privileged user can get PIT results 
      
      GrouperServiceUtils.testSession = GrouperSession.start(subjectWithAdminPriv);

      Timestamp pointInTimeFromTimestamp = GrouperServiceUtils.stringToTimestamp("2019/11/01 10:10:10.000");
      
      wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
          GROUPER_VERSION, null, 
          new WsSubjectLookup[]{new WsSubjectLookup(subjectPitMember.getId(), null, null)}, null, null, 
          null,
          false, null, false, null, null, null, null, null, null, null, null,
          null, null, null, null, 
          null, null, null, null, 
  ...
  public void testFindAttributeDefs() {
    ...
    wsFindAttributeDefsResults = GrouperServiceLogic.findAttributeDefs(
        GROUPER_VERSION, "testabc%", null, wsAttributeDefLookups, null, null, null, null,
        1, 2, "name", false, null, null, null, null, null, null);
...
//    WsSubjectLookup actAsSubjectLookup, WsParam[] params
    wsFindAttributeDefsResults = GrouperServiceLogic.findAttributeDefs(
        GROUPER_VERSION, "testabc%", null, wsAttributeDefLookups, null, null, null, null,
        1, null, null, null, null, null, true, null, null, false);
    ...
    wsFindAttributeDefsResults = GrouperServiceLogic.findAttributeDefs(
        GROUPER_VERSION, "testabc%", null, wsAttributeDefLookups, null, null, null, null,
        1, null, null, null, null, null, true, testAttributeDef.getName(), "string", false);
  ...
  public void testSendMessages() {
    ...
    // happy path
    WsMessageResults wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, "abc", null, null, null, null, true, new WsMessage[] {wsMessage}, actAsSubjectLookup, null);
    ...
    wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, null, null, null, null, null, true, new WsMessage[] {wsMessage}, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
  
    // there has to be at least one message
    wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, "abc", null, null, null, null, true, new WsMessage[] {}, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
  ...
  public void testReceiveMessages() {
    ...
    WsMessageResults wsMessageResults = GrouperServiceLogic.receiveMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, "abc", null, null, null, null, true, 0, 10, actAsSubjectLookup, null);
    assertTrue("test", wsMessageResults.getMessages().length > 0);
    
    // null/blank queueTopicName not allowed
    wsMessageResults = GrouperServiceLogic.receiveMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, null, null, null, null, null, true, 0, 10, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
  ...
  public void testGetMembershipsPagingForMember() {
    ...
    group4.addMember(SubjectTestHelper.SUBJ3);    
    group1.addMember(SubjectTestHelper.SUBJ4);    
    group1.addMember(SubjectTestHelper.SUBJ5);    
    group1.addMember(SubjectTestHelper.SUBJ6);
    group3.addMember(SubjectTestHelper.SUBJ7);
    group4.addMember(SubjectTestHelper.SUBJ8);
    group5.addMember(SubjectTestHelper.SUBJ9);
    ChangeLogTempToEntity.convertRecords();
    ...
    WsGetMembershipsResults wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        GROUPER_VERSION, wsGroupLookups, null, null, null, 
        Group.getDefaultList(), true, null, false, null, null, null, null, null, null, null, null, null, null, null, null,
        null, null,
        null, null, 
        2, 1, "m.subjectIdDb", true,
        null, null, null, null, 
        null, null, null, null, false,
        null, null);
    ...
    assertEquals(wsSubject.getId(), group1.getName(), wsGroup.getName());
    assertEquals(SubjectTestHelper.SUBJ0.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ0.getSourceId(), wsSubject.getSourceId());

    wsSubject = wsGetMembershipsResults.getWsSubjects()[1];
    
    assertEquals(wsSubject.getId(), group1.getName(), wsGroup.getName());
    assertEquals(SubjectTestHelper.SUBJ4.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ4.getSourceId(), wsSubject.getSourceId());
    ...
    assertEquals(wsSubject.getId(), group1.getName(), wsGroup.getName());
    assertEquals(SubjectTestHelper.SUBJ5.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ5.getSourceId(), wsSubject.getSourceId());

    wsSubject = wsGetMembershipsResults.getWsSubjects()[1];
    
    assertEquals(wsSubject.getId(), group1.getName(), wsGroup.getName());
    assertEquals(SubjectTestHelper.SUBJ6.getId(), wsSubject.getId());
    assertEquals(SubjectTestHelper.SUBJ6.getSourceId(), wsSubject.getSourceId());
  ...
  public void testGetAuditEntries() {
    ...
    WsStemLookup wsStemLookup = new WsStemLookup(group1.getParentStemName(), group1.getParentStem().getUuid());
    
    // get all entries
    WsGetAuditEntriesResults auditEntriesResults = GrouperServiceLogic.getAuditEntries(
        GROUPER_VERSION, null, "group", "addGroup",
        null, wsStemLookup, null, 
        null, null, null, null, null,
        null, null,
        false, null, null, null, null, null);
    
    assertEquals(auditEntriesResults.getResultMetadata().getResultMessage(),
        WsGetAuditEntriesResultsCode.SUCCESS.name(), 
        auditEntriesResults.getResultMetadata().getResultCode());
    
    assertEquals(3, GrouperUtil.length(auditEntriesResults.getWsAuditEntries()));
    
    // cursor pagination
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    
    wsStemLookup = new WsStemLookup(group1.getParentStemName(), group1.getParentStem().getUuid());
    
    auditEntriesResults = GrouperServiceLogic.getAuditEntries(
        GROUPER_VERSION, null, "group", "addGroup",
        null, wsStemLookup, null, 
    ...
    assertEquals(2, GrouperUtil.length(auditEntriesResults.getWsAuditEntries()));
    ...
    auditEntriesResults = GrouperServiceLogic.getAuditEntries(
        ...
        "id", true,
        true, auditEntriesResults.getWsAuditEntries()[1].getId(), "string", false,
        null, null);
