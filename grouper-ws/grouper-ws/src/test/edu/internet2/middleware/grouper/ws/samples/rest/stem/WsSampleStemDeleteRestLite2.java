 ...
 * @author mchyzer
 */
public class WsSampleStemDeleteRestLite2 implements WsSampleRest {
  ...
  public static void stemDeleteLite(WsSampleRestType wsSampleRestType) {
    ...
    try {
      ...
      WsRestStemDeleteLiteRequest stemDeleteLite = new WsRestStemDeleteLiteRequest();

      // set the act as id
      stemDeleteLite.setActAsSubjectId("GrouperSystem");

      //get the xml / json / xhtml / paramString
      String requestDocument = wsSampleRestType.getWsLiteRequestContentType().writeString(stemDeleteLite);
      ...
      WsStemDeleteLiteResult wsStemDeleteLiteResult = (WsStemDeleteLiteResult)resultObject;
