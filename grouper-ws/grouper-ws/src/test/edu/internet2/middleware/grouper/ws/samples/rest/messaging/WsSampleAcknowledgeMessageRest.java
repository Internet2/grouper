...
/**
 * @author vsachdeva
 * sample web service client to acknowledge messages
 */
public class WsSampleAcknowledgeMessageRest implements WsSampleRest {

  /**
   * acknowledge messages with REST
   * @param wsSampleRestType is the type of rest (xml, xhtml, etc)
   */
  public static void acknowledgeMessages(WsSampleRestType wsSampleRestType) {
    ...
    try {
      ...
      acknowledgeMessageRequest.setMessageIds(new String[] {"test_message_id"});
      acknowledgeMessageRequest.setQueueOrTopicName("ghi");
      
      //get the xml / json / xhtml / paramString
      String requestDocument = wsSampleRestType.getWsLiteRequestContentType()
          .writeString(acknowledgeMessageRequest);
      ...
      WsMessageAcknowledgeResults wsMessageResutls = (WsMessageAcknowledgeResults) result;
  ...
  public static void main(String[] args) {
    acknowledgeMessages(WsSampleRestType.json);
  }
  ...
  public void executeSample(WsSampleRestType wsSampleRestType) {
    acknowledgeMessages(wsSampleRestType);
  }
