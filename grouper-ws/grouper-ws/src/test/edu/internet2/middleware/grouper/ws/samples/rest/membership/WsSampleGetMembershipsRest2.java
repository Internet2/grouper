 ...
 * @author mchyzer
 */
public class WsSampleGetMembershipsRest2 implements WsSampleRest {
  ...
  public static void getMembershipsLite(WsSampleRestType wsSampleRestType) {
    ...
    try {
      ...
      getMemberships.setWsSubjectLookups(new WsSubjectLookup[]{new WsSubjectLookup("test.subject.0", "jdbc", null)});
      
      getMemberships.setMemberFilter("Immediate");
      getMemberships.setFieldName("members");
  ...
  public static void main(String[] args) {
    getMembershipsLite(WsSampleRestType.json);
  }
