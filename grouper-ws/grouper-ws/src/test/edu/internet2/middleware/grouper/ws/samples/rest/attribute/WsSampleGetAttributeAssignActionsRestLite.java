 ...
 * @author mchyzer
 */
public class WsSampleGetAttributeAssignActionsRestLite implements WsSampleRest {
  ...
  public static void getAttributeAssignments(WsSampleRestType wsSampleRestType) {
    ...
    try {
      ...
      String requestDocument = wsSampleRestType.getWsLiteRequestContentType().writeString(getAttributeAssignActions);
