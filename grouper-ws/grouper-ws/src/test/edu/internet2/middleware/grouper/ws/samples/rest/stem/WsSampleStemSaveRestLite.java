...
public class WsSampleStemSaveRestLite implements WsSampleRest {
  ...
  public static void stemSaveLite(WsSampleRestType wsSampleRestType) {
    ...
    try {
      ...
      WsRestStemSaveLiteRequest stemSaveLite = new WsRestStemSaveLiteRequest();

      // set the act as id
      stemSaveLite.setActAsSubjectId("GrouperSystem");
      stemSaveLite.setStemName("aStem:aStemToSave");
      stemSaveLite.setDescription("desc1");
      stemSaveLite.setDisplayExtension("disp1");

      //get the xml / json / xhtml / paramString
      String requestDocument = wsSampleRestType.getWsLiteRequestContentType().writeString(stemSaveLite);
      ...
      WsStemSaveLiteResult wsStemSaveLiteResult = (WsStemSaveLiteResult)resultObject;
      ...
      System.out.println("Server version: " + wsStemSaveLiteResult.getResponseMetadata().getServerVersion()
