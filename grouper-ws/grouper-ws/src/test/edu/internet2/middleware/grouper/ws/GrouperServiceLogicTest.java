 ...
 ******************************************************************************/
/*
 * @author mchyzer $Id: GrouperServiceLogicTest.java,v 1.2 2008-12-04 07:51:34 mchyzer Exp
 * $
 */
...
public class GrouperServiceLogicTest extends GrouperTest {
  ...
  protected void setUp() {
    ...
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
        .put("attributeDefs.create.grant.all.attrAdmin", "false");
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
        .put("attributeDefs.create.grant.all.attrOptin", "false");
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
        .put("attributeDefs.create.grant.all.attrOptout", "false");
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
        .put("attributeDefs.create.grant.all.attrRead", "false");
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
        .put("attributeDefs.create.grant.all.attrUpdate", "false");
    GrouperConfig.retrieveConfig().propertiesOverrideMap()
    ...
    GrouperWsVersionUtils
        .assignCurrentClientVersion(GROUPER_VERSION, new StringBuilder());
  }
  ...
  public void assertGroupSetsAndOrder(Set<Group> set1, WsGroup[] groupResultArray) {
    ...
    if (set1length != set2length) {
      fail("Expecting groups of size: " + set1length + " but received size: "
          + set2length + ", expecting: "
          + GrouperUtil.toStringForLog(set1, 200) + ", but received: "
          + GrouperUtil.toStringForLog(groupResultArray, 200));
    }
    ...
    for (Group group : set1) {
      if (!StringUtils.equals(group.getName(), groupResultArray[i].getName())) {
        fail("Expecting index of set: " + i + " to be: " + group.getName()
            + ", but received: "
  ...
  public void testGetSubjects() {
    ...
    Group group1 = new GroupSave(GrouperSession.staticGrouperSession())
        ...
        .assignGroupNameToEdit("test:group1").assignName("test:group1")
    ...
    WsGetSubjectsResults wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, null, null, null, false,
        null);
    ...
    assertTrue(GrouperUtil.length(wsGetSubjectsResults.getWsSubjects()) + "",
        GrouperUtil.length(wsGetSubjectsResults.getWsSubjects()) >= 10);
    ...
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, wsGroupLookup, null,
        null, false, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, wsGroupLookup,
        WsMemberFilter.Immediate, null, false, null);
    ...
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, wsGroupLookup,
        WsMemberFilter.NonImmediate, null, false, null);
    ...
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, wsGroupLookup, null,
        Group.getDefaultList(), false, null);
    ...
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, null, wsGroupLookup, null,
        FieldFinder.find("admins", true), false, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null,
        new String[] { SubjectTestHelper.SUBJ0.getSourceId() }, wsGroupLookup, null,
        null, false, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, null, "test.", false, null, null, new String[] { group1
            .toSubject().getSourceId() }, wsGroupLookup, null, null, false, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetSubjectsResults = GrouperServiceLogic.getSubjects(
        GROUPER_VERSION, new WsSubjectLookup[] { new WsSubjectLookup(
            SubjectTestHelper.SUBJ0_ID, null, null) },
  ...
  public void testFindGroups() {
    ...
    Group testRole = new GroupSave(grouperSession).assignName("test:role")
        .assignTypeOfGroup(TypeOfGroup.role).save();
    Group testEntity = new GroupSave(grouperSession).assignName("test:entity")
        .assignTypeOfGroup(TypeOfGroup.entity).save();

    Group testGroup2 = new GroupSave(grouperSession).assignName("test:sub:group2").save();
    Group testRole2 = new GroupSave(grouperSession).assignName("test:sub:role2")
        .assignTypeOfGroup(TypeOfGroup.role).save();
    Group testEntity2 = new GroupSave(grouperSession).assignName("test:sub:entity2")
        .assignTypeOfGroup(TypeOfGroup.entity).save();
    ...
    assertGroupSetsAndOrder(
        GrouperUtil.toSet(testEntity, testRole, testEntity2, testRole2), wsGroups);
    ...
    wsGroups = GrouperServiceLogic.findGroups(
        ...
        null,
        new WsGroupLookup[] {
            new WsGroupLookup(null, null, testRole.getIdIndex().toString()),
            new WsGroupLookup(null, null, testRole2.getIdIndex().toString()) })
        .getGroupResults();
  ...
  public void testGetGroups() {
    ...
    Group group2 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:group2").assignName("test:group2")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    Group group3 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:group3").assignName("test:group3")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    Group group4 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:group4").assignName("test:group4")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();
    ...
    WsSubjectLookup wsSubjectLookup0 = new WsSubjectLookup(
        SubjectTestHelper.SUBJ0.getId(), null, null);
    ...
    WsGetGroupsResults wsGetGroupsResults = GrouperServiceLogic.getGroups(
        ...
        null, true, true, null, null, null, null, null, null, null, null, null, null,
        null, null, null);
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, WsMemberFilter.Immediate,
        null, true, true, null, null, "updaters", null, null, null, null, null, null,
        null, null, null, null);
  ...
  public void testGetGroupsPIT() {
    ...
    WsGetGroupsResults wsGetGroupsResults = GrouperServiceLogic.getGroups(
        ...
        null, false, true, null, null, null, null, null, null, null, null, null, null,
        null, null, new Timestamp(new Date().getTime()));
    ...
    Group group5 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test2:group5").assignName("test2:group5")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    Group group6 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test2:sub:group6").assignName("test2:sub:group6")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null,
        null, false, true, null, null, null, "test2:", null, null, null, null, null,
        null, null, null, new Timestamp(new Date().getTime()));
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        ...
        new WsStemLookup(stem.getName(), null), StemScope.ALL_IN_SUBTREE, null, null,
        null, null, null, null, new Timestamp(new Date().getTime()));
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null,
        null, false, true, null, null, null, null,
        new WsStemLookup(stem.getName(), null), StemScope.ONE_LEVEL, null, null, null,
        null, null, null, new Timestamp(new Date().getTime()));
    ...
    wsGetGroupsResults = GrouperServiceLogic.getGroups(
        GROUPER_VERSION, wsSubjectLookups, null,
        null, false, true, null, null, "admins", "test:", null, null, null, null, null,
        null, null, null, new Timestamp(new Date().getTime()));
  ...
  public void testHasMember() {
    ...
    WsSubjectLookup wsSubjectLookup1 = new WsSubjectLookup(
        SubjectTestHelper.SUBJ1.getId(), null, null);
    WsSubjectLookup[] wsSubjectLookups = new WsSubjectLookup[] { wsSubjectLookup0,
        wsSubjectLookup1 };
    ...
    if (wsSubject1.getId().equals(SubjectTestHelper.SUBJ0.getId())) {
      ...
      assertEquals(WsHasMemberResultCode.IS_MEMBER,
          wsHasMemberResults.getResults()[0].resultCode());
      assertEquals(WsHasMemberResultCode.IS_NOT_MEMBER,
          wsHasMemberResults.getResults()[1].resultCode());
    } else {
    ...
    WsSubjectLookup wsSubjectLookup2 = new WsSubjectLookup(
        SubjectTestHelper.SUBJ2.getId(), null, null);
  ...
  public void testGetMembers() {
    ...
    WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
        ...
        Group.getDefaultList(), true, true, null, null, null, null, null, null, null,
        null, null);
    ...
    assertEquals(1,
        GrouperUtil.length(wsGetMembersResults.getResults()[0].getWsSubjects()));
  ...
  public void testGetMembersPIT() {
    ...
    //valid query
    {
      ...
      WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
          ...
          Group.getDefaultList(), false, true, null, null, null, null, new Timestamp(
              new Date().getTime()), null, null, null, null);
      ...
      assertTrue(SubjectTestHelper.SUBJ0.getId().equals(wsSubject1.getId())
          || SubjectTestHelper.SUBJ0.getId().equals(wsSubject2.getId()));
      assertTrue(SubjectTestHelper.SUBJ1.getId().equals(wsSubject1.getId())
          || SubjectTestHelper.SUBJ1.getId().equals(wsSubject2.getId()));
    ...
    //another valid query -- this time recreate the deleted group and find by name
    {
      ...
      if (GrouperUtil.length(wsGetMembersResults.getResults()[0].getWsSubjects()) == 1) {
        assertEquals(2,
            GrouperUtil.length(wsGetMembersResults.getResults()[1].getWsSubjects()));
  ...
  public void testSaveGroupDetailInsert() throws SessionException {
    ...
    WsSubjectLookup actAsSubjectLookup = new WsSubjectLookup(SubjectFinder
        .findRootSubject().getId(), null, null);
    WsGroupSaveResults wsGroupSaveResults = GrouperServiceLogic.groupSave(
        GrouperVersion.valueOfIgnoreCase("v1_4_000"),
    ...
    if (!StringUtils.equals("T", wsGroupSaveResults.getResultMetadata().getSuccess())) {
      int index = 0;
      for (WsGroupSaveResult wsGroupSaveResult : GrouperUtil.nonNull(
          wsGroupSaveResults.getResults(), WsGroupSaveResult.class)) {
        if (!StringUtils.equals("T", wsGroupSaveResult.getResultMetadata().getSuccess())) {
          System.out.println("Error on index: " + index + ", "
              + wsGroupSaveResult.getResultMetadata().getResultMessage());
        }
        index++;
      }
    }
    ...
    wsGroupSaveResults = GrouperServiceLogic.groupSave(
        GrouperVersion.valueOfIgnoreCase("v1_4_000"),
        new WsGroupToSave[] { leftGroupToSave, rightGroupToSave, wsGroupToSave },
        actAsSubjectLookup, GrouperTransactionType.NONE, true, null);
    ...
    wsGroupDetail.setLeftGroup(leftWsGroup);
    wsGroupDetail.setRightGroup(rightWsGroup);
    actAsSubjectLookup = new WsSubjectLookup(SubjectFinder.findRootSubject().getId(),
        null, null);
  ...
  public void testGetAttributeAssignmentsMember() {
    ...
    AttributeDefName attributeDefName2 = AttributeDefNameTest.exampleAttributeDefNameDb(
        "test", "testAttributeAssignAssignName");
    ...
    attributeDef2.getPrivilegeDelegate().grantPriv(SubjectTestHelper.SUBJ0,
        AttributeDefPrivilege.ATTR_READ, false);

    Member member = MemberFinder.findBySubject(GrouperServiceUtils.testSession,
    ...
    AttributeAssignResult attributeAssignResult = member.getAttributeDelegate()
    ...
    //valid query
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            GROUPER_VERSION, AttributeAssignType.member, null, null, null,
            null, null, new WsSubjectLookup[] { new WsSubjectLookup(
                member.getSubjectId(), member.getSubjectSourceId(), null) }, null,
            null, null, null, false, null, false, null, false, null, null, null, null,
    ...
    assertEquals(1,
        GrouperUtil.length(wsGetAttributeAssignmentsResults.getWsAttributeAssigns()));

    WsAttributeAssign wsAttributeAssign = wsGetAttributeAssignmentsResults
        .getWsAttributeAssigns()[0];

    assertEquals(attributeAssign.getId(), wsAttributeAssign.getId());

    assertEquals(SubjectTestHelper.SUBJ0_ID,
        wsGetAttributeAssignmentsResults.getWsSubjects()[0].getId());
  ...
  public void testGetAttributeAssignmentsMembership() {
    ...
    Group group1 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:membershipTestAttrAssign")
        .assignName("test:membershipTestAttrAssign")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    group1.addMember(SubjectTestHelper.SUBJ0);

    Membership membership = group1.getMemberships(FieldFinder.find("members", true))
        .iterator().next();

    AttributeAssignResult attributeAssignResult = membership.getAttributeDelegate()
        .assignAttribute(attributeDefName);
    AttributeAssign attributeAssign = attributeAssignResult.getAttributeAssign();
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            null, null, null, new WsMembershipLookup[] { new WsMembershipLookup(
                membership.getUuid()) },
            null, null, null, false, null, false, null, false, null, null, null, null,
            false, null, null, null, null, null);
    ...
    assertEquals(membership.getImmediateMembershipId(),
        wsGetAttributeAssignmentsResults.getWsMemberships()[0].getImmediateMembershipId());
    assertEquals(membership.getUuid(),
        wsGetAttributeAssignmentsResults.getWsMemberships()[0].getMembershipId());
  ...
  public void testGetAttributeAssignmentsStem() {
    ...
    Stem stem = new StemSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignStemNameToEdit("test:stemTestAttrAssign")
        .assignName("test:stemTestAttrAssign").assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    AttributeAssignResult attributeAssignResult = stem.getAttributeDelegate()
        .assignAttribute(attributeDefName);
    AttributeAssign attributeAssign = attributeAssignResult.getAttributeAssign();
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            null, new WsStemLookup[] { new WsStemLookup(stem.getName(), null) }, null,
            null,
            null, null, null, false, null, false, null, false, null, null, null, null,
            false, null, null, null, null, null);
    ...
    assertEquals(stem.getName(),
        wsGetAttributeAssignmentsResults.getWsStems()[0].getName());

    WsAttributeAssignValue[] wsAttributeAssignValues = wsAttributeAssign
        .getWsAttributeAssignValues();

    assertEquals(1, GrouperUtil.length(wsAttributeAssignValues));

    assertEquals(GrouperServiceUtils.dateToString(now),
        wsAttributeAssignValues[0].getValueSystem());
  ...
  public void testGetPermissionAssignments() {
    ...
    GrouperSession grouperSession = GrouperSession.startRootSession();
    Stem top = StemFinder.findRootStem(grouperSession).addChildStem("top",
        "top display name");
    ...
    AttributeDef attributeDef = top.addChildAttributeDef("attributeDef",
        AttributeDefType.perm);
    attributeDef.setAssignToEffMembership(true);
    attributeDef.setAssignToGroup(true);
    attributeDef.store();
    AttributeDefName attrDefName = top.addChildAttributeDefName(attributeDef,
        "attrDefName", "attrDefName");
    AttributeDefName attrDefName2 = top.addChildAttributeDefName(attributeDef,
        "attrDefName2", "attrDefName2");
    ...
    AttributeDef assignOnAssignDef = top.addChildAttributeDef("assignOnAssignDef",
        AttributeDefType.limit);
    ...
    GrouperConfig
        ...
        .put("grouper.permissions.limits.logic.customEl.limitName",
            assignOnAssignDefName.getName());
    GrouperConfig
        .retrieveConfig()
        .propertiesOverrideMap()
        .put("grouper.permissions.limits.logic.customEl.logicClass",
            PermissionLimitElLogic.class.getName());

    AttributeValueResult attributeValueResult = attributeAssignResult
        .getAttributeAssign()
        .getAttributeValueDelegate()
        .assignValueString(assignOnAssignDefName.getName(), "amount < 50");
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        ...
        null, false, false, false, false, null, false, null, false, null, null, null,
        null, false, null,
        PermissionProcessor.FILTER_REDUNDANT_PERMISSIONS_AND_PROCESS_LIMITS, null, false);

    //new WsGroupLookup[]{new WsGroupLookup(group.getName(), null)}

    assertEquals("You must pass in some criteria",
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        ...
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup("top:abc", null) },
        null, null,
        null, false, false, false, false, null, false, null, false, null, null, null,
        null,
    ...
    assertEquals(0,
        GrouperUtil.length(wsGetPermissionAssignmentsResults.getWsPermissionAssigns()));
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null, null, null, null,
        new String[] { "action" }, false, false, false, false, null, false, null, false,
        null,
        null, null, null, false, null, null, null, false);

    assertEquals("This is ok: "
        + wsGetPermissionAssignmentsResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsGetPermissionAssignmentsResults.getResultMetadata().getResultCode());
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null,
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup("top:attrDefName",
            null) }, null, null,
        null, false, false, false, false, null, false, null, false, null, null, null,
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null,
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup("top:attrDefName2",
            null) }, null, null,
        null, false, false, false, false, null, false, null, false, null, null, null,
        null, false, null, null, null, false);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        null, false, false, false, false, null, false, null, false, null, null, null,
        null, false, null, null, null, false);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null, null,
        new WsGroupLookup[] { new WsGroupLookup(role.getName(), null) }, null,
        null, false, false, false, false, null, false, null, false, null, null, null,
        null, false, null, null, null, false);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null, null, null, new WsSubjectLookup[] { new WsSubjectLookup(
            SubjectTestHelper.SUBJ0_ID, null, null) },
        null, false, false, false, false, null, false, null, false, null, null, null,
        null, false, null, null, null, false);
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, true, false, false, false, null, false, null, false,
        null, null, null, null,
        false, null, null, null, false);
    ...
    assertEquals(
        MemberFinder.findBySubject(GrouperServiceUtils.testSession,
            SubjectTestHelper.SUBJ1, true).getUuid(), wsPermissionAssign.getDetail()
            .getMemberId());
    ...
    assertEquals("If not a role assignment, this is not used, -1", "-1",
        wsPermissionAssign.getDetail().getRoleSetDepth());
    assertEquals(0,
        GrouperUtil.length(wsGetPermissionAssignmentsResults.getWsAttributeDefNames()));
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, null, null, null, new WsSubjectLookup[] { new WsSubjectLookup(
            SubjectTestHelper.SUBJ1_ID, null, null) },
        null, false, true, false, false, null, false, null, false, null, null, null,
        null,
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, false, true, false, false, null, false, null, false,
        null, null, null, null,
        false, null, null, null, false);
    ...
    assertEquals(1,
        GrouperUtil.length(wsGetPermissionAssignmentsResults.getWsAttributeDefNames()));
    assertEquals(attrDefName2.getId(),
        wsGetPermissionAssignmentsResults.getWsAttributeDefNames()[0].getUuid());
    assertEquals(attrDefName2.getName(),
        wsGetPermissionAssignmentsResults.getWsAttributeDefNames()[0].getName());

    assertEquals(0,
        GrouperUtil.length(wsGetPermissionAssignmentsResults.getWsAttributeAssigns()));
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, false, false, true, false, null, false, null, false,
        null, null, null,
        null, false, null, null, null, false);
    ...
    assertEquals("action2",
        wsGetPermissionAssignmentsResults.getWsAttributeAssigns()[0]
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, false, false, false, true, null, false, null, false,
        null, null, null,
        null, false, null, null, null, false);
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, false, false, true, true, null, false, null, false,
        null,
        null, null, null, false, null, null, null, false);
    ...
    assertEquals("action2",
        wsGetPermissionAssignmentsResults.getWsAttributeAssigns()[0]
            .getAttributeAssignActionName());
    assertEquals("assign",
        wsGetPermissionAssignmentsResults.getWsAttributeAssigns()[1]
            .getAttributeAssignActionName());
    assertEquals(attributeValueResult.getAttributeAssignResult().getAttributeAssign()
        .getId(), wsGetPermissionAssignmentsResults.getWsAttributeAssigns()[1].getId());
    assertEquals(1, GrouperUtil.length(wsGetPermissionAssignmentsResults
        .getWsAttributeAssigns()[1].getWsAttributeAssignValues()));
    assertEquals("amount < 50",
        wsGetPermissionAssignmentsResults.getWsAttributeAssigns()[1]
            .getWsAttributeAssignValues()[0].getValueSystem());
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        GROUPER_VERSION, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
            "top:attributeDef", null) }, null, null, null,
        new String[] { "action2" }, false, false, false, false, null, false, null, true,
        null, null,
    ...
    assertEquals("F", wsGetPermissionAssignmentsResults.getWsGroups()[0].getDetail()
  ...
  public void testGetPermissionAssignmentsPIT() {
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        ...
        null, null, null, new Timestamp(new Date().getTime()), false, null, null, null,
        false);
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        ...
        false, null, null, null, new Timestamp(new Date().getTime()), false, null, null,
        null, false);
    ...
    wsGetPermissionAssignmentsResults = GrouperServiceLogic.getPermissionAssignments(
        ...
        false, null, false, null, null, null, new Timestamp(new Date().getTime()), false,
  ...
  public void testGetGrouperPrivilegesLite() {
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    Stem stem = new StemSave(GrouperServiceUtils.testSession).assignName(stemName)
        .assignCreateParentStemsIfNotExist(true).save();
    Stem stem2 = new StemSave(GrouperServiceUtils.testSession).assignName(stemName2)
        .assignCreateParentStemsIfNotExist(true).save();
    Group group = new GroupSave(GrouperServiceUtils.testSession).assignName(groupName)
        .assignCreateParentStemsIfNotExist(true).save();
    Group group2 = new GroupSave(GrouperServiceUtils.testSession).assignName(groupName2)
        .assignCreateParentStemsIfNotExist(true).save();
    Subject subjectWithAdminPriv = SubjectFinder.findByIdOrIdentifier(
        subjectIdWithAdminPriv, true);
    Subject subjectWithUpdatePriv = SubjectFinder.findByIdOrIdentifier(
        subjectIdWithUpdatePriv, true);
    ...
    Group whitelistGroup = new GroupSave(GrouperServiceUtils.testSession)
        .assignName("test:whitelistGroup")
        .assignCreateParentStemsIfNotExist(true).save();
    ...
    assertEquals(GrouperUtil.toStringForLog(wsGetGrouperPrivilegesLiteResult
        .getPrivilegeResults()),
    ...
    String oldName = GrouperWsConfig.retrieveConfig().propertiesOverrideMap()
        .get("ws.groupNameOfUsersWhoCanCheckAllPrivileges");
    GrouperWsConfig.retrieveConfig().propertiesOverrideMap()
        .put("ws.groupNameOfUsersWhoCanCheckAllPrivileges", whitelistGroup.getName());
    ...
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        subjectWithAdminPriv, AccessPrivilege.ADMIN);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        SubjectFinder.findAllSubject(), AccessPrivilege.READ);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        SubjectFinder.findAllSubject(), AccessPrivilege.VIEW);

    if (oldName == null) {
      GrouperWsConfig.retrieveConfig().propertiesOverrideMap()
          .remove("ws.groupNameOfUsersWhoCanCheckAllPrivileges");
    } else {
      GrouperWsConfig.retrieveConfig().propertiesOverrideMap()
          .put("ws.groupNameOfUsersWhoCanCheckAllPrivileges", oldName);
    }
    ...
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        subjectWithUpdatePriv, AccessPrivilege.UPDATE);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        SubjectFinder.findAllSubject(), AccessPrivilege.READ);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        SubjectFinder.findAllSubject(), AccessPrivilege.VIEW);
    ...
    assertTrue(GrouperUtil.toStringForLog(wsGetGrouperPrivilegesLiteResult
        .getPrivilegeResults()),
    ...
    wsGetGrouperPrivilegesLiteResult = GrouperServiceLogic.getGrouperPrivilegesLite(
        ...
        null, stemName, null, null, null, null, null, null, false, null, false, null,
        null, null, null);
    ...
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), stemName,
        subjectWithUpdatePriv, NamingPrivilege.CREATE);
    ...
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), stemName,
        subjectWithUpdatePriv, NamingPrivilege.CREATE);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), stemName,
        subjectWithAdminPriv, NamingPrivilege.STEM);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), stemName,
        SubjectFinder.findRootSubject(), NamingPrivilege.STEM);
    ...
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        subjectWithUpdatePriv, AccessPrivilege.UPDATE);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        subjectWithUpdatePriv, AccessPrivilege.VIEW);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), groupName,
        subjectWithUpdatePriv, AccessPrivilege.READ);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(), stemName2,
        subjectWithUpdatePriv, NamingPrivilege.CREATE);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(),
        groupName2, subjectWithUpdatePriv, AccessPrivilege.UPDATE);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(),
        groupName2, subjectWithUpdatePriv, AccessPrivilege.VIEW);
    assertHasPrivilege(wsGetGrouperPrivilegesLiteResult.getPrivilegeResults(),
        groupName2, subjectWithUpdatePriv, AccessPrivilege.READ);
   ...
   * @param privilege
   */
  public void assertHasPrivilege(WsGrouperPrivilegeResult[] wsGrouperPrivilegeResults,
      String ownerName, Subject subject, Privilege privilege) {
    for (WsGrouperPrivilegeResult wsGrouperPrivilegeResult : GrouperUtil.nonNull(
        wsGrouperPrivilegeResults, WsGrouperPrivilegeResult.class)) {
      if (Privilege.isAccess(privilege)) {

        if (StringUtils.equals(wsGrouperPrivilegeResult.getAllowed(), "T")
            && StringUtils.equals(wsGrouperPrivilegeResult.getPrivilegeName(),
                privilege.getName())
            && StringUtils.equals(wsGrouperPrivilegeResult.getWsGroup().getName(),
                ownerName)
            && (StringUtils.equals(wsGrouperPrivilegeResult.getWsSubject().getId(),
                subject.getId())
                && StringUtils.equals(wsGrouperPrivilegeResult.getWsSubject()
                    .getSourceId(), subject.getSourceId())
                || (StringUtils.equals(
                wsGrouperPrivilegeResult.getOwnerSubject().getId(), subject.getId())
            && StringUtils.equals(wsGrouperPrivilegeResult.getOwnerSubject()
                .getSourceId(), subject.getSourceId())))) {
          return;
        }
        ...
        if (StringUtils.equals(wsGrouperPrivilegeResult.getAllowed(), "T")
            && StringUtils.equals(wsGrouperPrivilegeResult.getPrivilegeName(),
                privilege.getName())
            && StringUtils.equals(wsGrouperPrivilegeResult.getWsStem().getName(),
                ownerName)
            && StringUtils.equals(wsGrouperPrivilegeResult.getOwnerSubject().getId(),
                subject.getId())
            && StringUtils.equals(wsGrouperPrivilegeResult.getOwnerSubject()
                .getSourceId(), subject.getSourceId())) {
          return;
    ...
    fail("\nExpected user: " + subject.getSourceId() + " - " + subject.getId()
        + " to have " + privilege.getName() + " on " + ownerName
        + ", but these were the privs:\n"
   ...
   * @param field
   */
  public void assertHasMembership(WsMembership[] wsMemberships, String ownerName,
      Subject subject, Field field) {
    for (WsMembership wsMembership : GrouperUtil.nonNull(wsMemberships,
        WsMembership.class)) {
      if (field.isGroupListField()) {
        ...
        if (StringUtils.equals(wsMembership.getListName(), field.getName())
            ...
            && StringUtils.equals(wsMembership.getSubjectSourceId(),
                subject.getSourceId())) {
          return;
        }
  ...
  public void testGetAttributeAssignmentsGroup() {
    ...
    Group group = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:groupTestAttrAssign")
        .assignName("test:groupTestAttrAssign").assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    Group group2 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:groupTestAttrAssign2")
    ...
    AttributeAssignResult attributeAssignResult = group.getAttributeDelegate()
        .assignAttribute(attributeDefName);
    AttributeAssign attributeAssign = attributeAssignResult.getAttributeAssign();

    AttributeAssignResult attributeAssignResult2 = attributeAssign.getAttributeDelegate()
        .assignAttribute(attributeDefName2);
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) }, null, null,
            null,
            null, null, null, false, null, false, null, false, null, null, null, null,
            false, null, null, null, null, null);
    ...
    assertEquals(attributeAssign.getAttributeAssignActionId(),
        wsAttributeAssign.getAttributeAssignActionId());
    ...
    assertEquals(attributeAssign.getAttributeDefName().getAttributeDefId(),
        wsAttributeAssign.getAttributeDefId());
    assertEquals("test:testAttributeAssignDefNameDef",
        wsAttributeAssign.getAttributeDefName());
    assertEquals(attributeAssign.getAttributeDefNameId(),
        wsAttributeAssign.getAttributeDefNameId());
    assertEquals("test:testAttributeAssignDefName",
        wsAttributeAssign.getAttributeDefNameName());
    assertEquals(GrouperServiceUtils.dateToString(attributeAssign.getCreatedOn()),
        wsAttributeAssign.getCreatedOn());
    assertEquals(GrouperServiceUtils.dateToString(attributeAssign.getDisabledTime()),
        wsAttributeAssign.getDisabledTime());
    assertEquals("T", wsAttributeAssign.getEnabled());
    assertEquals(GrouperServiceUtils.dateToString(attributeAssign.getEnabledTime()),
        wsAttributeAssign.getEnabledTime());
    assertEquals(attributeAssign.getId(), wsAttributeAssign.getId());
    assertEquals(GrouperServiceUtils.dateToString(attributeAssign.getLastUpdated()),
        wsAttributeAssign.getLastUpdated());
    ...
    assertEquals(group.getName(),
        wsGetAttributeAssignmentsResults.getWsGroups()[0].getName());
    ...
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        ...
        new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) }, null, null,
        null,
        null, null, null, false, null, false, null, false, null, null, null, null, false,
    ...
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        ...
        new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) }, null, null,
        null,
        null, null, null, true, null, false, null, false, null, null, null, null, false,
        null, null, null, null, null);
    ...
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        ...
        new WsAttributeAssignLookup[] { new WsAttributeAssignLookup(attributeAssign
            .getId()) }, null, null,
        null, null, null, null,
        null, null, null, false, null, false, null, false, null, null, null, null, false,
        null, null, null, null, null);
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        GROUPER_VERSION, AttributeAssignType.group, null,
        new WsAttributeDefLookup[] { new WsAttributeDefLookup(attributeDef.getName(),
            null) }, null,
        null, null, null, null,
        null, null, null, false, null, false, null, false, null, null, null, null, false,
        null, null, null, null, null);
    ...
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        ...
        null,
        null,
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(attributeDefName
            .getName(), null) },
        null, null, null, null,
        null, null, null, false, null, false, null, false, null, null, null, null, false,
        null, null, null, null, null);
    ...
    wsGetAttributeAssignmentsResults = GrouperServiceLogic.getAttributeAssignments(
        GROUPER_VERSION, AttributeAssignType.group, null, null, null,
        new WsGroupLookup[] { new WsGroupLookup(group.getName(), null),
            new WsGroupLookup(group2.getName(), null) },
        null, null, null,
        null, null, null, false, null, false, null, false, null, null, null, null, false,
        null, null, null, null, null);
  ...
  public void testListServicesForUser() {
    ...
    try {
      ...
      AttributeDef jiraServiceDef = new AttributeDefSave(grouperSession)
          .assignCreateParentStemsIfNotExist(true)
          .assignAttributeDefType(AttributeDefType.service)
      ...
      jiraService = new AttributeDefNameSave(grouperSession, jiraServiceDef)
          .assignCreateParentStemsIfNotExist(true)
          .assignName("apps:jira:jiraService")
          .assignDisplayExtension("Central IT production Jira issue tracker").save();

      //jira group
      Group jiraGroup = new GroupSave(grouperSession)
          .assignName("apps:jira:groups:admins").assignCreateParentStemsIfNotExist(true)
          .save();
      ...
      AttributeDef confluenceServiceDef = new AttributeDefSave(grouperSession)
          .assignCreateParentStemsIfNotExist(true)
          .assignAttributeDefType(AttributeDefType.service)
          .assignName("apps:confluence:confluenceServiceDefinition").assignToStem(true)
          .save();

      confluenceService = new AttributeDefNameSave(grouperSession, confluenceServiceDef)
          .assignCreateParentStemsIfNotExist(true)
          .assignName("apps:confluence:confluenceService")
          .assignDisplayExtension("Central IT production Confluence wiki").save();

      Group confluenceGroup = new GroupSave(grouperSession)
          .assignName("apps:confluence:editors").assignCreateParentStemsIfNotExist(true)
          .save();
      ...
      Stem confluenceFolder = StemFinder.findByName(grouperSession, "apps:confluence",
          true);
      ...
      AttributeDef directoryServiceDef = new AttributeDefSave(grouperSession)
          .assignCreateParentStemsIfNotExist(true)
          .assignAttributeDefType(AttributeDefType.service)
          .assignName("apps:directory:directoryServiceDefinition").assignToStem(true)
          .save();

      directoryService = new AttributeDefNameSave(grouperSession, directoryServiceDef)
          .assignCreateParentStemsIfNotExist(true)
          .assignName("apps:directory:directoryService")
          .assignDisplayExtension("MySchool directory").save();

      Group directoryGroup = new GroupSave(grouperSession)
          .assignName("apps:directory:users").assignCreateParentStemsIfNotExist(true)
          .save();
      ...
      //the confluence folder has the confluence service tag
      Stem directoryFolder = StemFinder
          .findByName(grouperSession, "apps:directory", true);
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic
          .findAttributeDefNames(
              GROUPER_VERSION, "%", null, null, null, null, null, null, null, null,
              null, null, null, null, new WsSubjectLookup(SubjectTestHelper.SUBJ0_ID,
                  null, null), ServiceRole.user);

      WsAttributeDefName[] wsAttributeDefNames = wsFindAttributeDefNamesResults
          .getAttributeDefNameResults();

      assertEquals(GrouperUtil.toStringForLog(wsAttributeDefNames), 1,
          GrouperUtil.length(wsAttributeDefNames));
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic
          .findAttributeDefNamesLite(
              ...
              SubjectTestHelper.SUBJ0_ID, null, null, ServiceRole.user);
    ...
    try {
      ...
      assertEquals(GrouperUtil.toStringForLog(wsAttributeDefNames), 0,
          GrouperUtil.length(wsAttributeDefNames));
      //assertEquals(jiraService.getId(), wsAttributeDefNames[0].getUuid());
    ...
    try {
      ...
      WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic
          .findAttributeDefNames(
              GROUPER_VERSION, "%", null, null, null, null, null, null, null, null,
              null, null, null, null, new WsSubjectLookup(null, null,
                  SubjectTestHelper.SUBJ7_IDENTIFIER), ServiceRole.admin);
  ...
  public void testGetAttributeAssignmentsAnyMembership() {
    ...
    Group group1 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:anyMembershipTestAttrAssign")
        .assignName("test:anyMembershipTestAttrAssign")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();

    Group group2 = new GroupSave(GrouperSession.staticGrouperSession())
        .assignSaveMode(SaveMode.INSERT_OR_UPDATE)
        .assignGroupNameToEdit("test:anyMembershipTestAttrAssign2")
        .assignName("test:anyMembershipTestAttrAssign2")
        .assignCreateParentStemsIfNotExist(true)
        .assignDescription("description").save();
    ...
    Membership membership = (Membership) MembershipFinder
        .findMemberships(GrouperUtil.toSet(group1.getId()),
            GrouperUtil.toSet(member.getUuid()), null, null,
            FieldFinder.find("members", true), null, null, null, null, null).iterator()
        .next()[0];

    AttributeAssignResult attributeAssignResult = membership
        .getAttributeDelegateEffMship().assignAttribute(attributeDefName);
    AttributeAssign attributeAssign = attributeAssignResult.getAttributeAssign();
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            null, null, null, null,
            new WsMembershipAnyLookup[] { new WsMembershipAnyLookup(new WsGroupLookup(
                group1.getName(), group1.getUuid()),
                new WsSubjectLookup(member.getSubjectId(), member.getSubjectSourceId(),
                    null)) },
            null, null, false, null, false, null, false, null, null, null, null, false,
            null, null, null, null, null);
  ...
  public void testGetAttributeAssignmentsAttributeDef() {
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            null,
            null,
            new WsAttributeDefLookup[] { new WsAttributeDefLookup(attributeDefAssignTo
                .getName(), null) },
            null, false, null, false, null, false, null, null, null, null, false, null,
            null, null, null, null);
    ...
    assertEquals(attributeDefAssignTo.getName(),
        wsGetAttributeAssignmentsResults.getWsAttributeDefs()[1].getName());
  ...
  public void testAssignAttributes() {
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            GROUPER_VERSION, null,
            new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(
                attributeDefName.getName(), null) },
            AttributeAssignOperation.assign_attr, null,
            null, null, null, null, null, null, new WsGroupLookup[] { new WsGroupLookup(
                group.getName(), null) }, null, null, null,
    ...
    assertTrue(
        "You must pass in an attributeAssignType",
        wsAssignAttributesResults.getResultMetadata().getResultMessage()
            .contains("You need to pass in an attributeAssignType"));
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        ...
        AttributeAssignOperation.assign_attr, null,
        null, null, null, null, null,
        new WsAttributeAssignLookup[] { new WsAttributeAssignLookup("abc") },
        new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) }, null, null,
        null,
        null, null, null, null, null, false, null, false, null, null, null, null);

    assertEquals("Cant do defName and assign lookup",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertTrue(
        wsAssignAttributesResults.getResultMetadata().getResultMessage(),
    ...
    assertTrue(
        ...
        wsAssignAttributesResults.getResultMetadata().getResultMessage()
            .contains("Why is there more than one type of lookup?"));
    ...
    assertEquals("Need to pass in attributeAssignOperation",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertTrue(
        "Need to pass in attributeAssignOperation",
        wsAssignAttributesResults.getResultMetadata().getResultMessage()
            .contains("You need to pass in an attributeAssignOperation"));
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        GROUPER_VERSION, AttributeAssignType.group, null,
        AttributeAssignOperation.add_attr, null,
        null, null, null, null, null,
        new WsAttributeAssignLookup[] { new WsAttributeAssignLookup("abc") },
        null, null, null, null,
        null, null, null, null, null, false, null, false, null, null, null, null);

    assertEquals("attributeAssignOperation must be assign_attr",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    ...
    assertEquals("but this operation was passed attributeAssignType",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertTrue(wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        wsAssignAttributesResults.getResultMetadata().getResultMessage().contains(
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    group.getAttributeDelegate().removeAttribute(attributeDefName);
    attributeAssignResult = group.getAttributeDelegate()
        .assignAttribute(attributeDefName);
    ...
    assertEquals("Cant pass in values when deleting attributes",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertTrue(wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        wsAssignAttributesResults.getResultMetadata().getResultMessage().contains(
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        ...
        null,
        null,
        AttributeAssignValueOperation.remove_value,
        new WsAttributeAssignLookup[] { new WsAttributeAssignLookup(attributeAssign
            .getId()) },
        null, null, null, null,
        null, null, null, null, null, false, null, false, null, null, null, null);

    assertEquals("Cant pass in attributeAssignValueOperation when deleting attributes",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertTrue(wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        wsAssignAttributesResults.getResultMetadata().getResultMessage().contains(
    ...
    assertEquals("assign an existing attribute is ok",
        ...
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertEquals("F",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0].getChanged());
    ...
    assertFalse("should be deleted",
        group.getAttributeDelegate().hasAttribute(attributeDefName));
    ...
    attributeAssign = group.getAttributeDelegate().retrieveAssignments(attributeDefName)
        .iterator().next();
    ...
    assertEquals("assign an existing attribute is ok: "
        ...
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertEquals("F",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0].getValuesChanged());
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0].getChanged());
    ...
    attributeAssign = group.getAttributeDelegate().retrieveAssignments(attributeDefName)
        .iterator().next();
    assertEquals(id, attributeAssign.getId());
    assertEquals(AttributeAssignDelegatable.TRUE,
        attributeAssign.getAttributeAssignDelegatable());
    ...
    attributeAssignResult = group.getAttributeDelegate()
        .assignAttribute(attributeDefName);
    attributeAssign = attributeAssignResult.getAttributeAssign();
    AttributeAssignValueResult attributeAssignValueResult = attributeAssign
        .getValueDelegate().assignValue("123");
    id = attributeAssign.getId();

    wsAttributeAssignValue = new WsAttributeAssignValue();
    wsAttributeAssignValue.setId(attributeAssignValueResult.getAttributeAssignValue()
        .getId());
    ...
    assertEquals(1,
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults().length);
    assertEquals("123",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[0].getWsAttributeAssignValue()
            .getValueSystem());
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[0].getChanged());
    assertEquals("F",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[0].getDeleted());
    ...
    assertEquals("replace an existing attribute is ok: "
        + wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertEquals("T",
    ...
    assertEquals("234",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[1].getWsAttributeAssignValue()
            .getValueSystem());
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[1].getChanged());
    assertEquals("F",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[1].getDeleted());
    ...
    assertEquals("assign attribute add a value is ok: "
        + wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertEquals("T",
    ...
    assertEquals("345",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[2].getWsAttributeAssignValue()
            .getValueSystem());
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[2].getChanged());
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0]
            .getWsAttributeAssignValueResults()[2].getDeleted());

    GrouperServiceUtils.testSession = GrouperSession.startRootSession();

    Set<AttributeAssign> attributeAssigns = group.getAttributeDelegate()
    ...
    assertEquals(0, GrouperUtil.length(wsAssignAttributesResults
        .getWsAttributeAssignResults()[0].getWsAttributeAssignValueResults()));
    ...
    assertEquals("remove an attribute is ok: "
        + wsAssignAttributesResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsAssignAttributesResults.getResultMetadata().getResultCode());
    assertEquals(1,
    ...
    assertEquals("T",
        wsAssignAttributesResults.getWsAttributeAssignResults()[0].getChanged());
    assertEquals(2, GrouperUtil.length(wsAssignAttributesResults
        .getWsAttributeAssignResults()[0].getWsAttributeAssigns()));
    ...
    Subject subjectWithGroupAdminPriv = SubjectFinder.findByIdOrIdentifier(
        "test.subject.0", true);
    Subject subjectWithAttrDefAdminPriv = SubjectFinder.findByIdOrIdentifier(
        "test.subject.1", true);
    Subject subjectWithBothAdminPriv = SubjectFinder.findByIdOrIdentifier(
        "test.subject.2", true);
    Subject subjectWithNoAdminPriv = SubjectFinder.findByIdOrIdentifier("test.subject.3",
        true);
    ...
    attributeDefName.getAttributeDef().getPrivilegeDelegate()
        .grantPriv(subjectWithAttrDefAdminPriv, AttributeDefPrivilege.ATTR_ADMIN, false);
    attributeDefName.getAttributeDef().getPrivilegeDelegate()
        .grantPriv(subjectWithBothAdminPriv, AttributeDefPrivilege.ATTR_ADMIN, false);
    attributeDefName.getAttributeDef().getPrivilegeDelegate()
        .grantPriv(subjectWithNoAdminPriv, AttributeDefPrivilege.ATTR_READ, false);
    attributeDefName.getAttributeDef().getPrivilegeDelegate()
        .grantPriv(subjectWithGroupAdminPriv, AttributeDefPrivilege.ATTR_READ, false);
  ...
  public void testAssignAttributesStem() {
    ...
    AttributeAssign attributeAssign = stem.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
  ...
  public void testAssignAttributesMember() {
    ...
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            ...
            null,
            null,
            new WsSubjectLookup[] { new WsSubjectLookup(SubjectTestHelper.SUBJ0.getId(),
                SubjectTestHelper.SUBJ0.getSourceId(), null) }, null,
            null, null, null, null, null, false, null, false, null, null, null, null);
    ...
    AttributeAssign attributeAssign = member.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
  ...
  public void testAssignAttributesMembership() {
    ...
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            ...
            null,
            null,
            new WsMembershipLookup[] { new WsMembershipLookup(membership.getUuid()) },
            null, null, null, null, null, false, null, false, null, null, null, null);
  ...
  public void testAssignAttributesAnyMembership() {
    ...
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            ...
            new WsMembershipAnyLookup[] { new WsMembershipAnyLookup(new WsGroupLookup(
                group1.getName(), null),
                new WsSubjectLookup(SubjectTestHelper.SUBJ0.getId(),
                    SubjectTestHelper.SUBJ0.getSourceId(), null)) },
    ...
    AttributeAssign attributeAssign = new GroupMember(group1, member)
        .getAttributeDelegate().retrieveAssignments(attributeDefName).iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
  ...
  public void testAssignAttributesAttributeDef() {
    ...
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            ...
            null,
            null, null,
            null, new WsAttributeDefLookup[] { new WsAttributeDefLookup(
                attributeDefAssignTo.getName(), null) },
    ...
    AttributeAssign attributeAssign = attributeDefAssignTo.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
  ...
  public void testAssignAttributesAttrAssign() {
    ...
    WsAssignAttributesResults wsAssignAttributesResults = GrouperServiceLogic
        .assignAttributes(
            ...
            null,
            null, null,
            null, null, new WsAttributeAssignLookup[] { new WsAttributeAssignLookup(
                attributeAssign.getId()) }, null, null, false, null, false, null, null,
            null, null);
    ...
    AttributeAssign attributeAssign2 = attributeAssign.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign2.getAttributeDefName()
        .getName());
  ...
  public void testAssignPermissions() {
    ...
    //Error case attribute assign type
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    WsAssignPermissionsResults wsAssignPermissionsResults = GrouperServiceLogic
        .assignPermissions(
            GROUPER_VERSION, null,
            new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(
                attributeDefName.getName(), null) },
    ...
    assertEquals("You must pass in a permissionType",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignPermissionsResults.getResultMetadata().getResultCode());
    assertTrue(
        "You must pass in a permissionType",
        wsAssignPermissionsResults.getResultMetadata().getResultMessage()
            .contains("You need to pass in a permissionType"));
    ...
    wsAssignPermissionsResults = GrouperServiceLogic.assignPermissions(
        ...
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(attributeDefName
            .getName(), null) },
        PermissionAssignOperation.assign_permission, null,
        null, null, null, new WsAttributeAssignLookup[] { new WsAttributeAssignLookup(
    ...
    wsAssignPermissionsResults = GrouperServiceLogic.assignPermissions(
        ...
        PermissionAssignOperation.assign_permission, null,
        null, null, null, new WsAttributeAssignLookup[] { new WsAttributeAssignLookup(
            "abc") }, new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) },
        null, null, null,
        false, null, false, null, null, null, false);
    ...
    wsAssignPermissionsResults = GrouperServiceLogic.assignPermissions(
        ...
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(attributeDefName
            .getName(), null) },
        null, null,
        null, null, null, null, new WsGroupLookup[] { new WsGroupLookup(group.getName(),
            null) }, null, null, null,
        false, null, false, null, null, null, false);

    assertEquals("Need to pass in permissionAssignOperation",
        WsGetAttributeAssignmentsResultsCode.INVALID_QUERY.name(),
        wsAssignPermissionsResults.getResultMetadata().getResultCode());
    assertTrue(
        "Need to pass in permissionAssignOperation: "
            + wsAssignPermissionsResults.getResultMetadata().getResultMessage(),
        wsAssignPermissionsResults.getResultMetadata().getResultMessage()
            .contains("You need to pass in an permissionAssignOperation"));

    //Cant pass in attr def name ids when sending in attribute assign id
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();

    AttributeAssignResult attributeAssignResult = role.getPermissionRoleDelegate()
        .assignRolePermission(attributeDefName, PermissionAllowed.ALLOWED);
    AttributeAssign attributeAssign = attributeAssignResult.getAttributeAssign();
    ...
    wsAssignPermissionsResults = GrouperServiceLogic.assignPermissions(
        ...
        new WsGroupLookup[] { new WsGroupLookup(group.getName(), null) }, null,
        new String[] { "a" }, null,
        false, null, false, null, null, null, false);
    ...
    attributeAssignResult = role.getPermissionRoleDelegate().assignRolePermission(
        attributeDefName, PermissionAllowed.ALLOWED);
    attributeAssign = attributeAssignResult.getAttributeAssign();
    ...
    assertEquals("assign an existing attribute is ok",
        ...
        wsAssignPermissionsResults.getResultMetadata().getResultCode());
    assertEquals("F",
        wsAssignPermissionsResults.getWsAssignPermissionResults()[0].getChanged());
    ...
    assertEquals("T",
        wsAssignPermissionsResults.getWsAssignPermissionResults()[0].getChanged());
    assertEquals("notes",
        wsAssignPermissionsResults.getWsAssignPermissionResults()[0]
            .getWsAttributeAssigns()[0].getNotes());
    ...
    wsAssignPermissionsResults = GrouperServiceLogic.assignPermissions(
        ...
        new WsGroupLookup[] { new WsGroupLookup(role.getName(), null) }, null, null,
        null,
        false, null, false, null, null, null, false);
    ...
    WsMembershipAnyLookup wsMembershipAnyLookup = new WsMembershipAnyLookup(
        new WsGroupLookup(role.getName(), null), new WsSubjectLookup(
            SubjectTestHelper.SUBJ4_ID, null, null));
    ...
    Member member4 = MemberFinder.findBySubject(GrouperServiceUtils.testSession,
        SubjectTestHelper.SUBJ4, false);

    Set<AttributeAssign> attributeAssigns = GrouperDAOFactory
        .getFactory()
        .getAttributeAssign()
        .findAnyMembershipAttributeAssignments(null, null, null,
            GrouperUtil.toSet(new MultiKey(role.getId(), member4.getUuid())), null, null,
            false);
    assertEquals(1, attributeAssigns.size());
  ...
  public void testAssignAttributesStemReplace() {
    ...
    AttributeDefName attributeDefName2 = AttributeDefNameTest.exampleAttributeDefNameDb(
        "test", "testAttributeAssignDefName2");
    ...
    //###################### SIMPLE REPLACE
    for (AttributeAssign attributeAssign : stem.getAttributeDelegate()
        .retrieveAssignments()) {
    ...
    assertEquals(1,
        GrouperUtil.length(wsAssignAttributesResults.getWsAttributeAssignResults()));
    WsAssignAttributeResult wsAssignAttributeResult = wsAssignAttributesResults
    ...
    assertEquals(0,
        GrouperUtil.length(wsAssignAttributeResult.getWsAttributeAssignValueResults()));
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    ...
    attributeAssign = stem.getAttributeDelegate().retrieveAssignments(attributeDefName)
        .iterator().next();
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        GROUPER_VERSION,
        AttributeAssignType.stem,
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(attributeDefName2
            .getName(), null) },
        AttributeAssignOperation.replace_attrs,
        null,
        null, null, null, null, null, null,
        ...
        new WsStemLookup[] { new WsStemLookup(stem.getName(), null) },
        null, null,
        null, null, null, new String[] { "a" }, null, false, null, false, null, null,
        null, null);
    ...
    assertEquals("test:testAttributeAssignDefName2",
        wsAssignAttributeResult.getWsAttributeAssigns()[0].getAttributeDefNameName());
    assertEquals("F", wsAssignAttributeResult.getDeleted());
    assertEquals("F", wsAssignAttributeResult.getValuesChanged());
    assertEquals("T", wsAssignAttributeResult.getChanged());
    ...
    assertEquals(
        0,
        GrouperUtil.length(stem.getAttributeDelegate().retrieveAssignments(
            attributeDefName)));
    assertEquals(
        1,
        GrouperUtil.length(stem.getAttributeDelegate().retrieveAssignments(
            attributeDefName2)));
    attributeAssign = stem.getAttributeDelegate().retrieveAssignments(attributeDefName2)
        .iterator().next();
    assertEquals(attributeDefName2.getName(), attributeAssign.getAttributeDefName()
        .getName());
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        ...
        new WsStemLookup[] { new WsStemLookup(stem.getName(), null) },
        null, null,
        null, null, null, new String[] { "b" }, null, false, null, false, null,
        new WsAttributeDefLookup[] { new WsAttributeDefLookup(attributeDef2.getName(),
            null) }, null, null);
    ...
    assertEquals(
        ...
        GrouperUtil.length(stem.getAttributeDelegate().retrieveAssignments(
            attributeDefName2)));
    attributeAssign = (AttributeAssign) GrouperUtil.get(stem.getAttributeDelegate()
        .retrieveAssignments(attributeDefName), 0);
    assertEquals(attributeDefName.getName(), attributeAssign.getAttributeDefName()
        .getName());
    attributeAssign = (AttributeAssign) GrouperUtil.get(stem.getAttributeDelegate()
        .retrieveAssignments(attributeDefName2), 0);
    assertEquals(attributeDefName2.getName(), attributeAssign.getAttributeDefName()
        .getName());
    ...
    wsAssignAttributesResults = GrouperServiceLogic.assignAttributes(
        ...
        new WsStemLookup[] { new WsStemLookup(stem.getName(), null) },
        null, null,
        null, null, null, new String[] { "b" }, null, false, null, false, null, null,
        null, new String[] { AttributeDefType.attr.name() });
  ...
  public void testAddExternalMember() {
    ...
    WsSubjectLookup[] subjectLookups = new WsSubjectLookup[] { new WsSubjectLookup(null,
        null, "a@b.c") };
    ...
    assertEquals("Should not be success: "
        + wsAddMemberResults.getResultMetadata().getResultMessage(),
    ...
    assertEquals("Should be success: "
        + wsAddMemberResults.getResultMetadata().getResultMessage(),
        WsAddMemberResultsCode.SUCCESS.name(),
        wsAddMemberResults.getResultMetadata().getResultCode());

    assertEquals("Should be success-created: "
        + wsAddMemberResults.getResults()[0].getResultMetadata().getResultMessage(),
  ...
  public void testAssignAttributeDefNameInheritance() {
    ...
    Stem testStem = new StemSave(GrouperServiceUtils.testSession).assignName("test1")
        .save();
    Stem testSubStem = new StemSave(GrouperServiceUtils.testSession).assignName(
        "test1:sub").save();
    Stem rootStem = StemFinder.findRootStem(GrouperServiceUtils.testSession);

    AttributeDef testAttributeDef = new AttributeDefSave(GrouperServiceUtils.testSession)
    ...
    AttributeDefName testAttributeDefName1 = new AttributeDefNameSave(
        GrouperServiceUtils.testSession, testAttributeDef)
        .assignName("test1:attributeDefName1").save();
    AttributeDefName testAttributeDefName2 = new AttributeDefNameSave(
        GrouperServiceUtils.testSession, testAttributeDef)
        .assignName("test2:attributeDefName2").assignCreateParentStemsIfNotExist(true)
        .save();
    AttributeDefName testAttributeDefName3 = new AttributeDefNameSave(
        GrouperServiceUtils.testSession, testAttributeDef)
        .assignName("test2:attributeDefName3").assignCreateParentStemsIfNotExist(true)
        .save();
    AttributeDefName testAttributeDefName4 = new AttributeDefNameSave(
        GrouperServiceUtils.testSession, testAttributeDef)
        .assignName("test2:attributeDefName4").assignCreateParentStemsIfNotExist(true)
        .save();

    testAttributeDefName1.getAttributeDefNameSetDelegate().addToAttributeDefNameSet(
        testAttributeDefName2);
    ...
    //assign something
    WsAssignAttributeDefNameInheritanceResults wsAssignAttributeDefNameInheritanceResults = GrouperServiceLogic
        .assignAttributeDefNameInheritance(
            GROUPER_VERSION, new WsAttributeDefNameLookup(
                testAttributeDefName1.getName(), null),
    ...
    assertEquals(wsAssignAttributeDefNameInheritanceResults.getResultMetadata()
        .getResultMessage(),
    ...
    testAttributeDefName1 = AttributeDefNameFinder.findById(
        testAttributeDefName1.getId(), true);
    Set<AttributeDefName> attributeDefNames = testAttributeDefName1
    ...
    assertEquals("F", wsAssignAttributeDefNameInheritanceResults.getResultMetadata()
        .getSuccess());
    assertEquals("INSUFFICIENT_PRIVILEGES", wsAssignAttributeDefNameInheritanceResults
    ...
    testAttributeDefName1 = AttributeDefNameFinder.findById(
        testAttributeDefName1.getId(), true);
    attributeDefNames = testAttributeDefName1.getAttributeDefNameSetDelegate()
    ...
    assertEquals("T", wsAssignAttributeDefNameInheritanceResults.getResultMetadata()
        .getSuccess());
    assertEquals("SUCCESS", wsAssignAttributeDefNameInheritanceResults
        .getResultMetadata().getResultCode());
  ...
  public void testAttributeDefNameSave() {
    ...
    WsAttributeDefNameSaveResults wsAttributeDefNameSaveResults = GrouperServiceLogic
        .attributeDefNameSave(
            GROUPER_VERSION, new WsAttributeDefNameToSave[] { wsAttributeDefNameToSave1,
                wsAttributeDefNameToSave2 }, null, null, null);
    ...
    assertEquals(testAttributeDef.getId(), wsAttributeDefNameSaveResults.getResults()[0]
        .getWsAttributeDefName().getAttributeDefId());
    assertEquals(wsAttributeDefName1.getName(),
        wsAttributeDefNameSaveResults.getResults()[0].getWsAttributeDefName().getName());
    assertEquals(wsAttributeDefName1.getDisplayExtension(),
        wsAttributeDefNameSaveResults.getResults()[0].getWsAttributeDefName()
            .getDisplayExtension());
    assertEquals(wsAttributeDefName1.getDescription(),
        wsAttributeDefNameSaveResults.getResults()[0].getWsAttributeDefName()
            .getDescription());

    GrouperServiceUtils.testSession = GrouperSession.startRootSession();

    AttributeDefName testAttributeDefName2 = AttributeDefNameFinder.findByName(
        wsAttributeDefName2.getName(), true);
    assertEquals(testAttributeDefName2.getDisplayExtension(),
        wsAttributeDefNameSaveResults.getResults()[1].getWsAttributeDefName()
            .getDisplayExtension());
    assertEquals(testAttributeDefName2.getDescription(),
        wsAttributeDefNameSaveResults.getResults()[1].getWsAttributeDefName()
            .getDescription());
    ...
    testAttributeDefName2 = AttributeDefNameFinder.findByName(
        wsAttributeDefName2.getName(), true);
    assertEquals(testAttributeDefName2.getDisplayExtension(),
        wsAttributeDefNameSaveResults.getResults()[1].getWsAttributeDefName()
            .getDisplayExtension());
    ...
    assertEquals("PROBLEM_SAVING_ATTRIBUTE_DEF_NAMES", wsAttributeDefNameSaveResults
        .getResultMetadata().getResultCode());
    assertEquals("F", wsAttributeDefNameSaveResults.getResults()[0].getResultMetadata()
        .getSuccess());
    assertEquals("INSUFFICIENT_PRIVILEGES", wsAttributeDefNameSaveResults.getResults()[0]
        .getResultMetadata().getResultCode());
    assertEquals("F", wsAttributeDefNameSaveResults.getResults()[1].getResultMetadata()
        .getSuccess());
    assertEquals("INSUFFICIENT_PRIVILEGES", wsAttributeDefNameSaveResults.getResults()[1]
        .getResultMetadata().getResultCode());
  ...
  public void testAttributeDefNameDelete() {
    ...
    //save two attribute def names
    WsAttributeDefNameDeleteResults wsAttributeDefNameDeleteResults = GrouperServiceLogic
        .attributeDefNameDelete(
            GROUPER_VERSION, new WsAttributeDefNameLookup[] {
                new WsAttributeDefNameLookup(testAttributeDefName1.getName(), null),
                new WsAttributeDefNameLookup(null, testAttributeDefName2.getId()) },
            null, null, null);
    ...
    testAttributeDefName1 = AttributeDefNameFinder.findByName(
        testAttributeDefName1.getName(), false);
    testAttributeDefName2 = AttributeDefNameFinder.findByName(
        testAttributeDefName2.getName(), false);
    ...
    grouperSession = GrouperSession.startRootSession();
    testAttributeDefName1 = AttributeDefNameFinder.findByName(
        testAttributeDefName1.getName(), true);
    testAttributeDefName2 = AttributeDefNameFinder.findByName(
        testAttributeDefName2.getName(), true);
    ...
    assertEquals("PROBLEM_DELETING_ATTRIBUTE_DEF_NAMES", wsAttributeDefNameDeleteResults
        .getResultMetadata().getResultCode());
    assertEquals("F", wsAttributeDefNameDeleteResults.getResults()[0].getResultMetadata()
        .getSuccess());
    assertEquals("INSUFFICIENT_PRIVILEGES",
        wsAttributeDefNameDeleteResults.getResults()[0].getResultMetadata()
            .getResultCode());
    assertEquals("F", wsAttributeDefNameDeleteResults.getResults()[1].getResultMetadata()
        .getSuccess());
    assertEquals("INSUFFICIENT_PRIVILEGES",
        wsAttributeDefNameDeleteResults.getResults()[1].getResultMetadata()
            .getResultCode());
  ...
  public void testFindAttributeDefNames() {
    ...
    WsFindAttributeDefNamesResults wsFindAttributeDefNamesResults = GrouperServiceLogic
        .findAttributeDefNames(
            GROUPER_VERSION, "test3%", null, null, null, null, null, null, null, null,
            null, null, null, null, null, null);
    ...
    assertEquals(0,
        GrouperUtil.length(wsFindAttributeDefNamesResults.getAttributeDefNameResults()));
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "test%", null, null, null, null, null, null, null, null, null,
        null, null, null, null, null);
    ...
    assertEquals(2,
        GrouperUtil.length(wsFindAttributeDefNamesResults.getAttributeDefNameResults()));
    assertEquals(testAttributeDefName1.getName(),
        wsFindAttributeDefNamesResults.getAttributeDefNameResults()[0].getName());
    assertEquals(testAttributeDefName2.getName(),
        wsFindAttributeDefNamesResults.getAttributeDefNameResults()[1].getName());

    assertEquals(1, GrouperUtil.length(wsFindAttributeDefNamesResults.getAttributeDefs()));
    assertEquals(testAttributeDef.getName(),
        wsFindAttributeDefNamesResults.getAttributeDefs()[0].getName());
    ...
    assertEquals("INVALID_QUERY", wsFindAttributeDefNamesResults.getResultMetadata()
        .getResultCode());
    ...
    GrouperServiceUtils.testSession = GrouperSession.startRootSession();
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, null, new WsAttributeDefLookup(testAttributeDef.getName(),
            null), null, null,
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        ...
        new WsAttributeDefNameLookup[] {
            new WsAttributeDefNameLookup(testAttributeDefName1.getName(), null),
            new WsAttributeDefNameLookup(null, testAttributeDefName2.getId()) }, null,
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, "test%", null, null, null, null, null, null, 1, null, null,
        null, null, null, null, null);
    assertEquals("F", wsFindAttributeDefNamesResults.getResultMetadata().getSuccess());
    assertEquals("INVALID_QUERY", wsFindAttributeDefNamesResults.getResultMetadata()
        .getResultCode());
    ...
    GrouperServiceUtils.testSession = GrouperSession.start(SubjectTestHelper.SUBJ1);
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, null, new WsAttributeDefLookup(null, null,
            testAttributeDef.getIdIndex().toString()), null, null, null,
        1, 2, "name", false, null, null, null, null, null);
    ...
    wsFindAttributeDefNamesResults = GrouperServiceLogic.findAttributeDefNames(
        GROUPER_VERSION, null, null, null, null, null,
        new WsAttributeDefNameLookup[] { new WsAttributeDefNameLookup(null, null,
            testAttributeDefName1.getIdIndex().toString()) },
  ...
  public void testAssignAttributesBatch() {
    ...
    AttributeDefName attributeDefName2 = AttributeDefNameTest.exampleAttributeDefNameDb(
        "test", "testAttributeAssignAssignName");
    AttributeDefName attributeDefName3 = AttributeDefNameTest.exampleAttributeDefNameDb(
        "test", "testAttributeAssignAssignName2");
    ...
    wsAssignAttributeBatchEntry.setWsOwnerGroupLookup(new WsGroupLookup(group.getName(),
        null));
    wsAssignAttributeBatchEntry.setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(
        attributeDefName.getName(), null));
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());

    WsAssignAttributeBatchEntry[] wsAssignAttributeBatchEntries = new WsAssignAttributeBatchEntry[] { wsAssignAttributeBatchEntry };

    WsAssignAttributesBatchResults wsAssignAttributesBatchResults = GrouperServiceLogic
        .assignAttributesBatch(
            GROUPER_VERSION,
            wsAssignAttributeBatchEntries, null, false, null, null, false, null);

    assertEquals("You must pass in an attributeAssignType",
        WsAssignAttributesBatchResultsCode.PROBLEM_WITH_ASSIGNMENT.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());

    assertEquals(1, GrouperUtil.length(wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()));

    WsAssignAttributeBatchResult wsAssignAttributeBatchResult = wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()[0];

    assertEquals("You must pass in an attributeAssignType",
        WsAssignAttributeBatchResultCode.INVALID_QUERY.name(),
        wsAssignAttributeBatchResult.getResultMetadata().getResultCode());
    assertTrue(
        "You must pass in an attributeAssignType",
        wsAssignAttributeBatchResult.getResultMetadata().getResultMessage()
            .contains("You need to pass in an attributeAssignType"));
    ...
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry
        .setWsOwnerAttributeAssignLookup(new WsAttributeAssignLookup("abc"));
    ...
    wsAssignAttributeBatchResult = wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()[0];
    ...
    wsAssignAttributeBatchEntry.setWsAttributeAssignLookup(new WsAttributeAssignLookup(
        attributeAssign.getId()));
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.remove_attr.name());
    ...
    wsAssignAttributeBatchEntry
        .setValues(new WsAttributeAssignValue[] { wsAttributeAssignValue });
    ...
    assertEquals("lets assign by id and assign enabled date",
        WsAssignAttributesBatchResultsCode.SUCCESS.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());
    ...
    attributeAssign = group.getAttributeDelegate().retrieveAssignments(attributeDefName)
        .iterator().next();
    assertEquals(id, attributeAssign.getId());
    assertEquals("2012/01/01 01:01:01.111",
        GrouperUtil.timestampToString(attributeAssign.getEnabledTime()));
    ...
    assertEquals("lets assign by id and assign disabled date",
        WsAssignAttributesBatchResultsCode.SUCCESS.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());
    ...
    assertEquals(id, attributeAssign.getId());
    assertEquals("2012/01/01 01:01:01.111",
        GrouperUtil.timestampToString(attributeAssign.getDisabledTime()));
    ...
    assertEquals("lets assign by id and assign delegatable",
        WsAssignAttributesBatchResultsCode.SUCCESS.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());
    ...
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry
        .setAttributeAssignValueOperation(AttributeAssignValueOperation.assign_value
            .name());
    wsAttributeAssignValue = new WsAttributeAssignValue();
    wsAttributeAssignValue.setValueSystem("123");
    ...
    assertEquals("lets assign value: "
        + wsAssignAttributesBatchResults.getResultMetadata().getResultMessage()
        + ", "
        + wsAssignAttributesBatchResults.getWsAssignAttributeBatchResultArray()[0]
    ...
    assertEquals(new Long(123), attributeAssign.getValueDelegate()
        .getAttributeAssignValues().iterator().next().getValueInteger());
    ...
    assertEquals("T", wsAssignAttributeBatchResult.getValuesChanged());
    assertEquals(1,
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults().length);
    assertEquals("123",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[0]
            .getWsAttributeAssignValue().getValueSystem());
    ...
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry.setValues(new WsAttributeAssignValue[] {
        wsAttributeAssignValue, wsAttributeAssignValue2 });
    wsAssignAttributeBatchEntry
        .setAttributeAssignValueOperation(AttributeAssignValueOperation.replace_values
            .name());
    ...
    assertEquals("123",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[0]
            .getWsAttributeAssignValue().getValueSystem());
    assertEquals("F",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[0].getChanged());
    assertEquals("F",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[0].getDeleted());
    assertEquals("234",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[1]
            .getWsAttributeAssignValue().getValueSystem());
    assertEquals("T",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[1].getChanged());
    assertEquals("F",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[1].getDeleted());
    ...
    assertEquals(group.getName(),
        wsAssignAttributesBatchResults.getWsGroups()[0].getName());
    ...
    assertEquals("F",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[1].getDeleted());
    assertEquals("345",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[2]
            .getWsAttributeAssignValue().getValueSystem());
    assertEquals("T",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[2].getChanged());
    assertEquals("T",
        wsAssignAttributeBatchResult.getWsAttributeAssignValueResults()[2].getDeleted());
    ...
    wsAssignAttributeBatchEntry.setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(
        attributeDefName.getName(), null));
    wsAssignAttributeBatchEntry
        .setAttributeAssignOperation(AttributeAssignOperation.add_attr.name());
    ...
    assertEquals("remove attribute is ok: "
        + wsAssignAttributesBatchResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());
    ...
    assertEquals(2,
        GrouperUtil.length(wsAssignAttributeBatchResult.getWsAttributeAssigns()));
    ...
    wsAssignAttributeBatchEntry2.setAttributeAssignType(AttributeAssignType.group_asgn
        .name());
    wsAssignAttributeBatchEntry2
        .setWsOwnerAttributeAssignLookup(new WsAttributeAssignLookup(null, "0"));
    wsAssignAttributeBatchEntry2
        .setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(attributeDefName2
            .getName(), null));
    wsAssignAttributeBatchEntry2
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry2
    ...
    wsAssignAttributeBatchEntry3.setAttributeAssignType(AttributeAssignType.group_asgn
        .name());
    wsAssignAttributeBatchEntry3
        .setWsOwnerAttributeAssignLookup(new WsAttributeAssignLookup(null, "0"));
    wsAssignAttributeBatchEntry3
        .setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(attributeDefName3
            .getName(), null));
    wsAssignAttributeBatchEntry3
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry3
        .setValues(new WsAttributeAssignValue[] { wsAttributeAssignValue2 });
    wsAssignAttributeBatchEntry3
        .setAttributeAssignValueOperation(AttributeAssignValueOperation.assign_value
            .name());

    wsAssignAttributeBatchEntries = new WsAssignAttributeBatchEntry[] {
        wsAssignAttributeBatchEntry, wsAssignAttributeBatchEntry2,
        wsAssignAttributeBatchEntry3 };
    ...
    assertEquals("assign attributes is ok: "
        + wsAssignAttributesBatchResults.getResultMetadata().getResultMessage(),
        WsGetAttributeAssignmentsResultsCode.SUCCESS.name(),
        wsAssignAttributesBatchResults.getResultMetadata().getResultCode());

    assertEquals(3, GrouperUtil.length(wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()));
    ...
    assertEquals("T",
        wsAssignAttributesBatchResults.getWsAssignAttributeBatchResultArray()[1]
            .getValuesChanged());
    assertEquals("T",
        wsAssignAttributesBatchResults.getWsAssignAttributeBatchResultArray()[1]
            .getChanged());
    ...
    assertEquals("T",
        wsAssignAttributesBatchResults.getWsAssignAttributeBatchResultArray()[2]
            .getValuesChanged());
    assertEquals("T",
        wsAssignAttributesBatchResults.getWsAssignAttributeBatchResultArray()[2]
            .getChanged());
    ...
    assertEquals(1, GrouperUtil.length(wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()[0].getWsAttributeAssigns()));
    ...
    attributeAssign = attributeAssigns.iterator().next();
    assertEquals("hello1", attributeAssign.getAttributeValueDelegate()
        .retrieveValueString(attributeDefName2.getName()));
    assertEquals("hello2", attributeAssign.getAttributeValueDelegate()
        .retrieveValueString(attributeDefName3.getName()));
  ...
  public void testFindStems() {
    ...
    WsFindStemsResults wsFindStemsResults = GrouperServiceLogic.findStems(
        GROUPER_VERSION, null, null, null, new WsStemLookup[] {
            new WsStemLookup(null, null, testStem.getIdIndex().toString()),
    ...
    assertStemSetsAndOrder(GrouperUtil.toSet(testStem, testSubStem),
  ...
  public void assertStemSetsAndOrder(Set<Stem> set1, WsStem[] stemResultArray) {
    ...
    if (set1length != set2length) {
      fail("Expecting stems of size: " + set1length + " but received size: " + set2length
          + ", expecting: "
          + GrouperUtil.toStringForLog(set1, 200) + ", but received: "
          + GrouperUtil.toStringForLog(stemResultArray, 200));
    }
    ...
    for (Stem stem : set1) {
      if (!StringUtils.equals(stem.getName(), stemResultArray[i].getName())) {
        fail("Expecting index of set: " + i + " to be: " + stem.getName()
            + ", but received: "
   ...
   */
  public void assertAttributeDefNameSetsAndOrder(Set<AttributeDefName> set1,
      WsAttributeDefName[] attributeDefNameResultArray) {
    int set1length = GrouperUtil.length(set1);
    int set2length = GrouperUtil.length(attributeDefNameResultArray);
    if (set1length != set2length) {
      fail("Expecting attributeDefNames of size: " + set1length + " but received size: "
          + set2length + ", expecting: "
          + GrouperUtil.toStringForLog(set1, 200) + ", but received: "
          + GrouperUtil.toStringForLog(attributeDefNameResultArray, 200));
    }
    ...
    for (AttributeDefName attributeDefName : set1) {
      if (!StringUtils.equals(attributeDefName.getName(),
          attributeDefNameResultArray[i].getName())) {
        fail("Expecting index of set: " + i + " to be: " + attributeDefName.getName()
            + ", but received: "
  ...
  public void testGetMembersPaging() {
    ...
    WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
        GROUPER_VERSION, wsGroupLookups, WsMemberFilter.Immediate, null,
        Group.getDefaultList(), true, true, null, null, null, null, null, 2, 1, null,
        null);
  ...
  public void testGetMembersPITpaging() {
    ...
    //valid query
    {
      ...
      WsGetMembersResults wsGetMembersResults = GrouperServiceLogic.getMembers(
          GROUPER_VERSION, wsGroupLookups, WsMemberFilter.All, null,
          Group.getDefaultList(), false, true, null, null, null, null, new Timestamp(
              new Date().getTime()), 2, 2, null, null);
  ...
  public void testGetAttributeAssignmentsMembershipBatch() {
    ...
    Member member1 = MemberFinder.findBySubject(GrouperSession.staticGrouperSession(),
        SubjectTestHelper.SUBJ1, true);
    Membership membership1 = group1
        .getMemberships(FieldFinder.find("members", true), GrouperUtil.toSet(member1))
        .iterator().next();

    attributeAssignResult = membership1.getAttributeDelegate().assignAttribute(
        attributeDefName);
    AttributeAssign attributeAssign1 = attributeAssignResult.getAttributeAssign();

    group1.addMember(SubjectTestHelper.SUBJ2);
    Member member2 = MemberFinder.findBySubject(GrouperSession.staticGrouperSession(),
        SubjectTestHelper.SUBJ2, true);

    Membership membership2 = group1
        .getMemberships(FieldFinder.find("members", true), GrouperUtil.toSet(member2))
        .iterator().next();
    ...
    WsGetAttributeAssignmentsResults wsGetAttributeAssignmentsResults = GrouperServiceLogic
        .getAttributeAssignments(
            ...
            null, null, null,
            new WsMembershipLookup[] { new WsMembershipLookup(membership.getUuid()),
                new WsMembershipLookup(membership1.getUuid()),
    ...
    for (int i = 0; i < 2; i++) {
      ...
      assertTrue(StringUtils.equals(membership.getImmediateMembershipId(),
          wsGetAttributeAssignmentsResults.getWsMemberships()[i]
              .getImmediateMembershipId())
          || StringUtils.equals(membership1.getImmediateMembershipId(),
              wsGetAttributeAssignmentsResults.getWsMemberships()[i]
                  .getImmediateMembershipId()));
      assertTrue(StringUtils.equals(membership.getUuid(),
          wsGetAttributeAssignmentsResults.getWsMemberships()[i].getMembershipId())
          || StringUtils.equals(membership1.getUuid(),
              wsGetAttributeAssignmentsResults.getWsMemberships()[i].getMembershipId()));
  ...
  public void testAssignAttributesBatchImmMembership() {
    ...
    Membership membership = group
        .getMemberships(FieldFinder.find("members", true), GrouperUtil.toSet(member))
        .iterator().next();
    ...
    WsAssignAttributeBatchEntry wsAssignAttributeBatchEntry = new WsAssignAttributeBatchEntry();
    wsAssignAttributeBatchEntry.setWsOwnerMembershipLookup(new WsMembershipLookup(
        membership.getUuid()));
    wsAssignAttributeBatchEntry.setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(
        attributeDefName.getName(), null));
    wsAssignAttributeBatchEntry
    ...
    wsAssignAttributeBatchEntry
        .setAttributeAssignValueOperation(AttributeAssignValueOperation.assign_value
            .name());
    wsAssignAttributeBatchEntry
        .setAttributeAssignType(AttributeAssignType.imm_mem.name());
    WsAttributeAssignValue wsAttributeAssignValue = new WsAttributeAssignValue();
    ...
    wsAssignAttributeBatchEntry1.setWsOwnerMembershipLookup(new WsMembershipLookup(
        membership1.getUuid()));
    wsAssignAttributeBatchEntry1
        .setWsAttributeDefNameLookup(new WsAttributeDefNameLookup(attributeDefName
            .getName(), null));
    wsAssignAttributeBatchEntry1
        .setAttributeAssignOperation(AttributeAssignOperation.assign_attr.name());
    wsAssignAttributeBatchEntry1
    ...
    assertEquals(new Long(3), membership.getAttributeValueDelegate()
        .retrieveValueInteger(attributeDefName.getName()));
    assertEquals(new Long(5), membership1.getAttributeValueDelegate()
        .retrieveValueInteger(attributeDefName.getName()));

    assertEquals(2, GrouperUtil.length(wsAssignAttributesBatchResults
        .getWsAssignAttributeBatchResultArray()));

    AttributeAssign attributeAssign = membership.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();
    AttributeAssign attributeAssign1 = membership1.getAttributeDelegate()
        .retrieveAssignments(attributeDefName).iterator().next();

    for (int i = 0; i < 2; i++) {
      WsAssignAttributeBatchResult wsAssignAttributeBatchResult = wsAssignAttributesBatchResults
          .getWsAssignAttributeBatchResultArray()[i];
      assertEquals("T", wsAssignAttributeBatchResult.getChanged());
      assertEquals("T", wsAssignAttributeBatchResult.getValuesChanged());
      assertTrue(StringUtils.equals(attributeAssign.getId(),
          wsAssignAttributeBatchResult.getWsAttributeAssigns()[0].getId())
          || StringUtils.equals(attributeAssign1.getId(),
              wsAssignAttributeBatchResult.getWsAttributeAssigns()[0].getId()));
    }
  ...
  public void testGetMemberships() {
    ...
    Stem stem2 = new StemSave(GrouperServiceUtils.testSession).assignName(stemName2)
        .assignCreateParentStemsIfNotExist(true).save();
    AttributeDef attributeDef = new AttributeDefSave(GrouperServiceUtils.testSession)
        .assignName(attributeDefName).assignCreateParentStemsIfNotExist(true).save();
    AttributeDef attributeDef2 = new AttributeDefSave(GrouperServiceUtils.testSession)
        .assignName(attributeDefName2).assignCreateParentStemsIfNotExist(true).save();
    Group group = new GroupSave(GrouperServiceUtils.testSession).assignName(groupName)
        .assignCreateParentStemsIfNotExist(true).save();
    Group group2 = new GroupSave(GrouperServiceUtils.testSession).assignName(groupName2)
        .assignCreateParentStemsIfNotExist(true).save();
    ...
    attributeDef.getPrivilegeDelegate().grantPriv(subjectWithAdminPriv,
        AttributeDefPrivilege.ATTR_ADMIN, false);
    attributeDef.getPrivilegeDelegate().grantPriv(subjectNoPrivs,
        AttributeDefPrivilege.ATTR_VIEW, false);
    attributeDef.getPrivilegeDelegate().grantPriv(subjectWithUpdatePriv,
        AttributeDefPrivilege.ATTR_UPDATE, false);
    attributeDef.getPrivilegeDelegate().revokePriv(SubjectFinder.findAllSubject(),
        AttributeDefPrivilege.ATTR_VIEW, false);
    attributeDef.getPrivilegeDelegate().revokePriv(SubjectFinder.findAllSubject(),
        AttributeDefPrivilege.ATTR_READ, false);
    attributeDef2.getPrivilegeDelegate().grantPriv(subjectWithAdminPriv,
        AttributeDefPrivilege.ATTR_ADMIN, false);
    attributeDef2.getPrivilegeDelegate().grantPriv(subjectWithUpdatePriv,
        AttributeDefPrivilege.ATTR_UPDATE, false);
    attributeDef2.getPrivilegeDelegate().revokePriv(SubjectFinder.findAllSubject(),
        AttributeDefPrivilege.ATTR_VIEW, false);
    attributeDef2.getPrivilegeDelegate().revokePriv(SubjectFinder.findAllSubject(),
        AttributeDefPrivilege.ATTR_READ, false);
    attributeDef2.getPrivilegeDelegate().grantPriv(subjectNoPrivs,
        AttributeDefPrivilege.ATTR_VIEW, false);
    ...
    wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        GROUPER_VERSION, null,
        new WsSubjectLookup[] { new WsSubjectLookup(subjectMember.getId(), null, null) },
        null, null, null,
    ...
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), groupName,
        subjectMember, Group.getDefaultList());
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), groupName2,
        subjectMember, Group.getDefaultList());
    ...
    wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        ...
        null, null, null, new WsStemLookup[] { new WsStemLookup(stem.getName(), null) },
        null, null, null, null);
    ...
    wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        ...
        new WsStemLookup[] { new WsStemLookup(stem.getName(), null) }, null, null, null,
        null);

    assertEquals(GrouperUtil.toStringForLog(wsGetMembershipsResults.getWsMemberships()),
        3, GrouperUtil.length(wsGetMembershipsResults.getWsMemberships()));

    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), stemName,
        subjectWithAdminPriv, FieldFinder.find("stemmers", true));
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), stemName,
        subjectWithUpdatePriv, FieldFinder.find("creators", true));
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), stemName,
        SubjectFinder.findRootSubject(), FieldFinder.find("stemmers", true));
    ...
    wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        GROUPER_VERSION, null,
        new WsSubjectLookup[] { new WsSubjectLookup(subjectWithUpdatePriv.getId(), null,
            null) }, null, null,
    ...
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), stemName,
        subjectWithUpdatePriv, FieldFinder.find("creators", true));
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), stemName2,
        subjectWithUpdatePriv, FieldFinder.find("creators", true));
    ...
    wsGetMembershipsResults = GrouperServiceLogic
        .getMemberships(
            GROUPER_VERSION, null,
            new WsSubjectLookup[] { new WsSubjectLookup(subjectIdWithUpdatePriv, null,
                null) }, null, null, null,
            false, null, false, null, null, null, null, null, null, null, null, null,
            FieldType.NAMING, null, null);
    ...
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), groupName,
        subjectWithUpdatePriv, FieldFinder.find("updaters", true));
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), groupName2,
        subjectWithUpdatePriv, FieldFinder.find("updaters", true));
    ...
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), attributeDefName,
        subjectWithUpdatePriv, FieldFinder.find("attrUpdaters", true));
    assertHasMembership(wsGetMembershipsResults.getWsMemberships(), attributeDefName2,
        subjectWithUpdatePriv, FieldFinder.find("attrUpdaters", true));
    ...
    wsGetMembershipsResults = GrouperServiceLogic.getMemberships(
        ...
        new WsAttributeDefLookup[] { new WsAttributeDefLookup(attributeDefName, null) },
        null, null, null);
  ...
  public void testAddRemoveMemberUpdatePrivs() {
    ...
    WsSubjectLookup wsSubjectLookup5 = new WsSubjectLookup(
        SubjectTestHelper.SUBJ5.getId(), null, null);
    ...
    //valid query, add member
    {
      ...
      assertEquals(WsAddMemberResultCode.SUCCESS.name(),
          wsAddMemberResults.getResults()[0].resultCode().name());
    }
  ...
  public void testAddRemoveMember() {
    ...
    //valid query, add member again
    {
      ...
      assertEquals(SubjectTestHelper.SUBJ5.getId(), wsSubject5.getId());
      assertEquals(WsAddMemberResultCode.SUCCESS_ALREADY_EXISTED.name(),
          wsAddMemberResults.getResults()[0].resultCode().name());
    }
...

    {
      ...
      assertEquals(SubjectTestHelper.SUBJ5.getId(), wsSubject5.getId());
      assertEquals(
          WsDeleteMemberResultCode.SUCCESS_WASNT_IMMEDIATE_BUT_HAS_EFFECTIVE.name(),
          wsDeleteMemberResults.getResults()[0].resultCode().name());
    }
