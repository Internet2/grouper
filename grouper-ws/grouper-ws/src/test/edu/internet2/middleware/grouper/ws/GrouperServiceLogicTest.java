...
//  //Cant pass in values when deleting attributes
  ...
  public void testSendMessages() {
    ...
    // happy path
    WsMessageResults wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, "abc", null, null, null, true, new WsMessage[] {wsMessage}, actAsSubjectLookup, null);
    ...
    wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, null, null, null, null, true, new WsMessage[] {wsMessage}, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
  
    // there has to be at least one message
    wsMessageResults = GrouperServiceLogic.sendMessage(GROUPER_VERSION, GrouperMessageQueueType.queue, "abc", null, null, null, true, new WsMessage[] {}, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
  ...
  public void testReceiveMessages() {
    ...
    WsMessageResults wsMessageResults = GrouperServiceLogic.receiveMessage(GROUPER_VERSION, "abc", null, null, null, true, 0, 10, actAsSubjectLookup, null);
    assertTrue("test", wsMessageResults.getMessages().length > 0);
    
    // null/blank queueTopicName not allowed
    wsMessageResults = GrouperServiceLogic.receiveMessage(GROUPER_VERSION, null, null, null, null, true, 0, 10, actAsSubjectLookup, null);
    assertEquals(wsMessageResults.getResultMetadata().getResultMessage(),
        WsMessageResultsCode.INVALID_QUERY.name(), 
        wsMessageResults.getResultMetadata().getResultCode());
