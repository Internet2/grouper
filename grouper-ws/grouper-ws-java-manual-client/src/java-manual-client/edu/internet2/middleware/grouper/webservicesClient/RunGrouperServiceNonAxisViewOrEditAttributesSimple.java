	...
	public static void viewOrEditAttributesSimpleRest() {
		...
		try {
	        ...
	        GetMethod method = new GetMethod(
	                ...
	                "&groupName=aStem:aGroup&groupUuid=&attributeName0=description&attributeValue0=some description" +
	                "&attributeDelete0=&attributeName1=description&attributeValue1=some description&attributeDelete1=" +
