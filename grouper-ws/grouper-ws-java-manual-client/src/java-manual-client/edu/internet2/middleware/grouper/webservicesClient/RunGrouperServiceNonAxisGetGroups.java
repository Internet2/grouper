 ...
 *
 */
public class RunGrouperServiceNonAxisGetGroups {
	
	/**
	 * 
	 */
	@SuppressWarnings("unchecked")
	public static void getGroupsRest() {
		...
		try {
	        ...
	        String xml = "<ns1:getGroups xmlns:ns1=\"http://webservices.grouper.middleware.internet2.edu/xsd\">" +
	        		"<ns1:subjectLookup><ns1:subjectId>GrouperSystem</ns1:subjectId></ns1:subjectLookup>" +
	        		"<ns1:memberFilter>All</ns1:memberFilter><ns1:actAsSubjectLookup>" +
