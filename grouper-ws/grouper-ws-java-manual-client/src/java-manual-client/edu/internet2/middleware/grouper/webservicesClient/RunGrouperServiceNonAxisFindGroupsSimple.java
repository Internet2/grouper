...
public class RunGrouperServiceNonAxisFindGroupsSimple {
  ...
  public static void findGroupsSimpleRest() {
    ...
    try {
      ...
      RunGrouperServiceNonAxisUtils.assertTrue("findGroupsResponse"
          .equals(findGroupsSimpleResponse.getName()), "root not findGroupsResponse: "
          + findGroupsSimpleResponse.getName());
      ...
      RunGrouperServiceNonAxisUtils.assertTrue(
          "edu.internet2.middleware.grouper.webservices.WsFindGroupsResults"
              .equals(theType),
          "type not edu.internet2.middleware.grouper.webservices.WsFindGroupsResults: "
              + theType);

      List<Element> groupResultsList = returnElement.getChildren("groupResults",
          namespace);
      ...
      if (groupResultsList != null) {
        ...
        for (Element groupResultsElement : groupResultsList) {
          ...
          RunGrouperServiceNonAxisUtils.assertTrue(
              "edu.internet2.middleware.grouper.webservices.WsGroupResult"
                  .equals(theType),
              "type not edu.internet2.middleware.grouper.webservices.WsGroupResult: "
                  + theType);

          //		<ns:createSource></ns:createSource>
          String createSource = groupResultsElement.getChildText("createSource",
              namespace);

          //		<ns:createSubjectId>GrouperSystem</ns:createSubjectId>
          String createSubjectId = groupResultsElement.getChildText("createSubjectId",
              namespace);
          ...
          String displayExtension = groupResultsElement.getChildText("displayExtension",
              namespace);
          ...
          String modifySource = groupResultsElement.getChildText("modifySource",
              namespace);

          //		<ns:modifySubjectId>GrouperSystem</ns:modifySubjectId>
          String modifySubjectId = groupResultsElement.getChildText("modifySubjectId",
              namespace);
          ...
          String parentStemName = groupResultsElement.getChildText("parentStemName",
              namespace);

          //		<ns:parentStemUuid>c5cdc0c4-04a8-47ac-931e-951b4eb44502</ns:parentStemUuid>
          String parentStemUuid = groupResultsElement.getChildText("parentStemUuid",
              namespace);
          ...
          //	</ns:groupResults>
          System.out.println("Group is: createSource: " + createSource
              + ", createSubjectId: " + createSubjectId + ", createTime: " + createTime
              + ", description: " + description + ", displayExtension: "
              + displayExtension + ", displayName: " + displayName + ", extension: "
              + extension + ", isComposite: " + isComposite + ", modifySource: "
              + modifySource + ", modifySubjectId: " + modifySubjectId + ", modifyTime: "
              + modifyTime + ", name:" + name + ", parentStemName: " + parentStemName
