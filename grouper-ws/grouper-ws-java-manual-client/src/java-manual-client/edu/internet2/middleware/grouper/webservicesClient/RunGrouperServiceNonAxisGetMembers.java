 ...
 *
 */
public class RunGrouperServiceNonAxisGetMembers {
	
	/**
	 * 
	 */
	@SuppressWarnings("unchecked")
	public static void getMembersRest() {
		...
		try {
	        ...
	        String xml = "<ns1:getMembers xmlns:ns1=\"http://webservices.grouper.middleware.internet2.edu/xsd\">" +
	        		...
	        		"</ns1:actAsSubjectLookup></ns1:getMembers>";
