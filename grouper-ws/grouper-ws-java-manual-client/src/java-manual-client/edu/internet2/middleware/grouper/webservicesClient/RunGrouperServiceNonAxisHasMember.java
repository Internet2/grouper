 ...
 *
 */
public class RunGrouperServiceNonAxisHasMember {

  /**
   * 
   */
  @SuppressWarnings("unchecked")
  public static void hasMemberRest() {
    ...
    try {
      ...
      String xml = "<ns1:hasMember xmlns:ns1=\"http://webservices.grouper.middleware.internet2.edu/xsd\">"
          + "<ns1:wsGroupLookup><ns1:groupName>aStem:aGroup</ns1:groupName></ns1:wsGroupLookup>"
          + "<ns1:subjectLookups><ns1:subjectId>GrouperSystem</ns1:subjectId></ns1:subjectLookups>"
