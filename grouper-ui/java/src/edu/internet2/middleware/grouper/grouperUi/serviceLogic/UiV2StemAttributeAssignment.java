...
public class UiV2StemAttributeAssignment {
   ...
   * @param stem
   */
  private void filterHelper(Stem stem) {
    ...
    guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#viewAttributeAssignments", 
        "/WEB-INF/grouperUi2/stemAttribute/stemViewAttributeAssignsContents.jsp"));
  }
  ...
  public void assignAttribute(final HttpServletRequest request, final HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#grouperMainContentDivId", 
          "/WEB-INF/grouperUi2/stemAttribute/stemAssignAttribute.jsp"));
  ...
  public void assignAttributeSubmit(final HttpServletRequest request, final HttpServletResponse response) {
    ...
    try {
      ...
      AttributeAssignStemDelegate attributeDelegate = stem.getAttributeDelegate();
  ...
  public void assignmentMenuAddValue(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#stemAttributeAssignments", 
          "/WEB-INF/grouperUi2/stemAttribute/attributeAssignAddValue.jsp"));
  ...
  public void assignmentMenuAddMetadataAssignment(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#stemAttributeAssignments", 
          "/WEB-INF/grouperUi2/stemAttribute/stemAttributeAssignAddMetadataAssignment.jsp"));
  ...
  public void assignEdit(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#stemAttributeAssignments", 
          "/WEB-INF/grouperUi2/stemAttribute/stemAttributeAssignEdit.jsp"));
  ...
  private void assignValueEdit() {
    ...
    try {
      ...
      guiResponseJs.addAction(GuiScreenAction.newInnerHtmlFromJsp("#stemAttributeAssignments", 
          "/WEB-INF/grouperUi2/stemAttribute/stemAttributeAssignValueEdit.jsp"));
