...
import edu.internet2.middleware.grouper.grouperUi.serviceLogic.UiV2Mcp;
import edu.internet2.middleware.grouper.grouperUi.serviceLogic.UiV2OAuth;
...
public class GrouperUiRestServlet extends HttpServlet {
  ...
  private static Set<String> operationsOkGet = GrouperUtil.toSet(
      ...
      UiV2Stem.class.getSimpleName() + ".viewAuditsExport",
