...
/**
 * @author shilen
 * @version $Id: PopulateCopyOtherStemToStemAction.java,v 1.1 2009-05-08 12:03:37 shilen Exp $
 */
public class PopulateCopyOtherStemToStemAction extends GrouperCapableAction {
  ...
  public ActionForward grouperExecute(ActionMapping mapping, ActionForm form,
    ...
    session.setAttribute("subtitle", "stems.action.copy-other-stem-to-stem");
