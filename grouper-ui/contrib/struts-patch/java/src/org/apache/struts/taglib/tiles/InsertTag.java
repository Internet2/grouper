/*
 * $Header: /home/hagleyj/i2mi/grouper-ui/contrib/struts-patch/java/src/org/apache/struts/taglib/tiles/InsertTag.java,v 1.1 2007-12-13 09:33:25 isgwb Exp $
 * $Revision: 1.1 $
 * $Date: 2007-12-13 09:33:25 $
 *
 ...
 *
 * @version $Revision: 1.1 $ $Date: 2007-12-13 09:33:25 $
 */
public class InsertTag
	...
	private Controller getController() throws JspException {
		...
		try {
			...
			throw new JspException("InstantiationException: " + ex.getMessage());
		}
	}
	...
	protected TagHandler processDefinitionName(String name)
		...
		try {
			...
			throw new JspException("FactoryNotFoundException: " + ex.getMessage());
			...
			pageContext.setAttribute(
				...
				ex,
				PageContext.REQUEST_SCOPE);
			throw new JspException("DefinitionsFactoryException: " + ex.getMessage());
		}
	}
	...
	protected class InsertHandler implements TagHandler {
		...
		public int doEndTag() throws JspException {
			...
			try {
				...
				log.error(msg, e);
				throw new JspException("IOException:" + msg);
				...
				if (!(page == null && isErrorIgnored)) {
					...
					log.error(msg, e);
					throw new JspException("IllegalArgumentException: " + msg);
				}
				...
				String msg =
					"ServletException in '" + page + "': " + cause.getClass().getSimpleName() + ":" + cause.getMessage();
