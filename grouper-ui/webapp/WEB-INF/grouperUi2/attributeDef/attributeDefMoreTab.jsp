<%@ include file="../assetsJsp/commonTaglib.jsp"%>
                ...
                <li class="dropdown"><a role="tab" data-toggle="dropdown" aria-label="${textContainer.text['ariaLabelGuiMoreOptions']}" href="#" class="dropdown-toggle"
                	aria-haspopup="true" aria-expanded="false" role="button" onclick="$('#attribute-more-tab').is(':visible') === true ? $(this).attr('aria-expanded','false') : $(this).attr('aria-expanded',function(index, currentValue) { $('#attribute-more-tab li').first().focus();return true;});">${textContainer.text['attributeDefMoreTab'] } <b class="caret"></b></a>
