  ...
  <div class="span12">
    ...
    <form id="simpleAttributeAssignAddValueForm" name="simpleAttributeAssignAddValueFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2AttributeDef.attributeAssignAddValueSubmit', {formIds: 'simpleAttributeAssignAddValueForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignAddValueSubmitButton'] }</button> 
        <a href="#" onclick="return guiV2link('operation=UiV2AttributeDef.viewAttributeDefAssignedOwners&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}');"
