         ...
         <div class="span3" id="groupFilterSubmitDiv">
          <input type="submit" class="btn" id="filterSubmitId" aria-controls="attributeDefOwnersResultId"
            value="${textContainer.textEscapeDouble['groupApplyFilterButton'] }"
             onclick="ajax('../app/UiV2AttributeDef.viewAttributeDefAssignedOwners?attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}', {formIds: 'attributeDefOwnersFilterFormId', formIdsOptional: 'attributeDefOwnersPagingFormId'}); return false;">
                    ...
                    <c:if test="${guiAttributeAssign.canUpdateAttributeDefName}">
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
                            <li><a href="?operation=UiV2AttributeDef.assignmentMenuAddValue&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2AttributeDef.assignmentMenuAddValue&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}');">${textContainer.text['simpleAttributeAssign.assignMenuAddValue'] }</a></li>
                            <li><a href="?operation=UiV2AttributeDef.assignmentMenuAddMetadataAssignment&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2AttributeDef.assignmentMenuAddMetadataAssignment&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}');">${textContainer.text['simpleAttributeAssign.assignMenuAddMetadataAssignment'] }</a></li>
                            <li><a href="?operation=UiV2AttributeDef.assignEdit&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2AttributeDef.assignEdit&attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}');">${textContainer.text['simpleAttributeUpdate.editAssignmentAlt'] }</a></li>
                            <li><button type="button" class="grouper-menuitem" onclick="ajax('../app/UiV2AttributeDef.assignDelete?attributeAssignId=${attributeAssign.id}&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}'); return false;" >${textContainer.text['simpleAttributeUpdate.deleteAssignmentAlt'] }</button></li>
                          </ul>
                      </div>
                    </c:if>
                   </td>
