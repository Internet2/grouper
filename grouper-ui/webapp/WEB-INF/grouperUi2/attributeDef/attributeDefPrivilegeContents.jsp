                        ...
                        <div class="row-fluid">
                          ...
                          <div class="span4">
                            <button type="submit" class="btn" 
                              onclick="ajax('../app/UiV2AttributeDef.assignPrivilegeBatch?attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}', {formIds: 'attributeDefFilterPrivilegesFormId,attributeDefPrivilegeFormId', formIdsOptional: 'attributeDefPagingPrivilegesFormId,attributeDefPagingPrivilegesFormPageNumberId'}); return false;">${textContainer.text['attributeDefPrivilegesUpdateSelected'] }</button>
                          </div>
                        </div>
                      </td>
                    </tr>
                          ...
                          <td data-hide="phone,medium" class="direct-actions privilege" >
                            ...
                            <c:choose>
                              <c:when test="${guiMembershipContainer != null 
                                ...
                                <button type="button" class="privilege-check-btn fa fa-check fa-direct" title="${grouper:escapeHtml(ariaRemovePrivilege)}" aria-label="${grouper:escapeHtml(ariaRemovePrivilege)}" onclick="if (confirmChange('${textContainer.textEscapeSingleDouble['attributeDefConfirmChanges']}')) {ajax('../app/UiV2AttributeDef.assignPrivilege?assign=false&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}&fieldName=${fieldName}&memberId=${guiMembershipSubjectContainer.guiMember.member.uuid}', {formIds: 'attributeDefFilterPrivilegesFormId', formIdsOptional: 'attributeDefPagingPrivilegesFormId,attributeDefPagingPrivilegesFormPageNumberId'});} return false;"></button>
                                <button type="button" title="${grouper:escapeHtml(ariaRemovePrivilege)}" aria-label="${grouper:escapeHtml(ariaRemovePrivilege)}" class="btn btn-inverse btn-super-mini remove"
                                   onclick="if (confirmChange('${textContainer.textEscapeSingleDouble['attributeDefConfirmChanges']}')) {ajax('../app/UiV2AttributeDef.assignPrivilege?assign=false&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}&fieldName=${fieldName}&memberId=${guiMembershipSubjectContainer.guiMember.member.uuid}', {formIds: 'attributeDefFilterPrivilegesFormId', formIdsOptional: 'attributeDefPagingPrivilegesFormId,attributeDefPagingPrivilegesFormPageNumberId'});} return false;"
                                  ><i class="fa fa-times" aria-hidden="true"></i></button>
                              </c:when>
                              <c:otherwise>
                                <c:if test="${guiMembershipContainer != null}"><button type="button" class="privilege-check-btn fa fa-check fa-disabled" title="${grouper:escapeHtml(ariaAssignPrivilege)}" aria-label="${grouper:escapeHtml(ariaAssignPrivilege)}" onclick="if (confirmChange('${textContainer.textEscapeSingleDouble['attributeDefConfirmChanges']}')) {ajax('../app/UiV2AttributeDef.assignPrivilege?assign=true&attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}&fieldName=${fieldName}&memberId=${guiMembershipSubjectContainer.guiMember.member.uuid}', {formIds: 'attributeDefFilterPrivilegesFormId', formIdsOptional: 'attributeDefPagingPrivilegesFormId,attributeDefPagingPrivilegesFormPageNumberId'});} return false;"></button></c:if>
