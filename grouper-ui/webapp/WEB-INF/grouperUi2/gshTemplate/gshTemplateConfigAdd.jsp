...
${grouper:title('miscellaneousGshTemplatesAddBreadcrumb')}
	 ...
	 <div class="bread-header-container">
       <ul class="breadcrumb">
           ...
           <li><a href="?operation=UiV2GshTemplateConfig.viewGshTemplates" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2GshTemplateConfig.viewGshTemplates');">${textContainer.text['miscellaneousGshTemplatesOverallBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
