              ...
              <div class="span12">
                ...
                <form class="form-inline form-filter" id="myGroupsForm"
                  ...
                  <div class="row-fluid">
                    ...
                    <div class="span3">&nbsp; &nbsp; <a class="btn" role="button" href="#" onclick="ajax('../app/UiV2MyGroups.myGroupsJoinSubmit', {formIds: 'myGroupsForm, myGroupsPagingFormId'}); return false;">${textContainer.text['myGroupsSearchButton'] }</a> &nbsp;
