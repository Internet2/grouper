            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <form class="form-inline form-filter" id="myGroupsForm"
                    onsubmit="ajax('../app/UiV2MyGroups.myGroupsMembershipsSubmit', {formIds: 'myGroupsForm', formIdsOptional: 'myGroupsPagingFormId'}); return false;">
                  <div class="row-fluid">
                    <div class="span1">
                    ...
                    <div class="span3">&nbsp; &nbsp; <button type="button" class="btn" aria-controls="myGroupsResultsId" onclick="ajax('../app/UiV2MyGroups.myGroupsMembershipsSubmit', {formIds: 'myGroupsForm', formIdsOptional: 'myGroupsPagingFormId'}); return false;">${textContainer.text['myGroupsSearchButton'] }</button> &nbsp;
                    <button type="button" onclick="ajax('../app/UiV2MyGroups.myGroupsMembershipsReset', {formIdsOptional: 'myGroupsPagingFormId'}); return false;" class="btn">${textContainer.text['myGroupsResetButton'] }</button></div>
                  </div>
                </form>
