                          ...
                          <tr>
                            ...
                            <c:if test="${grouperRequestContainer.scriptTesterContainer.jexlScriptTesterResult != null}">
                              ...
                              <tr> 
                                ...
                                <td style="vertical-align: top; white-space: nowrap;">&nbsp;</td>
                                <td>
                                 <p class="showHideGshScript"><button type="button" class="btn-link" style="padding:0;border:0;background:none;font-family:inherit;font-size:inherit;line-height:inherit;vertical-align:baseline;" onclick="$('.gshScript').toggle('slow'); return false;">${textContainer.text['showHideGshScript']} <i class="fa fa-angle-down"></i></button></p>
