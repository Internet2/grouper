<%@ include file="../assetsJsp/commonTaglib.jsp"%>
  ...
  <div class="btn-group btn-block">
    ...
    <a data-toggle="dropdown" href="#" aria-label="${textContainer.text['ariaLabelGuiMoreGrouperSubjectSourcesActions']}" id="more-action-button" class="btn btn-medium btn-block dropdown-toggle" 
      aria-haspopup="true" aria-expanded="false" role="button" onclick="$('#subject-source-more-options').is(':visible') === true ? $(this).attr('aria-expanded','false') : $(this).attr('aria-expanded',function(index, currentValue) { $('#subject-source-more-options li').first().focus();return true;});">
