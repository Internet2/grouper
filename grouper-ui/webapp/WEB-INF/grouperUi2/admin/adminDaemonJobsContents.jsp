                          ...
                          <td class="expand foo-clicker">
                            <div class="btn-group btn-block">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right" id="daemon-jobs-more-actions">
                                ...
                                <li><a href="#" onclick="return guiV2link('operation=UiV2Admin.viewPerformanceChart&jobName=${guiDaemonJob.jobName}'); return false;">${textContainer.text['adminDaemonJobsMoreActionsPerformance'] }</a></li>
                                <br />
