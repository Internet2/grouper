                  ...
                  <tbody>
                    ...
                    <c:forEach var="guiHib3GrouperLoaderLog" items="${grouperRequestContainer.adminContainer.guiHib3GrouperLoaderLogs}" >
                      ...
                      <tr>
                        ...
                        <td style="white-space: nowrap"><span class="jobMessageContainer"><grouper:abbreviateTextarea text="${guiHib3GrouperLoaderLog.hib3GrouperLoaderLog.jobMessage}" showCharCount="30" cols="20" rows="3"/></span><c:if test="${not empty guiHib3GrouperLoaderLog.hib3GrouperLoaderLog.jobMessage}"> <a href="#" onclick="grouperCopyJobMessage(this); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left:4px;"><i class="fa fa-clone" aria-hidden="true"></i></a></c:if></td>
