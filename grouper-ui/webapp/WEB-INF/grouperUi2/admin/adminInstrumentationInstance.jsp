...
${grouper:title('adminInstrumentationTitle')}
            ...
            <div class="bread-header-container">
              <ul class="breadcrumb">
                ...
                <li><a href="?operation=UiV2Admin.instrumentation" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Admin.instrumentation');">${textContainer.text['adminInstrumentationBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
