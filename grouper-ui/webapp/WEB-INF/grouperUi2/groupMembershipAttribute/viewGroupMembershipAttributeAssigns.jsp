...
${grouper:titleFromKeyAndText('groupMembershipAttributeAssignmentsPageTitle', grouperRequestContainer.groupContainer.guiGroup.group.displayName)}
              ...
              <div class="span12">
               ...
               <ul class="nav nav-tabs">
                ...
                <div id="groupAttributeAssignments">
                  <%@ include file="groupMembershipAttributeAssignmentSection.jsp"%>
                </div>
