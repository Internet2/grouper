  ...
  <div class="span12">
    ...
    <form id="simpleAttributeMetadataAddForm" name="simpleAttributeMetadataAddFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2AttributeDefName.assignMetadataAddSubmit', {formIds: 'simpleAttributeMetadataAddForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignAddValueSubmitButton'] }</button>
