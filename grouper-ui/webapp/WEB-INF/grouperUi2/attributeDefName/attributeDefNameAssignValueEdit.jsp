  ...
  <div class="span12">
    ...
    <form id="simpleAttributeAssignValueEditForm" name="simpleAttributeAssignValueEditFormName" class="form-horizontal" action="javascript:void(0);">
      ...
      <div class="form-actions">
        <a href="#" class="btn btn-primary" role="button" onclick="ajax('../app/UiV2AttributeDefName.assignValueEditSubmit', {formIds: 'simpleAttributeAssignValueEditForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignValueEditSubmitButton'] }</a>
        <a href="#" class="btn btn-cancel" role="button" onclick="ajax('../app/UiV2AttributeDefName.viewAttributeDefNameAssignedOwners', {formIds: 'simpleAttributeAssignValueEditForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignValueEditCancelButton'] }</a>
      </div>
