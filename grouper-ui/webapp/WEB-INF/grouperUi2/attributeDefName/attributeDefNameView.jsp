<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="bread-header-container">
              ...
              <div class="page-header blue-gradient">
                ...
                <h1> <i class="fa fa-cogs"></i> ${grouper:escapeHtml(grouperRequestContainer.attributeDefNameContainer.guiAttributeDefName.attributeDefName.extension)}
                </h1>
              </div>
            ...
            <div class="row-fluid">
              <div class="span9">
                  ...
                  <%-- div class="form-actions">
                  	<a href="#" onclick="return guiV2link('operation=UiV2AttributeDef.viewAttributeDef?attributeDefId=${grouperRequestContainer.attributeDefContainer.guiAttributeDef.attributeDef.id}');" class="btn btn-cancel">${textContainer.text['attributeDefCreateCancelButton'] }</a>
                  </div --%>
                </form>
              </div>
              <div class="span3" id="attributeDefNameMoreActionsButtonContentsDivId">
