...
${grouper:titleFromKeyAndText('viewAttributeDefNamePageTitle', grouperRequestContainer.attributeDefNameContainer.guiAttributeDefName.attributeDefName.displayName)}
