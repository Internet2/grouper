			                   ...
			                   <td>
			                     <div class="btn-group">
			                           ...
			                           <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
			                             <li><a href="#" onclick="return guiV2link('operation=UiV2ProvisionerConfiguration.viewProvisionerConfigDetails&provisionerConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&provisionerConfigType=${guiProvisionerConfiguration.provisionerConfiguration['class'].name}');">${textContainer.text['provisionerConfigsTableViewDetailsActionOption'] }</a></li>
			                             <li><a href="#" onclick="return guiV2link('operation=UiV2ProvisionerConfiguration.editProvisionerConfigDetails&provisionerConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&provisionerConfigType=${guiProvisionerConfiguration.provisionerConfiguration['class'].name}');">${textContainer.text['provisionerConfigsTableEditDetailsActionOption'] }</a></li>
			                             <%-- <li><a href="#" onclick="return guiV2link('operation=UiV2ExternalSystem.testExternalSystemConfigDetails&externalSystemConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&externalSystemType=${guiProvisionerConfiguration.grouperExternalSystem['class'].name}');">${textContainer.text['grouperExternalSystemTableTestDetailsActionOption'] }</a></li> --%>
					                     ...
					                     <c:if test="${guiProvisionerConfiguration.provisionerConfiguration.enabled == false}">
					                      <li><a href="#" onclick="return guiV2link('operation=UiV2ProvisionerConfiguration.enableExternalSystem&provisionerConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&provisionerConfigType=${guiProvisionerConfiguration.provisionerConfiguration['class'].name}');">${textContainer.text['provisionerConfigsTableEnableActionOption'] }</a></li>
					                     </c:if>
			                             
			                             <li><a href="#" onclick="if (confirmChange('${textContainer.textEscapeSingleDouble['provisionerConfigConfirmDeleteConfig']}')) { return guiV2link('operation=UiV2ProvisionerConfiguration.deleteProvisionerConfigDetails&provisionerConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&provisionerConfigType=${guiProvisionerConfiguration.provisionerConfiguration['class'].name}');}">${textContainer.text['provisionerConfigsTableDeleteDetailsActionOption'] }</a></li>
			                           </ul>
			                         </div>
			                   </td>
			              </c:forEach>
