			                   ...
			                   <td>
			                     <div class="btn-group">
			                           ...
			                           <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
			                             ...
			                             <li><a href="#" onclick="return guiV2link('operation=UiV2ProvisionerConfiguration.diagnostics&provisionerConfigId=${guiProvisionerConfiguration.provisionerConfiguration.configId}&provisionerConfigType=${guiProvisionerConfiguration.provisionerConfiguration['class'].name}');">${textContainer.text['provisionerConfigsTableDiagnosticsActionOption'] }</a></li>
