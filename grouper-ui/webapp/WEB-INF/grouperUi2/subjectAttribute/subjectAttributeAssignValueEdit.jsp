  ...
  <div class="span12">
    ...
    <form id="simpleAttributeAssignValueEditForm" name="simpleAttributeAssignValueEditFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <a href="#" class="btn btn-primary" role="button" onclick="ajax('../app/UiV2SubjectAttributeAssignment.assignValueEditSubmit', {formIds: 'simpleAttributeAssignValueEditForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignValueEditSubmitButton'] }</a>
        <a href="#" class="btn btn-cancel" role="button" onclick="ajax('../app/UiV2SubjectAttributeAssignment.viewAttributeAssignments', {formIds: 'simpleAttributeAssignValueEditForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignValueEditCancelButton'] }</a>
      </div>
