  ...
  <div class="span12">
    <form id="simplePermissionLimitValueEditForm" name="simplePermissionLimitValueEditFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2SubjectPermission.limitValueEditSubmit', {formIds: 'simplePermissionLimitValueEditForm'}); return false;">${textContainer.text['simplePermissionUpdate.limitValueEditSubmitButton'] }</button> 
        <button type="button" class="btn btn-cancel" onclick="ajax('../app/UiV2SubjectPermission.subjectPermission', {formIds: 'simplePermissionLimitValueEditForm'}); return false;">${textContainer.text['simplePermissionUpdate.limitValueEditCancelButton'] }</button>
      </div>
