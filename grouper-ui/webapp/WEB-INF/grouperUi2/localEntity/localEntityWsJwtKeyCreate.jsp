<%@ include file="../assetsJsp/commonTaglib.jsp"%>
   ...
   <form class="form-inline form-small form-filter" id="createLocalEntityWsJwtKeyFormId">
         ...
         <tbody>
           ...
           <tr>
             ...
             <td
               ...
               aria-controls="createLocalEntityWsJwtKeyFormId" id="submitId"
               value="${textContainer.text['localEntityViewWsJwtKeySaveButton'] }"
               onclick="ajax('../app/UiV2LocalEntity.createWsJwtKeySubmit', {formIds: 'createLocalEntityWsJwtKeyFormId'}); return false;">
