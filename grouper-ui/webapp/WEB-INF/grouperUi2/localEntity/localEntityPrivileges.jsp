<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="row-fluid">
              <div class="span12 tab-interface">
                ...
                <c:set var="grouperCurrentTab" value="localEntityPrivileges" />
                ...
                <form class="form-inline form-small form-filter" id="groupFilterPrivilegesFormId">
                  ...
                  <div class="row-fluid" style="margin-top: 5px;">
                    ...
                    <div class="span4"><input type="submit" class="btn" aria-controls="groupPrivilegeFilterResultsId"  id="filterSubmitId" value="${textContainer.textEscapeDouble['groupApplyFilterButton'] }"
                        onclick="ajax('../app/UiV2LocalEntity.filterPrivileges?groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}', {formIds: 'groupFilterPrivilegesFormId', formIdsOptional: 'groupPagingPrivilegesFormId'}); return false;"> 
