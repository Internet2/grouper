                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td
                          ...
                          onclick="ajax('../app/UiV2GrouperWorkflow.workflowConfigAddEditSubmit?groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}', {formIds: 'addWorkflowConfigFormId'}); return false;">
