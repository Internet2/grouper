<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="bread-header-container">
              <ul class="breadcrumb">
                  ...
                  <li><a href="#" onclick="return guiV2link('operation=UiV2Deprovisioning.deprovisioningMain');">${textContainer.text['miscellaneousDeprovisioningOverallBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
                  <li class="active">${textContainer.text['deprovisioningUserSearchBreadcrumb'] }</li>
              </ul>
                            
              <div class="page-header blue-gradient">
                <div class="row-fluid">
                  <div class="lead span9"><h1>${textContainer.text['deprovisioningUserSearchDecription'] }</h1></div>
                ...
                <div class="row-fluid">
                  <div class="span12">
                    <p style="margin-top: -1em; margin-bottom: 1em">${textContainer.text['deprovisioningUserSearchSubtitle']}</p>
                  </div>
                </div>
              </div>
