...
${grouper:title('miscellaneousDataFieldEditBreadcrumb')}
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
              <li><a href="?operation=UiV2EntityDataFields.viewEntityDataFields" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2EntityDataFields.viewEntityDataFields');">${textContainer.text['miscellaneousDataFieldsBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <div class="page-header blue-gradient">
              ...
              <div class="row-fluid">
                <div class="lead span9 pull-left"><h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousEntityDataFieldsMainDescription'] }</h1></div>
