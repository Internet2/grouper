...
${grouper:title('miscellaneousDataProviderAddBreadcrumb')}
   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li><a href="?operation=UiV2EntityDataFields.viewDataProviders" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2EntityDataFields.viewDataProviders');">${textContainer.text['miscellaneousDataProvidersBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
            
            <li class="active">${textContainer.text['miscellaneousDataProviderAddBreadcrumb'] }</li> 
        </ul>
       
       <div class="page-header blue-gradient">
       
         <div class="row-fluid">
           <div class="lead span9 pull-left"><h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousDataProvidersMainDescription'] }</h1></div>
    ...
    <div class="span12">
     <div id="messages"></div>
         ...
         <form class="form-inline form-small form-filter" id="dataProviderConfigDetails">
            <table class="table table-condensed table-striped">
              <tbody>
                <%@ include file="dataProviderConfigAddHelper.jsp" %>
                <tr>
                  <td>
                  ...
                  <td
                    ...
                    aria-controls="dataProviderConfigDetails" id="submitId"
                    value="${textContainer.text['dataFieldConfigAddFormSubmitButton'] }"
                    onclick="ajax('../app/UiV2EntityDataFields.addDataProviderConfigSubmit', {formIds: 'dataProviderConfigDetails'}); return false;">
                    &nbsp;
                  <a class="btn btn-cancel" role="button"
                          onclick="return guiV2link('operation=UiV2EntityDataFields.viewDataProviders'); return false;"
