  ...
  <div class="page-header blue-gradient">
    ...
    <div class="row-fluid">
      <div class="lead span9 pull-left">
        <h4>${textContainer.text['miscellaneousDataProvidersMainDescription'] }</h4>
      </div>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right"
                    ...
                    <li><a href="#" onclick="return guiV2link('operation=UiV2EntityDataFields.editDataProviderConfig&dataProviderConfigId=${guiDataProviderConfiguration.grouperDataProviderConfiguration.configId}');">${textContainer.text['dataFieldsEditActionsOption'] }</a></li>
