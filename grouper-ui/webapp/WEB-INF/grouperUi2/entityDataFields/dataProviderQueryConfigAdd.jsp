...
${grouper:title('miscellaneousDataProviderQueryAddBreadcrumb')}
   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li><a href="?operation=UiV2EntityDataFields.viewEntityDataProviderQueries" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2EntityDataFields.viewEntityDataProviderQueries');">${textContainer.text['miscellaneousDataProviderQueriesBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
