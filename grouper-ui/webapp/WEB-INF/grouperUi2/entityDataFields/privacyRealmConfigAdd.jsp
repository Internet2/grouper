<%@ include file="../assetsJsp/commonTaglib.jsp"%>
   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li><a href="?operation=UiV2EntityDataFields.viewPrivacyRealmConfigs" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2EntityDataFields.viewPrivacyRealmConfigs');">${textContainer.text['miscellaneousPrivacyRealmsBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
