...
${grouper:title('miscellaneousDataProviderChangeLogQueryAddBreadcrumb')}
   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li><a href="?operation=UiV2EntityDataFields.viewEntityDataProviderChangeLogQueries" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2EntityDataFields.viewEntityDataProviderChangeLogQueries');">${textContainer.text['miscellaneousDataProviderChangeLogQueriesBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
            
            <li class="active">${textContainer.text['miscellaneousDataProviderChangeLogQueryAddBreadcrumb'] }</li> 
        </ul>
       
       <div class="page-header blue-gradient">
       
         <div class="row-fluid">
           <div class="lead span9 pull-left"><h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousDataProviderChangeLogQueriesMainDescription'] }</h1></div>
     ...
     <div id="messages"></div>
         ...
         <form class="form-inline form-small form-filter" id="dataProviderChangeLogQueryConfigDetails">
            <table class="table table-condensed table-striped">
              <tbody>
                <%@ include file="dataProviderChangeLogQueryConfigAddHelper.jsp" %>
                <tr>
                  <td>
                  ...
                  <td
                    ...
                    aria-controls="dataProviderChangeLogQueryConfigDetails" id="submitId"
                    value="${textContainer.text['dataFieldConfigAddFormSubmitButton'] }"
                    onclick="ajax('../app/UiV2EntityDataFields.addDataProviderChangeLogQueryConfigSubmit', {formIds: 'dataProviderChangeLogQueryConfigDetails'}); return false;">
                    &nbsp;
