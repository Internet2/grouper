...
<div class="bread-header-container">
  <ul class="breadcrumb">
    ...
    <li class="active">${textContainer.text['miscellaneousDataRowsBreadcrumb'] }</li> 
  </ul>
  ...
  <div class="page-header blue-gradient">
    ...
    <div class="row-fluid">
      <div class="lead span9 pull-left">
        <h4>${textContainer.text['miscellaneousDataRowsMainDescription'] }</h4>
      </div>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right"
                    ...
                    <li><a href="#" onclick="return guiV2link('operation=UiV2EntityDataFields.editDataRowConfig&dataRowConfigId=${guiDataRowConfiguration.grouperDataRowConfiguration.configId}');">${textContainer.text['dataFieldsEditActionsOption'] }</a></li>

                    <li>&nbsp;</li>                                  
                    <li><a href="#" onclick="if (confirm('${textContainer.textEscapeSingleDouble['dataRowConfigsConfirmDeleteConfig']}')) { return guiV2link('operation=UiV2EntityDataFields.deleteDataRowConfig&dataRowConfigId=${guiDataRowConfiguration.grouperDataRowConfiguration.configId}');}">${textContainer.text['dataFieldsDeleteActionsOption'] }</a></li>
