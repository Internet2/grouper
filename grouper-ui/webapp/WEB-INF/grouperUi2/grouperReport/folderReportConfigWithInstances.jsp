            ...
            <tbody>
              ...
              <c:forEach items="${configInstance.guiReportInstances}" var="guiReportInstance">
                ...
                <tr>
                   ...
                   <td>
                     <a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.viewReportInstanceDetails&attributeAssignId=${guiReportInstance.reportInstance.attributeAssignId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">
