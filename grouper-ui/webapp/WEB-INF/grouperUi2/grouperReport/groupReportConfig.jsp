...
${grouper:titleFromKeyAndText('groupReportConfigPageTitle', grouperRequestContainer.groupContainer.guiGroup.group.displayName)}
                     ...
                     <div class="btn-group">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
                             ...
                             <c:if test="${grouperRequestContainer.grouperReportContainer.canWriteGrouperReports }">
                               <li class="divider"></li>
                               <li><a href="#" onclick="if (confirm('${textContainer.textEscapeSingleDouble['grouperReportConfigConfirmDeleteReportConfig']}')) { return guiV2link('operation=UiV2GrouperReport.deleteReportConfigForGroup&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}'); } return false;">${textContainer.text['grouperReportConfigTableReportActionsDeleteReportConfig'] }</a></li>
                               <c:choose>
                                 <c:when test="${guiReportConfig.reportConfigBean.reportConfigEnabled}">
