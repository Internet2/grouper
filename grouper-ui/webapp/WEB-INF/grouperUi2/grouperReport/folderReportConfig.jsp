...
<div class="row-fluid">
  <div class="span12 tab-interface">
    ...
    <c:choose>
              ...
              <c:forEach items="${grouperRequestContainer.grouperReportContainer.guiReportConfigs}" var="guiReportConfig">
                ...
                <tr>
                   <td style="white-space: nowrap;">
                    <a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.viewAllReportInstances&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">
                     ...
                     <div class="btn-group">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
                             ...
                             <c:if test="${not empty guiReportConfig.mostRecentReportInstance }">
                               <li><a href="../app/UiV2GrouperReport.downloadReport?attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}">${textContainer.text['grouperReportConfigTableReportActionsDownloadMostRecent'] }</a></li>
                               <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.viewReportInstanceDetails&attributeAssignId=${guiReportConfig.mostRecentReportInstance.attributeAssignId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">${textContainer.text['grouperReportConfigTableReportActionsViewMostRecent'] }</a></li>
                               <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.viewAllReportInstances&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">${textContainer.text['grouperReportConfigTableReportActionsReportInstances'] }</a></li>
                             ...
                             <c:if test="${grouperRequestContainer.grouperReportContainer.canWriteGrouperReports }">
                               <c:choose>
	                               <c:when test="${guiReportConfig.reportConfigBean.reportConfigEnabled}">
	                                 <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.changeReportConfigStatus&newStatus=disable&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">${textContainer.text['grouperReportConfigTableReportActionsDisbleReportConfig'] }</a></li>
	                               </c:when>
	                               <c:otherwise>
	                                 <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.changeReportConfigStatus&newStatus=enable&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">${textContainer.text['grouperReportConfigTableReportActionsEnableReportConfig'] }</a></li>
	                               </c:otherwise>
	                             </c:choose>
                               <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperReport.deleteReportConfig&attributeAssignmentMarkerId=${guiReportConfig.reportConfigBean.attributeAssignmentMarkerId}&stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}');">${textContainer.text['grouperReportConfigTableReportActionsDeleteReportConfig'] }</a></li>                             
                             </c:if>
                           </ul>
                         </div>
                   </td>
      ...
      <c:otherwise>
        <div class="row-fluid">
          <div class="span9"> <p><b>${textContainer.text['grouperReportNoEntitiesFoundOnFolder'] }</b></p></div>
        </div>
      </c:otherwise>
    </c:choose>
