<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <form class="form-inline form-small form-filter" id="groupFilterPrivilegesFormId">
                  <div class="row-fluid">
                    ...
                    <div class="span3"><input type="submit" class="btn"  id="filterSubmitId" value="${textContainer.textEscapeDouble['groupApplyFilterButton'] }"
                        onclick="ajax('../app/UiV2Group.filterThisGroupsGroupPrivileges?groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}', {formIds: 'groupFilterPrivilegesFormId'}); return false;"> 
                ...
                <div id="thisGroupsGroupPrivilegesFilterResultsId">
                </div>                
              </div>
            </div>
