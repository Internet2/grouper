...
${grouper:titleFromKeyAndText('groupGroupPrivilegesPageTitle', grouperRequestContainer.groupContainer.guiGroup.group.displayName)}
                ...
                <form class="form-inline form-small form-filter" id="groupFilterPrivilegesFormId">
                  <div class="row-fluid">
                    ...
                    <div class="span3"><input type="submit" class="btn"  id="filterSubmitId" aria-controls="thisGroupsGroupPrivilegesFilterResultsId" value="${textContainer.textEscapeDouble['groupApplyFilterButton'] }"
                        onclick="ajax('../app/UiV2Group.filterThisGroupsGroupPrivileges?groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}', {formIds: 'groupFilterPrivilegesFormId', formIdsOptional: 'groupPagingPrivilegesFormId'}); return false;"> 
