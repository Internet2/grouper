...
${grouper:titleFromKeyAndText('groupPrivilegesAssignedToMembersOfThisGroupPageTitle', grouperRequestContainer.groupContainer.guiGroup.group.displayName)}
            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <p class="lead">${textContainer.text['assignedToGroupPrivilegesInheritedFromFoldersDecription'] }</p>
                <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <p style="margin-top: -1em;">${textContainer.text['assignedToGroupPrivilegesInheritedFromFoldersSubtitle'] }</p>
