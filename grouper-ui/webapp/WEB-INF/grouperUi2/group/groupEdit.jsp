...
${grouper:titleFromKeyAndText('groupEditPageTitle', grouperRequestContainer.groupContainer.guiGroup.group.name)}
              ...
              <div class="span12">
                <form id="editGroupForm" class="form-horizontal">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="enabledDate" placeholder="${textContainer.text['groupCreateDatePlaceholder'] }" value="${grouperRequestContainer.groupContainer.guiGroup.enabledDateLabel }" id="groupEnabledDate"><span class="help-block">${textContainer.text['groupCreateEnabledDateDescription'] }</span>
                    </div>
                  </div>
                  <div class="control-group">
