                  ...
                  <thead>
                    <tr>
                      <th class="${grouperRequestContainer.groupContainer.guiSorting.columnCssClass['lastUpdatedDb']}"
                         onclick="ajax('../app/UiV2Attestation.viewGroupAuditsFilter?groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&querySortAscending=${!grouperRequestContainer.groupContainer.guiSorting.ascending}', {formIds: 'groupFilterAuditFormId', formIdsOptional: 'groupPagingAuditFormId'}); return false;"
