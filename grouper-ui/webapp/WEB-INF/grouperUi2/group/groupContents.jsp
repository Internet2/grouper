                      ...
                      <c:if test="${grouperRequestContainer.groupContainer.showPointInTimeAudit}">
                        <c:forEach items="${grouperRequestContainer.groupContainer.guiPITMembershipViews}" 
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="expand foo-clicker">${guiPITMembershipView.guiSubject.shortLinkWithIcon}<c:if test="${not empty guiPITMembershipView.guiSubject.subject.description}"> <button type="button" data-gr-copy-text="${grouperUtil.xmlEscape(guiPITMembershipView.guiSubject.subject.description)}" onclick="grouperCopyTextToClipboard(this); return false;" aria-label="${textContainer.textEscapeXml['groupViewCopyEntityDescriptionTooltip']}" title="${textContainer.text['groupViewCopyEntityDescriptionTooltip']}" class="btn-link" style="margin-left:4px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button></c:if> <br/>
                            </td>
                      ...
                      <c:if test="${!grouperRequestContainer.groupContainer.showPointInTimeAudit}">
                        <c:forEach items="${grouperRequestContainer.groupContainer.guiMembershipSubjectContainers}" 
                          ...
                          <tr>
                            ...
                            <td class="expand foo-clicker">${guiMembershipSubjectContainer.guiSubject.shortLinkWithIcon}<c:if test="${not empty guiMembershipSubjectContainer.guiSubject.subject.description}"> <button type="button" data-gr-copy-text="${grouperUtil.xmlEscape(guiMembershipSubjectContainer.guiSubject.subject.description)}" onclick="grouperCopyTextToClipboard(this); return false;" aria-label="${textContainer.textEscapeXml['groupViewCopyEntityDescriptionTooltip']}" title="${textContainer.text['groupViewCopyEntityDescriptionTooltip']}" class="btn-link" style="margin-left:4px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button></c:if> <br/>
                            </td>
                            <c:if test="${grouperRequestContainer.groupContainer.showEnabledStatus}">
