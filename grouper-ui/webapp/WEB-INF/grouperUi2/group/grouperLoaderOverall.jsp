                    ...
                    <table class="table table-hover table-bordered table-striped table-condensed data-table table-bulk-update table-privileges footable">
                      ...
                      <tbody>
                        ...
                        <c:forEach  items="${grouperRequestContainer.grouperLoaderContainer.guiGrouperLoaderJobs}" 
                          var="guiGrouperLoaderLog">
                          <tr>
                            <td class="expand foo-clicker" style="white-space: nowrap;">${guiGrouperLoaderLog.guiGroup.shortLinkWithIcon}
                            </td>
                            <td class="expand foo-clicker" 
                               style="color: White; 
                               background-color: ${guiGrouperLoaderLog.status == 'SUCCESS' ? 'green' : (guiGrouperLoaderLog.status == 'ERROR' ? 'red' : '')}; 
                               font-weight: bold;">
                            <span rel="tooltip" data-html="true" data-delay-show="200" data-placement="right" class="grouperTooltip" style="border-bottom-color: white;"
                                data-original-title="${grouper:escapeHtml(guiGrouperLoaderLog.statusDescription)}">${guiGrouperLoaderLog.status}</span>
                            </td>
                            <td class="expand foo-clicker">
                              <div class="btn-group btn-block">
					                      ...
					                      <ul class="dropdown-menu dropdown-menu-right" id="grouper-loader-more-options">
					                        ...
					                        <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperLoader.loader&groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
					                            >${textContainer.text['grouperLoaderMoreActionsViewLoader'] }</a></li>
					                            
				                          <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperLoader.viewLogs&groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
				                              >${textContainer.text['grouperLoaderMoreActionsViewLoaderLogs'] }</a></li>
  
			                            <li><a href="#" onclick="ajax('../app/UiV2Group.updateLoaderGroup?groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
			                              >${textContainer.text['groupRunLoaderProcessButton'] }</a></li>

				                          <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperLoader.loaderDiagnostics&groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
				                              >${textContainer.text['grouperLoaderDiagnosticsButton'] }</a></li>

				                          <li><a href="#" onclick="return guiV2link('operation=UiV2GrouperLoader.editGrouperLoader?groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
				                              >${textContainer.text['grouperLoaderEditConfiguration'] }</a></li>

				                          <li><a href="#" onclick="ajax('../app/UiV2Group.scheduleLoaderGroup?groupId=${guiGrouperLoaderLog.guiGroup.group.id}'); return false;"
				                            >${textContainer.text['groupScheduleLoaderProcessButton'] }</a></li>
					                            
					                      </ul>
					                    </div>
                            </td>
                            <td class="expand foo-clicker">${guiGrouperLoaderLog.count}
                            </td>
                            <td class="expand foo-clicker">${guiGrouperLoaderLog.changes}
                            </td>
                            <td class="expand foo-clicker">${guiGrouperLoaderLog.type}
                            </td>
                            <td class="expand foo-clicker"><span rel="tooltip" data-html="true" data-delay-show="200" data-placement="right" class="grouperTooltip"
                                data-original-title="${grouper:escapeHtml(guiGrouperLoaderLog.sourceDescription)}">${guiGrouperLoaderLog.source}</span>
                            
                            </td>
                            <td class="expand foo-clicker"><input type="text" value="${grouper:escapeHtml(guiGrouperLoaderLog.query)}" style="width: 50em"/>
                            </td>
                          </tr>
