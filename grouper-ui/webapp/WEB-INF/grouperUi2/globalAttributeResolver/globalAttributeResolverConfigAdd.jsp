...
${grouper:title('miscellaneousGlobalAttributeResolverConfigAddBreadcrumb')}
   ...
   <div class="bread-header-container">
       <ul class="breadcrumb">
           ...
           <li><a href="?operation=UiV2GlobalAttributeResolverConfig.viewGlobalAttributeResolverConfigs" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2GlobalAttributeResolverConfig.viewGlobalAttributeResolverConfigs');">${textContainer.text['miscellaneousGlobalAttributeResolverConfigsOverallBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
           <li class="active">${textContainer.text['miscellaneousGlobalAttributeResolverConfigAddBreadcrumb'] }</li>
       </ul>
       
       <div class="page-header blue-gradient">
       
         <div class="row-fluid">
           <div class="lead span9 pull-left"><h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousGlobalAttributeResolverConfigsMainDescription'] }</h1></div>
     ...
     <div id="messages"></div>
         ...
         <form class="form-inline form-small form-filter" id="globalAttributeResolverConfigDetails">
            <table class="table table-condensed table-striped">
              <tbody>
                <%@ include file="globalAttributeResolverConfigAddHelper.jsp" %>
                <tr>
                  <td>
                  ...
                  <td
                    ...
                    aria-controls="globalAttributeResolverConfigDetails" id="submitId"
                    value="${textContainer.text['globalAttributeResolverConfigAddFormSubmitButton'] }"
                    onclick="ajax('../app/UiV2GlobalAttributeResolverConfig.addGlobalAttributeResolverConfigSubmit', {formIds: 'globalAttributeResolverConfigDetails'}); return false;">
                    &nbsp;
                  <a class="btn btn-cancel" role="button"
                          ...
                          >${textContainer.text['globalAttributeResolverConfigAddFormCancelButton'] }</a>
                  </td>
                </tr>
