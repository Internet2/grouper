<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="bread-header-container">
              <ul class="breadcrumb">
               ...
               <li><a href="#" onclick="return guiV2link('operation=UiV2AuthenticationConfig.viewWsTrustedJwts');">${textContainer.text['miscellaneousGlobalAttributeResolverConfigsOverallBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
