              ...
              <div class="span12">
                <form class="form-horizontal" id="editMembershipFormId">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="datetime-local" step="1" name="startDate"  placeholder="${textContainer.text['membershipEditDatePlaceholder'] }"  
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="datetime-local" step="1" name="endDate" placeholder="${textContainer.text['membershipEditDatePlaceholder'] }"
