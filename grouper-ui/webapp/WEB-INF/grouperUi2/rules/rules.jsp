...
${grouper:title('rulesConfigsPageTitle')}
            ...
            <div class="bread-header-container">
              ...
              <div class="page-header blue-gradient">
                ...
                <div class="row-fluid">
                  <div class="lead span9 pull-left"><h1>${textContainer.text['miscellaneousRulesConfigurationsMainDescription'] }</h1></div>
      ...
      <div class="row-fluid">
          ...
          <c:choose>
            ...
            <c:otherwise>
              <div class="row-fluid">
                <div class="span9"> <p><b>${textContainer.text['rulesConfigNoConfiguredRulesConfigsFound'] }</b></p></div>
              </div>
            </c:otherwise>
          </c:choose>
