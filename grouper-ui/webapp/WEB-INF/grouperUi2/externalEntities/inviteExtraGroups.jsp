<%@ include file="../assetsJsp/commonTaglib.jsp"%>
                ...
                <c:forEach items="${grouperRequestContainer.inviteExternalContainer.inviteExtraGuiGroups}" 
                  ...
                  ${guiGroup.linkWithIcon} <a href="#" role="button" aria-label="Remove group ${grouper:escapeHtml(guiGroup.group.displayExtension)}" onclick="ajax('../app/UiV2ExternalEntities.inviteRemoveGroup?removeGroupId=${grouper:escapeUrl(guiGroup.group.id)}', {formIds: 'inviteFormId'}); return false;"><i class="fa fa-times" style="color: #aaaaaa" aria-hidden="true"></i></a>
