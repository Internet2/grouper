                            ...
                            <c:if test="${guiMembershipSubjectContainer.guiGroup.canUpdate
                              ...
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" id="subject-contents-more-options${i}">
                                  ...
                                  <li><a href="#"  onclick="return guiV2link('operation=UiV2Provisioning.viewProvisioningOnMembership&groupId=${guiMembershipSubjectContainer.membershipSubjectContainer.groupOwner.id}&subjectId=${grouperRequestContainer.subjectContainer.guiSubject.subject.id}&sourceId=${grouperRequestContainer.subjectContainer.guiSubject.subject.sourceId}'); return false;" class="actions-attribute-assignments">${textContainer.text['subjectViewProvisioningButton'] }</a></li>
                                </ul>
                              </div>
                            </c:if>
                          </td>
