<header class="pull-left"><a href="?operation=UiV2Main.indexMain" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Main.indexMain');" title="${textContainer.text['institutionName']}"><img class="brand" src="../../${mediaMap['image.organisation-logo']}" alt="${textContainer.textEscapeXml['ariaLabelGrouperHome']}" style="padding-top: 5px; padding-bottom: 5px" /></a><br />
