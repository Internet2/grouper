  ...
  <div class="span12">
    <form id="simplePermissionEditForm" name="simplePermissionEditFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2GroupPermission.permissionEditSubmit', {formIds: 'simplePermissionEditForm'}); return false;">${textContainer.text['simplePermissionAssign.assignEditSubmitButton'] }</button> 
        <button type="button" class="btn btn-cancel" onclick="ajax('../app/UiV2GroupPermission.groupPermission', {formIds: 'simplePermissionEditForm'}); return false;">${textContainer.text['groupAssignPermissionCancelButton'] }</button>
      </div>
