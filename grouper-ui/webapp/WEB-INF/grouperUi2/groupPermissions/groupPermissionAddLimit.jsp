  ...
  <div class="span12">
    ...
    <form id="attributePermissionAddLimitFormId" class="form-horizontal" name="attributePermissionAddLimitFormName" onsubmit="return false;" >
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2GroupPermission.assignLimitSubmit', {formIds: 'attributePermissionAddLimitFormId'}); return false;">${textContainer.text['groupAssignPermissionSaveButton'] }</button> 
        <button type="button" class="btn btn-cancel" onclick="ajax('../app/UiV2GroupPermission.groupPermission', {formIds: 'attributePermissionAddLimitFormId'}); return false;">${textContainer.text['groupAssignPermissionCancelButton'] }</button> 
      </div>
