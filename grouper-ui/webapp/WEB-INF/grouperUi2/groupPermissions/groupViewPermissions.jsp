...
<c:choose>
  ...
  <form class="form-horizontal" id="attributePermissionsFormId" name="attributePermissionsFormName" onsubmit="return false;">
   <input type="hidden" name="permissionAssignType"
                  ...
                  <c:if test="${guiPermissionEntryActionsContainer.showAction[action]}">
                    ...
                    <div class="btn-group" style="display: inline-block;">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                          <a href="#" onclick="ajax('../app/UiV2GroupPermission.assignmentMenu', {requestParams: {menuItemId: 'analyzeAssignment', menuIdOfMenuTarget: 'permissionMenuButton_${guiPermissionId}__${grouperRequestContainer.permissionUpdateRequestContainer.permissionType.name}'}}); return false;">${textContainer.text['simplePermissionAssign.assignMenuAnalyzeAssignment']}</a>
                        </li>
                        <li>
                          <a href="#" onclick="ajax('../app/UiV2GroupPermission.assignmentMenu', {requestParams: {menuItemId: 'editAssignment', menuIdOfMenuTarget: 'permissionMenuButton_${guiPermissionId}__${grouperRequestContainer.permissionUpdateRequestContainer.permissionType.name}'}}); return false;">${textContainer.text['simplePermissionAssign.editAssignment']}</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <c:when test="${guiPermissionLimitBeanContainer.immediate}" >
                      <div class="btn-group" style="display: inline-block;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                          ...
                          <li>
                            <a href="#" onclick="ajax('../app/UiV2GroupPermission.limitMenu', {requestParams: {menuItemId: 'editLimit', menuIdOfMenuTarget: 'limitMenuButton_${guiPermissionLimitBeanContainer.permissionLimitBean.limitAssign.id}'}}); return false;">${textContainer.text['simplePermissionAssign.limitMenuEditLimit']}</a>
                          </li>
                          <li>
                            <a href="#" onclick="ajax('../app/UiV2GroupPermission.limitMenu', {requestParams: {menuItemId: 'deleteLimit', menuIdOfMenuTarget: 'limitMenuButton_${guiPermissionLimitBeanContainer.permissionLimitBean.limitAssign.id}'}}); return false;">${textContainer.text['simplePermissionAssign.limitMenuDeleteLimit']}</a>
                          </li>
                        </ul>
                      </div>
                    </c:when>
    ...
    <div>
      <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2GroupPermission.saveMultiplePermissionSubmit', {formIds: 'attributePermissionsFormId'}); return false;">${textContainer.text['groupAssignPermissionSaveButton'] }</button> 
    </div>
    </form>
  </c:otherwise>
</c:choose>