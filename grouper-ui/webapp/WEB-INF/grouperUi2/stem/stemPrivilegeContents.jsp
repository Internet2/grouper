                        ...
                        <div class="row-fluid">
                          ...
                          <div class="span4">
                            <button type="submit" class="btn" 
                              onclick="ajax('../app/UiV2Stem.assignPrivilegeBatch?stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}', {formIds: 'stemFilterPrivilegesFormId,stemPrivilegeFormId', formIdsOptional: 'stemPagingPrivilegesFormId,stemPagingPrivilegesFormPageNumberId'}); return false;">${textContainer.text['stemUpdateSelectedPrivilegesButton'] }</button>
                          </div>
                        </div>
                      </td>
                    </tr>
