                                ...
                                <div class="btn-group"><button type="button" data-toggle="dropdown" aria-label="${textContainer.text['ariaLabelGuiMoreMembershipActions']}" class="btn btn-mini dropdown-toggle"
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
                                    ...
                                    <c:if test="${guiMembershipContainer.membershipContainer.membershipAssignType.immediate && guiMembershipSubjectContainer.guiGroup.canUpdate}">
                                      <li><button type="button" class="grouper-menuitem" onclick="ajax('../app/UiV2Stem.removeGroupMember?stemId=${grouperRequestContainer.stemContainer.guiStem.stem.id}&groupId=${guiMembershipSubjectContainer.guiGroup.group.id}&memberId=${guiMembershipSubjectContainer.guiMember.member.uuid}', {formIds: 'groupFilterFormId,groupPagingFormId'}); return false;" class="actions-revoke-membership">${textContainer.text['groupViewRevokeMembershipButton'] }</button></li>
                                    </c:if>
