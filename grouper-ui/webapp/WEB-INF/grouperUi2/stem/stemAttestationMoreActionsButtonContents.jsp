<%@ include file="../assetsJsp/commonTaglib.jsp"%>
                    ...
                    <div class="btn-group btn-block">
                      ...
                      <button type="button" data-toggle="dropdown" aria-label="${textContainer.text['ariaLabelGuiMoreStemAttestationActions']}" id="more-action-button" class="btn btn-medium btn-block dropdown-toggle" 
