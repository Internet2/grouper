     	...
     	<table class="table table-hover table-bordered table-striped table-condensed data-table">
          ...
          <c:set var="grouperProvisioningAttributeValue" 
              ...
              <tr>
               ...
               <td>
                   <div class="btn-group">
                         <button type="button" data-toggle="dropdown" id="actions_${grouper:escapeHtml(guiGrouperProvisioningAttributeValue.externalizedName)}_id" aria-label="${textContainer.text['ariaLabelGuiMoreOptions']}" class="btn btn-mini dropdown-toggle"
                         ...
                         <ul class="dropdown-menu dropdown-menu-right" id="more-options${i}">
                          ...
                          <c:if test="${grouperProvisioningAttributeValue.directAssignment || guiGrouperProvisioningAttributeValue.provisionable }">
                           ...
                           <c:if test="${guiGrouperProvisioningAttributeValue.canAssignProvisioning}">     
                            <li><a href="?operation=UiV2Provisioning.editProvisioningOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.editProvisioningOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsEditProvisioning'] }</a></li>   
                           </c:if>
                          </c:if>

                          <c:if test="${guiGrouperProvisioningAttributeValue.provisionable && guiGrouperProvisioningAttributeValue.canAssignProvisioning}">
                            <li><a href="?operation=UiV2Provisioning.runGroupSync&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.runGroupSync&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsRunGroupSync'] }</a></li>   
                          </c:if>
                          ...
                          <c:if test="${grouperProvisioningAttributeValue.directAssignment && guiGrouperProvisioningAttributeValue.provisionable && !guiGrouperProvisioningAttributeValue.parentWillMakeThisProvisionable}">
                            <c:if test="${guiGrouperProvisioningAttributeValue.canAssignProvisioning}">
                             <li><a id="doNotProvisionToGroup_${grouper:escapeHtml(guiGrouperProvisioningAttributeValue.externalizedName)}_id" href="?operation=UiV2Provisioning.removeProvisioningOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.removeProvisioningOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsDoNotProvision'] }</a></li>
                           </c:if>
                          </c:if>
                          
                          <li><a href="?operation=UiV2Provisioning.viewProvisioningConfigurationOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.viewProvisioningConfigurationOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsViewConfiguration'] }</a></li>
                          
                          <c:if test="${guiGrouperProvisioningAttributeValue.provisionable}">
                            <li><a href="?operation=UiV2Provisioning.viewProvisioningTargetDetailsOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.viewProvisioningTargetDetailsOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsViewDetails'] }</a></li>
                          </c:if>

                          <li><a href="?operation=UiV2Provisioning.viewProvisioningTargetLogsOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Provisioning.viewProvisioningTargetLogsOnGroup&groupId=${grouperRequestContainer.groupContainer.guiGroup.group.id}&provisioningTargetName=${guiGrouperProvisioningAttributeValue.grouperProvisioningAttributeValue.targetName}');">${textContainer.text['provisioningConfigTableActionsViewLogs'] }</a></li>
