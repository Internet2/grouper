  ...
  <div class="span12">
    ...
    <form id="simpleAttributeAssignAddValueForm" name="simpleAttributeAssignAddValueFormName" class="form-horizontal">
      ...
      <div class="form-actions">
        <button type="button" class="btn btn-primary" onclick="ajax('../app/UiV2StemAttributeAssignment.attributeAssignAddValueSubmit', {formIds: 'simpleAttributeAssignAddValueForm'}); return false;">${textContainer.text['simpleAttributeAssign.assignAddValueSubmitButton'] }</button>
