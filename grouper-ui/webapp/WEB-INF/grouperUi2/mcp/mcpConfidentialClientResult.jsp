                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="grouperCopyToClipboard('confClientId'); return false;" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left: 6px;"><i class="fa fa-clone"></i></a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="grouperCopyToClipboard('confClientSecret'); return false;" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left: 6px;"><i class="fa fa-clone"></i></a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="grouperCopyToClipboard('confAuthUrl'); return false;" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left: 6px;"><i class="fa fa-clone"></i></a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="grouperCopyToClipboard('confTokenUrl'); return false;" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left: 6px;"><i class="fa fa-clone"></i></a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" onclick="grouperCopyToClipboard('confScope'); return false;" title="${textContainer.text['copyToClipboardTooltip']}" style="margin-left: 6px;"><i class="fa fa-clone"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
