                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" onclick="grouperCopyToClipboard('confClientId'); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" class="btn-link" style="margin-left: 6px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" onclick="grouperCopyToClipboard('confClientSecret'); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" class="btn-link" style="margin-left: 6px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" onclick="grouperCopyToClipboard('confAuthUrl'); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" class="btn-link" style="margin-left: 6px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" onclick="grouperCopyToClipboard('confTokenUrl'); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" class="btn-link" style="margin-left: 6px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" onclick="grouperCopyToClipboard('confScope'); return false;" aria-label="${textContainer.textEscapeXml['copyToClipboardTooltip']}" title="${textContainer.text['copyToClipboardTooltip']}" class="btn-link" style="margin-left: 6px;padding:0;border:0;background:none;vertical-align:baseline;"><i class="fa fa-clone" aria-hidden="true"></i></button>
                      </td>
                    </tr>
                  </tbody>
                </table>
