...
${grouper:title('miscellaneousGrouperExternalSystemsViewDetailsBreadcrumb')}
            ...
            <div class="bread-header-container">
              <ul class="breadcrumb">
                  ...
                  <li><a href="?operation=UiV2ExternalSystem.viewExternalSystems" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2ExternalSystem.viewExternalSystems');">${textContainer.text['miscellaneousGrouperExternalSystemsBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
              ...
              <div class="page-header blue-gradient">
                ...
                <div class="row-fluid">
                  <div class="lead span9 pull-left"><h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousGrouperExternalSystemsMainDescription'] }</h1></div>
