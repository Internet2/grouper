<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="bread-header-container">
              <ul class="breadcrumb">
                  ...
                  <li><a href="?operation=UiV2Configure.index" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Configure.index');">${textContainer.text['miscellaneousConfigureBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
                  <li><a href="?operation=UiV2Configure.configure" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2Configure.configure');">${textContainer.text['miscellaneousConfigurationFilesBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
