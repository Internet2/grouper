        ...
        <div class="row-fluid">
         <div id="assign-membership-attribute-block-container" class="well hide">
          <form id="assignAttributeMembershipForm" class="form-horizontal">
             ...
             <div class="control-group">
               <label class="control-label">${textContainer.text['membershipAssignAttributeAttributeDefLabel'] }</label>
               <div class="controls">               
                 <input type="hidden" id="attribute-assignment-type" name="attributeAssignType" />          
                 <grouper:combobox2 idBase="attributeDefCombo" style="width: 30em"
                   ...
                   />
                 <span class="help-block">${textContainer.text['membershipAssignAttributeAttributeDefDescription'] }</span>
