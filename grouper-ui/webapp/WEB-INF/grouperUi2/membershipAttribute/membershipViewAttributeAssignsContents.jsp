                 ...
                 <c:forEach items="${guiAttributeAssign.attributeAssign.valueDelegate.attributeAssignValues}" var="attributeAssignValue">
                   ...
                   <div class="btn-group" style="display: inline-block;">
                     ...
                     <ul class="dropdown-menu dropdown-menu-right">
                       <li>
                         <a href="#" onclick="ajax('../app/UiV2MembershipAttributeAssignment.assignmentValueMenu', {requestParams: {menuItemId: 'editValue', menuIdOfMenuTarget: 'assignmentValueButton_${guiAttributeAssign.attributeAssign.id}_${attributeAssignValue.id}'}}); return false;">${textContainer.text['simpleAttributeUpdate.editValueAssignmentAlt']}</a>
                       </li>
                       <li>
                         <a href="#" onclick="ajax('../app/UiV2MembershipAttributeAssignment.assignmentValueMenu', {requestParams: {menuItemId: 'deleteValue', menuIdOfMenuTarget: 'assignmentValueButton_${guiAttributeAssign.attributeAssign.id}_${attributeAssignValue.id}'}}); return false;">${textContainer.text['simpleAttributeUpdate.assignDeleteValueAlt']}</a>
                       </li>
                     </ul>
                   </div>
                   ...
                   <td style="white-space: nowrap;">
                     ...
                     <c:forEach items="${guiAttributeAssignAssign.attributeAssign.valueDelegate.attributeAssignValues}" var="attributeAssignValue">          
                       ...
                       <div class="btn-group" style="display: inline-block;">
                         ...
                         <ul class="dropdown-menu dropdown-menu-right">
                           <li>
                             <a href="#" onclick="ajax('../app/UiV2MembershipAttributeAssignment.assignmentValueMenu', {requestParams: {menuItemId: 'editValue', menuIdOfMenuTarget: 'assignmentValueButton_${guiAttributeAssignAssign.attributeAssign.id}_${attributeAssignValue.id}'}}); return false;">${textContainer.text['simpleAttributeUpdate.editValueAssignmentAlt']}</a>
                           </li>
                           <li>
                             <a href="#" onclick="ajax('../app/UiV2MembershipAttributeAssignment.assignmentValueMenu', {requestParams: {menuItemId: 'deleteValue', menuIdOfMenuTarget: 'assignmentValueButton_${guiAttributeAssignAssign.attributeAssign.id}_${attributeAssignValue.id}'}}); return false;">${textContainer.text['simpleAttributeUpdate.assignDeleteValueAlt']}</a>
                           </li>
                         </ul>
                       </div>
