...
${grouper:title('miscellaneousUserLifecycleActionsAddBreadcrumb')}
   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li class="active">${textContainer.text['miscellaneousUserLifecycleActionsAddBreadcrumb'] }</li> 
        </ul>
     ...
     <div id="messages"></div>
         ...
         <form class="form-inline form-small form-filter" id="userLifecycleActionsConfigDetails">
            <table class="table table-condensed table-striped">
              <tbody>
                <%@ include file="userLifecycleActionConfigAddHelper.jsp" %>
                <tr>
                  <td>
                  ...
                  <td
                    ...
                    aria-controls="userLifecycleActionsConfigDetails" id="submitId"
                    value="${textContainer.text['dataFieldConfigAddFormSubmitButton'] }"
                    onclick="ajax('../app/UiV2UserLifecycle.addUserLifecycleActionConfigSubmit', {formIds: 'userLifecycleActionsConfigDetails'}); return false;">
                    &nbsp;
