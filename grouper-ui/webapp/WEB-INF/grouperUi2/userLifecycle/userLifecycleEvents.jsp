...
<div class="bread-header-container">
  <ul class="breadcrumb">
    ...
    <li class="active">${textContainer.text['miscellaneousUserLifecycleEventsBreadcrumb'] }</li>
  </ul>
...
<div class="row-fluid">
      ...
      <table
        ...
        <tbody>
         <c:set var="i" value="0" />
         <c:forEach items="${grouperRequestContainer.userLifecycleContainer.guiUserLifecycleEventConfigurations}" var="guiUserLifecycleEventConfig">
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right"
                    ...
                    <li><a href="?operation=UiV2UserLifecycle.editUserLifecycleEventConfig&configId=${guiUserLifecycleEventConfig.userLifecycleEventConfiguration.configId}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2UserLifecycle.editUserLifecycleEventConfig&configId=${guiUserLifecycleEventConfig.userLifecycleEventConfiguration.configId}');">${textContainer.text['dataFieldsEditActionsOption'] }</a></li>

                    <li>&nbsp;</li>                                  
                    <li><a href="#" onclick="if (confirm('${textContainer.textEscapeSingleDouble['userLifecycleEventConfigsConfirmDeleteConfig']}')) { return guiV2link('operation=UiV2UserLifecycle.deleteUserLifecycleEventConfig&configId=${guiUserLifecycleEventConfig.userLifecycleEventConfiguration.configId}');}">${textContainer.text['dataFieldsDeleteActionsOption'] }</a></li>
