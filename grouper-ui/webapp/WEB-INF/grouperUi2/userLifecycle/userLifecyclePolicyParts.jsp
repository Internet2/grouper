...
<div class="bread-header-container">
  <ul class="breadcrumb">
    ...
    <li class="active">${textContainer.text['miscellaneousUserLifecyclePolicyPartsBreadcrumb'] }</li>
  </ul>
  ...
  <div class="page-header blue-gradient">
    ...
    <div class="row-fluid">
      <div class="lead span8 pull-left">
        <h1 class="grouper-heading-as-h4">${textContainer.text['miscellaneousUserLifecyclePolicyPartsMainDescription'] }</h1>
      </div>
...
<div class="row-fluid">
      ...
      <table
        ...
        <tbody>
         <c:set var="i" value="0" />
         <c:forEach items="${grouperRequestContainer.userLifecycleContainer.guiUserLifecyclePolicyPartConfigurations}" var="guiUserLifecyclePolicyPartConfig">
              
            <tr>
              <td style="white-space: nowrap;">
                ${guiUserLifecyclePolicyPartConfig.userLifecyclePolicyPartConfiguration.configId}
              </td>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right"
                    ...
                    <li><a href="?operation=UiV2UserLifecycle.editUserLifecyclePolicyPartConfig&configId=${guiUserLifecyclePolicyPartConfig.userLifecyclePolicyPartConfiguration.configId}" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2UserLifecycle.editUserLifecyclePolicyPartConfig&configId=${guiUserLifecyclePolicyPartConfig.userLifecyclePolicyPartConfiguration.configId}');">${textContainer.text['dataFieldsEditActionsOption'] }</a></li>

                    <li>&nbsp;</li>                                  
                    <li><a href="#" onclick="if (confirm('${textContainer.textEscapeSingleDouble['userLifecyclePolicyPartConfigsConfirmDeleteConfig']}')) { return guiV2link('operation=UiV2UserLifecycle.deleteUserLifecyclePolicyPartConfig&configId=${guiUserLifecyclePolicyPartConfig.userLifecyclePolicyPartConfiguration.configId}');}">${textContainer.text['dataFieldsDeleteActionsOption'] }</a></li>
