   ...
   <div class="bread-header-container">
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
       ...
       <div class="page-header blue-gradient">
         ...
         <div class="row-fluid">
           <div class="lead span9 pull-left"><h4>${textContainer.text['miscellaneousUserLifecyclePolicyPartsMainDescription'] }</h4></div>
     ...
     <div id="messages"></div>
         ...
         <form class="form-inline form-small form-filter" id="userLifecyclePolicyPartsConfigDetails">
            <table class="table table-condensed table-striped">
              <tbody>
                <%@ include file="userLifecyclePolicyPartConfigAddHelper.jsp" %>
                <tr>
                  <td>
                  ...
                  <td
                    ...
                    aria-controls="userLifecyclePolicyPartsConfigDetails" id="submitId"
                    value="${textContainer.text['dataFieldConfigAddFormSubmitButton'] }"
                    onclick="ajax('../app/UiV2UserLifecycle.addUserLifecyclePolicyPartConfigSubmit', {formIds: 'userLifecyclePolicyPartsConfigDetails'}); return false;">
                    &nbsp;
