...
${grouper:title('miscellaneousUserLifecycleActionEditBreadcrumb')}
      ...
      class="divider"><i class='fa fa-angle-right'></i></span></li>
            ...
            <li><a href="?operation=UiV2UserLifecycle.viewUserLifecycleActions" onclick="return handleGuiV2LinkClick(event, 'operation=UiV2UserLifecycle.viewUserLifecycleActions');">${textContainer.text['miscellaneousUserLifecycleActionsBreadcrumb'] }</a><span class="divider"><i class='fa fa-angle-right'></i></span></li>
            
              <li class="active">${textContainer.text['miscellaneousUserLifecycleActionEditBreadcrumb'] }</li>
           </ul>
      ...
      <div class="row-fluid">
        <div class="span12">
          <form class="form-inline form-small form-filter" id="userLifecycleActionsConfigDetails">
            <input type="hidden" name="previousConfigId" value="${grouperRequestContainer.userLifecycleContainer.guiUserLifecycleActionConfiguration.userLifecycleActionConfiguration.configId}" />
          ...
          <table class="table table-condensed table-striped">
              ...
              <td style="vertical-align: top; white-space: nowrap;"><strong><label>${textContainer.text['dataFieldConfigIdLabel']}</label></strong></td>
                ...
                <td>
                 ${grouper:escapeHtml(grouperRequestContainer.userLifecycleContainer.guiUserLifecycleActionConfiguration.userLifecycleActionConfiguration.configId)}
                </td>
            </tr>
                    
                      
              <c:forEach items="${grouperRequestContainer.userLifecycleContainer.guiUserLifecycleActionConfiguration.userLifecycleActionConfiguration.subSections}" var="subSection">
                <tbody>
                  ...
                  <c:forEach items="${subSection.attributesValues}" var="attribute">
                    ...
                    <grouper:configFormElement 
                      ...
                      ajaxCallback="ajax('../app/UiV2UserLifecycle.editUserLifecycleActionConfig?configId=${grouperRequestContainer.userLifecycleContainer.guiUserLifecycleActionConfiguration.userLifecycleActionConfiguration.configId}', {formIds: 'userLifecycleActionsConfigDetails'}); return false;"
          ...
          <div class="span6">
                     ...
                     <input type="submit" class="btn btn-primary"
                          ...
                          onclick="ajax('../app/UiV2UserLifecycle.editUserLifecycleActionConfigSubmit?configId=${grouperRequestContainer.userLifecycleContainer.guiUserLifecycleActionConfiguration.userLifecycleActionConfiguration.configId}', {formIds: 'userLifecycleActionsConfigDetails'}); return false;">
                          &nbsp; 
                     <a class="btn btn-cancel" role="button"
                          onclick="return guiV2link('operation=UiV2UserLifecycle.viewUserLifecycleActions'); return false;"
