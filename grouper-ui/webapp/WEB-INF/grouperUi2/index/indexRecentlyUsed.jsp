<%@ include file="../assetsJsp/commonTaglib.jsp"%>
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        <button type="button" class="btn-link" style="padding:0;border:0;background:none;font-family:inherit;font-size:inherit;line-height:inherit;vertical-align:baseline;" onclick="ajax('UiV2Main.indexColRecentlyUsed?col=${col}&storePref=false'); return false;">${textContainer.text['indexRecentlyUsedRecentlyUsedLoad'] }</button>
                        <br /><br /><br /><br/>
                      </c:otherwise>
                    </c:choose>
