<%@ include file="../assetsJsp/commonTaglib.jsp"%>
            ...
            <div class="bread-header-container">
              ...
              --%>
              <ul class="breadcrumb">
                <li><a href="#" onclick="return guiV2link('operation=UiV2Main.indexMain');">${textContainer.text['myFavoritesHomeBreadcrumb'] }</a><span class="divider"><i class='icon-angle-right'></i></span></li>
