...
<%--
  @author shilen
  @version $Id: CopyOtherStemToStem.jsp,v 1.1 2009-05-08 12:03:37 shilen Exp $
--%>
...
<div class="section">
  <div class="sectionBody">
    ...
    <html:form styleId="StemFormBean" action="/copyOtherStemToStem" method="post">
      <fieldset>
        ...
        <table class="formTable formTableSpaced" cellspacing="2">
          <tr class="formTableRow">
            <td class="formTableLeft">
              <grouper:message key="stems.copy.stemToCopy" />
            </td>
        ...
        <html:submit styleClass="blueButton" property="submit.save" value="${navMap['stems.action.copy-other-stem-to-stem']}" /> 
      </fieldset>
    </html:form>
