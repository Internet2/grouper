...
--%><%--
  @author Gary Brown.
  @version $Id: groupAsSubjectSearchResultView.jsp,v 1.6 2008-04-07 07:54:15 mchyzer Exp $
--%>
...
<img src="grouper/images/group.gif" class="groupIcon" />&nbsp;<span class="<c:out value="${viewObject.subjectType}"/>Subject"><c:out value="${viewObject[groupSearchResultField]}" /></span>
