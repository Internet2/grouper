...
--%><%--
  @author Gary Brown.
  @version $Id: searchGroupResultFieldChoice.jsp,v 1.4 2008-03-25 14:59:51 mchyzer Exp $
--%>
...
<c:forTokens items="${mediaMap['search.group.result-field-choice']}" delims=" " var="field" varStatus="counter">
	<c:if test="${counter.count==1}"><grouper:message bundle="${nav}" key="find.groups.select-result-field"/></c:if>
