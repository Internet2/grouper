...
<div class="section">
  <div class="sectionBody">
    ...
    <html:form styleId="StemFormBean" action="/moveOtherStemToStem" method="post">
      <fieldset>
        ...
        <table class="formTable formTableSpaced" cellspacing="2">
          <tr class="formTableRow">
            <td class="formTableLeft">
              <grouper:message key="stems.move.stemToMove" />
            </td>
        ...
        <html:submit styleClass="blueButton" property="submit.save" value="${navMap['stems.action.move-other-stem-to-stem']}" /> 
      </fieldset>
    </html:form>
