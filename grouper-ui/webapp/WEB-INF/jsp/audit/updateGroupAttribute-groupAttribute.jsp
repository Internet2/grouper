...
--%><%--
  @author Gary Brown.
  @version $Id: updateGroupAttribute-groupAttribute.jsp,v 1.2 2009-08-10 14:03:01 isgwb Exp $
--%>
...
<grouper:message bundle="${nav}" key="audit.result.label.from"/> <em><c:out value="${viewObject.fields.oldValue}"/></em>
<br/><grouper:message bundle="${nav}" key="audit.result.label.for"/> 
<c:choose>
