...
--%><%--
  @author Gary Brown.
  @version $Id: deleteGroupField-groupField.jsp,v 1.3 2009-09-09 15:10:03 mchyzer Exp $
--%>
<%@include file="/WEB-INF/jsp/include.jsp"%>
<tiles:importAttribute ignore="true"/>
<c:out value="${viewObject.fields.type}"/> <em><c:out value="${viewObject.fields.name}"/></em>
<grouper:message key="audit.result.label.from"/>
...
<em><strong><c:choose>
	...
	<c:otherwise><a title="<grouper:message key="audit.result.label.group-type.link-title"/>" 
