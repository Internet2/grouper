...
--%><%--
  @author Gary Brown.
  @version $Id: unassignGroupType-groupTypeAssignment.jsp,v 1.2 2009-08-10 14:03:01 isgwb Exp $
...
<em><c:out value="${viewObject.fields.typeName}"/></em> <grouper:message bundle="${nav}" key="audit.result.label.from"/>
<c:choose>
