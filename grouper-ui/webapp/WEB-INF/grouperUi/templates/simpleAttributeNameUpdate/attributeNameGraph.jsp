...
<!-- Start: simpleAttributeNameUpdate/attributeNameGraph.jsp -->

<div class="section" style="min-width: 900px">

  <grouper:subtitle key="simpleAttributeNameUpdate.attributeDefNameGraphSectionHeader" />
  ...
  <div class="sectionBody">
    ...
    <applet code="edu.internet2.middleware.networkGraph.TreeCollapse.class"
      ...
      <c:forEach items="${attributeNameUpdateRequestContainer.attributeNameGraphStartingPoints}" var="startingPoint">
        <param name="vertex_${index}" value="${grouper:escapeJavascript(startingPoint)}"/>
        <c:set var="index" value="${index + 1}" />
      </c:forEach>      
      
      <c:set var="index" value="0" />
      <c:forEach items="${attributeNameUpdateRequestContainer.attributeNameGraphNodesFrom}" var="nodeFrom">
        <c:set var="nodeTo" value="${attributeNameUpdateRequestContainer.attributeNameGraphNodesTo[index]}" />
...
<!-- End: simpleAttributeNameUpdate/attributeNameGraph.jsp -->
