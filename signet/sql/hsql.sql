...
--
-- $Header: /home/hagleyj/i2mi/signet/sql/hsql.sql,v 1.43 2007-05-03 01:16:14 ddonn Exp $
--
...
(
categoryKey         int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
subsystemID         varchar(64)         NOT NULL,
...
(
functionKey         int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
subsystemID         varchar(64)         NOT NULL,
...
(
permissionKey       int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
subsystemID         varchar(64)         NOT NULL,
...
(
limitKey            int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
subsystemID         varchar(64)         NOT NULL,
...
subjectKey          bigint              GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
subjectAttributeKey  bigint             GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
(
choiceSetKey        int          GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
(
choiceKey           int          GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
(
assignmentID        int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
(
historyID           int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
assignmentID        int                 NOT NULL,
instanceNumber      int                 NOT NULL,
status              varchar(16)         NOT NULL,
functionKey         int                 NOT NULL,
...
(
proxyID             int                 GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
instanceNumber      int                 NOT NULL,
status              varchar(16)         NOT NULL,
subsystemID         varchar(64)         NULL,
grantorKey          bigint              NOT NULL,
