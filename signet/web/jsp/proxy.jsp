...
<!--
  $Id: proxy.jsp,v 1.7 2007-07-06 21:59:20 ddonn Exp $
...
<% 
  ...
  SignetSubject grantee      = currentProxy.getGrantee();
  SignetSubject grantor      = currentProxy.getGrantor();
  SignetSubject proxySubject = currentProxy.getProxy();
