REM $Header: /home/hagleyj/i2mi/signet/util/dist-signet_cp.bat,v 1.12 2008-09-29 00:48:45 ddonn Exp $
REM
...
set CLASSPATH=%CLASSPATH%;%SIGNET_LIBS%\subject.jar
set CLASSPATH=%CLASSPATH%;%SIGNET_LIBS%\morphString.jar
