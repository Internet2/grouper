...
rem -----------------------------------------------------------------------------
rem Script for command line util to load Subject definitions
rem
...
%JAVA_HOME%/bin/java -cp %CLASSPATH% edu.internet2.middleware.signet.util.SubjectFileLoader %1 %2 %3 %4 %5 %6 %7 %8 %9
