/*
	$Header: /home/hagleyj/i2mi/signet/src/edu/internet2/middleware/signet/util/xml/adapter/SignetXa.java,v 1.4 2008-06-23 22:27:44 ddonn Exp $
...
public class SignetXa
{
	...
	{
		xmlSignet.setSignetVersion(Signet.getVersion());
//		ObjectFactory of = new ObjectFactory();
//		xmlSignet.setAssignmentSet(of.createAssignmentSetXb());
//		xmlSignet.setProxySet(of.createProxySetXb());
