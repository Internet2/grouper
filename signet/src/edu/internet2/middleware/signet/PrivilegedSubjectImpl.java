/*--
$Id: PrivilegedSubjectImpl.java,v 1.2 2004-12-24 04:15:46 acohen Exp $
...
throws ObjectNotFoundException
{
  ...
  Iterator iterator
  	= this.getAssignmentsReceived(Status.ACTIVE, null).iterator();
  while (iterator.hasNext())
  {
    Assignment assignment = (Assignment)(iterator.next());
    Function candidateFunction = assignment.getFunction();
    Subsystem candidateSubsystem
    	= candidateFunction.getSubsystem();
...
public Set getGrantableScopes(Function aFunction)
{
  ...
  try
  {
    ...
    {
      Set grantableAssignments
      	= getGrantableAssignments(aFunction);
