/*--
$Id: LimitShapeType.java,v 1.3 2006-02-09 10:22:04 lmcrae Exp $
$Date: 2006-02-09 10:22:04 $
...
/**
 * Should never be used by Signet application programs. Manages
 * persistence for the {@link LimitShape} typesafe enumeration. <br />
...
class LimitShapeType implements UserType
{
   ...
   * @return <code>true</code> iff both represent the same LimitShape type.
   * @throws ClassCastException
   *           if x or y isn't a {@link LimitShape}.
   */
  public boolean equals(Object x, Object y)
  {
    // We can compare instances, since LimitShape values are immutable
    // singletons.
    return (x == y);
  }
   ...
   * 
   * @return {@link LimitShape}, the actual type returned by {@link #nullSafeGet}.
   */
  public Class returnedClass()
  {
    return LimitShape.class;
  }
   ...
   * @return the retrieved {@link LimitShape} value, or <code>null</code>.
      ...
      throws HibernateException, SQLException
  {
    ...
    try
    {
      return LimitShape.getInstanceByName(name);
    }
    catch (java.util.NoSuchElementException e)
    {
      throw new HibernateException("Bad LimitShape value: " + name, e);
    }
  }
