/*--
$Id: TreeNodeImpl.java,v 1.2 2004-12-24 04:15:46 acohen Exp $
...
public Set getParents()
{
  if (parentsAlreadyFetched == false)
  {
    try
    {
      this.parents = signet.getParents(this);
    }
...
public Set getChildren()
{
  if (childrenAlreadyFetched == false)
  {
    try
    {
      this.children = signet.getChildren(this);
    }
    catch (TreeNotFoundException tnfe)
    {
      throw new SignetRuntimeException(tnfe);
...
throws TreeNotFoundException
{
      ...
      && (this.signet != null))
  {
    try
    {
      this.tree = (TreeImpl)(this.signet.getTree(this.treeId));
    }
...
throws ObjectNotFoundException
{
  ...
  if (this.signet != null)
  {
    this.tree = (TreeImpl)(this.signet.getTree(treeId));
  }
}
...
private void saveRelationship
	(TreeNode childNode, TreeNode parentNode)
throws TreeNotFoundException
{
  TreeNodeRelationship tnr
  	= new TreeNodeRelationship
...
public String toString()
{
  ...
  {
    return
    	this.getTree().getAdapter().getClass().getName()
...
{
  return new TreeNodeFullyQualifiedId
  	(this.getTreeId(), this.getId());
}
...
throws ObjectNotFoundException
{
  ...
  if (signet != null)
  {
    this.tree = (TreeImpl)(this.signet.getTree(tnfqId.getTreeId()));
  }
}
