/*--
 $Id: TreeTypeImpl.java,v 1.3 2005-01-11 20:38:44 acohen Exp $
  ...
  implements TreeType
{
  ...
  public TreeTypeImpl(Signet signet, String id, String name,
    ...
    catch (ClassNotFoundException cnfe)
    {
      throw new SignetRuntimeException(
          "A Tree in the Signet database uses a TreeTypeAdapter which"
              + " is implemented by the class named '" + name
