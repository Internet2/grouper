/*--
  $Id: AddData.java,v 1.1 2004-12-09 20:49:07 mnguyen Exp $
...
public class AddData
{
  ...
  {
    TreeType treeType = signet.getTreeType(Signet.DEFAULT_TREE_TYPE_ID);
    Tree adminOrgsTree
      = signet.newTree(treeType, "adminorgs", "Administrative Organizations");
    

      TreeNode presNode
    	  = signet.newTreeNode
    			  (adminOrgsTree, "PRES", "Office of the President", "organization");
      adminOrgsTree.addRoot(presNode);
      
        TreeNode registrarNode
    	    = signet.newTreeNode
        			(adminOrgsTree, "REGISTRAR", "University Registrar", "organization");
        presNode.addChild(registrarNode);
        
          TreeNode admissionNode
          	= signet.newTreeNode
          			(adminOrgsTree, "ADMISSION", "Admissions", "organization");
          registrarNode.addChild(admissionNode);
          
          TreeNode finaidNode
          	= signet.newTreeNode
          			(adminOrgsTree, "FINAID", "Financial Aid", "organization");
          registrarNode.addChild(finaidNode);
          
          TreeNode bursarNode
          	= signet.newTreeNode
          			(adminOrgsTree, "BURSAR", "Bursar", "organization");
          registrarNode.addChild(bursarNode);
          
          TreeNode sturecNode
          	= signet.newTreeNode
          			(adminOrgsTree, "STUREC", "Student Records", "organization");
          registrarNode.addChild(sturecNode);
          
    
        TreeNode hrNode
    	    = signet.newTreeNode
        			(adminOrgsTree, "HR", "Human Resources", "organization");
        presNode.addChild(hrNode);
        
          TreeNode adminNode
          	= signet.newTreeNode
          			(adminOrgsTree, "ADMIN", "HR Administration", "organization");
          hrNode.addChild(adminNode);
          
          TreeNode benefitsNode
          	= signet.newTreeNode
          			(adminOrgsTree, "BENEFITS", "Benefits", "organization");
          hrNode.addChild(benefitsNode);
          
          TreeNode hrrecNode
          	= signet.newTreeNode
          			(adminOrgsTree, "HRREC", "HR Records", "organization");
          hrNode.addChild(hrrecNode);
          
          TreeNode salaryNode
          	= signet.newTreeNode
          			(adminOrgsTree, "SALARY", "Salaries", "organization");
          hrNode.addChild(salaryNode);
          
        
        TreeNode controllerNode
    	    = signet.newTreeNode
        			(adminOrgsTree, "CONTROLLER", "Controller's Office", "organization");
        presNode.addChild(controllerNode);
        
        	TreeNode reqsNode
        		= signet.newTreeNode
        				(adminOrgsTree, "REQS", "Requisitions", "organization");
        	controllerNode.addChild(reqsNode);
        
        TreeNode libraryNode
    	    = signet.newTreeNode
        			(adminOrgsTree, "LIBRARY", "University Library", "organization");
        presNode.addChild(libraryNode);
    
        TreeNode itNode
    	    = signet.newTreeNode
        			(adminOrgsTree, "IT", "Information Technology", "organization");
        presNode.addChild(itNode);
        
        	TreeNode networkingNode
        		= signet.newTreeNode
        				(adminOrgsTree, "NETWORKING", "Networking", "organization");
        	itNode.addChild(networkingNode);
        	
        	TreeNode commNode
        		= signet.newTreeNode
        				(adminOrgsTree, "COMM", "Commnications", "organization");
        	itNode.addChild(commNode);
        	
        	TreeNode acadcompNode
        		= signet.newTreeNode
        				(adminOrgsTree, "ACADCOMP", "Academic Computing", "organization");
        	itNode.addChild(acadcompNode);
        	
        	TreeNode admincompNode
        		= signet.newTreeNode
        				(adminOrgsTree, "ADMINCOMP", "Administrative Computing", "organization");
        	itNode.addChild(admincompNode);
        	
        	TreeNode developmentNode
        		= signet.newTreeNode
        				(adminOrgsTree, "DEVELOPMENT", "Development", "organization");
      ...
      TreeNode provostNode
        = signet.newTreeNode
            (adminOrgsTree, "PROVOST", "Office of the Provost", "organization");
      adminOrgsTree.addRoot(provostNode);
      
      	TreeNode archNode
      		= signet.newTreeNode
      				(adminOrgsTree, "ARCH", "School of Architecture", "school");
      	provostNode.addChild(archNode);
      	
      	TreeNode businessNode
      		= signet.newTreeNode
      				(adminOrgsTree, "BUSINESS", "Business School", "school");
      	provostNode.addChild(businessNode);
      	
      	TreeNode engineerNode
      		= signet.newTreeNode
      				(adminOrgsTree, "ENGINEER", "School of Engineering", "school");
      	provostNode.addChild(engineerNode);
      	
      	TreeNode humsciNode
      		= signet.newTreeNode
      				(adminOrgsTree, "HUMSCI", "Humanities & Sciences", "school");
      	provostNode.addChild(humsciNode);
      	
      		TreeNode artNode
      			= signet.newTreeNode
      					(adminOrgsTree, "ART", "Art Department", "department");
      		humsciNode.addChild(artNode);
      		
      		TreeNode athleticsNode
      			= signet.newTreeNode
  							(adminOrgsTree, "ATHLETICS", "Department of Athletics and Physical Education", "department");
      		humsciNode.addChild(athleticsNode);
      		
      		TreeNode biologyNode
      			= signet.newTreeNode
      					(adminOrgsTree, "BIOLOGY", "Biology", "department");
      		humsciNode.addChild(biologyNode);
      		
      		TreeNode chemNode
      			= signet.newTreeNode
      					(adminOrgsTree, "CHEM", "Chemistry", "department");
      		humsciNode.addChild(chemNode);
      		
      		TreeNode compcsiNode
      			= signet.newTreeNode
      					(adminOrgsTree, "COMPCSI", "Computer Science", "department");
      		humsciNode.addChild(compcsiNode);
      		
      		TreeNode dramaNode
      			= signet.newTreeNode
      					(adminOrgsTree, "DRAMA", "Art Department", "department");
      		humsciNode.addChild(dramaNode);
      		
      		TreeNode englishNode
      			= signet.newTreeNode
      					(adminOrgsTree, "ENGLISH", "Art Department", "department");
      		humsciNode.addChild(englishNode);
      		
      		TreeNode litNode
      			= signet.newTreeNode
      					(adminOrgsTree, "LIT", "Literature", "department");
      		humsciNode.addChild(litNode);
      		
      		TreeNode musicNode
      			= signet.newTreeNode
      					(adminOrgsTree, "MUSIC", "Music Department", "department");
      		humsciNode.addChild(musicNode);
      		
      		TreeNode physicsNode
      			= signet.newTreeNode
      					(adminOrgsTree, "PHYSICS", "Physics", "department");
      		humsciNode.addChild(physicsNode);
      		
      	
      	TreeNode lawNode
      		= signet.newTreeNode
      				(adminOrgsTree, "LAW", "Law School", "school");
      	provostNode.addChild(lawNode);
      	
      	TreeNode medicineNode
      		= signet.newTreeNode
      				(adminOrgsTree, "MEDICINE", "School of Medicine", "school");
  ...
  throws ObjectNotFoundException
  {
    ...
    function000.addPermission(signet.newPermission("my_id0000", subsystem0));
    function000.addPermission(signet.newPermission("my_id0001", subsystem0));
    function000.addPermission(signet.newPermission("my_id0002", subsystem0));
    

    TreeType defaultTreeType
    	= signet.getTreeType(Signet.DEFAULT_TREE_TYPE_ID);
    Tree tree00
    	= signet.newTree(defaultTreeType, "my_id00", "my_name00");
    ...
    TreeNode treeNode0000 
    	= signet.newTreeNode
    			(tree00, "my_id0000", "my_name0000", "my_nodetype0000");
    TreeNode treeNode0001
  		= signet.newTreeNode
  				(tree00, "my_id0001", "my_name0001", "my_nodetype0001");
    TreeNode treeNode0002
  		= signet.newTreeNode
  				(tree00, "my_id0002", "my_name0002", "my_nodetype0002");
