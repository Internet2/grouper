/*--
  $Id: StatusType.java,v 1.1 2004-12-09 20:49:07 mnguyen Exp $
...
/**
 * Should never be used by Signet application programs.
 * Manages persistence for the {@link Status} typesafe enumeration.
 * <br />
 ...
 * though it is of no use to Signet users. If, in the future, Hibernate
 * allows this class to be non-public, its visibility should be reduced, to
 * avoid distracting and confusing Signet application programmers.
 */
...
public class StatusType implements UserType
{
   ...
   * @throws ClassCastException if x or y isn't a {@link Status}.
   */
   ...
   *
   * @return {@link Status}, the actual type returned
   * by {@link #nullSafeGet}.
   */
