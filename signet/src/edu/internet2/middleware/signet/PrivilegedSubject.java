/*--
  $Id: PrivilegedSubject.java,v 1.1 2004-12-09 20:49:07 mnguyen Exp $
...
//	public Assignment[] getAssignmentsByScope(Scope scope);
	...
	/**
	 * This method returns true if this PrivilegedSubject has authority to edit
   ...
   * @return the ID of the SubjectType which underlies this PrivilegedSubject.
   */
