...
//   persistMgr = HibernateDB.getInstance();
//
...
// {
//   List resultList = persistMgr.find("from edu.internet2.middleware.signet.TreeImpl as tree"); 
//
...
//   try
//   {
//    List privilegedSubjects = persistMgr.find("from edu.internet2.middleware.signet.PrivilegedSubject"); 
...
//      try
//      {
//        signetSubject = persistMgr.fetchPrivilegedSubject(SubjectTypeEnum.APPLICATION.getName(),
...
//   try
//   {
//     subsystemImpl = (SubsystemImpl) (persistMgr.load(SubsystemImpl.class, id));
//   }
//   catch (ObjectNotFoundException onfe)
//   {
...
///////////////////////////////////////////////////////////////////////
	...
	public Subsystem getSubsystem(String subsystemId)
	{
		...
		try { retval = getPersistentDB().getSubsystem(subsystemId); }
