...
class SubjectImpl extends EntityImpl implements Subject
{
  ...
  SubjectImpl(Signet signet, SubjectType type, String id, String name,
      String description, String displayId)
  {
  ...
  {
    this.type = type;
    ((SubjectTypeImpl) (this.type)).setSignet(this.getSignet());
  }
  ...
  public void addAttribute(String name, String value)
  {
    ...
    String normalized = this.getSignet().normalizeSubjectAttributeValue(value);

    SubjectAttrKey subjectAttrKey = new SubjectAttrKey(this.getSubjectType(),
        this.getId(), name, list.size() + 1);

    SubjectAttributeValue attrVal = new SubjectAttributeValue(subjectAttrKey,
        value, normalized);
  ...
  public boolean equals(Object obj)
  {
    ...
    return new EqualsBuilder().append(this.getId(), rhs.getId()).append(
        this.getSubjectType(), rhs.getSubjectType()).isEquals();
  }
  ...
  public int hashCode()
  {
    ...
    return new HashCodeBuilder(17, 37).append(this.getId()).append(
        this.getSubjectType()).toHashCode();
  }
}