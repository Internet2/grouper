 ...
 * @version $Id: TestGrouperAccessOPTIN.java,v 1.6 2005-11-28 17:53:06 blair Exp $
 */
public class TestGrouperAccessOPTIN extends TestCase {
  ...
  public void testRevokePrivs() {
    ...
    PrivHelper.revokePriv(s, i2,  s.getSubject()      , AccessPrivilege.OPTIN);      
    PrivHelper.revokePriv(s, i2,  SubjectHelper.SUBJ0 , AccessPrivilege.OPTIN);    
    PrivHelper.getPrivs(
      s, i2,  s.getSubject()      , 0, true,  true,   true,   true,   true,   true
    );
    PrivHelper.getPrivs(
