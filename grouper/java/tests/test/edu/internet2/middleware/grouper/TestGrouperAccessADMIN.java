 ...
 * @version $Id: TestGrouperAccessADMIN.java,v 1.6 2005-11-28 17:53:06 blair Exp $
 */
public class TestGrouperAccessADMIN extends TestCase {
  ...
  public void testRevokePrivs() {
    ...
    PrivHelper.revokePriv(s, i2,  s.getSubject()      , AccessPrivilege.ADMIN);      
    PrivHelper.revokePriv(s, i2,  SubjectHelper.SUBJ0 , AccessPrivilege.ADMIN);    
    PrivHelper.getPrivs(
      s, i2,  s.getSubject()      , 0, true,  true,   true,   true,   true,   true
    );
    PrivHelper.getPrivs(
