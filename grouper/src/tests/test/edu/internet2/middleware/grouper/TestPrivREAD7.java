 ...
 * @version $Id: TestPrivREAD7.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD7 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD7.class);
  ...
  public TestPrivREAD7(String name) {
    super(name);
  }
