 ...
 * @version $Id: TestGrouperAccessREAD.java,v 1.6 2005-11-28 17:53:06 blair Exp $
 */
public class TestGrouperAccessREAD extends TestCase {
  ...
  public void testGrantPrivs() {
    PrivHelper.grantPriv( s, i2,  s.getSubject()      , AccessPrivilege.READ);      
    PrivHelper.grantPriv( s, i2,  SubjectHelper.SUBJ0 , AccessPrivilege.READ);    
    PrivHelper.getPrivs(
  ...
  public void testRevokePrivs() {
    ...
    PrivHelper.revokePriv(s, i2,  s.getSubject()      , AccessPrivilege.READ);      
    PrivHelper.revokePriv(s, i2,  SubjectHelper.SUBJ0 , AccessPrivilege.READ);    
    PrivHelper.getPrivs(
      s, i2,  s.getSubject()      , 0, true,  true,   true,   true,   true,   true
    );
    PrivHelper.getPrivs(
