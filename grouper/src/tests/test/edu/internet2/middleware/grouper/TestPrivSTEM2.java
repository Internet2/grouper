 ...
 * @version $Id: TestPrivSTEM2.java,v 1.1 2006-03-10 19:36:36 blair Exp $
 */
public class TestPrivSTEM2 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestPrivSTEM2.class);
  private static final Privilege  PRIV  = NamingPrivilege.STEM;


  public TestPrivSTEM2(String name) {
    super(name);
  }
