 ...
 * @version $Id: TestMemberOf6.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf6 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf6.class); 
  ...
  public TestMemberOf6(String name) {
    super(name);
  }
