 ...
 * @version $Id: TestMemberOf9.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf9 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf9.class); 
  ...
  public TestMemberOf9(String name) {
    super(name);
  }
