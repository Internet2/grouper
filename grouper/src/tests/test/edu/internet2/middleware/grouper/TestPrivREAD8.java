 ...
 * @version $Id: TestPrivREAD8.java,v 1.1 2006-03-23 18:36:31 blair Exp $
 */
public class TestPrivREAD8 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestPrivREAD8.class);
  ...
  public TestPrivREAD8(String name) {
    super(name);
  }
