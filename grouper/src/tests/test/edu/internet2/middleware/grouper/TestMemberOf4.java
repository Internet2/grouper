 ...
 * @version $Id: TestMemberOf4.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf4 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf4.class); 
  ...
  public TestMemberOf4(String name) {
    super(name);
  }
