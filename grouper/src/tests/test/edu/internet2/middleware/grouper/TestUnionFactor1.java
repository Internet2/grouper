...
public class TestUnionFactor1 extends TestCase {
  ...
  private static final Log LOG = LogFactory.getLog(TestUnionFactor1.class);

  public TestUnionFactor1(String name) {
    super(name);
  }
  ...
  public void testFailToAddUnionFactorWithCircularRightNode() {
