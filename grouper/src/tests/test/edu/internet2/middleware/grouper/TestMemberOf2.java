 ...
 * @version $Id: TestMemberOf2.java,v 1.1 2006-03-06 20:21:50 blair Exp $
 */
public class TestMemberOf2 extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestMemberOf2.class); 
  ...
  public TestMemberOf2(String name) {
    super(name);
  }
