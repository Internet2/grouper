 ...
 * @version $Id: TestGroup9.java,v 1.1 2006-05-31 22:44:40 blair Exp $
 */
public class TestGroup9 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestGroup9.class);
  ...
  public void testFailCanReadFieldValidSubjectInvalidField() {
    ...
    try {
      ...
      try {
        a.canReadField(r.rs.getSubject(), FieldFinder.find("stemmers"));
