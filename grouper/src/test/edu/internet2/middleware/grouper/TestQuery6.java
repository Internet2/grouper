 ...
 * @version $Id: TestQuery6.java,v 1.1.2.1 2006-04-13 19:52:49 blair Exp $
 */
public class TestQuery6 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestQuery6.class);

  public TestQuery6(String name) {
    super(name);
  }
