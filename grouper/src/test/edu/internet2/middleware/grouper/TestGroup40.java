 ...
 * @version $Id: TestGroup40.java,v 1.3 2008-07-21 04:43:57 mchyzer Exp $
 * @since   1.1.0
 */
public class TestGroup40 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestGroup40.class);

  public TestGroup40(String name) {
    super(name);
  }
