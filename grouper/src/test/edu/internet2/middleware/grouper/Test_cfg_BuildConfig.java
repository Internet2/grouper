...
/**
 * Test {@link BuildConfig}.
 * <p/>
 * @author  blair christensen.
 * @version $Id: Test_cfg_BuildConfig.java,v 1.2 2007-08-27 15:53:53 blair Exp $
 * @since   1.2.1
 */
public class Test_cfg_BuildConfig extends GrouperTest {

  Configuration cfg;
  String        prop_invalid  = "this.property.should.not.exist";
  String        prop_valid    = "build.dir";


  public void setUp() {
    super.setUp();
    this.cfg = new BuildConfig();
  }
