 ...
 * @version $Id: SuiteCompositesU.java,v 1.1.2.22 2006-05-23 17:53:44 blair Exp $
 */
public class SuiteCompositesU extends TestCase {
  ...
  static public Test suite() {
    ...
    suite.addTestSuite( TestCompositeU39.class  );  // add member to comp's child
    suite.addTestSuite( TestCompositeU40.class  );  // del member from comp's child
    return suite;
  } // static public Test suite()
