...
public class XmlExportAttributeAssignActionTest extends GrouperTest {
  ...
  public void testConvertToXml() {
    ...
    String xml = xmlExportAttributeAssignAction.toXml(new GrouperVersion(GrouperVersion.grouperContainerVersionOrMavenVersion()));
    
    xmlExportAttributeAssignAction = XmlExportAttributeAssignAction.fromXml(new GrouperVersion(GrouperVersion.grouperContainerVersionOrMavenVersion()), xml);
  ...
  public void testConvertToAttributeAssignAction() {
    ...
    XmlExportAttributeAssignAction xmlExportAttributeAssignAction = attributeAssignAction.xmlToExportAttributeAssignAction(new GrouperVersion(GrouperVersion.grouperContainerVersionOrMavenVersion()));
