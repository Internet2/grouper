 ...
 * @version $Id: TestXml25.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.1.0
 */
public class TestXml25 extends GrouperTest {

  private static final Log LOG = GrouperUtil.getLog(TestXml25.class);

  public TestXml25(String name) {
    super(name);
  }
