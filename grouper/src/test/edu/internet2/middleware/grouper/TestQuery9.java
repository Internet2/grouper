 ...
 * @version $Id: TestQuery9.java,v 1.1.2.1 2006-04-13 19:52:49 blair Exp $
 */
public class TestQuery9 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestQuery9.class);

  public TestQuery9(String name) {
    super(name);
  }
