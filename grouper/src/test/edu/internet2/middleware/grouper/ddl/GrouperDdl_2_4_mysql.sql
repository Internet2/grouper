...
insert into grouper_ddl (id, object_name, db_version, last_updated, history) values ('a2eb3afff7ff4fd1ba27cfb929b9cce9', 'Grouper', 1, '2020/03/29 11:33:02', 
'2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ');
commit;
...
update grouper_ddl set db_version = 2, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
ALTER TABLE grouper_QZ_JOB_DETAILS
    MODIFY COLUMN is_durable TINYINT(1) NOT NULL;

ALTER TABLE grouper_QZ_JOB_DETAILS
    MODIFY COLUMN is_nonconcurrent TINYINT(1) NOT NULL;

ALTER TABLE grouper_QZ_JOB_DETAILS
    MODIFY COLUMN is_update_data TINYINT(1) NOT NULL;

ALTER TABLE grouper_QZ_JOB_DETAILS
    MODIFY COLUMN requests_recovery TINYINT(1) NOT NULL;

ALTER TABLE grouper_QZ_JOB_DETAILS
    MODIFY COLUMN job_data LONGBLOB NULL;

ALTER TABLE grouper_QZ_TRIGGERS
    MODIFY COLUMN job_data LONGBLOB NULL;

ALTER TABLE grouper_QZ_SIMPROP_TRIGGERS
    MODIFY COLUMN bool_prop_1 TINYINT(1);

ALTER TABLE grouper_QZ_SIMPROP_TRIGGERS
    MODIFY COLUMN bool_prop_2 TINYINT(1);

ALTER TABLE grouper_QZ_BLOB_TRIGGERS
    MODIFY COLUMN blob_data LONGBLOB NULL;

ALTER TABLE grouper_QZ_CALENDARS
    MODIFY COLUMN calendar LONGBLOB NOT NULL;

ALTER TABLE grouper_QZ_FIRED_TRIGGERS
    MODIFY COLUMN is_nonconcurrent TINYINT(1);

ALTER TABLE grouper_QZ_FIRED_TRIGGERS
    MODIFY COLUMN requests_recovery TINYINT(1);
...
update grouper_ddl set db_version = 3, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 4, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 5, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 6, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 7, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 8, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 9, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 10, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 11, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 12, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 13, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 14, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 15, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 16, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 17, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 18, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 19, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 20, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 21, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 22, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 23, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 24, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 25, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 26, last_updated = '2020/03/29 11:33:02', 
history = '2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 27, last_updated = '2020/03/29 11:33:03', 
history = '2020/03/29 11:33:03: upgrade Grouper from V26 to V27, 2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 28, last_updated = '2020/03/29 11:33:03', 
history = '2020/03/29 11:33:03: upgrade Grouper from V27 to V28, 2020/03/29 11:33:03: upgrade Grouper from V26 to V27, 2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 29, last_updated = '2020/03/29 11:33:03', 
history = '2020/03/29 11:33:03: upgrade Grouper from V28 to V29, 2020/03/29 11:33:03: upgrade Grouper from V27 to V28, 2020/03/29 11:33:03: upgrade Grouper from V26 to V27, 2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 30, last_updated = '2020/03/29 11:33:03', 
history = '2020/03/29 11:33:03: upgrade Grouper from V29 to V30, 2020/03/29 11:33:03: upgrade Grouper from V28 to V29, 2020/03/29 11:33:03: upgrade Grouper from V27 to V28, 2020/03/29 11:33:03: upgrade Grouper from V26 to V27, 2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 31, last_updated = '2020/03/29 11:33:03', 
history = '2020/03/29 11:33:03: upgrade Grouper from V30 to V31, 2020/03/29 11:33:03: upgrade Grouper from V29 to V30, 2020/03/29 11:33:03: upgrade Grouper from V28 to V29, 2020/03/29 11:33:03: upgrade Grouper from V27 to V28, 2020/03/29 11:33:03: upgrade Grouper from V26 to V27, 2020/03/29 11:33:02: upgrade Grouper from V25 to V26, 2020/03/29 11:33:02: upgrade Grouper from V24 to V25, 2020/03/29 11:33:02: upgrade Grouper from V23 to V24, 2020/03/29 11:33:02: upgrade Grouper from V22 to V23, 2020/03/29 11:33:02: upgrade Grouper from V21 to V22, 2020/03/29 11:33:02: upgrade Grouper from V20 to V21, 2020/03/29 11:33:02: upgrade Grouper from V19 to V20, 2020/03/29 11:33:02: upgrade Grouper from V18 to V19, 2020/03/29 11:33:02: upgrade Grouper from V17 to V18, 2020/03/29 11:33:02: upgrade Grouper from V16 to V17, 2020/03/29 11:33:02: upgrade Grouper from V15 to V16, 2020/03/29 11:33:02: upgrade Grouper from V14 to V15, 2020/03/29 11:33:02: upgrade Grouper from V13 to V14, 2020/03/29 11:33:02: upgrade Grouper from V12 to V13, 2020/03/29 11:33:02: upgrade Grouper from V11 to V12, 2020/03/29 11:33:02: upgrade Grouper from V10 to V11, 2020/03/29 11:33:02: upgrade Grouper from V9 to V10, 2020/03/29 11:33:02: upgrade Grouper from V8 to V9, 2020/03/29 11:33:02: upgrade Grouper from V7 to V8, 2020/03/29 11:33:02: upgrade Grouper from V6 to V7, 2020/03/29 11:33:02: upgrade Grouper from V5 to V6, 2020/03/29 11:33:02: upgrade Grouper from V4 to V5, 2020/03/29 11:33:02: upgrade Grouper from V3 to V4, 2020/03/29 11:33:02: upgrade Grouper from V2 to V3, 2020/03/29 11:33:02: upgrade Grouper from V1 to V2, 2020/03/29 11:33:02: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
insert into grouper_ddl (id, object_name, db_version, last_updated, history) values ('d69ab4b976064a4b8e8b108b433ec820', 'Subject', 1, '2020/03/29 11:33:03', 
'2020/03/29 11:33:03: upgrade Subject from V0 to V1, ');
commit;
