...
DROP VIEW grouper_ext_subj_v;

DROP VIEW grouper_ext_subj_invite_v;

DROP VIEW grouper_attr_asn_group_v;

DROP VIEW grouper_attr_asn_efmship_v;

DROP VIEW grouper_attr_asn_stem_v;

DROP VIEW grouper_attr_asn_member_v;

DROP VIEW grouper_attr_asn_mship_v;

DROP VIEW grouper_attr_asn_attrdef_v;

DROP VIEW grouper_attr_asn_asn_group_v;

DROP VIEW grouper_attr_asn_asn_stem_v;

DROP VIEW grouper_attr_asn_asn_member_v;

DROP VIEW grouper_attr_asn_asn_mship_v;

DROP VIEW grouper_attr_asn_asn_efmship_v;

DROP VIEW grouper_attr_asn_asn_attrdef_v;

DROP VIEW grouper_aval_asn_group_v;

DROP VIEW grouper_aval_asn_efmship_v;

DROP VIEW grouper_aval_asn_stem_v;

DROP VIEW grouper_aval_asn_member_v;

DROP VIEW grouper_aval_asn_mship_v;

DROP VIEW grouper_aval_asn_attrdef_v;

DROP VIEW grouper_aval_asn_asn_group_v;

DROP VIEW grouper_aval_asn_asn_stem_v;

DROP VIEW grouper_aval_asn_asn_member_v;

DROP VIEW grouper_aval_asn_asn_mship_v;

DROP VIEW grouper_aval_asn_asn_efmship_v;

DROP VIEW grouper_aval_asn_asn_attrdef_v;

DROP VIEW grouper_attr_def_name_set_v;

DROP VIEW grouper_attr_assn_action_set_v;

DROP VIEW grouper_attr_def_priv_v;

DROP VIEW grouper_audit_entry_v;

DROP VIEW grouper_change_log_entry_v;

DROP VIEW grouper_composites_v;

DROP VIEW grouper_groups_v;

DROP VIEW grouper_perms_all_v;

DROP VIEW grouper_perms_role_v;

DROP VIEW grouper_perms_role_subject_v;

DROP VIEW grouper_perms_assigned_role_v;

DROP VIEW grouper_pit_attr_asn_value_v;

DROP VIEW grouper_pit_perms_all_v;

DROP VIEW grouper_pit_perms_role_v;

DROP VIEW grouper_pit_perms_role_subj_v;

DROP VIEW grouper_roles_v;

DROP VIEW grouper_memberships_v;

DROP VIEW grouper_memberships_lw_v;

DROP VIEW grouper_mship_attrdef_lw_v;

DROP VIEW grouper_mship_stem_lw_v;

DROP VIEW grouper_memberships_all_v;

DROP VIEW grouper_pit_memberships_all_v;

DROP VIEW grouper_role_set_v;

DROP VIEW grouper_rpt_composites_v;

DROP VIEW grouper_rpt_group_field_v;

DROP VIEW grouper_rpt_groups_v;

DROP VIEW grouper_rpt_members_v;

DROP VIEW grouper_rpt_roles_v;

DROP VIEW grouper_rpt_stems_v;

DROP VIEW grouper_rules_v;

DROP VIEW grouper_service_role_v;

DROP VIEW grouper_stems_v;

DROP VIEW grouper_stem_set_v;
...
update grouper_ddl set db_version = 30, last_updated = '2020/09/21 18:06:06', 
history = '2020/09/21 18:06:06: upgrade Grouper from V29 to V30, 2020/09/21 17:38:36: upgrade Grouper from V28 to V29, 2020/09/21 17:38:36: upgrade Grouper from V27 to V28, 2020/09/21 17:38:36: upgrade Grouper from V26 to V27, 2020/09/21 17:38:36: upgrade Grouper from V25 to V26, 2020/09/21 17:38:36: upgrade Grouper from V24 to V25, 2020/09/21 17:38:35: upgrade Grouper from V23 to V24, 2020/09/21 17:38:35: upgrade Grouper from V22 to V23, 2020/09/21 17:38:35: upgrade Grouper from V21 to V22, 2020/09/21 17:38:35: upgrade Grouper from V20 to V21, 2020/09/21 17:38:35: upgrade Grouper from V19 to V20, 2020/09/21 17:38:35: upgrade Grouper from V18 to V19, 2020/09/21 17:38:35: upgrade Grouper from V17 to V18, 2020/09/21 17:38:35: upgrade Grouper from V16 to V17, 2020/09/21 17:38:35: upgrade Grouper from V15 to V16, 2020/09/21 17:38:35: upgrade Grouper from V14 to V15, 2020/09/21 17:38:35: upgrade Grouper from V13 to V14, 2020/09/21 17:38:35: upgrade Grouper from V12 to V13, 2020/09/21 17:38:35: upgrade Grouper from V11 to V12, 2020/09/21 17:38:35: upgrade Grouper from V10 to V11, 2020/09/21 17:38:35: upgrade Grouper from V9 to V10, 2020/09/21 17:38:35: upgrade Grouper from V8 to V9, 2020/09/21 17:38:35: upgrade Grouper from V7 to V8, 2020/09/21 17:38:35: upgrade Grouper from V6 to V7, 2020/09/21 17:38:35: upgrade Grouper from V5 to V6, 2020/09/21 17:38:35: upgrade Grouper from V4 to V5, 2020/09/21 17:38:35: upgrade Grouper from V3 to V4, 2020/09/21 17:38:35: upgrade Grouper from V2 to V3, 2020/09/21 17:38:35: upgrade Grouper from V1 to V2, 2020/09/21 17:38:35: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
