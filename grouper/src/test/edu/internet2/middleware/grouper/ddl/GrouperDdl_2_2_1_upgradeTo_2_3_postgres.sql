...
DROP VIEW IF EXISTS grouper_ext_subj_v cascade;

DROP VIEW IF EXISTS grouper_ext_subj_invite_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_group_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_efmship_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_stem_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_member_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_mship_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_attrdef_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_group_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_stem_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_member_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_mship_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_efmship_v cascade;

DROP VIEW IF EXISTS grouper_attr_asn_asn_attrdef_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_group_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_efmship_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_stem_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_member_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_mship_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_attrdef_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_group_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_stem_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_member_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_mship_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_efmship_v cascade;

DROP VIEW IF EXISTS grouper_aval_asn_asn_attrdef_v cascade;

DROP VIEW IF EXISTS grouper_attr_def_name_set_v cascade;

DROP VIEW IF EXISTS grouper_attr_assn_action_set_v cascade;

DROP VIEW IF EXISTS grouper_attr_def_priv_v cascade;

DROP VIEW IF EXISTS grouper_audit_entry_v cascade;

DROP VIEW IF EXISTS grouper_change_log_entry_v cascade;

DROP VIEW IF EXISTS grouper_composites_v cascade;

DROP VIEW IF EXISTS grouper_groups_v cascade;

DROP VIEW IF EXISTS grouper_perms_all_v cascade;

DROP VIEW IF EXISTS grouper_perms_role_v cascade;

DROP VIEW IF EXISTS grouper_perms_role_subject_v cascade;

DROP VIEW IF EXISTS grouper_perms_assigned_role_v cascade;

DROP VIEW IF EXISTS grouper_pit_attr_asn_value_v cascade;

DROP VIEW IF EXISTS grouper_pit_perms_all_v cascade;

DROP VIEW IF EXISTS grouper_pit_perms_role_v cascade;

DROP VIEW IF EXISTS grouper_pit_perms_role_subj_v cascade;

DROP VIEW IF EXISTS grouper_roles_v cascade;

DROP VIEW IF EXISTS grouper_memberships_v cascade;

DROP VIEW IF EXISTS grouper_memberships_lw_v cascade;

DROP VIEW IF EXISTS grouper_mship_attrdef_lw_v cascade;

DROP VIEW IF EXISTS grouper_mship_stem_lw_v cascade;

DROP VIEW IF EXISTS grouper_memberships_all_v cascade;

DROP VIEW IF EXISTS grouper_pit_memberships_all_v cascade;

DROP VIEW IF EXISTS grouper_role_set_v cascade;

DROP VIEW IF EXISTS grouper_rpt_composites_v cascade;

DROP VIEW IF EXISTS grouper_rpt_group_field_v cascade;

DROP VIEW IF EXISTS grouper_rpt_groups_v cascade;

DROP VIEW IF EXISTS grouper_rpt_members_v cascade;

DROP VIEW IF EXISTS grouper_rpt_roles_v cascade;

DROP VIEW IF EXISTS grouper_rpt_stems_v cascade;

DROP VIEW IF EXISTS grouper_rules_v cascade;

DROP VIEW IF EXISTS grouper_service_role_v cascade;

DROP VIEW IF EXISTS grouper_stems_v cascade;

DROP VIEW IF EXISTS grouper_stem_set_v cascade;
...
ALTER TABLE grouper_pit_groups DROP constraint fk_pit_group_stem;
ALTER TABLE grouper_pit_stems DROP constraint fk_pit_stem_parent;
ALTER TABLE grouper_pit_attribute_def DROP constraint fk_pit_attr_def_stem;
ALTER TABLE grouper_pit_memberships DROP constraint fk_pit_ms_owner_attrdef_id;
ALTER TABLE grouper_pit_memberships DROP constraint fk_pit_ms_owner_group_id;
ALTER TABLE grouper_pit_memberships DROP constraint fk_pit_ms_owner_stem_id;
ALTER TABLE grouper_pit_memberships DROP constraint fk_pit_ms_member_id;
ALTER TABLE grouper_pit_memberships DROP constraint fk_pit_ms_field_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_owner_attrdef_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_owner_group_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_owner_stem_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_member_attrdef_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_member_group_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_member_stem_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_field_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_member_field_id;
ALTER TABLE grouper_pit_group_set DROP constraint fk_pit_gs_parent_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_action_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_def_name_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_assn_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_def_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_grp_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_mem_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_ms_id;
ALTER TABLE grouper_pit_attribute_assign DROP constraint fk_pit_attr_assn_owner_stem_id;
ALTER TABLE grouper_pit_attr_assn_value DROP constraint fk_pit_attr_assn_value_assn_id;
ALTER TABLE grouper_pit_attr_assn_actn DROP constraint fk_pit_attr_assn_attr_def_id;
ALTER TABLE grouper_pit_attr_def_name DROP constraint fk_pit_attr_def_name_stem;
ALTER TABLE grouper_pit_attr_def_name DROP constraint fk_pit_attr_def_name_def_id;
ALTER TABLE grouper_pit_attr_def_name_set DROP constraint fk_pit_attr_def_name_set_parnt;
ALTER TABLE grouper_pit_attr_def_name_set DROP constraint fk_pit_attr_def_name_if;
ALTER TABLE grouper_pit_attr_def_name_set DROP constraint fk_pit_attr_def_name_then;
ALTER TABLE grouper_pit_attr_assn_actn_set DROP constraint fk_pit_attr_action_set_parent;
ALTER TABLE grouper_pit_attr_assn_actn_set DROP constraint fk_pit_attr_action_set_if;
ALTER TABLE grouper_pit_attr_assn_actn_set DROP constraint fk_pit_attr_action_set_then;
ALTER TABLE grouper_pit_role_set DROP constraint fk_pit_role_set_parent;
ALTER TABLE grouper_pit_role_set DROP constraint fk_pit_role_if;
ALTER TABLE grouper_pit_role_set DROP constraint fk_pit_role_then;
ALTER TABLE grouper_ext_subj_attr DROP constraint fk_ext_subj_attr_subj_uuid;
ALTER TABLE grouper_stem_set DROP constraint fk_stem_set_parent;
ALTER TABLE grouper_stem_set DROP constraint fk_stem_set_if;
ALTER TABLE grouper_stem_set DROP constraint fk_stem_set_then;
...
update grouper_ddl set db_version = 30, last_updated = '2020/09/21 18:22:36', 
history = '2020/09/21 18:22:36: upgrade Grouper from V29 to V30, 2020/09/21 18:19:08: upgrade Grouper from V28 to V29, 2020/09/21 18:19:05: upgrade Grouper from V27 to V28, 2020/09/21 18:19:03: upgrade Grouper from V26 to V27, 2020/09/21 18:19:00: upgrade Grouper from V25 to V26, 2020/09/21 18:18:58: upgrade Grouper from V24 to V25, 2020/09/21 18:18:55: upgrade Grouper from V23 to V24, 2020/09/21 18:18:54: upgrade Grouper from V22 to V23, 2020/09/21 18:18:54: upgrade Grouper from V21 to V22, 2020/09/21 18:18:53: upgrade Grouper from V20 to V21, 2020/09/21 18:18:53: upgrade Grouper from V19 to V20, 2020/09/21 18:18:53: upgrade Grouper from V18 to V19, 2020/09/21 18:18:52: upgrade Grouper from V17 to V18, 2020/09/21 18:18:52: upgrade Grouper from V16 to V17, 2020/09/21 18:18:52: upgrade Grouper from V15 to V16, 2020/09/21 18:18:52: upgrade Grouper from V14 to V15, 2020/09/21 18:18:51: upgrade Grouper from V13 to V14, 2020/09/21 18:18:51: upgrade Grouper from V12 to V13, 2020/09/21 18:18:51: upgrade Grouper from V11 to V12, 2020/09/21 18:18:51: upgrade Grouper from V10 to V11, 2020/09/21 18:18:51: upgrade Grouper from V9 to V10, 2020/09/21 18:18:51: upgrade Grouper from V8 to V9, 2020/09/21 18:18:51: upgrade Grouper from V7 to V8, 2020/09/21 18:18:51: upgrade Grouper from V6 to V7, 2020/09/21 18:18:51: upgrade Grouper from V5 to V6, 2020/09/21 18:18:50: upgrade Grouper from V4 to V5, 2020/09/21 18:18:50: upgrade Grouper from V3 to V4, 2020/09/21 18:18:50: upgrade Grouper from V2 to V3, 2020/09/21 18:18:50: upgrade Grouper from V1 to V2, 2020/09/21 18:18:50: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
