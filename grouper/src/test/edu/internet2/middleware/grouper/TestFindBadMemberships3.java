...
public class TestFindBadMemberships3 extends TestCase {
  ...
  public void testFindBadMemberships3() {
    ...
    try {
      ...
      MembershipDTO invalid =
        (MembershipDTO)MembershipTestHelper.findEffectiveMembership(r.rs, gG, gD.toSubject(), gE, 1, FieldFinder.find("updaters")).getDTO();
      invalid.setId(null);
      ...
      // gD -> gH gets deleted
      MembershipDTO gDgH =
        (MembershipDTO)MembershipTestHelper.findEffectiveMembership(r.rs, gH, gD.toSubject(), gA, 2, FieldFinder.find("updaters")).getDTO();
      mof = new DefaultMemberOf();
      mof.addDelete(gDgH);
      GrouperDAOFactory.getFactory().getMembership().update(mof);
      ...
      MembershipDTO gDnsA =
        (MembershipDTO)MembershipTestHelper.findEffectiveMembership(r.rs, nsA, gD.toSubject(), gE, 1, FieldFinder.find("creators")).getDTO();
      mof = new DefaultMemberOf();
      mof.addDelete(gDnsA);
      GrouperDAOFactory.getFactory().getMembership().update(mof);
      ...
      MembershipDTO gDnsB =
        (MembershipDTO)MembershipTestHelper.findEffectiveMembership(r.rs, nsB, gD.toSubject(), gE, 1, FieldFinder.find("stemmers")).getDTO();
      mof = new DefaultMemberOf();
      mof.addDelete(gDnsB);
      GrouperDAOFactory.getFactory().getMembership().update(mof);
