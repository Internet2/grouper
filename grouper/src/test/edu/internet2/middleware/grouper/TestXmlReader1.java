 ...
 * @version $Id: TestXmlReader1.java,v 1.7 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.1.0
 */
public class TestXmlReader1 extends GrouperTest {

  private static final Log LOG = GrouperUtil.getLog(TestXmlReader1.class);

  public TestXmlReader1(String name) {
    super(name);
  }
