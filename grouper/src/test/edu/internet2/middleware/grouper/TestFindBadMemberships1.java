...
public class TestFindBadMemberships1 extends TestCase {
  ...
  public void testFindBadMemberships1() {
    ...
    try {
      ...
      // SB -> gL gets deleted
      MembershipDTO SBgL = 
        (MembershipDTO)MembershipTestHelper.findEffectiveMembership(r.rs, gL, subjB, gI, 1, Group.getDefaultList()).getDTO();
      ...
      // gQ -> gI gets deleted
      MembershipDTO gQgI = 
        (MembershipDTO)MembershipTestHelper.findCompositeMembership(r.rs, gI, gQ.toSubject()).getDTO();
      ...
      MembershipDTO SBgE =
        (MembershipDTO)MembershipTestHelper.findCompositeMembership(r.rs, gE, subjB).getDTO();
      mof = new DefaultMemberOf();
      SBgE.setId(null);
