...
import edu.internet2.middleware.grouper.filter.MembershipCreatedBeforeFilter;
 ...
 * @version $Id: TestQuery19.java,v 1.4 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.1.0
 */
public class TestQuery19 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestQuery19.class);
