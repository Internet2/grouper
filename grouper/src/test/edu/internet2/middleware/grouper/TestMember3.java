 ...
 * @version $Id: TestMember3.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestMember3 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestMember3.class);

  public TestMember3(String name) {
    super(name);
  }
