 ...
 * @version $Id: TestCompositeC1.java,v 1.11 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.0
 */
public class TestCompositeC1 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestCompositeC1.class);

  public TestCompositeC1(String name) {
    super(name);
  }
