 ...
 */
public class TestGQGroupCurrentNameExactFilter extends GrouperTest {
   ...
   * @param name
   */
  public TestGQGroupCurrentNameExactFilter(String name) {
    super(name);
  }
  ...
  public void testDisplayName() {
    ...
    try {
      GrouperQuery gq = GrouperQuery.createQuery(
        s, new GroupCurrentNameExactFilter("education:internet2")
      );
  ...
  public void testSecurity() throws Exception {
    ...
    try {
      GrouperQuery gq = GrouperQuery.createQuery(
          subjASession, new GroupCurrentNameExactFilter("edu:i2")
      );
      Assert.assertTrue("groups",  gq.getGroups().size()      == 0);
      Assert.assertTrue("members", gq.getMembers().size()     == 0);
      Assert.assertTrue("mships",  gq.getMemberships().size() == 0);
