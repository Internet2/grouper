 ...
 * @version $Id: TestMember6.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestMember6 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestMember6.class);

  public TestMember6(String name) {
    super(name);
  }
