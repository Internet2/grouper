...
public class ChangeLogTest extends GrouperTest {
  ...
  protected void tearDown() {
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().remove("changeLog.includeRolesWithPermissionChanges");
   ...
   * @throws Exception
   */
  public void testRolePermissionEnableDisableWithPermissionChangeOnSubjectNotifications() throws Exception {
    ...
    ChangeLogEntry changeLogEntry = HibernateSession.byHqlStatic()
      ...
      .setString("theChangeLogType", ChangeLogTypeBuiltin.PERMISSION_CHANGE_ON_SUBJECT.getChangeLogType().getId())
    ...
    assertEquals(newMember1.getUuid(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.memberId));
    assertEquals(newMember1.getSubjectId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(newMember1.getSubjectSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
   ...
   * @throws Exception
   */
  public void testSubjectRolePermissionEnableDisableWithPermissionChangeOnSubjectNotifications() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectByMember() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    assertEquals(newMember2.getUuid(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.memberId));
    assertEquals(newMember2.getSubjectId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(newMember2.getSubjectSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectByGroupSet() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    // Verify group2
    ChangeLogEntry changeLogEntry = HibernateSession.byHqlStatic()
      .createQuery("from ChangeLogEntryEntity where changeLogTypeId = :theChangeLogType and string01 = :subjectId")
      .setString("theChangeLogType", ChangeLogTypeBuiltin.PERMISSION_CHANGE_ON_SUBJECT.getChangeLogType().getId())
    ...
    assertEquals(group2.toMember().getUuid(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.memberId));
    assertEquals(group2.toSubject().getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(group2.toSubject().getSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
    ...
    assertEquals(group3.toMember().getUuid(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.memberId));
    assertEquals(group3.toSubject().getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(group3.toSubject().getSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectByAction() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    group.getPermissionRoleDelegate().assignRolePermission("testAction1", attributeDefName, PermissionAllowed.ALLOWED).getAttributeAssign();
    ChangeLogTempToEntity.convertRecords();
    ...
    // 2 flat changes - because 2 different set deletions
    Set<ChangeLogEntry> changeLogEntries = HibernateSession.byHqlStatic()
      .createQuery("from ChangeLogEntryEntity where changeLogTypeId = :theChangeLogType")
      .setString("theChangeLogType", ChangeLogTypeBuiltin.PERMISSION_CHANGE_ON_SUBJECT.getChangeLogType().getId())
      .listSet(ChangeLogEntry.class);
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectByAttributeDefName() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    attributeDef.getAttributeDefActionDelegate().addAction("testAction1");
    ...
    // 2 flat deletes - this is 2 because the attribute name sets are removed separately
    Set<ChangeLogEntry> changeLogEntries = HibernateSession.byHqlStatic()
      .createQuery("from ChangeLogEntryEntity where changeLogTypeId = :theChangeLogType")
      .setString("theChangeLogType", ChangeLogTypeBuiltin.PERMISSION_CHANGE_ON_SUBJECT.getChangeLogType().getId())
      .listSet(ChangeLogEntry.class);
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectByRoleSets() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    assertEquals(newMember1.getSubjectId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(newMember1.getSubjectSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group1.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group1.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
   ...
   * @throws Exception
   */
  public void testPermissionChangeOnSubjectWithSubjectRolePermissions() throws Exception {
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.includeSubjectsWithPermissionChanges", "true");
    ...
    // assign permission
    group1.getPermissionRoleDelegate().assignSubjectRolePermission(attributeDefName, newMember1, PermissionAllowed.ALLOWED).getAttributeAssign();
    ...
    assertEquals(newMember1.getSubjectId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectId));
    assertEquals(newMember1.getSubjectSourceId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.subjectSourceId));
    assertEquals(group2.getId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleId));
    assertEquals(group2.getName(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.PERMISSION_CHANGE_ON_SUBJECT.roleName));
  ...
  public void testTypeAssignment() throws Exception {
    ...
    assertEquals("Should have added 4 entries in temp change log -- attribute assignment and group type assignment and 2 group sets", 4, newChangeLogTempCount);
    assertEquals("Should be the same", 0, newChangeLogCount);
    ...
    assertNotNull(pitGroupSet.getStartTimeDb());
    ...
    assertNotNull(pitGroupSet.getStartTimeDb());
    assertNotNull(pitGroupSet.getEndTimeDb());
   ...
   * @throws Exception
   */
  public void testMembersAdditionalAttributes() throws Exception {
    ...
    assertEquals(member.getSubjectTypeId(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.MEMBER_ADD.subjectTypeId));
    assertEquals(member.getSubjectIdentifier0(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.MEMBER_ADD.subjectIdentifier0));
    assertEquals(member.getSubjectIdentifier1(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.MEMBER_ADD.subjectIdentifier1));
    assertEquals(member.getSubjectIdentifier2(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.MEMBER_ADD.subjectIdentifier2));
    assertEquals(member.getEmail0(), changeLogEntry.retrieveValueForLabel(ChangeLogLabels.MEMBER_ADD.email0));
    ...
    //try an update of one field
    member.setSubjectIdentifier2("newIdentifier");
    ...
    assertEquals(member.getSubjectSourceId(), changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectSourceId));
    assertEquals(member.getSubjectTypeId(), changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectTypeId));
    assertEquals(member.getSubjectIdentifier0(), changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier0));
    assertEquals(member.getSubjectIdentifier1(), changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier1));
    assertEquals("newIdentifier", changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier2));
    assertEquals(member.getEmail0(), changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.email0));
    assertEquals("subjectIdentifier2", changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyChanged));
    assertEquals("description.test.subject.0", changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyOldValue));
    assertEquals("newIdentifier", changeLogEntry2.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyNewValue));
    ...
    //try an update of one field
    member.setEmail0("newEmail@sdf.sdf");
    ...
    assertEquals(member.getSubjectSourceId(), changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectSourceId));
    assertEquals(member.getSubjectTypeId(), changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectTypeId));
    assertEquals(member.getSubjectIdentifier0(), changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier0));
    assertEquals(member.getSubjectIdentifier1(), changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier1));
    assertEquals(member.getSubjectIdentifier2(), changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.subjectIdentifier2));
    assertEquals("newEmail@sdf.sdf", changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.email0));
    assertEquals("email0", changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyChanged));
    assertEquals("test.subject.0@somewhere.someSchool.edu", changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyOldValue));
    assertEquals("newEmail@sdf.sdf", changeLogEntry3.retrieveValueForLabel(ChangeLogLabels.MEMBER_UPDATE.propertyNewValue));
    ...
    assertEquals(member.getSubjectTypeId(), changeLogEntry4.retrieveValueForLabel(ChangeLogLabels.MEMBER_DELETE.subjectTypeId));
    assertEquals(member.getSubjectIdentifier0(), changeLogEntry4.retrieveValueForLabel(ChangeLogLabels.MEMBER_DELETE.subjectIdentifier0));
    assertEquals(member.getSubjectIdentifier1(), changeLogEntry4.retrieveValueForLabel(ChangeLogLabels.MEMBER_DELETE.subjectIdentifier1));
    assertEquals(member.getSubjectIdentifier2(), changeLogEntry4.retrieveValueForLabel(ChangeLogLabels.MEMBER_DELETE.subjectIdentifier2));
    assertEquals(member.getEmail0(), changeLogEntry4.retrieveValueForLabel(ChangeLogLabels.MEMBER_DELETE.email0));
  ...
  public void testAttributeDefs() throws Exception {
    ...
    // 4 temp change log changes - attributeDef, action, actionSet
    assertEquals("Should have added change log temp", 11, newChangeLogTempCount);
    assertEquals("Should be the same", 0, newChangeLogCount);
    ...
    assertEquals("Should have nothing in temp table", 0, newChangeLogTempCount);
    assertEquals("Should have in the change log table", 11, newChangeLogCount);
    ...
    assertEquals("Should have one in temp table", 1, newChangeLogTempCount);
    assertEquals("Should have four records in the change log table", 11, newChangeLogCount);
    ...
    assertEquals("Should have in temp table", 11, newChangeLogTempCount);
    assertEquals("Should have five records in the change log table", 12, newChangeLogCount);
  ...
  public void testTypes() throws Exception {
    ...
    assertEquals("Should have temp change log entries",13, newChangeLogTempCount);
  ...
  public void testMemberships() throws Exception {
    ...
    newChangeLogCount = HibernateSession.bySqlStatic().select(int.class, 
      "select count(1) from grouper_change_log_entry");
    assertEquals("Should have 20 new change log entries", 20, newChangeLogCount);
    ...
    assertEquals("Should have 25 new change log entries", 25, newChangeLogCount);
  ...
  public void testAccessPrivileges() throws Exception {
    ...
    assertEquals("Should have 4 new change log entries", 4, newChangeLogCount);
    ...
    assertEquals("Should have 5 new change log entries", 5, newChangeLogCount);
    ...
    assertEquals("Should have 6 change log entries", 6, changeLogEntries.size());
  ...
  private void verifyEffectiveCustomListMembershipsDelete(Membership g3g4Mship, Membership g3g5Mship, String contextId) {
    ...
    Group g4 = GrouperDAOFactory.getFactory().getGroup().findByUuid(g3g4Mship.getMemberSubjectId(), true);
    Group g5 = GrouperDAOFactory.getFactory().getGroup().findByUuid(g3g5Mship.getMemberSubjectId(), true);
  ...
  public void testMembershipsNoPrivileges() throws Exception {
    ...
    assertEquals(16, newChangeLogCount);
