 ...
 * @version $Id: TestStem4.java,v 1.1.2.1 2006-04-13 18:37:46 blair Exp $
 */
public class TestStem4 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestStem4.class);

  public TestStem4(String name) {
    super(name);
  }
