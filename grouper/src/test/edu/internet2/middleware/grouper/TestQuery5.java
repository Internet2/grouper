 ...
 * @version $Id: TestQuery5.java,v 1.1.2.1 2006-04-13 19:52:49 blair Exp $
 */
public class TestQuery5 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestQuery5.class);

  public TestQuery5(String name) {
    super(name);
  }
