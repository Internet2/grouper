 ...
 * @version $Id: TestCompositeModel3.java,v 1.1.2.1 2006-04-17 18:19:54 blair Exp $
 */
public class TestCompositeModel3 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeModel3.class);

  public TestCompositeModel3(String name) {
    super(name);
  }
  ...
  public void testFailNullRight() {
    ...
    try {
      ...
      T.string("error message", CompositeValidator.ERR_R, eM.getMessage());
    }
    catch (Exception e) {
