 ...
 * @version $Id: TestCompositeU10.java,v 1.1.2.1 2006-05-11 16:41:44 blair Exp $
 */
public class TestCompositeU10 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeU10.class);

  public TestCompositeU10(String name) {
    super(name);
  }
