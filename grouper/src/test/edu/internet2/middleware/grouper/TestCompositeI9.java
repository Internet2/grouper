 ...
 * @version $Id: TestCompositeI9.java,v 1.4 2008-07-21 04:43:57 mchyzer Exp $
 */
public class TestCompositeI9 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeI9.class);

  public TestCompositeI9(String name) {
    super(name);
  }
