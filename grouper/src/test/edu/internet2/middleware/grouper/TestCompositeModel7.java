 ...
 * @version $Id: TestCompositeModel7.java,v 1.1.2.1 2006-04-17 18:19:54 blair Exp $
 */
public class TestCompositeModel7 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeModel7.class);
  ...
  public void testFailLeftNotGroup() {
    ...
    try {
      ...
      T.string("error message", CompositeValidator.ERR_LC, eM.getMessage());
    }
    catch (Exception e) {
