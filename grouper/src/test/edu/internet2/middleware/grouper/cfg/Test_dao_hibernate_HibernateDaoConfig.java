 ...
 * @version $Id: Test_dao_hibernate_HibernateDaoConfig.java,v 1.1 2009-03-20 19:56:42 mchyzer Exp $
 * @since   1.2.1
 */
public class Test_dao_hibernate_HibernateDaoConfig extends GrouperTest {
  ...
  String        prop_valid    = "hibernate.dialect";


  public void setUp() {
    super.setUp();
    this.cfg = new HibernateDaoConfig();
  }
