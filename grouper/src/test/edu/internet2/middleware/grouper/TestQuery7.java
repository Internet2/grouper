 ...
 * @version $Id: TestQuery7.java,v 1.1.2.1 2006-04-13 19:52:49 blair Exp $
 */
public class TestQuery7 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestQuery7.class);

  public TestQuery7(String name) {
    super(name);
  }
