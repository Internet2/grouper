 ...
 * @author 
 */
public class OktaProvisionerTestUtils {
  ...
  public static void setupOktaExternalSystem() {
  ...
  /**
   * 
   * @param oktaProvisioningTestConfigInput
   * @param suffix
   * @param value
   */
  private static void configureProvisionerSuffix(OktaProvisionerTestConfigInput oktaProvisioningTestConfigInput, String suffix, String value) {
    // if its overridden then dont set
    if (!oktaProvisioningTestConfigInput.getExtraConfig().containsKey(suffix)) {
      new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("provisioner." + oktaProvisioningTestConfigInput.getConfigId() + "." + suffix).value(value).store();
    }
  }
  
  // not ready for testing. it doesn't work.
  public static void configureOktaProvisionerDavidJardim(OktaProvisionerTestConfigInput provisioningTestConfigInput) {
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "oktaExternalSystemConfigId", "okta");
   ...
   *       new OktaProvisioningTestConfigInput()
   *    .assignConfigId(string)
   *    .addExtraConfig("allowProvisionableRegexOverride", "true")
   *
   */
  public static void configureOktaProvisioner(OktaProvisionerTestConfigInput provisioningTestConfigInput) {
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "customizeEntityCrud", "false");
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "targetEntityAttribute.0.insert", "false");
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "entityAttributeValueCache3has", "true");
    configureProvisionerSuffix(provisioningTestConfigInput, "entityAttributeValueCache3source", "target");
    configureProvisionerSuffix(provisioningTestConfigInput, "entityAttributeValueCache3type", "entityAttribute");
    configureProvisionerSuffix(provisioningTestConfigInput, "entityAttributeValueCache3entityAttribute", "login");
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "targetEntityAttribute.4.name", "login");
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "entityMatchingAttributeCount", "1");
    configureProvisionerSuffix(provisioningTestConfigInput, "entityMatchingAttribute0name", "login");
