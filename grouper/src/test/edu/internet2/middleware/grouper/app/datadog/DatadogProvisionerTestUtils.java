...
/**
 * Test utils for Datadog provisioner
 */
public class DatadogProvisionerTestUtils {

  public static void setupDatadogExternalSystem() {
    ...
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.datadogDev.endpoint")
        .value((ssl ? "https://" : "http://") + domainName + ":" + port + "/grouper/mockServices/datadog").store();
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.datadogDev.httpAuthnType").value("bearerToken").store();
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.datadogDev.accessTokenPassword")
        .value("{\"apiKey\": \"testApiKey123\", \"applicationKey\": \"testAppKey456\"}").store();

    new GrouperDbConfig().configFileName("grouper.properties").propertyName("grouperTest.exampleDatadog.mockExternalSystem.configId").value("datadogDev").store();
  }
   ...
   * @param value
   */
  public static void configureProvisionerSuffix(DatadogProvisionerTestConfigInput provisioningTestConfigInput, String suffix, String value) {
  ...
  private static void configureProvisioner(DatadogProvisionerTestConfigInput provisioningTestConfigInput) {
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "datadogExternalSystemConfigId", "datadogDev");
    configureProvisionerSuffix(provisioningTestConfigInput, "class", "edu.internet2.middleware.grouper.app.datadog.DatadogProvisioner");
    ...
    // group attribute value cache: cache0=id
   ...
   * @param provisioningTestConfigInput
   */
  public static void configureDatadogProvisioner(DatadogProvisionerTestConfigInput provisioningTestConfigInput) {
