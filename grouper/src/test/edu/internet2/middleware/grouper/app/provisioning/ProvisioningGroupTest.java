...
public class ProvisioningGroupTest extends GrouperTest {
  ...
  public static void main(String[] args) {
    ...
    TestRunner.run(new ProvisioningGroupTest("testConvertToJsonForCache"));
  ...
  public void testConvertToJsonForCache() {
    ...
    String expectedString = "{\"description\":\"This is the description of the group\",\"displayName\":\"Some name\",\"id\":\"abc123\","
        + "\"name\":\"someName\",\"objectClass\":[\"groupOfNames\",\"memberGroup\",\"top\"],\"uuid\":\"abc123xyz456\"}";
    ...
    assertEquals(0, GrouperUtil.length(provisioningGroup2.getTruncatedAttributes()));
  }
