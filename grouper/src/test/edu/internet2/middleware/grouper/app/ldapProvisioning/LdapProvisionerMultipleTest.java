...
public class LdapProvisionerMultipleTest extends GrouperTest {
  ...
  public void testMultipleProvisionersFull() {
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.0.fieldName", "name");
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.0.isFieldElseAttribute", "true");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.1.isFieldElseAttribute", "false");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.2.isFieldElseAttribute", "false");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.3.isFieldElseAttribute", "false");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.4.isFieldElseAttribute", "false");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.5.isFieldElseAttribute", "false");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetGroupAttribute.5.translateFromGrouperProvisioningGroupField", "attribute__description");

    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetEntityAttributeCount", "2");

    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetEntityAttribute.0.fieldName", "name");
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetEntityAttribute.0.isFieldElseAttribute", "true");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.ldapProvTest2.targetEntityAttribute.1.isFieldElseAttribute", "false");
