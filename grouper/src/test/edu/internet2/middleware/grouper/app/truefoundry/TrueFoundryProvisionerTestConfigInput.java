...
/**
 * Config input for TrueFoundry provisioner tests
 */
public class TrueFoundryProvisionerTestConfigInput {
   ...
   */
  public TrueFoundryProvisionerTestConfigInput assignConfigId(String string) {
   ...
   * @return this for chaining
   */
  public TrueFoundryProvisionerTestConfigInput addExtraConfig(String suffix, String value) {
   ...
   * @return this for chaining
   */
  public TrueFoundryProvisionerTestConfigInput assignGroupOfUsersToProvision(Group groupOfUsersToProvision) {
