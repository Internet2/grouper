...
/**
 * Config input for CCure provisioner tests
 */
public class CCureProvisionerTestConfigInput {
   ...
   */
  public CCureProvisionerTestConfigInput assignConfigId(String string) {
   ...
   * @return this for chaining
   */
  public CCureProvisionerTestConfigInput addExtraConfig(String suffix, String value) {
   ...
   * @return this for chaining
   */
  public CCureProvisionerTestConfigInput assignGroupOfUsersToProvision(Group groupOfUsersToProvision) {
