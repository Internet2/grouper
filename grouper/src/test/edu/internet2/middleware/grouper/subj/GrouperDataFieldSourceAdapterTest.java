...
//    new GcDbAccess().sql(_sql).executeSql();
    ...
    new GrouperDbConfig().configFileName("subject.properties").propertyName("subjectApi.source.dataFieldSubjectSource.searchAttribute.0.attributeName").value("description").store();
    new GrouperDbConfig().configFileName("subject.properties").propertyName("subjectApi.source.dataFieldSubjectSource.searchAttributeCount").value("1").store();
    new GrouperDbConfig().configFileName("subject.properties").propertyName("subjectApi.source.dataFieldSubjectSource.sortAttribute.0.attributeName").value("name").store();
    new GrouperDbConfig().configFileName("subject.properties").propertyName("subjectApi.source.dataFieldSubjectSource.sortAttributeCount").value("1").store();
