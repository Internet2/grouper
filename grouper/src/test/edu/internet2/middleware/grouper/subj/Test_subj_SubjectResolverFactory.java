 ...
 * @version $Id: Test_subj_SubjectResolverFactory.java,v 1.1 2009-03-20 19:56:41 mchyzer Exp $
 * @since   1.2.1
 */
public class Test_subj_SubjectResolverFactory extends GrouperTest {
  ...
  public void test_getInstance_twoInstancesNotEqual() {
    assertFalse( 
      ...
      SubjectResolverFactory.getInstance().equals( SubjectResolverFactory.getInstance() )
    );
  }
  ...
  public void test_getResolver_twoResolversEqual() {
    assertEquals( 
      ...
      SubjectResolverFactory.getResolver(),
      SubjectResolverFactory.getResolver()
    );
  }
