 ...
 * @version $Id: Test_Integration_HibernateStemDAO_findAllByApproximateDisplayExtension.java,v 1.4 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.2.0
 */
public class Test_Integration_HibernateStemDAO_findAllByApproximateDisplayExtension extends GrouperTest {

  // PRIVATE CLASS CONSTANTS //
  private static final Log LOG = GrouperUtil.getLog(Test_Integration_HibernateStemDAO_findAllByApproximateDisplayExtension.class);
