 ...
 * @version $Id: Test_Unit_API_GrouperSourceAdapter_search.java,v 1.3 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.2.0
 */
public class Test_Unit_API_GrouperSourceAdapter_search extends GrouperTest {

  // PRIVATE CLASS CONSTANTS //
  private static final Log LOG = GrouperUtil.getLog(Test_Unit_API_GrouperSourceAdapter_search.class);
