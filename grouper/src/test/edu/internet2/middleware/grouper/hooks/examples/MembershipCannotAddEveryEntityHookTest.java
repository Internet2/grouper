...
public class MembershipCannotAddEveryEntityHookTest extends GrouperTest {

  /**
   * 
   */
  public MembershipCannotAddEveryEntityHookTest() {
    super();
  }
   ...
   * @param name
   */
  public MembershipCannotAddEveryEntityHookTest(String name) {
    super(name);
  }
  ...
  public static void main(String[] args) {
    TestRunner.run(new MembershipCannotAddEveryEntityHookTest("testHook"));
  }
