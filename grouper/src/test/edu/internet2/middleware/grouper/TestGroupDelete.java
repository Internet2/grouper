 ...
 * @version $Id: TestGroupDelete.java,v 1.1.2.1 2006-04-10 19:07:20 blair Exp $
 */
public class TestGroupDelete extends TestCase {
  ...
  public void testGroupDeleteWhenMemberAndHasMembers() {
    ...
    Member          m     = Helper.getMemberBySubject(s, SubjectTestHelper.SUBJ0);
    GroupHelper.addMember(uofc, SubjectTestHelper.SUBJ0, m);
    MembershipHelper.testNumMship(uofc, Group.getDefaultList(), 1, 1, 0);
    MembershipHelper.testNumMship(i2,   Group.getDefaultList(), 0, 0, 0);
    MembershipHelper.testImmMship(s, uofc, SubjectTestHelper.SUBJ0, Group.getDefaultList());
    ...
    MembershipHelper.testEffMship(
      s, i2, SubjectTestHelper.SUBJ0, Group.getDefaultList(), uofc, 1
    );
    try {
      uofc.delete();
      Assert.assertTrue("group deleted", true);
