 ...
 * @version $Id: TestSimpleWPCache1.java,v 1.2 2006-10-17 17:19:37 blair Exp $
 * @since   1.1.0
 */
public class TestSimpleWPCache1 extends GrouperTest {

  private static final Log LOG = LogFactory.getLog(TestSimpleWPCache1.class);

  public TestSimpleWPCache1(String name) {
    super(name);
  }
...
} // public class TestSimpleWPCache1
