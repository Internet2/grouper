 ...
 * @version $Id: TestCompositeU31.java,v 1.1.2.1 2006-05-22 18:36:15 blair Exp $
 */
public class TestCompositeU31 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeU31.class);

  public TestCompositeU31(String name) {
    super(name);
  }
