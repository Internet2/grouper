 ...
 * @version $Id: Test_Unit_API_CompositeMembershipValidator_validate.java,v 1.6 2008-07-21 04:43:57 mchyzer Exp $
 * @since   1.2.0
 */
public class Test_Unit_API_CompositeMembershipValidator_validate extends GrouperTest {

  // PRIVATE CLASS CONSTANTS //
  private static final Log LOG = LogFactory.getLog(Test_Unit_API_CompositeMembershipValidator_validate.class);
