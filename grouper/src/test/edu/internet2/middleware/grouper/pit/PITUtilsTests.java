...
public class PITUtilsTests extends GrouperTest {
  ...
  public void testDeleteInactiveGroup() {
    ...
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssign().findById(attributeAssign1.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDef().findById(attributeDef1.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action1a.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action1c.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet1aTo1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet1cTo1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignValue().findById(value1.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName1a.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName1c.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet1aTo1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet1cTo1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITField().findById(field1.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role1a.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role1b.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role1c.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role1d.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet1aTo1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet1cTo1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMember().findById(member1.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership1.getImmediateMembershipId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership1aTo1b.getImmediateMembershipId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership1cTo1d.getImmediateMembershipId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet1aTo1b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet1cTo1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITStem().findById(stem1.getUuid()));
    
    // verify data set 2...
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssign().findById(attributeAssign2.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDef().findById(attributeDef2.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2a.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2c.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2aTo2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2cTo2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignValue().findById(value2.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2a.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2c.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2aTo2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2cTo2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITField().findById(field2.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2a.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2b.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2c.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2d.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2aTo2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2cTo2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMember().findById(member2.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2.getImmediateMembershipId()));
    assertNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2aTo2b.getImmediateMembershipId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2cTo2d.getImmediateMembershipId()));
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2aTo2b.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2cTo2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITStem().findById(stem2.getUuid()));
  }
  ...
  public void testDeleteInactiveStem() {
    ...
    assertNotNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet1cTo1d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITStem().findById(stem1.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITStem().findById(edu.getUuid()));
    
    // verify data set 2...
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssign().findById(attributeAssign2.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDef().findById(attributeDef2.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2a.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2c.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignAction().findById(action2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2aTo2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignActionSet().findById(actionSet2cTo2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeAssignValue().findById(value2.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2a.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2c.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefName().findById(attributeDefName2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2aTo2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITAttributeDefNameSet().findById(attributeDefNameSet2cTo2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITField().findById(field2.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2a.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2b.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2c.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroup().findById(role2d.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2aTo2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITGroupSet().findById(groupSet2cTo2d.getId()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITMember().findById(member2.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2.getImmediateMembershipId()));
    assertNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2aTo2b.getImmediateMembershipId()));
    assertNull(GrouperDAOFactory.getFactory().getPITMembership().findById(membership2cTo2d.getImmediateMembershipId()));
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2aTo2b.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2cTo2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITStem().findById(stem2.getUuid()));
    assertNull(GrouperDAOFactory.getFactory().getPITStem().findById(edu2.getUuid()));
  }
  ...
  public void testDeleteInactiveObjectsInStem() {
    ...
    assertNull(GrouperDAOFactory.getFactory().getPITRoleSet().findById(roleSet2cTo2d.getId()));
    assertNull(GrouperDAOFactory.getFactory().getPITStem().findById(stem2.getUuid()));
    assertNotNull(GrouperDAOFactory.getFactory().getPITStem().findById(edu2.getUuid()));
  }
}