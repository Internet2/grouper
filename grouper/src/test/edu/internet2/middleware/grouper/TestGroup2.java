 ...
 * @version $Id: TestGroup2.java,v 1.1.2.1 2006-05-15 18:24:49 blair Exp $
 */
public class TestGroup2 extends TestCase {

  private static final Log LOG = LogFactory.getLog(TestGroup2.class);

  public TestGroup2(String name) {
    super(name);
  }
