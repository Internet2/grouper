 ...
 *
 */
public class PermissionLimitLabelsContainTest extends GrouperTest {
  ...
  public static void main(String[] args) {
    TestRunner.run(new PermissionLimitLabelsContainTest("testLabelsContain"));
  }
   ...
   * 
   */
  public PermissionLimitLabelsContainTest() {
    super();
  }
   ...
   * @param name
   */
  public PermissionLimitLabelsContainTest(String name) {
    super(name);
  }
  ...
  public void testLabelsContain() {
    ...
    assertFalse(new PermissionFinder().addSubject(this.subj0)
        .addAction(this.readString).addPermissionName(this.english)
        .assignPermissionProcessor(PermissionProcessor.FILTER_REDUNDANT_PERMISSIONS_AND_ROLES_AND_PROCESS_LIMITS)
        .addLimitEnvVar("labels", "oneFactor, whatever").hasPermission());
    assertFalse(new PermissionFinder().addSubject(this.subj0)
        .addAction(this.readString).addPermissionName(this.english)
        .assignPermissionProcessor(PermissionProcessor.FILTER_REDUNDANT_PERMISSIONS_AND_ROLES_AND_PROCESS_LIMITS)
        .addLimitEnvVar("labels", "").hasPermission());
