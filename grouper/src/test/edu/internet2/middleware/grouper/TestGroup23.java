 ...
 * @version $Id: TestGroup23.java,v 1.7 2009-01-02 06:57:11 mchyzer Exp $
 */
public class TestGroup23 extends TestCase {

  // Private Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestGroup23.class);


  public TestGroup23(String name) {
    super(name);
  }
  ...
  public void testFailCanWriteFieldNullSubjectValidField() {
    ...
    try {
      ...
      try {
        a.canWriteField(null, FieldFinder.find("theAttribute1"));
