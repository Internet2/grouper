 ...
 * @version $Id: TestCompositeU20.java,v 1.1.2.1 2006-05-11 17:29:40 blair Exp $
 */
public class TestCompositeU20 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = LogFactory.getLog(TestCompositeU20.class);

  public TestCompositeU20(String name) {
    super(name);
  }
