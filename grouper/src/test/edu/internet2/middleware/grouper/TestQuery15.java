 ...
 * @version $Id: TestQuery15.java,v 1.5 2008-09-29 03:38:27 mchyzer Exp $
 * @since   1.1.0
 */
public class TestQuery15 extends TestCase {

  private static final Log LOG = GrouperUtil.getLog(TestQuery15.class);

  public TestQuery15(String name) {
    super(name);
  }
