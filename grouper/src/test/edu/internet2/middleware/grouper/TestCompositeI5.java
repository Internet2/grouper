 ...
 * @version $Id: TestCompositeI5.java,v 1.6 2008-09-29 03:38:27 mchyzer Exp $
 */
public class TestCompositeI5 extends TestCase {

  // Private Static Class Constants
  private static final Log LOG = GrouperUtil.getLog(TestCompositeI5.class);

  public TestCompositeI5(String name) {
    super(name);
  }
