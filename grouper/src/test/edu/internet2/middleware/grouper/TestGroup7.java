 ...
 * @version $Id: TestGroup7.java,v 1.3 2006-08-30 18:35:38 blair Exp $
 */
public class TestGroup7 extends TestCase {

  // Private Class Constants
  private static final Log LOG = LogFactory.getLog(TestGroup7.class);


  public TestGroup7(String name) {
    super(name);
  }
