...
insert into grouper_ddl (id, object_name, db_version, last_updated, history) values ('85f343fc3afe4d2c84066ebe1f1b607e', 'Grouper', 1, '2020/03/30 19:42:37', 
'2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ');
commit;
...
update grouper_ddl set db_version = 2, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
DROP TABLE grouper_attribute_assign_value CASCADE;
...
DROP TABLE grouper_attribute_assign_value_ CASCADE;
...
DROP TABLE grouper_pit_attr_assn_value CASCADE;
...
DROP TABLE grouper_pit_attr_assn_value_ CASCADE;
...
DROP TABLE grouper_QZ_JOB_DETAILS CASCADE;
...
DROP TABLE grouper_QZ_JOB_DETAILS_ CASCADE;
...
DROP TABLE grouper_QZ_TRIGGERS CASCADE;
...
DROP TABLE grouper_QZ_TRIGGERS_ CASCADE;

CREATE TABLE grouper_QZ_SIMPROP_TRIGGERS_
(
    sched_name VARCHAR(120) NOT NULL,
    trigger_name VARCHAR(200) NOT NULL,
    trigger_group VARCHAR(200) NOT NULL,
...
INSERT INTO grouper_QZ_SIMPROP_TRIGGERS_ (sched_name,trigger_name,trigger_group,str_prop_1,str_prop_2,str_prop_3,int_prop_1,int_prop_2,long_prop_1,long_prop_2,dec_prop_1,dec_prop_2,bool_prop_1,bool_prop_2) SELECT sched_name,trigger_name,trigger_group,str_prop_1,str_prop_2,str_prop_3,int_prop_1,int_prop_2,long_prop_1,long_prop_2,dec_prop_1,dec_prop_2,bool_prop_1,bool_prop_2 FROM grouper_QZ_SIMPROP_TRIGGERS;

DROP TABLE grouper_QZ_SIMPROP_TRIGGERS CASCADE;
...
INSERT INTO grouper_QZ_SIMPROP_TRIGGERS (sched_name,trigger_name,trigger_group,str_prop_1,str_prop_2,str_prop_3,int_prop_1,int_prop_2,long_prop_1,long_prop_2,dec_prop_1,dec_prop_2,bool_prop_1,bool_prop_2) SELECT sched_name,trigger_name,trigger_group,str_prop_1,str_prop_2,str_prop_3,int_prop_1,int_prop_2,long_prop_1,long_prop_2,dec_prop_1,dec_prop_2,bool_prop_1,bool_prop_2 FROM grouper_QZ_SIMPROP_TRIGGERS_;

DROP TABLE grouper_QZ_SIMPROP_TRIGGERS_ CASCADE;
...
DROP TABLE grouper_QZ_BLOB_TRIGGERS CASCADE;
...
DROP TABLE grouper_QZ_BLOB_TRIGGERS_ CASCADE;
...
DROP TABLE grouper_QZ_CALENDARS CASCADE;
...
DROP TABLE grouper_QZ_CALENDARS_ CASCADE;

CREATE TABLE grouper_QZ_FIRED_TRIGGERS_
(
    sched_name VARCHAR(120) NOT NULL,
    entry_id VARCHAR(95) NOT NULL,
    trigger_name VARCHAR(200) NOT NULL,
...
INSERT INTO grouper_QZ_FIRED_TRIGGERS_ (sched_name,entry_id,trigger_name,trigger_group,instance_name,fired_time,sched_time,priority,state,job_name,job_group,is_nonconcurrent,requests_recovery) SELECT sched_name,entry_id,trigger_name,trigger_group,instance_name,fired_time,sched_time,priority,state,job_name,job_group,is_nonconcurrent,requests_recovery FROM grouper_QZ_FIRED_TRIGGERS;

DROP TABLE grouper_QZ_FIRED_TRIGGERS CASCADE;
...
INSERT INTO grouper_QZ_FIRED_TRIGGERS (sched_name,entry_id,trigger_name,trigger_group,instance_name,fired_time,sched_time,priority,state,job_name,job_group,is_nonconcurrent,requests_recovery) SELECT sched_name,entry_id,trigger_name,trigger_group,instance_name,fired_time,sched_time,priority,state,job_name,job_group,is_nonconcurrent,requests_recovery FROM grouper_QZ_FIRED_TRIGGERS_;

DROP TABLE grouper_QZ_FIRED_TRIGGERS_ CASCADE;
...
update grouper_ddl set db_version = 3, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 4, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 5, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 6, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 7, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 8, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 9, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 10, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 11, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 13, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 14, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 15, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 16, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 17, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 18, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 19, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 20, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 21, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 22, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 23, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 24, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V23 to V24, 2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 25, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V24 to V25, 2020/03/30 19:42:37: upgrade Grouper from V23 to V24, 2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 27, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V26 to V27, 2020/03/30 19:42:37: upgrade Grouper from V25 to V26, 2020/03/30 19:42:37: upgrade Grouper from V24 to V25, 2020/03/30 19:42:37: upgrade Grouper from V23 to V24, 2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 28, last_updated = '2020/03/30 19:42:37', 
history = '2020/03/30 19:42:37: upgrade Grouper from V27 to V28, 2020/03/30 19:42:37: upgrade Grouper from V26 to V27, 2020/03/30 19:42:37: upgrade Grouper from V25 to V26, 2020/03/30 19:42:37: upgrade Grouper from V24 to V25, 2020/03/30 19:42:37: upgrade Grouper from V23 to V24, 2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
update grouper_ddl set db_version = 30, last_updated = '2020/03/30 19:42:38', 
history = '2020/03/30 19:42:38: upgrade Grouper from V29 to V30, 2020/03/30 19:42:38: upgrade Grouper from V28 to V29, 2020/03/30 19:42:37: upgrade Grouper from V27 to V28, 2020/03/30 19:42:37: upgrade Grouper from V26 to V27, 2020/03/30 19:42:37: upgrade Grouper from V25 to V26, 2020/03/30 19:42:37: upgrade Grouper from V24 to V25, 2020/03/30 19:42:37: upgrade Grouper from V23 to V24, 2020/03/30 19:42:37: upgrade Grouper from V22 to V23, 2020/03/30 19:42:37: upgrade Grouper from V21 to V22, 2020/03/30 19:42:37: upgrade Grouper from V20 to V21, 2020/03/30 19:42:37: upgrade Grouper from V19 to V20, 2020/03/30 19:42:37: upgrade Grouper from V18 to V19, 2020/03/30 19:42:37: upgrade Grouper from V17 to V18, 2020/03/30 19:42:37: upgrade Grouper from V16 to V17, 2020/03/30 19:42:37: upgrade Grouper from V15 to V16, 2020/03/30 19:42:37: upgrade Grouper from V14 to V15, 2020/03/30 19:42:37: upgrade Grouper from V13 to V14, 2020/03/30 19:42:37: upgrade Grouper from V12 to V13, 2020/03/30 19:42:37: upgrade Grouper from V11 to V12, 2020/03/30 19:42:37: upgrade Grouper from V10 to V11, 2020/03/30 19:42:37: upgrade Grouper from V9 to V10, 2020/03/30 19:42:37: upgrade Grouper from V8 to V9, 2020/03/30 19:42:37: upgrade Grouper from V7 to V8, 2020/03/30 19:42:37: upgrade Grouper from V6 to V7, 2020/03/30 19:42:37: upgrade Grouper from V5 to V6, 2020/03/30 19:42:37: upgrade Grouper from V4 to V5, 2020/03/30 19:42:37: upgrade Grouper from V3 to V4, 2020/03/30 19:42:37: upgrade Grouper from V2 to V3, 2020/03/30 19:42:37: upgrade Grouper from V1 to V2, 2020/03/30 19:42:37: upgrade Grouper from V0 to V1, ' where object_name = 'Grouper';
commit;
...
COMMENT ON COLUMN grouper_pit_members.subject_source IS 'id of the source from sources.xml';
...
insert into grouper_ddl (id, object_name, db_version, last_updated, history) values ('8c3fe9d7e7864ec2b727918d8c10f895', 'Subject', 1, '2020/03/30 19:42:39', 
'2020/03/30 19:42:39: upgrade Subject from V0 to V1, ');
commit;
