...
public class GrouperProvisioningAttributePropagationTest extends GrouperProvisioningBaseTest {
  ...
  public void testIncrementalRegexRestriction() {
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.junitProvisioningAttributePropagationTest.targetGroupAttribute.1.showAdvancedAttribute", "true");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.consumer.junitProvisioningAttributePropagationTestCLC.quartzCron",  "9 59 23 31 12 ? 2099");
  ...
  public void testFullPolicyRestriction() {
    ...
    LdapProvisionerTestUtils.configureLdapProvisioner(
        ...
        .assignConfigId("junitProvisioningAttributePropagationTest"));
  ...
  public void testFullMultipleProvisioners() {
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.junitProvisioningAttributePropagationTest2.targetGroupAttribute.1.showAdvancedAttribute", "true");
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("provisioner.junitProvisioningAttributePropagationTest2.targetGroupAttribute.1.showAttributeValueSettings", "true");
    ...
    GrouperLoaderConfig.retrieveConfig().propertiesOverrideMap().put("changeLog.consumer.junitProvisioningAttributePropagationTest2CLC.quartzCron",  "9 59 23 31 12 ? 2099");
