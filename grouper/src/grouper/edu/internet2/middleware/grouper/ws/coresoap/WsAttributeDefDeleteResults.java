 ...
 * @author vsachdeva
 */
public class WsAttributeDefDeleteResults implements WsResponseBean, ResultMetadataHolder {
  ...
  public boolean tallyResults(GrouperTransactionType grouperTransactionType,
    ...
    if (this.getResults() != null) {
      ...
      final Map<String, Object> debugMap = GrouperWsRequestContext.retrieveDebugMap();
