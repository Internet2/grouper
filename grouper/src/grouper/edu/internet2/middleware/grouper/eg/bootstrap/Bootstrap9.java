...
/**
 * Step 9: Check for membership in the wheel group.
 * <p>
 * Now that you have your wheel group and the subject you wish to add as a
 * member you should check to see if the subject is already a member.
 * </p>
 * <pre class="eg">
 ...
 * @version $Id: Bootstrap9.java,v 1.2 2007-01-04 17:17:45 blair Exp $
 * @see     <a href="http://viewvc.internet2.edu/viewvc.py/grouper/src/grouper/edu/internet2/middleware/grouper/eg/bootstrap/Bootstrap9.java?root=I2MI&view=markup">Source</a>
 * @since   1.1.0
 */
public class Bootstrap9 {

  // PRIVATE CLASS CONSTANTS //
  private static final Log LOG = LogFactory.getLog(Bootstrap9.class);
