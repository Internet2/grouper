 ...
 */
public enum GrouperMidpointDdl implements DdlVersionable {

  /** first version of grouper, make sure the ddl table is there */
  V1 {
    /**
     * add the table testgrouper_loader
     * @see GrouperMidpointDdl#updateVersionFromPrevious(org.apache.ddlutils.model.Database, DdlVersionBean)
     */
    @Override
  ...
  public static int currentVersion() {
    if (currentVersion == -1) {
      int max = -1;
      for (GrouperMidpointDdl grouperDdl : GrouperMidpointDdl.values()) {
  ...
  public String[] getSampleTablenames() {
    return new String[]{"gr_mp_groups"};
  }
