...
public class OktaProvisionerConfiguration extends ProvisioningConfiguration {
  
  public final static Set<String> startWithConfigClassNames = new LinkedHashSet<String>();
  
  static {
    startWithConfigClassNames.add(OktaProvisioningStartWith.class.getName());
  }
  ...
  public String getPropertyValueThatIdentifiesThisConfig() {
    return GrouperOktaProvisioner.class.getName();
  }
