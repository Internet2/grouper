...
public class GrouperOktaLog {

  /** logger */
  private static final Log LOG = edu.internet2.middleware.grouper.util.GrouperUtil.getLog(GrouperOktaLog.class);
 
  /**
   * log something to the log file
   * @param message
   */
  public static void oktaLog(String message) {
    LOG.debug(message);
  }
   ...
   */
  public static void oktaLog(Map<String, Object> messageMap, Long startTimeNanos) {
