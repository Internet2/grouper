...
public class GrouperDaemonEnabledDisabledConfiguration extends GrouperDaemonConfiguration {
  ...
  public String getConfigIdRegex() {
    return "^(changeLog\\.enabledDisabled)\\.(.*)$";
  }
  ...
  public boolean matchesQuartzJobName(String jobName) {
    return "MAINTENANCE__enabledDisabled".equals(jobName);
  }
}
