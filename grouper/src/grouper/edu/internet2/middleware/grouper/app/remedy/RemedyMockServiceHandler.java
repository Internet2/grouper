...
public class RemedyMockServiceHandler extends MockServiceHandler {
  ...
  public RemedyMockServiceHandler() {
  }
...
//          GrouperAzureAuth.createTableAzureAuth(ddlVersionBean, database);
   ...
   * 
   */
  public static void dropRemedyMockTables() {
    MockServiceServlet.dropMockTable("mock_remedy_membership");
    MockServiceServlet.dropMockTable("mock_remedy_user");
    MockServiceServlet.dropMockTable("mock_remedy_group");
//    MockServiceServlet.dropMockTable("mock_remedy_auth");
  }
...
//    System.out.println(hmac);
  ...
  public void checkAuthorization(MockServiceRequest mockServiceRequest) {
    ...
    String configId = GrouperConfig.retrieveConfig().propertyValueStringRequired("grouperTest.remedy.mock.configId");
    String expectedIntegrationKey = GrouperConfig.retrieveConfig().propertyValueStringRequired("grouper.remedyConnector."+configId+".adminIntegrationKey");
    String adminDomainName = GrouperConfig.retrieveConfig().propertyValueStringRequired("grouper.remedyConnector."+configId+".adminDomainName");
    ...
    String adminSecretKey = GrouperConfig.retrieveConfig().propertyValueStringRequired("grouper.remedyConnector."+configId+".adminSecretKey");
...
//    }
  ...
  public void getUsers(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    ByHqlStatic query = HibernateSession.byHqlStatic().createQuery("select distinct user from GrouperRemedyUser user left join user.groups groups");
    ...
    for (GrouperRemedyUser grouperRemedyUser : grouperRemedyUsers) {
      valueNode.add(toUserJson(grouperRemedyUser));
    }
    
    resultNode.set("response", valueNode);
    if (queryPaging.getTotalRecordCount() > offsetInt + grouperRemedyUsers.size()) {
  ...
  public void getUser(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    List<GrouperRemedyUser> grouperRemedyUsers = HibernateSession.byHqlStatic().createQuery("select distinct user from GrouperRemedyUser user left join user.groups groups where user.id = :theId")
    ...
    if (GrouperUtil.length(grouperRemedyUsers) == 1) {
      ...
      resultNode.put("stat", "OK");
      ObjectNode objectNode = toUserJson(grouperRemedyUsers.get(0));
      ...
      throw new RuntimeException("userById: " + GrouperUtil.length(grouperRemedyUsers) + ", id: " + userId);
    }
  ...
  public void getGroupsByUser(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    ByHqlStatic query = HibernateSession.byHqlStatic()
        .createQuery("from GrouperRemedyGroup g where g.id in (select m.groupId from GrouperRemedyMembership m where m.userId = :theUserId) ")
    ...
    List<GrouperRemedyGroup> grouperRemedyGroups = query.list(GrouperRemedyGroup.class);
    ...
    for (GrouperRemedyGroup grouperRemedyGroup : grouperRemedyGroups) {
      valueNode.add(toGroupJson(grouperRemedyGroup));
    }
    
    resultNode.set("response", valueNode);
    if (queryPaging.getTotalRecordCount() > offsetInt + grouperRemedyGroups.size()) {
      ObjectNode metadataNode = GrouperUtil.jsonJacksonNode();
      metadataNode.put("next_offset", offsetInt + limitInt);
      resultNode.set("metadata", metadataNode);
    }
  ...
  public void disassociateGroupFromUser(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    List<GrouperRemedyUser> grouperRemedyUsers = HibernateSession.byHqlStatic().createQuery("select user from GrouperRemedyUser user where user.id = :theId")
        .setString("theId", userId).list(GrouperRemedyUser.class);
    ...
    HibernateSession.byHqlStatic()
      .createQuery("delete from GrouperRemedyMembership where userId = :userId and groupId = :groupId")
  ...
  public void associateGroupWithUser(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    List<GrouperRemedyGroup> grouperRemedyGroups = HibernateSession.byHqlStatic().createQuery("from GrouperRemedyGroup where group_id = :theId")
        .setString("theId", groupId).list(GrouperRemedyGroup.class);
    ...
    List<GrouperRemedyMembership> memberships = HibernateSession.byHqlStatic()
        .createQuery("from GrouperRemedyMembership m where m.userId = :userId and m.groupId = :groupId ")
        .setString("userId", userId)
        .setString("groupId", groupId)
...
//      grouperRemedyMembership.setGroupId(groupId);
//      grouperRemedyMembership.setUserId(userId);
//      grouperRemedyMembership.setId(GrouperUuid.getUuid());
...
//    grouperRemedyUser.setId(GrouperUuid.getUuid());
//    grouperRemedyUser.setEmail(email);
//    grouperRemedyUser.setUserName(userName);
//    grouperRemedyUser.setRealName(realName);
//    grouperRemedyUser.setFirstName(firstName);
//    grouperRemedyUser.setLastName(lastName);
    
//    List<GrouperRemedyUser> grouperRemedyUsers = HibernateSession.byHqlStatic().createQuery("select user from GrouperRemedyUser user where user.userName = :userName ")
//        .setString("userName", grouperRemedyUser.getUserName())
//        .list(GrouperRemedyUser.class);
    
    List<GrouperRemedyUser> grouperRemedyUsers = new ArrayList<>();
    
    if (grouperRemedyUsers != null && grouperRemedyUsers.size() > 0) {
      mockServiceResponse.setResponseCode(400);
      return;
    }
     
    HibernateSession.byObjectStatic().save(grouperRemedyUser);
    
    ObjectNode resultNode = GrouperUtil.jsonJacksonNode();
    
    resultNode.put("stat", "OK");
    ObjectNode objectNode = toUserJson(grouperRemedyUser);
  ...
  public void updateUser(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    List<GrouperRemedyUser> grouperRemedyUsers = HibernateSession.byHqlStatic().createQuery(
        "from GrouperRemedyUser where id = :theId")
        .setString("theId", userId).list(GrouperRemedyUser.class);
    ...
    if (GrouperUtil.length(grouperRemedyUsers) > 1) {
      throw new RuntimeException("Found multiple matched users! " + GrouperUtil.length(grouperRemedyUsers));
    }
    ...
    GrouperRemedyUser grouperRemedyUser = grouperRemedyUsers.get(0);

    if (StringUtils.isNotBlank(userName)) {
      
      //check if the new username is already taken
      List<GrouperRemedyUser> existingUsersWithSameUserName = HibernateSession.byHqlStatic().createQuery("select user from GrouperRemedyUser user where user.userName = :userName ")
          .setString("userName", userName)
          .list(GrouperRemedyUser.class);
      
      if (existingUsersWithSameUserName != null && existingUsersWithSameUserName.size() > 0) {
        
//        for (GrouperRemedyUser existingUser: existingUsersWithSameUserName) {
...
//    }
    ...
    HibernateSession.byObjectStatic().saveOrUpdate(grouperRemedyUser);
...
//    grouperRemedyGroup.setGroup_id(GrouperUuid.getUuid());
//    grouperRemedyGroup.setName(groupName);
//    grouperRemedyGroup.setDesc(desc);
    
    HibernateSession.byObjectStatic().save(grouperRemedyGroup);
    
    ObjectNode resultNode = GrouperUtil.jsonJacksonNode();
    
    resultNode.put("stat", "OK");
    ObjectNode objectNode = toGroupJson(grouperRemedyGroup);
  ...
  public void getGroups(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    ByHqlStatic query = HibernateSession.byHqlStatic().createQuery("from GrouperRemedyGroup");
  ...
  public void getUsersByGroup(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    ByHqlStatic query = HibernateSession.byHqlStatic()
        .createQuery("from GrouperRemedyUser u where u.id in (select m.userId from GrouperRemedyMembership m where m.groupId = :theGroupId) ")
  ...
  public void getGroup(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    if (GrouperUtil.length(grouperRemedyGroups) == 1) {
      ...
      resultNode.put("stat", "OK");
      ObjectNode objectNode = toGroupJson(grouperRemedyGroups.get(0));
      ...
      throw new RuntimeException("groupsById: " + GrouperUtil.length(grouperRemedyGroups) + ", id: " + groupId);
    }
  ...
  public void updateGroup(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    List<GrouperRemedyGroup> grouperRemedyGroups = HibernateSession.byHqlStatic().createQuery(
        "from GrouperRemedyGroup where group_id = :theId")
        .setString("theId", groupId).list(GrouperRemedyGroup.class);
    ...
    if (GrouperUtil.length(grouperRemedyGroups) > 1) {
      throw new RuntimeException("Found multiple matched groups! " + GrouperUtil.length(grouperRemedyGroups));
    }
    GrouperRemedyGroup grouperRemedyGroup = grouperRemedyGroups.get(0);
    ...
    HibernateSession.byObjectStatic().saveOrUpdate(grouperRemedyGroup);
  ...
  public void postAuth(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    Pattern clientIdPattern = Pattern.compile("^grouper\\.remedyConnector\\.([^.]+)\\.clientId$");
    ...
    String tenantId = GrouperLoaderConfig.retrieveConfig().propertyValueStringRequired("grouper.remedyConnector." + configId + ".tenantId");
    ...
    String resourceConfig = GrouperLoaderConfig.retrieveConfig().propertyValueStringRequired("grouper.remedyConnector." + configId + ".resource");
...
//      }
  ...
  public void deleteGroups(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    HibernateSession.byHqlStatic()
    .createQuery("delete from GrouperRemedyMembership where groupId = :groupId")
    .setString("groupId", groupId).executeUpdateInt();
    
    int groupsDeleted = HibernateSession.byHqlStatic()
        .createQuery("delete from GrouperRemedyGroup where group_id = :theId")
  ...
  public void deleteUsers(MockServiceRequest mockServiceRequest, MockServiceResponse mockServiceResponse) {
    ...
    HibernateSession.byHqlStatic()
    .createQuery("delete from GrouperRemedyMembership where userId = :userId")
    .setString("userId", userId).executeUpdateInt();
    
    HibernateSession.byHqlStatic()
        .createQuery("delete from GrouperRemedyUser where id = :theId")
   ...
   * @return the grouper remedy user
   */
  private static ObjectNode toUserJson(GrouperRemedyUser grouperRemedyUser) {
...
//    GrouperUtil.jsonJacksonAssignString(result, "email", grouperRemedyUser.getEmail());
//    GrouperUtil.jsonJacksonAssignString(result, "firstname", grouperRemedyUser.getFirstName());
...
//    for (GrouperRemedyGroup grouperRemedyGroup: GrouperUtil.nonNull(grouperRemedyUser.getGroups())) {
//      groupsNode.add(toGroupJson(grouperRemedyGroup));
//    }
    
    result.set("groups", groupsNode);
    
//    GrouperUtil.jsonJacksonAssignString(result, "lastname", grouperRemedyUser.getLastName());
...
//    GrouperUtil.jsonJacksonAssignString(result, "realname", grouperRemedyUser.getRealName());
...
//    GrouperUtil.jsonJacksonAssignString(result, "user_id", grouperRemedyUser.getId());
//    GrouperUtil.jsonJacksonAssignString(result, "username", grouperRemedyUser.getUserName());
   ...
   * @return the group
   */
  private static ObjectNode toGroupJson(GrouperRemedyGroup grouperRemedyGroup) {
    ObjectMapper objectMapper = new ObjectMapper();
    ObjectNode result = objectMapper.createObjectNode();

//    result.put("desc", grouperRemedyGroup.getDesc());
//    result.put("name", grouperRemedyGroup.getName());
//    result.put("group_id", grouperRemedyGroup.getGroup_id());
