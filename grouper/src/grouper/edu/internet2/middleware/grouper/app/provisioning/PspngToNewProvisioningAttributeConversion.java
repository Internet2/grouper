...
//    AttributeDefName provisionToAttirbuteDefName = AttributeDefNameFinder.findByName(etc + ":pspng:provision_to", false);
//    
//    List<Stem> stems = new ArrayList<Stem>(new StemFinder().assignAttributeCheckReadOnAttributeDef(false)
//        .assignNameOfAttributeDefName(etc + ":pspng:provision_to").findStems());
//    
//    System.out.println("stems size with provision_to assigned is "+stems.size());
    
    
    /**
     *  test1 -> provision_to = a newProvision = a 
     *    test2 -> provision_to = b newProvision = a, b 
     *      test3 -> newProvision = a, b
     *      
     * 
     * 
     * 
     * 
     *   test1 -> provision_to = 1
     *     test2 -> do_not_provision = 1
     *       test3 -> provision_to = 1 
     * 
     *   test1 -> provisionNew = 1, true
     *     test2 -> provisionNew = 1, false 
     *       test3 -> provisionNew = 1, true
     * 
     */
    
//    for (Stem stem: stems) {
//      System.out.println("stem name is "+stem.getName());
//      
//      Set<AttributeAssign> attributeAssigns = stem.getAttributeDelegate().retrieveAssignments(provisionToAttirbuteDefName);
//      
//      System.out.println("found "+attributeAssigns.size() + " attribute assigns on " + stem.getName());
//      
...
//          System.out.println("Target assigned to provision_to is "+attributeAssignValue.getValueString());
//          
//          if (!validTargetNames.contains(attributeAssignValue.getValueString())) {
//            System.out.println(attributeAssignValue.getValueString() + " is not a valid target. Valid target names are"
//                + " "+String.join(",", validTargetNames));
//          } else {
//            GrouperProvisioningAttributeValue grouperProvisioningAttributeValue = new GrouperProvisioningAttributeValue();
//            grouperProvisioningAttributeValue.setTargetName(attributeAssignValue.getValueString());
//            grouperProvisioningAttributeValue.setDirectAssignment(true);
//            grouperProvisioningAttributeValue.setDoProvision(true);
//            grouperProvisioningAttributeValue.setStemScopeString(Stem.Scope.SUB.name().toLowerCase());
//            
//            //GrouperProvisioningService.saveOrUpdateProvisioningAttributes(grouperProvisioningAttributeValue, stem);
//            System.out.println("Successfully assigned "+attributeAssignValue.getValueString() + " to "+stem.getName());
//          }
//          
//        }
//      }
