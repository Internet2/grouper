...
public class GrouperOktaAuth {
  
  /**
   * @param ddlVersionBean
   * @param database
   */
  public static void createTableOktaAuth(DdlVersionBean ddlVersionBean, Database database) {

    final String tableName = "mock_okta_auth";
