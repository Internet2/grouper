 ...
 * @version $Id: Stem.java,v 1.146.2.1 2008-03-19 18:46:11 mchyzer Exp $
 */
...
`  * String source = ns.getModifySource();
    ...
    throws  GrouperRuntimeException
  {
    try {
      StemDTO _ns = new StemDTO()
        ...
        ;
      _ns.setHibernateVersion( GrouperDAOFactory.getFactory().getStem().createRootStem(_ns) );
      Stem root = new Stem();
      root.setDTO(_ns);
      root.setSession(s);
      return root;
            ...
            InsufficientPrivilegeException
  {
    ...
    try {
      ...
      child.setDTO( 
        _g.setHibernateVersion( GrouperDAOFactory.getFactory().getStem().createChildGroup( this._getDTO(), _g, _m ) ) 
      );
      child.setSession( this.getSession() );
            ...
            InsufficientPrivilegeException
  {
    ...
    try {
      ...
      _ns.setHibernateVersion( GrouperDAOFactory.getFactory().getStem().createChildStem( this._getDTO(), _ns ) );
