...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("grouperClient.jar", 4217426, "edu.internet2.middleware.grouperClient.ClientOperation", "2.2.1");
    ...
    checkJar("subject.jar", 260483, "edu.internet2.middleware.subject.InvalidQueryException", "2.2.1");
