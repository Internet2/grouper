...
public class GrouperCheckConfig {
  ...
  public static void checkJar(String name, Set<Long> sizes, String sampleClassName, String manifestVersion) {
    ...
    if (!Pattern.compile("^activation(-.*)?.jar").matcher(name).matches()) {
...
//      }
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("activation-1.1.1.jar", 69409, "com.sun.activation.registries.LogSupport", "1.8.0_40");
    ...
    checkJar("grouperClient.jar", GrouperUtil.toSet(4341330L, 4404057L), "edu.internet2.middleware.grouperClientExt.com.thoughtworks.xstream.InitializationException", "2.3.1");
