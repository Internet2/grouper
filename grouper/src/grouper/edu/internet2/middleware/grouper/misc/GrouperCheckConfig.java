...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("grouperClient.jar", 2647083, "edu.internet2.middleware.grouperClientExt.com.thoughtworks.xstream.InitializationException", "2.0.0");
    ...
    checkJar("subject.jar", 175950, "edu.internet2.middleware.subject.InvalidQueryException", "2.0.2");
