...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("subject.jar", 183159, "edu.internet2.middleware.subject.InvalidQueryException", "2.1.0");
    checkJar("vt-ldap.jar", 450697, "edu.vt.middleware.ldap.AbstractCli", "3.3.4");
