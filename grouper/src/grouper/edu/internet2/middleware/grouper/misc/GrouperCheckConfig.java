...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("grouperClient.jar", 4217612, "edu.internet2.middleware.grouperClient.ClientOperation", "2.2.2");
    ...
    checkJar("subject.jar", 261463, "edu.internet2.middleware.subject.InvalidQueryException", "2.2.2");
