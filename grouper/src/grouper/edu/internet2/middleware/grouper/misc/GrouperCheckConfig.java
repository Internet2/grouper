...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("activation.jar", 54665, "javax.activation.ActivationDataFlavor", "1.6.0_17");
    ...
    checkJar("subject.jar", 114232, "edu.internet2.middleware.subject.InvalidQueryException", "1.6.0");
