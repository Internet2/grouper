/*
 * @author mchyzer
 * $Id: GrouperCheckConfig.java,v 1.33 2009-10-23 04:11:00 mchyzer Exp $
 */
...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("log4j.jar", 391834, "org.apache.log4j.Appender", "1.2.15");
    ...
    checkJar("subject.jar", 96031, "edu.internet2.middleware.subject.InvalidQueryException", "0.4.6");
