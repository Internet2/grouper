...
//      }
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("ant-1.7.1.jar", 3323026, "org.apache.tools.ant.AntClassLoader", "1.7.1");
    checkJar("antlr-2.7.7.jar", 445288, "antlr.actions.cpp.ActionLexer", "null");
    checkJar("asm-util-3.3.1.jar", 36961, "org.objectweb.asm.util.ASMifiable", "3.3.1");
    checkJar("asm-3.3.1.jar", 43579, "org.objectweb.asm.AnnotationVisitor", "3.3.1");
    checkJar("backport-util-concurrent-3.0.jar", 328268, "edu.emory.mathcs.backport.java.util.AbstractCollection", "3.0");
    checkJar("bsh-2.0b4.jar", 281694, "bsh.BSHFormalComment", "2.0b4 2005-05-23 11:49:20");
    ...
    checkJar("commons-codec-1.3.jar", 46725, "org.apache.commons.codec.BinaryDecoder", "1.3");
    checkJar("commons-collections-3.2.1.jar", 1224771, "org.apache.commons.collections.ArrayStack", "3.2.1");
    checkJar("commons-digester.jar", 384875, "org.apache.commons.digester3.AbstractMethodRule", "3.2");
    checkJar("commons-discovery-0.4.jar", 76685, "org.apache.commons.discovery.ant.ServiceDiscoveryTask", "0.4");
    checkJar("commons-httpclient-3.0.jar", 279383, "org.apache.commons.httpclient.auth.AuthChallengeException", "3.0");
    checkJar("commons-io-1.4.jar", 263589, "org.apache.commons.io.comparator.DefaultFileComparator", "1.4");
    checkJar("commons-jexl.jar", 388170, "org.apache.commons.jexl2.DebugInfo", "2.0.1");
    checkJar("commons-lang-2.6.jar", 651510, "org.apache.commons.lang.ArrayUtils", "2.6");
    checkJar("commons-lang3-3.5.jar", 479881, "org.apache.commons.lang3.builder.ToStringExclude", "3.5");
    checkJar("commons-logging-1.1.1.jar", 131078, "org.apache.commons.logging.impl.AvalonLogger", "1.1.1");
    checkJar("commons-math-1.1.jar", 174535, "org.apache.commons.math.distribution.ExponentialDistributionImpl", "1.1");
    checkJar("cron-parser-core-2.9.jar", 29961, "net.redhogs.cronparser.builder.AbstractDescriptionBuilder", "null");
    checkJar("ddlutils-1.0.jar", 713153, "org.apache.ddlutils.alteration.AddColumnChange", "1.0");
    ...
    checkJar("ezmorph-1.0.6.jar", 86542, "net.sf.ezmorph.array.AbstractArrayMorpher", "1.0.6");
    ...
    checkJar("hibernate-ehcache-5.0.4.Final.jar", 140995, "org.hibernate.cache.ehcache.EhCacheMessageLogger", "5.0.4.Final");
    ...
    checkJar("json-lib-2.3-jdk15.jar", 255813, "net.sf.json.filters.AndPropertyFilter", "2.3");
    checkJar("jsr107cache-1.0.jar", 8302, "net.sf.jsr107cache.Cache", "1.0");
    checkJar("jta.jar", 8374, "javax.transaction.HeuristicCommitException", "1.0.1B");
    checkJar("jug-1.1.2.jar", 19091, "com.ccg.net.ethernet.BadAddressException", "1.1.1");
    checkJar("log4j-1.2.17.jar", 489883, "org.apache.log4j.Appender", "1.2.17");
    ...
    checkJar("quartz-2.2.2.jar", 660381, "org.quartz.Calendar", "null");
    checkJar("slf4j-api-1.6.1.jar", 25496, "org.slf4j.helpers.BasicMarker", "1.6.1");
    checkJar("slf4j-log4j12-1.6.2.jar", 9752, "org.slf4j.impl.Log4jLoggerAdapter", "1.6.2");
    ...
    //all the classes in xpp3_min also exist in smack.jar, so it's hard to check for this
    //checkJar("xpp3_min-1.1.4c.jar", 24979, "org.xmlpull.mxp1.MXParser", "3.1.0");
    checkJar("xstream-1.3.jar", 692061, "com.thoughtworks.xstream.alias.CannotResolveClassException", "1.3");
