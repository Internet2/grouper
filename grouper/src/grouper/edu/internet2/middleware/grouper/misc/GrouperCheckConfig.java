...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("grouperClient.jar", 2641894, "edu.internet2.middleware.grouperClient.ClientOperation", "2.0.2");
    ...
    checkJar("subject.jar", 184228, "edu.internet2.middleware.subject.InvalidQueryException", "2.0.2");
