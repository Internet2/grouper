...
public class GrouperCheckConfig {
  ...
  public static void checkGroups() {
    ...
    try {
      ...
      if (GrouperDeprovisioningJob.deprovisioningEnabled()) {
        ...
        String deprovisioningRootStemName = GrouperDeprovisioningJob.deprovisioningStemName();
        ...
        String deprovisioningTypeDefName = deprovisioningRootStemName + ":" + GrouperDeprovisioningJob.DEPROVISIONING_DEF;
        ...
        if (deprovisioningType == null) {
          deprovisioningType = deprovisioningStem.addChildAttributeDef(GrouperDeprovisioningJob.DEPROVISIONING_DEF, AttributeDefType.type);
        ...
        String deprovisioningAttrDefName = deprovisioningRootStemName + ":" + GrouperDeprovisioningJob.DEPROVISIONING_VALUE_DEF;
        ...
        if (deprovisioningAttrType == null) {
          deprovisioningAttrType = deprovisioningStem.addChildAttributeDef(GrouperDeprovisioningJob.DEPROVISIONING_VALUE_DEF, AttributeDefType.attr);
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_AUTO_CHANGE_LOADER, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_AUTOSELECT_FOR_REMOVAL, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_DIRECT_ASSIGNMENT, 
            "if deprovisioning configuration is directly assigned to the group or folder or inherited from parent", wasInCheckConfig);
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_EMAIL_ADDRESSES, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_MAIL_TO_GROUP, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_SEND_EMAIL, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_SHOW_FOR_REMOVAL, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_DEPROVISION, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_STEM_SCOPE, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_EMAIL_SUBJECT, 
        ...
        checkAttribute(deprovisioningStem, deprovisioningAttrType, GrouperDeprovisioningJob.DEPROVISIONING_EMAIL_BODY, 
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("quartz.jar", 660381, "org.quartz.Calendar", "null");
    ...
    checkJar("vt-ldap.jar", 255330, "edu.vt.middleware.ldap.AbstractCli", "null");
