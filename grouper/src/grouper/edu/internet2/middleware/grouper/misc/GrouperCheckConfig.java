...
public class GrouperCheckConfig {
  ...
  private static void checkGrouperJars() {
    ...
    checkJar("grouperClient.jar", GrouperUtil.toSet(4468322L, 4397537L, 4422891L, 4423489L, 4423587L, 4423679L, 4475423L, 4469727L, 4470134L, 4471310L, 4431078L, 4448499L, 4452443L, 4449157L, 4449953L, 4449940L, 4456413L), "edu.internet2.middleware.grouperClient.ClientOperation", "2.4.0");
