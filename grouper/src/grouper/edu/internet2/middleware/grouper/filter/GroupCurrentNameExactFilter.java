 ...
 * <p/>
 * @author shilen
 * @version $Id: GroupCurrentNameExactFilter.java,v 1.1 2009-03-27 19:32:41 shilen Exp $
 */
public class GroupCurrentNameExactFilter extends BaseQueryFilter {
   ...
   */
  public GroupCurrentNameExactFilter(String name1) {
    this.name = name1;
  }
  ...
  public Set<Group> getResults(GrouperSession s) 
    ...
    Group group = null;
    try {
      group = GroupFinder.findByCurrentName(s, this.name, true);
