...
public class XmlExportAttributeDefNameSet {
  ...
  public static void processXmlFirstPass(final XmlImportMain xmlImportMain) {
    xmlImportMain.getReader().addHandler( "/grouperExport/attributeDefNameSets", 
        new ElementHandler() {
    ...
    xmlImportMain.getReader().addHandler( "/grouperExport/attributeDefNameSets/XmlExportAttributeDefNameSet", 
        new ElementHandler() {
            public void onStart(ElementPath path) {
                // do nothing here...    
            }
