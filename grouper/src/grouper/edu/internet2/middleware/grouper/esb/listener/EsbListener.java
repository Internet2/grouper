...
public class EsbListener {
	...
	/**
	 * 
	 * @param jsonString representation of a populated {@link EsbListenerEvent} class
	 * @param grouperSession initialised grouperSession
	...
	public String processEvent(String jsonString, GrouperSession grouperSession) {
		...
		EsbListenerEvents events = GrouperUtil.jsonConvertFrom(jsonString, EsbListenerEvents.class);
