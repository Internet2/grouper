 ...
 * @version $Id: GroupCreatedBeforeFilter.java,v 1.1.2.1 2005-11-09 23:20:03 blair Exp $
 */
public class GroupCreatedBeforeFilter extends BaseQueryFilter {
  ...
  public GroupCreatedBeforeFilter(Date d, Stem ns) {
    this.d  = d;
    this.ns = ns;
  } // public GroupCreatedBeforeFilter(d, ns)
  ...
  {
    Set candidates  = GroupFinder.findByCreatedBefore(s, this.d);
