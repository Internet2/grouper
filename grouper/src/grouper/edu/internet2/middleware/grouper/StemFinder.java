...
public class StemFinder implements Serializable {
    ...
    public static List findByStemId(java.lang.String stem_id) throws SQLException, HibernateException {
        Session session = HibernateHelper.getSession();
        List finds = session.find("from edu.internet2.middleware.grouper.Stem as stem where stem.stem_id=?", stem_id, Hibernate.STRING);
        return finds;
    }
