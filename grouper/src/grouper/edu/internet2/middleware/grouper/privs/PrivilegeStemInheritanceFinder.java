...
public class PrivilegeStemInheritanceFinder {
   ...
   * @return
   */
  public PrivilegeStemInheritanceFinder assignRunAsRoot(boolean runAsRoot) {
   ...
   */
  public PrivilegeStemInheritanceFinder assignPrivilege(Privilege privilege) {
   ...
   * @return this for chaining
   */
  private PrivilegeStemInheritanceFinder assignPrivilegeHelper(Privilege privilege, String searchFor) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignPrivilegeName(String thePrivilegeName) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignField(Field theField) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignFieldId(String theFieldId) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignFieldName(String theFieldName) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignStem(Stem theStem) {
    this.stem = theStem;
    return this;
  }
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignStemId(String theStemId) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignStemName(String theStemName) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignSubject(Subject theSubject) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignSubjectId(String theSubjectId) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignSubjectIdentifier(String theSubjectIdentifier) {
   ...
   * @return this for chaining
   */
  public PrivilegeStemInheritanceFinder assignSubjectSourceId(String theSubjectSourceId) {
  ...
  public boolean hasAssignedPrivilege() {
    GrouperUtil.assertion(PrivilegeStemInheritanceFinder.this.privilege != null,  "You must pass the privilege to the finder");
  ...
  public Set<Privilege> findAssignedPrivileges() {
    ...
    return (Set<Privilege>) GrouperSession.internal_callbackRootGrouperSession(new GrouperSessionHandler() {
      ...
      public Object callback(GrouperSession grouperSession) throws GrouperSessionException {
        ...
        if (stem == null && !StringUtils.isBlank(PrivilegeStemInheritanceFinder.this.stemId)) {
          stem = StemFinder.findByUuid(GrouperSession.staticGrouperSession(), PrivilegeStemInheritanceFinder.this.stemId, false, new QueryOptions().secondLevelCache(false));
        } 
        if (stem == null && !StringUtils.isBlank(PrivilegeStemInheritanceFinder.this.stemName)) {
          stem = StemFinder.findByName(GrouperSession.staticGrouperSession(), PrivilegeStemInheritanceFinder.this.stemName, false, new QueryOptions().secondLevelCache(false));
        }
        ...
        if (subject == null && !StringUtils.isBlank(subjectId) && !StringUtils.isBlank(subjectSourceId)) {
          subject = SubjectFinder.findByIdAndSource(PrivilegeStemInheritanceFinder.this.subjectId, PrivilegeStemInheritanceFinder.this.subjectSourceId, false);
        }            
        if (subject == null && !StringUtils.isBlank(subjectId) && StringUtils.isBlank(subjectSourceId)) {
          subject = SubjectFinder.findById(PrivilegeStemInheritanceFinder.this.subjectId, false);
        }            
        if (subject == null && !StringUtils.isBlank(subjectIdentifier) && !StringUtils.isBlank(subjectSourceId)) {
          subject = SubjectFinder.findByIdentifierAndSource(PrivilegeStemInheritanceFinder.this.subjectIdentifier, PrivilegeStemInheritanceFinder.this.subjectSourceId, false);
        }
        if (subject == null && !StringUtils.isBlank(subjectIdentifier) && StringUtils.isBlank(subjectSourceId)) {
          subject = SubjectFinder.findByIdentifier(PrivilegeStemInheritanceFinder.this.subjectIdentifier, false);
        }
        ...
        for (Stem stemLocal: stems) {
          ...
          stemRuleDefinitions.addAll(GrouperUtil.nonNull(RuleFinder.findFolderPrivilegeInheritRules(stem)));
        }
