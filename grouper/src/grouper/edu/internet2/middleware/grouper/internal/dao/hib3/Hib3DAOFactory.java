...
public class Hib3DAOFactory extends GrouperDAOFactory {
  ...
  /**
   * @see edu.internet2.middleware.grouper.misc.GrouperDAOFactory#getGrouperPassword()
   */
  @Override
  ...
  /**
   * @see edu.internet2.middleware.grouper.misc.GrouperDAOFactory#getGrouperPasswordRecentlyUsed()
   */
  @Override
