...
public enum RoleHierarchyType {
   ...
   */
  public static RoleHierarchyType valueOfIgnoreCase(String string, boolean exceptionOnNull) {
    return GrouperUtil.enumValueOfIgnoreCase(RoleHierarchyType.class, 
