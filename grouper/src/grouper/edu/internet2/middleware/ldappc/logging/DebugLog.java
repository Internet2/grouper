...
/**
 * Ldappc API debug logging. Contains methods for displaying a log message prefixed by the
 * class name in brackets. The logging levels allowed are info and debug.
 * 
 * 
 * @author Gil Singer.
 */
