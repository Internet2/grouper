...
public final class ErrorLog {
  ...
  /**
   * The Log file created by the log factory for this class. Contains methods for
   * displaying a log message prefixed by the class name in brackets. The logging levels
   * allowed are fatal, error, and warn.
   */
  private static final Log LOG;

  /**
   * flag indicating that one or more fatal errors occurred during execution. This is
