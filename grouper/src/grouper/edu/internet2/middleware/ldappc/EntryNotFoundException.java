 ...
 */
public class EntryNotFoundException extends LdappcException {
  ...
  /**
   * Constructs a new exception with the specified detail message and cause. Note that the
   * detail message associated with cause is not automatically incorporated in this
