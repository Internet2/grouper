...
public class GrouperDaemonOtherJobDataProviderIncrementalSyncConfiguration extends GrouperDaemonConfiguration {
  ...
  public String getPropertyValueThatIdentifiesThisConfig() {
    return GrouperDataProviderIncrementalSyncJob.class.getName();
  }
