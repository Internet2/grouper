...
public class GrouperBoxAuth {

  public GrouperBoxAuth() {
  }
   ...
   * @param database
   */
  public static void createTableBoxAuth(DdlVersionBean ddlVersionBean, Database database) {

    final String tableName = "mock_box_auth";
