...
Run from the GROUPER_HOME directory:
    ...
    % java -cp lib/jdbcSamples/hsqldb-2.3.5.jar org.hsqldb.Server -port 9001 -database.0 file:grouperHSQL -dbname.0 grouper
...
If you want to start the hsql database manager, run this command in a new terminal:
    ...
    % java -cp lib/jdbcSamples/hsqldb-2.3.5.jar org.hsqldb.util.DatabaseManager -url jdbc:hsqldb:hsql://localhost:9001/grouper
