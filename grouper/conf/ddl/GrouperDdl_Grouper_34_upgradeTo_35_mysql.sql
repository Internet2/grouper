...
ALTER TABLE grouper_sync_group
    ADD COLUMN in_grouper VARCHAR(1) NULL;

ALTER TABLE grouper_sync_group
    ADD COLUMN in_grouper_insert_or_exists VARCHAR(1) NULL;

ALTER TABLE grouper_sync_group
    ADD COLUMN in_grouper_start DATETIME;

ALTER TABLE grouper_sync_group
    ADD COLUMN in_grouper_end DATETIME;
