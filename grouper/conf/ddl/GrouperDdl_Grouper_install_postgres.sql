...
create view grouper_sql_dependency_group_v (dependency_type_name, dependency_type_category, dependency_type_internal_id, dependency_internal_id, owner_cache_group_internal_id, owner_group_name,owner_group_id, owner_group_internal_id, owner_group_id_index, owner_field_name, owner_field_type, owner_field_internal_id, depen_cache_group_internal_id, depen_group_name, depen_group_id, depen_group_internal_id, depen_group_id_index, depen_field_name, depen_field_type, depen_field_internal_id) as select gscdt_group.name as dependency_type_name, gscdt_group.dependency_category as dependency_type_category, gscdt_group.internal_id as dependency_type_internal_id, gscd_group.internal_id as dependency_internal_id, gscg_owner.internal_id as owner_cache_group_internal_id, gg_owner.name as owner_group_name, gg_owner.id as owner_group_id, gg_owner.internal_id as owner_group_internal_id, gg_owner.id_index as owner_group_id_index, gf_owner.name as owner_field_name, gf_owner.type as owner_field_type, gf_owner.internal_id as owner_field_internal_id, gscg_dependent.internal_id as depen_cache_group_internal_id, gg_dependent.name as depen_group_name, gg_dependent.id as depen_group_name, gg_dependent.internal_id as depen_group_internal_id, gg_dependent.id_index as depen_group_id_index, gf_dependent.name as depen_field_name, gf_dependent.type as depen_field_type, gf_dependent.internal_id as depen_field_internal_id from  grouper_sql_cache_depend_type gscdt_group, grouper_sql_cache_dependency as gscd_group left join grouper_sql_cache_group as gscg_owner on gscd_group.owner_internal_id = gscg_owner.internal_id left join grouper_groups as gg_owner on gg_owner.internal_id = gscg_owner.group_internal_id left join grouper_fields as gf_owner on gscg_owner.field_internal_id = gf_owner.internal_id  left join grouper_sql_cache_group as gscg_dependent on gscd_group.dependent_internal_id = gscg_dependent.internal_id left join grouper_groups as gg_dependent on gg_dependent.internal_id = gscg_dependent.group_internal_id left join grouper_fields as gf_dependent on gscg_dependent.field_internal_id = gf_dependent.internal_id  where gscdt_group.name in ('mshipHistory_viaAttribute', 'mshipHistory_recentMships','mshipHistory_abac','abac_group')  and gscd_group.dep_type_internal_id = gscdt_group.internal_id ;
