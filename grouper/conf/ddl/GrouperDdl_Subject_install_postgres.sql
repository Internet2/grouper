...
('c08d3e076fdb4c41acdafe5992e5dc4e', 'Subject', 2, to_char(current_timestamp, 'YYYY/MM/DD HH12:MI:SS'), 
to_char(current_timestamp, 'YYYY/MM/DD HH12:MI:SS') || ': upgrade Subject from V1 to V2, ');
commit;
