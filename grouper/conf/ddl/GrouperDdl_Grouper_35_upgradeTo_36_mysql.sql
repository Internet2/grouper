...
DROP INDEX grouper_sync_gr_er_idx ON grouper_sync_group;

DROP INDEX grouper_sync_us_er_idx ON grouper_sync_member;

DROP INDEX grouper_sync_mship_er_idx ON grouper_sync_membership;

ALTER TABLE grouper_sync_group
    ADD COLUMN error_code VARCHAR(3);
