...
--%><%--
  @author Gary Brown.
  @version $Id: addGroupPrivilege-privilege.jsp,v 1.3 2009-09-09 15:10:03 mchyzer Exp $
--%>
...
<em><c:out value="${viewObject.fields.privilegeName}"/></em> <grouper:message key="audit.result.label.to-subject"/> 
<c:choose>
