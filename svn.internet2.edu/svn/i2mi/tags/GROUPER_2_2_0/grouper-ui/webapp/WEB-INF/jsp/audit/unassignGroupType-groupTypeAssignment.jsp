...
--%><%--
  @author Gary Brown.
  @version $Id: unassignGroupType-groupTypeAssignment.jsp,v 1.3 2009-09-09 15:10:03 mchyzer Exp $
...
<em><c:out value="${viewObject.fields.typeName}"/></em> <grouper:message key="audit.result.label.from"/>
<c:choose>
