<%@ include file="../assetsJsp/commonTaglib.jsp"%>
                          ...
                          <tbody>
                            <c:forEach items="${grouperRequestContainer.groupContainer.guiGroups}" 
                              ...
                              <tr>
                                ...
                                <td><a href="#" onclick="dijit.byId('groupCompositeRightFactorComboId').set('displayedValue', '${grouper:escapeJavascript(guiGroup.group.displayName)}'); dijit.byId('groupCompositeRightFactorComboId').set('value', '${guiGroup.group.id}'); return true;" data-dismiss="modal">${grouper:escapeHtml(guiGroup.group.displayExtension)}</a></td>
                              </tr>
                            </c:forEach>
                          </tbody>
                        </table>
                        ...
                        <div class="data-table-bottom clearfix">
                          <grouper:paging2 guiPaging="${grouperRequestContainer.groupContainer.guiPaging}" 
                            formName="rightFactorSearchGroupPagingForm" ajaxFormIds="rightFactorSearchFormId"
                            refreshOperation="../app/UiV2Group.rightGroupFactorSearch" />
                        </div>
