 ...
 * @version $Id: CanOptoutValidator.java,v 1.1 2008-07-21 04:43:58 mchyzer Exp $
 * @since   1.2.0
 */
public class CanOptoutValidator extends GrouperValidator {
  ...
  // @since   1.2.0
  public static CanOptoutValidator validate(Group g, Subject subj, Field f) {
    ...
    else if ( !PrivilegeHelper.canOptout(GrouperSession.staticGrouperSession(), g, subj) ) {
