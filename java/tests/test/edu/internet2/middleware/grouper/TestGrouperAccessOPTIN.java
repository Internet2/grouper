 ...
 * @version $Id: TestGrouperAccessOPTIN.java,v 1.10 2005-12-11 09:36:05 blair Exp $
 */
public class TestGrouperAccessOPTIN extends TestCase {

  // Private Class Constants
  private static final Log        LOG   = LogFactory.getLog(TestGrouperAccessOPTIN.class);
  private static final Privilege  PRIV  = AccessPrivilege.OPTIN;
  ...
  public TestGrouperAccessOPTIN(String name) {
    super(name);
  }
