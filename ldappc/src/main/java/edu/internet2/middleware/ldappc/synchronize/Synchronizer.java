...
public abstract class Synchronizer
{
     ...
     * <b>MUST</b> attribute for <code>objectClass</code>. If
     * <code>objectClass</code> is <code>null</code>, then the attribute is
     * required if <code>attributeName</code> indentifies a <b>MUST</b>
     ...
     * @param objectClass
     *            Name of the object class that supports attrName (this may be
     *            null)
     * @param attributeName
     ...
     * {@link #isAttributeRequired(LdapContext, Name, String, String)} to
     * determine if the attribute is required. If the schema cannot be accessed,
     * the <code>isRequired</code> value is returned rather than throwing an
     * exception.
     * 
     * @param ctx
     *            Ldap Context
     ...
     * @return If the schema can be accessed then <code>true</code> if the
     *         attribute is required, and <code>false</code> otherwise.
     *         Otherwise <code>isRequired</code> is returned.
     * @throws NamingException
     *             thrown if a Naming error occurs
     */
    protected boolean isAttributeRequired(LdapContext ctx, Name dn, String objectClass, String attributeName,
