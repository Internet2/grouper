 ...
 * This class builds the following database structure:
 *
 * testStem1
 *     teststem2
 *         teststem3
...
public class StemProcessorTest extends BaseTestCase
{
    ...
    public void testAddStemsAndGroups() 
    {
        ...
        catch(StemNotFoundException snfe)
        {
            ...
            testStem2 = stemProcessor.addStem(testStem1, "testStem2", "stemTest2 extension display");
            if (testStem2 == null)
            {    
        ...
        testStem3 = addStem(testStem2, "testStem3", "testStem1:testStem2:testStem3" , "stemTest3 extension display");
 /*       
        try
        {
            // If it already exists, use it.
            testStem3 = StemFinder.findByName(grouperSession, "testStem1:testStem2:testStem3");
        }
        catch(StemNotFoundException snfe)
        {
            // Stem does not exist so create it.

            testStem3 = stemProcessor.addStem(testStem1, "testStem3", "stemTest3 extension display");
            if (testStem3 == null)
            {    
...
*/
    ...
    /**
     * 
     * @param baseStem stem the stem is being added to 
     * @param stemExtension stem extension of the added stem
     * @param stemExtensionDisplay stem extension display of the added stem
     * @return the stem created
     */
    public Stem addStem(Stem baseStem, String stemExtension, String stemFullPath, String stemExtensionDisplay  )
    {
        Stem stem = null;
        try
        {
    ...
    public void addGroups() 
    {
        ...
        catch(GroupNotFoundException gnfe)
        {
            ...
            testGroup31 = stemProcessor.addGroup(testStem3,"testGroup31","testGroup31 extension display");
            if (testGroup31 == null)
            {    
        ...
        catch(GroupNotFoundException gnfe)
        {
            ...
            testGroup21 = stemProcessor.addGroup(testStem2,"testGroup21","testGroup21 extension display");
            if (testGroup21 == null)
            {    
