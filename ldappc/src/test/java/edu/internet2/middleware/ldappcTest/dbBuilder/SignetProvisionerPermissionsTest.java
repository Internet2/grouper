...
public class SignetProvisionerPermissionsTest extends BaseTestCase {
    ...
    public void testProvisionPermissions() {
        ...
        /*
         * TODO: replace below with appropriate changes. try { } catch
         * (???NotFoundException gnfe) { ErrorLog.error(this.getClass(),
         * "Permission not found: " + gnfe.getMessage());
    ...
    /**
     * A test of finding a PrivilegedSubject's permission, changing it in
     * Signet, doing the provisioning, verifying that the LDAP directory
     * reflects the change, changing it back and verifying the the LDAP
     * directory values is back to the original. (TODO)
     */
    public void testChangePermission() {
        ...
        try {
            ...
            LdappcConfigurationException ace = new LdappcConfigurationException("Failed to create Signet instance: Signet database may not be running.", sre);
            throw (ace);
        }

        // Uncomment this to display the data accessed below.
        // SignetUtil.displaySubjectPrivileges("local_person", "SD00009");
        ...
        //
        // I can not find methods for changing or deleting values in the Signet
        // database;
        // TODO: finish the rest of this when I figure out how.
        //
