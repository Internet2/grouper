...
/*
 * @author mchyzer
 * $Id: StandardApiClientJsonIndenter.java,v 1.2 2008-06-05 19:34:04 mchyzer Exp $
 */
 ...
 */
public class StandardApiClientJsonIndenter {
  ...
  public String result() {
    ...
    return StandardApiClientUtils.trim(this.result.toString());
  }
  ...
  private void newlineIndent() {
    this.result.append("\n").append(StandardApiClientUtils.repeat("  ", this.currentNumberOfIndents));
  }
   ...
   * indenter
   */
  public StandardApiClientJsonIndenter(String theJson) {
    if (theJson != null) {
      this.json = StandardApiClientUtils.trimToEmpty(theJson);
    }
  }
