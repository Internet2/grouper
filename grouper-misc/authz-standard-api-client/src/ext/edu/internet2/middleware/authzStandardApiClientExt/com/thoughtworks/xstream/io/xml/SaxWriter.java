...
/**
 * A SAX {@link edu.internet2.middleware.authzStandardApiClientExt.org.xml.sax.XMLReader parser} that acts as an XStream
 * {@link edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.io.HierarchicalStreamWriter} to enable direct generation of a
 ...
 * and {@link #parse(edu.internet2.middleware.authzStandardApiClientExt.org.xml.sax.InputSource)}) but relies on a proprietary SAX property
 ...
 * through a chain of {@link edu.internet2.middleware.authzStandardApiClientExt.org.xml.sax.XMLFilter filters} down to the underlying parser
 * object.
 * </p>
...
public final class SaxWriter extends AbstractXmlWriter implements XMLReader {
     ...
     * @see #parse(edu.internet2.middleware.authzStandardApiClientExt.org.xml.sax.InputSource)
     */
     ...
     * @throws SAXException Any SAX exception, possibly wrapping
     *                      another exception.
     * @see edu.internet2.middleware.authzStandardApiClientExt.org.xml.sax.InputSource
     * @see #parse(java.lang.String)
     * @see #setEntityResolver
     * @see #setDTDHandler
     * @see #setContentHandler
