...
package edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging;


import java.lang.reflect.Constructor;
import java.util.Hashtable;

import edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.impl.NoOpLog;
 ...
 *     <code>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.log</code> to the name of the
 *     <code>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.Log</code> implementation class
 *     you want to use.</li>
 ...
 *
 * @author Rod Waldhoff
 * @version $Id: LogSource.java,v 1.1 2008-11-30 10:57:27 mchyzer Exp $
 */
public class LogSource {
    ...
    static {
        ...
        // Is Log4J Available?
        try {
            if (null != Class.forName("edu.internet2.middleware.authzStandardApiClientExt.org.apache.log4j.Logger")) {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.impl.Log4JLogger");
     ...
     * <tt>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.log</tt> property.
     * The value of <tt>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>edu.internet2.middleware.authzStandardApiClientExt.org.apache.commons.logging.log</tt> is not set,
