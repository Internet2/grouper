 ...
 */
package edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.converters.javabean;
...
import edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.io.ExtendedHierarchicalStreamWriterHelper;
...
public class JavaBeanConverter implements Converter {
    ...
    /**
     * @deprecated As of 1.3, use {@link #JavaBeanConverter(Mapper)} and {@link edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.XStream#aliasAttribute(String, String)}
     */
    ...
    /**
     * @deprecated As of 1.2, use {@link #JavaBeanConverter(Mapper)} and {@link edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.XStream#aliasAttribute(String, String)}
     */
