...
import edu.internet2.middleware.authzStandardApiClientExt.com.thoughtworks.xstream.mapper.CGLIBMapper;
...
public class CGLIBEnhancedConverter extends SerializableConverter {
    ...
    public boolean canConvert(Class type) {
      ...
      try {
        Class.forName("edu.internet2.middleware.authzStandardApiClientExt.net.sf.cglib.proxy.Enhancer");
        enhancerExists = true;
      } catch (Throwable e) {
        //this is ok
      }
