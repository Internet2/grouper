...
/*
 * @author mchyzer
 * $Id: StandardApiClientXmlIndenter.java,v 1.1 2008-11-30 10:57:27 mchyzer Exp $
 */
 ...
 */
public class StandardApiClientXmlIndenter {
  ...
  static boolean textTag(String xml, int endTagIndex, String tagName, 
    ...
    if (StandardApiClientUtils.equals(tagName, nextTagName) && isNextCloseTag) {
      return true;
    }
    return false;
  }
   ...
   * indenter
   */
  public StandardApiClientXmlIndenter(String theXml) {
    if (theXml != null) {
      this.xml = StandardApiClientUtils.trimToEmpty(theXml);
    }
  }
