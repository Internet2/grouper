...
public class AsacMeta {
  ...
  public String getWarning() {
    return StandardApiClientUtils.trimToNull(this.resultWarning.toString());
  }
  ...
  public void setWarning(String resultWarnings1) {
    this.resultWarning = StandardApiClientUtils.isBlank(resultWarnings1) ? new StringBuilder() : new StringBuilder(resultWarnings1);
  }
  ...
  public static void main(String[] args) {
    ...
    AsacMeta asacMetaResponse = new AsacMeta();
    ...
    asacMetaResponse = (AsacMeta)StandardApiClientUtils.jsonConvertFrom(json, AsacMeta.class);
    ...
    asacMetaResponse = StandardApiClientUtils.xmlConvertFrom(xml, AsacMeta.class);
