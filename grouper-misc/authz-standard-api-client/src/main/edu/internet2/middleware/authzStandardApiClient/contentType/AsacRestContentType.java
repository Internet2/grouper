 ...
 */
package edu.internet2.middleware.authzStandardApiClient.contentType;

import java.io.File;

import edu.internet2.middleware.authzStandardApiClient.corebeans.AsacResponseBeanBase;
import edu.internet2.middleware.authzStandardApiClient.json.DefaultJsonConverter;
import edu.internet2.middleware.authzStandardApiClient.json.JsonConverter;
import edu.internet2.middleware.authzStandardApiClient.util.JsonIndenter;
...
import edu.internet2.middleware.authzStandardApiClient.util.XmlIndenter;
...
public enum AsacRestContentType {
  ...
  xml("text/xml") {
    ...
    public <T extends AsacResponseBeanBase> T parseString(Class<T> expectedResultClass, String input, StringBuilder warnings) {
      return StandardApiClientUtils.xmlConvertFrom(input, expectedResultClass);
    }
    ...
    public String writeString(Object object) {
      ...
      return XML_HEADER + StandardApiClientUtils.xmlConvertTo(object);
    }
