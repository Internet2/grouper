 ...
 * @author Pete Gieser
 * @since 1.0
 * @version $Id: GcHashCodeBuilder.java 161243 2005-04-14 04:30:28Z ggregory $
 */
public class GcHashCodeBuilder {
    ...
    public GcHashCodeBuilder(int initialNonZeroOddNumber, int multiplierNonZeroOddNumber) {
        if (initialNonZeroOddNumber == 0) {
            throw new IllegalArgumentException("GcHashCodeBuilder requires a non zero initial value");
        }
        if (initialNonZeroOddNumber % 2 == 0) {
            throw new IllegalArgumentException("GcHashCodeBuilder requires an odd initial value");
        }
        if (multiplierNonZeroOddNumber == 0) {
            throw new IllegalArgumentException("GcHashCodeBuilder requires a non zero multiplier");
        }
        if (multiplierNonZeroOddNumber % 2 == 0) {
            throw new IllegalArgumentException("GcHashCodeBuilder requires an odd multiplier");
        }
    ...
    public static int reflectionHashCode(
        ...
        GcHashCodeBuilder builder = new GcHashCodeBuilder(initialNonZeroOddNumber, multiplierNonZeroOddNumber);
     ...
     */
    private static void reflectionAppend(Object object, Class clazz, GcHashCodeBuilder builder, boolean useTransients) {
     ...
     * @return this GcHashCodeBuilder, used to chain calls.
     * @since 2.0
     */
