...
public class IndexHash extends IndexBase {
    private edu.internet2.middleware.grouperInstallerExt.org.tukaani.xz.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new edu.internet2.middleware.grouperInstallerExt.org.tukaani.xz.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new edu.internet2.middleware.grouperInstallerExt.org.tukaani.xz.check.CRC32();
        }
    }
