...
<!-- Start: simpleAttributeUpdate/attributeActionGraphPanel.jsp -->

<div class="section" style="min-width: 900px">

  <grouper:subtitle key="simpleAttributeUpdate.graphActionsSectionHeader" />
  ...
  <div class="sectionBody">
    ...
    <br />
      ...
      <c:forEach items="${attributeUpdateRequestContainer.actionGraphStartingPoints}" var="startingPoint">
        <param name="vertex_${index}" value="${grouper:escapeJavascript(startingPoint)}"/>
        <c:set var="index" value="${index + 1}" />
      </c:forEach>      
      
      <c:set var="index" value="0" />
      <c:forEach items="${attributeUpdateRequestContainer.actionGraphNodesFrom}" var="nodeFrom">
        <c:set var="nodeTo" value="${attributeUpdateRequestContainer.actionGraphNodesTo[index]}" />
...
<!-- End: simpleAttributeUpdate/attributeActionGraphPanel.jsp -->
