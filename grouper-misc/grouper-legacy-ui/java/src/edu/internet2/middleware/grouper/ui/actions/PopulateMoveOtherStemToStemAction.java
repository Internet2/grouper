...
/**
 * @author shilen
 * @version $Id: PopulateMoveOtherStemToStemAction.java,v 1.1 2009-05-08 12:03:37 shilen Exp $
 */
public class PopulateMoveOtherStemToStemAction extends GrouperCapableAction {
  ...
  public ActionForward grouperExecute(ActionMapping mapping, ActionForm form,
    ...
    session.setAttribute("subtitle", "stems.action.move-other-stem-to-stem");
