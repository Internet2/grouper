...
key: GRP-1029
cloud_key: 
onprem_url: https://todos.internet2.edu/browse/GRP-1029
type: New Feature
status: Resolved
resolution: Fixed
priority: Minor
...
created: 2014-08-28T16:02:16.541+0000
updated: 2014-08-28T16:07:35.529+0000
resolved: 2014-08-28T16:07:35.505+0000
...
if you want an endpoint that returns a display name, you could use the following "contacts" endpoint:
 ...
 GET http://somehost.whatever.org/bsp/contacts/urn:uuid:61c8922b-2d23-4fba-9bce-5f1dde6decf7
  ...
  [...]
    ...
    <contacts:emails>
        <email>PersonOne@example.com</email>
        <contacts:email>PersonOne@example.com</contacts:email>
    </contacts:emails>
...
From: Keith Hazelton <hazelton@example.com>
...
To: Keith Hazelton <hazelton@example.com>
Subject: RE: Custom RESTful subject adapter revisited
...
### mchyzer - 2014-08-28T16:07:35.525+0000
