...
key: GRP-235
cloud_key: 
onprem_url: https://todos.internet2.edu/browse/GRP-235
type: New Feature
status: Resolved
resolution: Fixed
priority: Major
...
created: 2009-02-25T06:28:10.983+0000
updated: 2009-10-30T09:45:58.032+0000
resolved: 2009-10-30T09:45:58.034+0000
components: [WS]
fixVersions: [1.5.0]
labels: []
links: []
...
### mchyzer - 2009-10-30T09:45:57.989+0000

This is fixed.  In the UI or WS, you can now do this:

C:\temp\grouperUi\WEB-INF> bin\gsh

or

[user@host /tmp/grouperUi/WEB-INF]$ bin/gsh.sh

Note: you might need to change line endings to unix (e.g. dos2unix), and you might need to chmod to executable: chmod +x bin/gsh.sh
