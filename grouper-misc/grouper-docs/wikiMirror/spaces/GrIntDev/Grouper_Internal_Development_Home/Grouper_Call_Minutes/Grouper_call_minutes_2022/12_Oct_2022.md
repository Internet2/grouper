...
pageId: 48793598
version: 9
lastUpdated: 2026-07-19T00:33:24.297Z
...
- [GRP-4420  
  update grouper client help text: ownerMembershipAny0SubjectSource](https://grouper.atlassian.net/browse/GRP-4420)
- [GRP-4419  
  fix welcome email disabled](https://grouper.atlassian.net/browse/GRP-4419)
- [GRP-4418  
  auto create ws users group if not exists and if configured](https://grouper.atlassian.net/browse/GRP-4418)
- [GRP-4417  
  upgrade xmlsec](https://grouper.atlassian.net/browse/GRP-4417)
- [GRP-4416  
  upgrade wss4j](https://grouper.atlassian.net/browse/GRP-4416)
- [GRP-4415  
  Add option to dump ddlScript output to stdout instead of a file](https://grouper.atlassian.net/browse/GRP-4415)
- [GRP-4414  
  remove jdom and xhtml WS format](https://grouper.atlassian.net/browse/GRP-4414)
- [GRP-4413  
  upgrade commons-fileupload jar](https://grouper.atlassian.net/browse/GRP-4413)
- [GRP-4412  
  do not query ldap_dn attribute in ldap filters](https://grouper.atlassian.net/browse/GRP-4412)
- [GRP-4411  
  Grouper Version Upgrade 2.6.16.2](https://grouper.atlassian.net/browse/GRP-4411)
- [GRP-4410  
  Allow option to not show subject attribute friendly description for names](https://grouper.atlassian.net/browse/GRP-4410)
- [GRP-4409  
  upgrade ldaptive version](https://grouper.atlassian.net/browse/GRP-4409)
- [GRP-4408  
  upgrade org.apache.qpid](https://grouper.atlassian.net/browse/GRP-4408)
- [GRP-4407  
  upgrade googleoauth jars](https://grouper.atlassian.net/browse/GRP-4407)
- [GRP-4406  
  upgrade jackson-dataformat-yaml in ws-scim](https://grouper.atlassian.net/browse/GRP-4406)
- [GRP-4405  
  upgrade commons collections4](https://grouper.atlassian.net/browse/GRP-4405)
- [GRP-4404  
  configure import file or copy paste submit does not do anything...](https://grouper.atlassian.net/browse/GRP-4404)
- [GRP-4403  
  ldap provisioner with default member does not get removed](https://grouper.atlassian.net/browse/GRP-4403)
- [GRP-4402  
  upgrade nimbus to latest due to json-smart library and security scan](https://grouper.atlassian.net/browse/GRP-4402)
- [GRP-4401  
  remove /root/.m2 directory in image](https://grouper.atlassian.net/browse/GRP-4401)
- [GRP-4400  
  loader subjob entries should be capped at 100](https://grouper.atlassian.net/browse/GRP-4400)
- [GRP-4399  
  data fixer daemon should make sure no group has the same name as another alternate name](https://grouper.atlassian.net/browse/GRP-4399)
- [GRP-4398  
  dont allow changing subject source id in subject source wizard](https://grouper.atlassian.net/browse/GRP-4398)
- [GRP-4397  
  dont chown / chmod logs directory in container runtime, just during create](https://grouper.atlassian.net/browse/GRP-4397)
- [GRP-4396  
  ldap loaders should auto enable like sql (on create)](https://grouper.atlassian.net/browse/GRP-4396)
- [GRP-4395  
  lite add member web service should accept subjectIdentifier](https://grouper.atlassian.net/browse/GRP-4395)
- [GRP-4394  
  Allow the UI list of Provisioners to be extended](https://grouper.atlassian.net/browse/GRP-4394)
- [GRP-4393  
  relieve or increase SQL size limit for loader jobs](https://grouper.atlassian.net/browse/GRP-4393)
