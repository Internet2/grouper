...
pageId: 48793328
version: 7
lastUpdated: 2026-07-12T17:02:58.224Z
...
- **[GRP-4352](https://todos.internet2.edu/browse/GRP-4352) loader should add before remove**
...
- [GRP-4350  
  error creating stems](https://todos.internet2.edu/browse/GRP-4350)
- [GRP-4349  
  new local entity screen should have "entity id" not "group id"](https://todos.internet2.edu/browse/GRP-4349)
- [GRP-4348  
  add view for change log temp](https://todos.internet2.edu/browse/GRP-4348)
- [GRP-4347  
  make dinkel ldap for arm processors](https://todos.internet2.edu/browse/GRP-4347)
- [GRP-4346  
  batch group set inserts on object create](https://todos.internet2.edu/browse/GRP-4346)
- [GRP-4345  
  WsGetGroupsLiteResult with no found groups should return empty list](https://todos.internet2.edu/browse/GRP-4345)
- [GRP-4344  
  allow gsh to run on arm processors](https://todos.internet2.edu/browse/GRP-4344)
- [GRP-4343  
  remove outdated groovy-all dependency](https://todos.internet2.edu/browse/GRP-4343)
- [GRP-4342  
  Create GrouperUtil.join() method that works on Collections](https://todos.internet2.edu/browse/GRP-4342)
- [GRP-4341  
  fix table indexes in batch](https://todos.internet2.edu/browse/GRP-4341)
- [GRP-4340  
  allow table index to reserve multiple ids at once](https://todos.internet2.edu/browse/GRP-4340)
- [GRP-4339  
  grouper loader should remove memberships from groups instead of delete groups as an option](https://todos.internet2.edu/browse/GRP-4339)
- [GRP-4338  
  moves in bushy LDAP should create OUs](https://todos.internet2.edu/browse/GRP-4338)
- [GRP-4337  
  GroupFinder builder missing method for assignIdIndexes() and addIdIndex()](https://todos.internet2.edu/browse/GRP-4337)
- [GRP-4336  
  make sure the full provisioner dnOverride-only retrieves the correct groups](https://todos.internet2.edu/browse/GRP-4336)
- [GRP-4335  
  add threads to provisioning](https://todos.internet2.edu/browse/GRP-4335)
- [GRP-4334  
  add oidc to grouper ui](https://todos.internet2.edu/browse/GRP-4334)
- [GRP-4333  
  add grouper_members id_index column](https://todos.internet2.edu/browse/GRP-4333)
- [GRP-4332  
  add id_index to the members table](https://todos.internet2.edu/browse/GRP-4332)
- [GRP-4331  
  provisioning sync member table get source id populated with subject id](https://todos.internet2.edu/browse/GRP-4331)
- [GRP-4330  
  Make ChangeLog Consumer queue/backlog size available via web request](https://todos.internet2.edu/browse/GRP-4330)
- [GRP-4329  
  cannot remove provisionable because override DN is required](https://todos.internet2.edu/browse/GRP-4329)
- [GRP-4328  
  if group.deleteMember WS remove the future enabled date if there](https://todos.internet2.edu/browse/GRP-4328)
- [GRP-4327  
  add container variable GROUPER_LOG](https://todos.internet2.edu/browse/GRP-4327)
