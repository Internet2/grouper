...
pageId: 48793605
version: 7
lastUpdated: 2026-07-19T00:33:24.945Z
...
[GRP-4445  
SQL subject source should show form field for maxPageSize](https://grouper.atlassian.net/browse/GRP-4445)

- [GRP-4444  
  show adds and updates and deletes if there is a long attribute list in provisioning logs](https://grouper.atlassian.net/browse/GRP-4444)
- [GRP-4443  
  run harvard group of names add a large group, takes 20 minutes](https://grouper.atlassian.net/browse/GRP-4443)
- [GRP-4442  
  allow nulls in jexl scripts](https://grouper.atlassian.net/browse/GRP-4442)
- [GRP-4440  
  provisioning translate DNs even if they are not cached](https://grouper.atlassian.net/browse/GRP-4440)
- [GRP-4439  
  Subject source adapters don't limit query to default limit when max results is blank](https://grouper.atlassian.net/browse/GRP-4439)
- [GRP-4438  
  azure error on memberships (null pointer)](https://grouper.atlassian.net/browse/GRP-4438)
- [GRP-4437  
  syncing large group to azure misses some members](https://grouper.atlassian.net/browse/GRP-4437)
- [GRP-4436  
  WS SCIM 2 allow to enable/disable via configuration property](https://grouper.atlassian.net/browse/GRP-4436)
- [GRP-4435  
  WS SCIM 2 to implement PATCH method](https://grouper.atlassian.net/browse/GRP-4435)
- [GRP-4434  
  WS SCIM 2 to implement Bulk updates](https://grouper.atlassian.net/browse/GRP-4434)
- [GRP-4433  
  WS SCIM 2 to implement /Schemas endpoint](https://grouper.atlassian.net/browse/GRP-4433)
- [GRP-4432  
  Rewrite SCIM 2 service to remove dependence on J2EE and TomEE](https://grouper.atlassian.net/browse/GRP-4432)
- [GRP-4431  
  grouper junit should shut down after test after a delay, and cancal shutdown on startup](https://grouper.atlassian.net/browse/GRP-4431)
- [GRP-4430  
  upgrade commons text](https://grouper.atlassian.net/browse/GRP-4430)
- [GRP-4429  
  MembershipSave.save() doesn't return a membership on insert](https://grouper.atlassian.net/browse/GRP-4429)
- [GRP-4428  
  For SQL subject source, add option for search column to wildcard just the suffix](https://grouper.atlassian.net/browse/GRP-4428)
- [GRP-4427  
  adjust mailNickname documentation to note the max length](https://grouper.atlassian.net/browse/GRP-4427)
- [GRP-4426  
  do not symlink /run/secrets](https://grouper.atlassian.net/browse/GRP-4426)
- [GRP-4425  
  provisioning edit provisionable if set provision to No, then it doesnt save (when previously provisionable)](https://grouper.atlassian.net/browse/GRP-4425)
- [GRP-4424  
  translate objects with default values](https://grouper.atlassian.net/browse/GRP-4424)
- [GRP-4423  
  provisioner exception](https://grouper.atlassian.net/browse/GRP-4423)
- [GRP-4422  
  allow other system to remove memberships in provisioning](https://grouper.atlassian.net/browse/GRP-4422)
- [GRP-4421  
  change dockerfile to get java from rpm and not direct install](https://grouper.atlassian.net/browse/GRP-4421)
