...
pageId: 48793379
version: 8
lastUpdated: 2026-07-19T00:33:10.138Z
...
- [GRP-4062](https://grouper.atlassian.net/browse/GRP-4062) Incremental loader full sync check issue
...
- There is a JIRA for Java 11: [https://grouper.atlassian.net/browse/GRP-2046](https://grouper.atlassian.net/browse/GRP-2046)
- 
...
- [GRP-4074](https://grouper.atlassian.net/browse/GRP-4074)
- [Grouper](https://grouper.atlassian.net/browse/GRP)
- [GRP-4075](https://grouper.atlassian.net/browse/GRP-4075) allow configuration in ldap to truncate part of the group name
...
- [GRP-4072  
  Add loader configuration to the OSGI services](https://grouper.atlassian.net/browse/GRP-4072)
- [GRP-4071  
  StemFinder missing addStemName(String) method](https://grouper.atlassian.net/browse/GRP-4071)
- [GRP-4070  
  osgi updates to initialize and register default classes like configs](https://grouper.atlassian.net/browse/GRP-4070)
- [GRP-4069  
  remove loginid from entity provisioner drop down](https://grouper.atlassian.net/browse/GRP-4069)
- [GRP-4068  
  provisioning (non membership) attributes not updated with incremental](https://grouper.atlassian.net/browse/GRP-4068)
- [GRP-4067  
  add daemon to remove old sync log rows](https://grouper.atlassian.net/browse/GRP-4067)
- [GRP-4066  
  group update idindex should add a chnagelog entry](https://grouper.atlassian.net/browse/GRP-4066)
- [GRP-4065  
  log a certain number of DAO errors per provisioning run](https://grouper.atlassian.net/browse/GRP-4065)
- [GRP-4064  
  auto-translate DN for ldap provisioning](https://grouper.atlassian.net/browse/GRP-4064)
- [GRP-4063  
  gsh template add a "warning" output status](https://grouper.atlassian.net/browse/GRP-4063)
- [GRP-4062  
  Incremental loader full sync check issue](https://grouper.atlassian.net/browse/GRP-4062)
- [GRP-4061  
  add provisioning option to delete groups with no members](https://grouper.atlassian.net/browse/GRP-4061)
- [GRP-4060  
  grouper smtp is enabled by default](https://grouper.atlassian.net/browse/GRP-4060)
- [GRP-4059  
  pspng null pointer in log and setup test](https://grouper.atlassian.net/browse/GRP-4059)
- [GRP-4058  
  LDAP loader form missing option to schedule job](https://grouper.atlassian.net/browse/GRP-4058)
- [GRP-4057  
  could not find membership on delete](https://grouper.atlassian.net/browse/GRP-4057)
- [GRP-4056  
  "Export configuration file" only exports DB properties without any indication](https://grouper.atlassian.net/browse/GRP-4056)
- [GRP-4055  
  dont even try to do * in sql sync, it doe](https://grouper.atlassian.net/browse/GRP-4055)
