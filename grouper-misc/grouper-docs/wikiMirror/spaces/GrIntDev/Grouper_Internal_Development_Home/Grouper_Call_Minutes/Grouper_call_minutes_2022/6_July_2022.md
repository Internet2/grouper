...
pageId: 48793576
version: 8
lastUpdated: 2026-07-12T17:03:17.148Z
...
- [GRP-4145  
  provisioning membership foreign key blank gives issues](https://todos.internet2.edu/browse/GRP-4145)
- [GRP-4144  
  provisioning without memberships can cause a null pointer exception](https://todos.internet2.edu/browse/GRP-4144)
- [GRP-4143  
  remove duplicate memberships from provisioning logs](https://todos.internet2.edu/browse/GRP-4143)
- [GRP-4142  
  provisioning remove memberships if the parent object is deleteable but not able to be deleted](https://todos.internet2.edu/browse/GRP-4142)
- [GRP-4141  
  update provisioning target cache on successful insert/update](https://todos.internet2.edu/browse/GRP-4141)
- [GRP-4139  
  dont start felix osgi if not using it](https://todos.internet2.edu/browse/GRP-4139)
- [GRP-4138  
  update libs based on trivy scanner](https://todos.internet2.edu/browse/GRP-4138)
- [GRP-4137  
  error resolving subject attributes. has null subject id and subject identifier](https://todos.internet2.edu/browse/GRP-4137)
- [GRP-4136  
  subjectLinkAttributeValueCache1 does not work](https://todos.internet2.edu/browse/GRP-4136)
- [GRP-4135  
  dn override ldap use case (select all groups should select overridden groups)](https://todos.internet2.edu/browse/GRP-4135)
- [GRP-4134  
  provisioner succeeds when there are errors, should be an error in daemon](https://todos.internet2.edu/browse/GRP-4134)
- [GRP-4133  
  main provisioning screen should show last incremental time, its blank now](https://todos.internet2.edu/browse/GRP-4133)
- [GRP-4132  
  dynamic logging does not work with LogFactory.getLog](https://todos.internet2.edu/browse/GRP-4132)
- [GRP-4131  
  add in debug info for inserts/updates/deletes in sql sync](https://todos.internet2.edu/browse/GRP-4131)
- [GRP-4130  
  add sftp delimited file to SQL job](https://todos.internet2.edu/browse/GRP-4130)
- [GRP-4129  
  mail.smtp.grouperEmailContentType values not supported for "Grouper report" email ( and likely other standard emails)](https://todos.internet2.edu/browse/GRP-4129)
- [GRP-4128  
  password not read correctly for sftp external system](https://todos.internet2.edu/browse/GRP-4128)
- [GRP-4127  
  Remove old copies of UI images (organisation-logo.gif, grouper.gif, infodot.gif)](https://todos.internet2.edu/browse/GRP-4127)
- [GRP-4126  
  Remove old ant project grouper-qs-builder](https://todos.internet2.edu/browse/GRP-4126)
- [GRP-4125  
  Rule membershipAdd does not work for members previously expired](https://todos.internet2.edu/browse/GRP-4125)[https://todos.internet2.edu/browse/GRP-4124](https://todos.internet2.edu/browse/GRP-4124)
