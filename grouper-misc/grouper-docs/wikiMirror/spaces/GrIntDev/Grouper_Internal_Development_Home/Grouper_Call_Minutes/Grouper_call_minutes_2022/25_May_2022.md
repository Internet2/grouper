...
pageId: 48793548
version: 9
lastUpdated: 2026-07-19T00:33:19.588Z
...
[Order by Created](https://grouper.atlassian.net/projects/GRP/issues/GRP-4054?filter=allissues)

- [GRP-4054  
  show english if french is not there](https://grouper.atlassian.net/browse/GRP-4054)
- [GRP-4053  
  attributeName in dijit combo box is one gear, not 3](https://grouper.atlassian.net/browse/GRP-4053)
- [GRP-4052  
  member not found in ui should not error out](https://grouper.atlassian.net/browse/GRP-4052)
- [GRP-4051  
  sql provisioner does not compute the correct matching id when provisioning to a membership table](https://grouper.atlassian.net/browse/GRP-4051)
- [GRP-4050  
  remove this start with read only row if not real start with](https://grouper.atlassian.net/browse/GRP-4050)
- [GRP-4049  
  Trace memberships audit data](https://grouper.atlassian.net/browse/GRP-4049)
- [GRP-4048  
  move morphString to grouper.hibernate.properties and document that it is required](https://grouper.atlassian.net/browse/GRP-4048)
- [GRP-4047  
  allow daemon jobs with underscores](https://grouper.atlassian.net/browse/GRP-4047)
- [GRP-4046  
  zoom duplicate user id](https://grouper.atlassian.net/browse/GRP-4046)
- [GRP-4045  
  grouper should require morph string at start up](https://grouper.atlassian.net/browse/GRP-4045)
- [GRP-4044  
  google provisioning framework should sync the manager role of a group](https://grouper.atlassian.net/browse/GRP-4044)Will tackle for azure or google eventually
- [GRP-4043  
  create buttons not showing up in new menu FIXED](https://grouper.atlassian.net/browse/GRP-4043)
- [GRP-4042  
  change add / replace / remove in group import to be a drop down with more documentation](https://grouper.atlassian.net/browse/GRP-4042)
- THIS CAME UP IN GROUPER TRAINING,
- [GRP-4041  
  add WS labels in UI for object fields](https://grouper.atlassian.net/browse/GRP-4041)
- 
- [GRP-4040  
  StemFinder and GroupFinder findByUuidOrName can't find when name has upper case letters](https://grouper.atlassian.net/browse/GRP-4040)
- [GRP-4039  
  non-Root with folder VIEW and ATTR_READ can't access attributes](https://grouper.atlassian.net/browse/GRP-4039)
- [GRP-4038  
  Changes lost between incremental loader triggering full loader(s)?](https://grouper.atlassian.net/browse/GRP-4038)
- [GRP-4037  
  Recent memberships UI issue with include current members option](https://grouper.atlassian.net/browse/GRP-4037)
- [GRP-4036  
  refactor group search and matching attribute configuration](https://grouper.atlassian.net/browse/GRP-4036)
- [GRP-4035  
  refactor entity search and matching attribute configuration](https://grouper.atlassian.net/browse/GRP-4035)
- [GRP-4034  
  add bit and boolean to sql sync](https://grouper.atlassian.net/browse/GRP-4034)
- [GRP-4033  
  support nvarchar in sql sync](https://grouper.atlassian.net/browse/GRP-4033)
- [GRP-4032  
