...
pageId: 48793384
version: 10
lastUpdated: 2026-07-12T17:03:03.300Z
...
- Chris -Verify Postgres driver version, this is related to [GRP-4322  
  Bump postgresql from 42.4.0 to 42.4.1 in /grouper-parent #189](https://todos.internet2.edu/browse/GRP-4322)
...
- Provisioning issue, delete from Grouper side, and recreate w same name within a week, Grouper gets confused. Important fix   
  [GRP-4303  
  problem deleting and recreating group in azure](https://todos.internet2.edu/browse/GRP-4303)
- [GRP-4316  
  add member web service should remove enabled/disabled dates if already there](https://todos.internet2.edu/browse/GRP-4316)
...
- 
- GRP 4253
- [https://todos.internet2.edu/browse/GRP-4253](https://todos.internet2.edu/browse/GRP-4253)
...
- [GRP-4317  
  container cp -ra does not work on openshift with different user](https://todos.internet2.edu/browse/GRP-4317)
...
- [GRP-4327  
  add container variable GROUPER_LOG_TO_PIPE=true](https://todos.internet2.edu/browse/GRP-4327)
- [GRP-4326  
  flat ldap dn should be there](https://todos.internet2.edu/browse/GRP-4326)
- [GRP-4325  
  provision to ldap, delete from ldap, run full, error](https://todos.internet2.edu/browse/GRP-4325)
- [GRP-4324  
  if you assign provisioning on folder, with policy groups true, it changes the drop down for provisionable to false. also changes the drop down for ONE or SUB...](https://todos.internet2.edu/browse/GRP-4324)
- [GRP-4323  
  added and improved french translations (provisioning) #191](https://todos.internet2.edu/browse/GRP-4323)
- [GRP-4322  
  Bump postgresql from 42.4.0 to 42.4.1 in /grouper-parent #189](https://todos.internet2.edu/browse/GRP-4322)
- [GRP-4321  
  add confirm popup for enabled/disable/delete on daemon jobs...](https://todos.internet2.edu/browse/GRP-4321)
- [GRP-4320  
  membership requirements enforce eligibility by folder](https://todos.internet2.edu/browse/GRP-4320)
- [GRP-4319  
  add target object cache to grouper provisioning](https://todos.internet2.edu/browse/GRP-4319)
- [GRP-4318  
  provisioning logging stores invalid postgres data](https://todos.internet2.edu/browse/GRP-4318)
- [GRP-4317  
  container cp -ra does not work on openshift with different user](https://todos.internet2.edu/browse/GRP-4317)
- [GRP-4316  
  add member web service should remove enabled/disabled dates if already there](https://todos.internet2.edu/browse/GRP-4316)
- [GRP-4315  
  changeLogTempToChangeLog daemon error](https://todos.internet2.edu/browse/GRP-4315)
- [GRP-4314  
  null pointer in provisioning sync integration](https://todos.internet2.edu/browse/GRP-4314)
- [GRP-4313  
  make sure batch sizes in azure provisioner are the max they can be](https://todos.internet2.edu/browse/GRP-4313)
- [GRP-4312  
  add threads to provisioner actions](https://todos.internet2.edu/browse/GRP-4312)
- [GRP-4311  
  escape backslash in config export so it can be imported (try regex)](https://todos.internet2.edu/browse/GRP-4311)
- [GRP-4310  
  Duplicate entry in grouper.textNg.en.us.base.properties](https://todos.internet2.edu/browse/GRP-4310)
- [GRP-4309  
  change default rule api from groupHasNoImmediateEnabledMembership to groupHasNoEnabledMembership](https://todos.internet2.edu/browse/GRP-4309)[GRP-4308  
  append intanceid and type to command log for provisioning](https://todos.internet2.edu/browse/GRP-4308)
- [GRP-4307  
  add createIfNotExist to member finding internal method to make things more clear](https://todos.internet2.edu/browse/GRP-4307)
- [GRP-4306  
  provisioning ui screens should not blow up if there is an invalid config...](https://todos.internet2.edu/browse/GRP-4306)[GRP-4305  
  disabled group breaks bad membership finder](https://todos.internet2.edu/browse/GRP-4305)
- [GRP-4304  
  add servername to apache configs in container](https://todos.internet2.edu/browse/GRP-4304)
- [GRP-4303  
  problem deleting and recreating group in azure](https://todos.internet2.edu/browse/GRP-4303)
- [GRP-4302  
  should be able to pick azure group type metadata from folder](https://todos.internet2.edu/browse/GRP-4302)
- [GRP-4301  
  update shib from image in grouper](https://todos.internet2.edu/browse/GRP-4301)
- [GRP-4300  
  dont log client secret in azure command log](https://todos.internet2.edu/browse/GRP-4300)
- [GRP-4299  
  Provisioning Framework should produce "Audit data" about what it does to external systems.](https://todos.internet2.edu/browse/GRP-4299)[GRP-4298  
  change group/entity clear provisioner button to clear cache buckets only](https://todos.internet2.edu/browse/GRP-4298)
- [GRP-4297  
  add manager role to provisioner to do](https://todos.internet2.edu/browse/GRP-4297)
