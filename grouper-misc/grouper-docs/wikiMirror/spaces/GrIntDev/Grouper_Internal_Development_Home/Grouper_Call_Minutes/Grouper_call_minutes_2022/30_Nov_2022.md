...
pageId: 48793899
version: 10
lastUpdated: 2026-07-12T17:03:42.485Z
...
- [GRP-4518  
  Docker image contains an old, now defunct source of SP packages.](https://todos.internet2.edu/browse/GRP-4518)
- [GRP-4517  
  add group membership filter by subject source](https://todos.internet2.edu/browse/GRP-4517)
- [GRP-4516  
  provisioning selects duplicate entity data from grouper, should be exists and not join](https://todos.internet2.edu/browse/GRP-4516)
- [GRP-4515  
  null pointer on subject name](https://todos.internet2.edu/browse/GRP-4515)
- [GRP-4514  
  check for nulls in provisioning translation scripts in a sensible way](https://todos.internet2.edu/browse/GRP-4514)
- [GRP-4513  
  develop query for jwts which are about to expire (WS)](https://todos.internet2.edu/browse/GRP-4513)
- [GRP-4512  
  add view for jwt creds](https://todos.internet2.edu/browse/GRP-4512)[GRP-4511  
  change notification daemon sql and email template to textarea](https://todos.internet2.edu/browse/GRP-4511)[GRP-4510  
  in ldap groups from attributes, if an extra attribute is a group attribute dont fail since multivalued is ok](https://todos.internet2.edu/browse/GRP-4510)
- [GRP-4509  
  make sure recent memberships job incremental is making all necessary changes](https://todos.internet2.edu/browse/GRP-4509)
- [GRP-4508  
  upgrade ehache for cve on embedded jackson-databind](https://todos.internet2.edu/browse/GRP-4508)
- [GRP-4507  
  allow bushy group to be in base DN](https://todos.internet2.edu/browse/GRP-4507)[GRP-4506  
  add compare methods for attributes in provisioning.](https://todos.internet2.edu/browse/GRP-4506)
- [GRP-4505  
  add example of generic provisioner](https://todos.internet2.edu/browse/GRP-4505)
- [GRP-4504  
  add generic provisioner](https://todos.internet2.edu/browse/GRP-4504)
- [GRP-4503  
  add incremental tests to example WS tests](https://todos.internet2.edu/browse/GRP-4503)
- [GRP-4502  
  provisioning membershipObjects should default to translation if there is a group and entity attribute](https://todos.internet2.edu/browse/GRP-4502)
- [GRP-4501  
  pull configuration defaults up a class in provisioner wizard configuration class](https://todos.internet2.edu/browse/GRP-4501)
- [GRP-4500  
  member index missing for oracle](https://todos.internet2.edu/browse/GRP-4500)
- [GRP-4499  
  upgrade jsoup for cve](https://todos.internet2.edu/browse/GRP-4499)
- [GRP-4498  
  upgrade jackson for cve](https://todos.internet2.edu/browse/GRP-4498)
- [GRP-4497  
  gsh template input should not have a max size of 10,000 chars](https://todos.internet2.edu/browse/GRP-4497)[GRP-4496  
  bad membership finder should remove invalid circular references from composites](https://todos.internet2.edu/browse/GRP-4496)
- [GRP-4495  
  Ability to use different regex for validation of groups/stems/etc per folder](https://todos.internet2.edu/browse/GRP-4495)
- [GRP-4494  
  when logging http command calls do not log azure client secret](https://todos.internet2.edu/browse/GRP-4494)
- [GRP-4493  
  stack loop on french translation](https://todos.internet2.edu/browse/GRP-4493)
- [GRP-4492  
  allow institution specific provisioners](https://todos.internet2.edu/browse/GRP-4492)
- [GRP-4491  
  allow extra config metadata for institution specific wizards](https://todos.internet2.edu/browse/GRP-4491)
- [GRP-4490  
  allow institution specific external systems](https://todos.internet2.edu/browse/GRP-4490)
- [GRP-4489  
  Copy start with configs into provisioner configs in grouper core](https://todos.internet2.edu/browse/GRP-4489)
- [GRP-4488  
  class cast exception on full sync provisioner](https://todos.internet2.edu/browse/GRP-4488)
- [GRP-4487  
  add midpoint provisioning mysql DDL example](https://todos.internet2.edu/browse/GRP-4487)
- [GRP-4486  
  add midpoint provisioning oracle DDL example](https://todos.internet2.edu/browse/GRP-4486)
- [GRP-4485  
  add midpoint provisioning postgres DDL example](https://todos.internet2.edu/browse/GRP-4485)
- [GRP-4484  
  ldaptive upgrade now uses durations for timeLimit and timeout](https://todos.internet2.edu/browse/GRP-4484)
- [GRP-4483  
  grouper_members ddl is too large for some mysql configurations](https://todos.internet2.edu/browse/GRP-4483)
- [GRP-4482  
  add a config in provisioner to replace memberships](https://todos.internet2.edu/browse/GRP-4482)
- [GRP-4481  
  implement insert/delete counts for provisioners which replace](https://todos.internet2.edu/browse/GRP-4481)
- [GRP-4480  
  null pointer in membership delete provisioning configuration](https://todos.internet2.edu/browse/GRP-4480)
- [GRP-4479  
  report viewers group combobox has trouble finding group by system name](https://todos.internet2.edu/browse/GRP-4479)
- [GRP-4478  
  add ability to remove an attribute via wizard. e.g. #3 of 5](https://todos.internet2.edu/browse/GRP-4478)
- [GRP-4477  
  show container version in the status servlet](https://todos.internet2.edu/browse/GRP-4477)
- [GRP-4476  
  add unit test for grouper / midpoint with multi valued metadata](https://todos.internet2.edu/browse/GRP-4476)
- [GRP-4475  
  sql provisioner with multivalued attributes (non membership) has error](https://todos.internet2.edu/browse/GRP-4475)[GRP-4474  
  provisioner for multivalued attributes should tell the DAO insert/delete instead of update](https://todos.internet2.edu/browse/GRP-4474)[GRP-4473  
  add drop down for use separate table for midpoint provisioner groups and entities](https://todos.internet2.edu/browse/GRP-4473)

[GRP-4472  
update provisioning help text for proper translation](https://todos.internet2.edu/browse/GRP-4472)**Wiki Updates since Nov 9, 2022**
