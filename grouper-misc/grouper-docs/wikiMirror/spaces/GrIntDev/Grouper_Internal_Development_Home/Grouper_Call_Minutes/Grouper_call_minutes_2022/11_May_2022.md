...
pageId: 48793355
version: 7
lastUpdated: 2026-07-12T17:03:00.572Z
...
- [GRP-4024  
  Application and policy templates through the API gives error](https://todos.internet2.edu/browse/GRP-4024)
...
[https://todos.internet2.edu/projects/GRP/issues/GRP-4032?filter=allissues](https://todos.internet2.edu/projects/GRP/issues/GRP-4032?filter=allissues)

[GRP-4032](https://todos.internet2.edu/browse/GRP-4032)

[container httpd config error format is after the include](https://todos.internet2.edu/browse/GRP-4032)

- [GRP-4031  
  look at the introspection endpoint for OIDC Connect (e.g. UI authn)](https://todos.internet2.edu/browse/GRP-4031)
- [GRP-4030  
  make a template example to disable daemon jobs](https://todos.internet2.edu/browse/GRP-4030)[GRP-4029  
  clean up grouper image after removing log4j, so its not in the intermediate files on system scans](https://todos.internet2.edu/browse/GRP-4029)
- [GRP-4028  
  ability for container to add ssl client cert for java](https://todos.internet2.edu/browse/GRP-4028)
- [GRP-4027  
  provision to target where user previous existed then is removed (membertoid2)](https://todos.internet2.edu/browse/GRP-4027)
- [GRP-4026  
  ability for container to add ssl anchor cert for OS/java](https://todos.internet2.edu/browse/GRP-4026)
- [GRP-4025  
  Removing recent membership config doesn't remove settings](https://todos.internet2.edu/browse/GRP-4025)
- [GRP-4024  
  Application and policy templates through the API gives error](https://todos.internet2.edu/browse/GRP-4024)
- [GRP-4023  
  in subject source config ldap the only option is subtree scope](https://todos.internet2.edu/browse/GRP-4023)
- [GRP-4022  
  add attestation report widget on home page](https://todos.internet2.edu/browse/GRP-4022)
- [GRP-4021  
  maybe have data owners as drop down and searchable groups by data owner](https://todos.internet2.edu/browse/GRP-4021)[GRP-4020  
  add zoom external system](https://todos.internet2.edu/browse/GRP-4020)
- [GRP-4019  
  refactor matching and search attribute configuration](https://todos.internet2.edu/browse/GRP-4019)
- [GRP-4018  
  provisioning config indent hide/show](https://todos.internet2.edu/browse/GRP-4018)
- [GRP-4017  
  provisioning sql specific column labels and descriptions](https://todos.internet2.edu/browse/GRP-4017)
- [GRP-4016  
  refactor subject link and cache](https://todos.internet2.edu/browse/GRP-4016)
- [GRP-4015  
  move subject link to the entity attribute cache section](https://todos.internet2.edu/browse/GRP-4015)
- [GRP-4014  
  move attribute value cache from entity attribute section to entity2 section](https://todos.internet2.edu/browse/GRP-4014)
- [GRP-4013  
  move attribute value cache from group attribute section to group2 section](https://todos.internet2.edu/browse/GRP-4013)
- [GRP-4012  
  Provisioner UI: Name field is set to drop down when the attribute name is EL-based.](https://todos.internet2.edu/browse/GRP-4012)
- [GRP-4011  
  Grouper UI queries root folder twice](https://todos.internet2.edu/browse/GRP-4011)
