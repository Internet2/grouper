...
pageId: 48793518
version: 11
lastUpdated: 2026-07-19T00:33:15.534Z
...
- [GRP-4541  
  add knobs for retries](https://grouper.atlassian.net/browse/GRP-4541)
- [GRP-4540  
  if not creating entities (or groups) and cant be found, then error should be DNE](https://grouper.atlassian.net/browse/GRP-4540)
- [GRP-4539  
  format errors better](https://grouper.atlassian.net/browse/GRP-4539)
- [GRP-4538  
  incremental provisioner (e.g. azure) when converting to group sync (over 500 members) will get skipped until full sync](https://grouper.atlassian.net/browse/GRP-4538)
- [GRP-4537  
  failure on membership import when session times out](https://grouper.atlassian.net/browse/GRP-4537)
- [GRP-4536  
  add a way to include common functions in GSH templates](https://grouper.atlassian.net/browse/GRP-4536)
- [GRP-4535  
  Deprecation logs for PSU SCIM requests](https://grouper.atlassian.net/browse/GRP-4535)
- [GRP-4534  
  start auto indexes at 1000000 for posix groups](https://grouper.atlassian.net/browse/GRP-4534)
- [GRP-4533  
  add request id and correlation id in WS logging](https://grouper.atlassian.net/browse/GRP-4533)
- [GRP-4532  
  allow sql loader queries to be brought in by config or other way](https://grouper.atlassian.net/browse/GRP-4532)
- [GRP-4531  
  dry run option for loader](https://grouper.atlassian.net/browse/GRP-4531)[GRP-4530  
  Container startup changes file permissions in /opt/grouper/slashRoot if GROUPER_RUN_TOMCAT_NOT_SUPERVISOR=false](https://grouper.atlassian.net/browse/GRP-4530)
- [GRP-4529  
  regex validation does not work for gsh template password inputs](https://grouper.atlassian.net/browse/GRP-4529)
- [GRP-4528  
  SubjectFinder() builder can only find one subject, not multiple](https://grouper.atlassian.net/browse/GRP-4528)
- [GRP-4527  
  using four digits for versions fails in certain circumstances](https://grouper.atlassian.net/browse/GRP-4527)
- [GRP-4526  
  if an exception occurs, check to see if the data is in the right state?](https://grouper.atlassian.net/browse/GRP-4526)
- [GRP-4521  
  Deprecation logs for SOAP requests](https://grouper.atlassian.net/browse/GRP-4521)
- [GRP-4520  
  add subject source restriction in membership requirements (e.g. only people)](https://grouper.atlassian.net/browse/GRP-4520)
- [GRP-4519  
