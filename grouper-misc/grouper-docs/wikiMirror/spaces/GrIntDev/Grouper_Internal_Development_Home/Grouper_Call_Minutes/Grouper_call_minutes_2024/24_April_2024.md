...
pageId: 48794119
version: 10
lastUpdated: 2026-07-19T00:34:05.174Z
...
- [GRP-5407  
  add newlines to gsh template summary toString()](https://grouper.atlassian.net/browse/GRP-5407)
- [GRP-5406  
  show error message in report daemon clear daemon](https://grouper.atlassian.net/browse/GRP-5406)
- [GRP-5405  
  make provisioning expression a textarea](https://grouper.atlassian.net/browse/GRP-5405)
- [GRP-5404  
  provisioning metadata on groups which cannot change, are readonly even if not set](https://grouper.atlassian.net/browse/GRP-5404)
- [GRP-5403  
  cannot edit metadata in provisioning](https://grouper.atlassian.net/browse/GRP-5403)
- [GRP-5402  
  provisioning folder metadata which is marked as not updateable or changeable cannot be entered](https://grouper.atlassian.net/browse/GRP-5402)
- [GRP-5401  
  Visualization with member criteria](https://grouper.atlassian.net/browse/GRP-5401)
