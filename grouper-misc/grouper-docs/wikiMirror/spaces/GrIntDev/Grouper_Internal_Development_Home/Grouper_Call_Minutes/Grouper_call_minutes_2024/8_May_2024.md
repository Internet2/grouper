...
pageId: 48793988
version: 10
lastUpdated: 2026-07-19T00:33:57.081Z
...
- [GRP-5419](https://grouper.atlassian.net/browse/GRP-5419)
- [remove wssec from soap web services](https://grouper.atlassian.net/browse/GRP-5419)
- [GRP-5418](https://grouper.atlassian.net/browse/GRP-5418)
- [add abac row array value any in list](https://grouper.atlassian.net/browse/GRP-5418)
- [GRP-5417](https://grouper.atlassian.net/browse/GRP-5417)
- [ldap pool validate time period by default should be 5 minutes](https://grouper.atlassian.net/browse/GRP-5417)
- [GRP-5416](https://grouper.atlassian.net/browse/GRP-5416)
- [java.lang.OutOfMemoryError: Required array length 2147483639 + 11 is too large](https://grouper.atlassian.net/browse/GRP-5416)
- [GRP-5415](https://grouper.atlassian.net/browse/GRP-5415)
- [allow multiple number attribute values or'ed together for non row assignments](https://grouper.atlassian.net/browse/GRP-5415)
- [GRP-5414](https://grouper.atlassian.net/browse/GRP-5414)
- [allow multiple string attribute values or'ed together for non row assignments](https://grouper.atlassian.net/browse/GRP-5414)

- [GRP-5413](https://grouper.atlassian.net/browse/GRP-5413)
- [add expiration time to ldap pool config in external system](https://grouper.atlassian.net/browse/GRP-5413)

- [GRP-5412](https://grouper.atlassian.net/browse/GRP-5412)
- [WsRestGetSubjectsRequest with multiple subjectIdentifiers specified collapsing SUBJECT_NOT_FOUND results.](https://grouper.atlassian.net/browse/GRP-5412)
- [GRP-5411](https://grouper.atlassian.net/browse/GRP-5411)
- [add slf4j log4j to grouper so logging from ldaptive can happen](https://grouper.atlassian.net/browse/GRP-5411)

- [GRP-5410](https://grouper.atlassian.net/browse/GRP-5410)
- [Improve memory usage for provisioning](https://grouper.atlassian.net/browse/GRP-5410)

- [GRP-5409](https://grouper.atlassian.net/browse/GRP-5409)
- [user can view folder with direct link](https://grouper.atlassian.net/browse/GRP-5409)

- [GRP-5408](https://grouper.atlassian.net/browse/GRP-5408)
- [add "active" to users for aws scim provision](https://grouper.atlassian.net/browse/GRP-5408)
