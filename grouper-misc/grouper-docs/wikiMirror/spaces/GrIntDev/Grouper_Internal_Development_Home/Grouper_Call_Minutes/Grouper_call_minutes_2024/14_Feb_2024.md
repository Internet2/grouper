...
pageId: 48793842
version: 13
lastUpdated: 2026-07-12T17:03:38.102Z
...
- [GRP-5309](https://todos.internet2.edu/browse/GRP-5309)
- [Privileges tab to have priv items in More tab](https://todos.internet2.edu/browse/GRP-5309)
- [GRP-5308](https://todos.internet2.edu/browse/GRP-5308)
- [Provisioning entities not filtering objectClass when Select All Entities is false](https://todos.internet2.edu/browse/GRP-5308)
- [GRP-5307](https://todos.internet2.edu/browse/GRP-5307)
- [Provisioner case sensitive compare wants to change value only differing in case](https://todos.internet2.edu/browse/GRP-5307)
- [GRP-5306](https://todos.internet2.edu/browse/GRP-5306)
- [Provisioners should log DNE errors as SUBJECT_ERROR with unresolvable count](https://todos.internet2.edu/browse/GRP-5306)
- [GRP-5305](https://todos.internet2.edu/browse/GRP-5305)
- [add a provisioning group roles method as poc](https://todos.internet2.edu/browse/GRP-5305)
- [GRP-5304](https://todos.internet2.edu/browse/GRP-5304)
- [do not flush ehcache controller when clearing caches if it is not alive](https://todos.internet2.edu/browse/GRP-5304)
- [GRP-5303](https://todos.internet2.edu/browse/GRP-5303)
- [underlying database connection issues are masked in logs in certain circumstances](https://todos.internet2.edu/browse/GRP-5303)
- [GRP-5302](https://todos.internet2.edu/browse/GRP-5302)
- [add tables and indexes for provisioning dependencies for group roles and user attributes based on groups](https://todos.internet2.edu/browse/GRP-5302)
- [GRP-5301](https://todos.internet2.edu/browse/GRP-5301)
- [Messaging Provisioner add messaging type AWS SQS FIFO](https://todos.internet2.edu/browse/GRP-5301)
- [GRP-5300](https://todos.internet2.edu/browse/GRP-5300)
- [make a ui method to attest groups easily in gsh](https://todos.internet2.edu/browse/GRP-5300)
- [GRP-5299](https://todos.internet2.edu/browse/GRP-5299)
- [add membership requirements and rules to the trace membership](https://todos.internet2.edu/browse/GRP-5299)
- [GRP-5298](https://todos.internet2.edu/browse/GRP-5298)
- [Minor typo on the GSH Template configuration page](https://todos.internet2.edu/browse/GRP-5298)
- [GRP-5297](https://todos.internet2.edu/browse/GRP-5297)
- [duo commands class should have helper method for raw json](https://todos.internet2.edu/browse/GRP-5297)
- [GRP-5296](https://todos.internet2.edu/browse/GRP-5296)
- [add ability for duo to return webauthncredentials and store in loaded table](https://todos.internet2.edu/browse/GRP-5296)
- [GRP-5295](https://todos.internet2.edu/browse/GRP-5295)
- [scheduler check daemon is null](https://todos.internet2.edu/browse/GRP-5295)
