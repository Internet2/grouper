...
pageId: 48794107
version: 10
lastUpdated: 2026-07-19T00:34:03.211Z
...
- [GRP-5303](https://grouper.atlassian.net/browse/GRP-5303) underlying database connection issues are masked in logs in certain circumstances
- [GRP-5304](https://grouper.atlassian.net/browse/GRP-5304) do not flush ehcache controller when clearing caches if it is not alive
...
- [Visualization](https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28548424/Visualization+API) work 
  ...
  - [GRP-5401 Visualization with member criteria](https://grouper.atlassian.net/browse/GRP-5401)
...
- Chris fixed Attestation Group Save issue
  ...
  - [GRP-5396  
    AttestationGroupSave.assignMarkAsAttested() does not work](https://grouper.atlassian.net/browse/GRP-5396)
...
- [GRP-5400  
  Template V2 tests fail: "gshTemplateOwnerType is a required field"](https://grouper.atlassian.net/browse/GRP-5400)
- [GRP-5399  
  SCIM attributes for ServiceNow](https://grouper.atlassian.net/browse/GRP-5399)
- [GRP-5398  
  mysql and oracle have grouper_sql_cache_group disable_on column as non null, should be nullable](https://grouper.atlassian.net/browse/GRP-5398)
- [GRP-5397  
  Veto invalid permission assignments based on attribute name](https://grouper.atlassian.net/browse/GRP-5397)
- [GRP-5396  
  AttestationGroupSave.assignMarkAsAttested() does not work](https://grouper.atlassian.net/browse/GRP-5396)
- [GRP-5395  
  upgrade tomcat to 9.0.87 since 8.5 is EOL](https://grouper.atlassian.net/browse/GRP-5395)
- [GRP-5394  
  error deleting, adding data field](https://grouper.atlassian.net/browse/GRP-5394)
- [GRP-5393  
  when abac data fields / rows / providers are edited in the UI, need to update the database aliases](https://grouper.atlassian.net/browse/GRP-5393)
- [GRP-5392  
  remove uesrSearchFilter from ldap provisioner config](https://grouper.atlassian.net/browse/GRP-5392)
- [GRP-5391  
  Foreign key constraint missing from Oracle upgrade DD](https://grouper.atlassian.net/browse/GRP-5391)[0](https://grouper.atlassian.net/browse/GRP-5370)
