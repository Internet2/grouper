...
pageId: 48793524
version: 9
lastUpdated: 2026-07-12T17:03:13.203Z
...
- JIRA 3666
- [GRP-3666  
  Improvements to provisioning diagnostics for 2.6.1](https://todos.internet2.edu/browse/GRP-3666)
...
- [GRP-3673  
  null group name causes errors on startu](https://todos.internet2.edu/browse/GRP-3673)

- [GRP-3672  
  config key error message](https://todos.internet2.edu/browse/GRP-3672)
- [GRP-3671  
  add Boolean as provisioning attribute type](https://todos.internet2.edu/browse/GRP-3671)
- [GRP-3670  
  jwt self service ui for ws authn](https://todos.internet2.edu/browse/GRP-3670)
- [GRP-3669  
  ddl upgrade does not make columns non - null](https://todos.internet2.edu/browse/GRP-3669)
- [GRP-3668  
  add provisioning troubleshooting zip download](https://todos.internet2.edu/browse/GRP-3668)
- [GRP-3667  
  Loading class `com.mysql.jdbc.Driver'. This is deprecated. The new driver class is `com.mysql.cj.jdbc.Driver'. The driver is automatically registered via the SPI and manual loading of the driver class is generally unnecessary.](https://todos.internet2.edu/browse/GRP-3667)
- [GRP-3666  
  Improvements to provisioning diagnostics for 2.6.1](https://todos.internet2.edu/browse/GRP-3666)
- [GRP-3665  
  validation error on group name does not put group name in stack](https://todos.internet2.edu/browse/GRP-3665)[GRP-3664  
  add subjectIdOrIdentifier to MembershipSave](https://todos.internet2.edu/browse/GRP-3664)
- [GRP-3663  
  cannot save rabbitmq connection, required pathToTrustStore](https://todos.internet2.edu/browse/GRP-3663)
