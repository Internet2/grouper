...
pageId: 48793752
version: 14
lastUpdated: 2026-07-19T00:33:37.064Z
...
[GRP-3084](https://grouper.atlassian.net/browse/GRP-3084)

[ldap provisioner validate string dn configured for groups and entities (if appl)](https://grouper.atlassian.net/browse/GRP-3084)

[GRP-3083](https://grouper.atlassian.net/browse/GRP-3083)

[add mock services framework](https://grouper.atlassian.net/browse/GRP-3083)

[GRP-3082](https://grouper.atlassian.net/browse/GRP-3082)

[add "intermediate" type to grouper](https://grouper.atlassian.net/browse/GRP-3082)

[GRP-3081](https://grouper.atlassian.net/browse/GRP-3081)

[azure provisioner (NG) with no extra libraries](https://grouper.atlassian.net/browse/GRP-3081)

[GRP-3080](https://grouper.atlassian.net/browse/GRP-3080)

[handle group/entity creates where id is assigned by target and is the search attribute](https://grouper.atlassian.net/browse/GRP-3080)

[GRP-3079](https://grouper.atlassian.net/browse/GRP-3079)

[add searchAttribute flag to provisioner attributes/fields](https://grouper.atlassian.net/browse/GRP-3079)

[GRP-3078](https://grouper.atlassian.net/browse/GRP-3078)

[If external system test has multiple errors, UI only shows latest one](https://grouper.atlassian.net/browse/GRP-3078)

[GRP-3077](https://grouper.atlassian.net/browse/GRP-3077)

[When importing members into a group, OK button on the progress screen does not work](https://grouper.atlassian.net/browse/GRP-3077)

[GRP-3076](https://grouper.atlassian.net/browse/GRP-3076)

[add provisioning configuration validation](https://grouper.atlassian.net/browse/GRP-3076)

[GRP-3075](https://grouper.atlassian.net/browse/GRP-3075)

[allow stems, groups, members, memberships to have provisioning metadata](https://grouper.atlassian.net/browse/GRP-3075)

[GRP-3074](https://grouper.atlassian.net/browse/GRP-3074)

[when filling out the provisioning form](https://grouper.atlassian.net/browse/GRP-3074)
