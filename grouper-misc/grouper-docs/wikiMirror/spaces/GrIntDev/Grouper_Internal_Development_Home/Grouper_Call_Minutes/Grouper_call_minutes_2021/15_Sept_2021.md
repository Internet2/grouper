...
pageId: 48793323
version: 7
lastUpdated: 2026-07-19T00:33:04.450Z
...
- [GRP-3603  
  add provisioning target attribute value validation (e.g. for eduPersonEntitlement)](https://grouper.atlassian.net/browse/GRP-3603)
...
- JIRA 3617 [https://grouper.atlassian.net/projects/GRP/issues/GRP-3617?filter=allissues](https://grouper.atlassian.net/projects/GRP/issues/GRP-3617?filter=allissues)
...
- created JIRAs
- [https://grouper.atlassian.net/browse/GRP-3608](https://grouper.atlassian.net/browse/GRP-3608)
...
- [GRP-3597  
  Group.replaceMembers tries to delete effective memberships, throws error](https://grouper.atlassian.net/browse/GRP-3597)
...
- [GRP-3611  
  add trusted JWT authn to WS](https://grouper.atlassian.net/browse/GRP-3611)
- [GRP-3610  
  add oidc WS authn](https://grouper.atlassian.net/browse/GRP-3610)
- [GRP-3609  
  add oidc jars to grouper api](https://grouper.atlassian.net/browse/GRP-3609)
- [GRP-3608  
  Add audit entry of specific subject in group members tab](https://grouper.atlassian.net/browse/GRP-3608)
- [GRP-3607  
  subject not found in rule will cause exception](https://grouper.atlassian.net/browse/GRP-3607)
- [GRP-3606  
  make rules invalid if subjects not found](https://grouper.atlassian.net/browse/GRP-3606)
- [GRP-3605  
  allow entitlements to translate group attributes without select or insert](https://grouper.atlassian.net/browse/GRP-3605)
- [GRP-3604  
  provisioning npe](https://grouper.atlassian.net/browse/GRP-3604)
- [GRP-3603  
  add provisioning target attribute value validation (e.g. for eduPersonEntitlement)](https://grouper.atlassian.net/browse/GRP-3603)
- [GRP-3602  
  provisioning wizard delete if deleted by grouper should hide if delete if not exist in grouper](https://grouper.atlassian.net/browse/GRP-3602)
- [GRP-3601  
  change default of grouper.client.properties grouperClient.saveFailoverStateEverySeconds to -1](https://grouper.atlassian.net/browse/GRP-3601)
- [GRP-3600  
  rusted JWT for web service](https://grouper.atlassian.net/browse/GRP-3600)
- [GRP-3599  
  provisioning UI "insert" was showing incorrect values](https://grouper.atlassian.net/browse/GRP-3599)
- [GRP-3598  
  implement provisioning framework delete types on various object types](https://grouper.atlassian.net/browse/GRP-3598)
- [GRP-3597  
  Group.replaceMembers tries to delete effective memberships, throws error](https://grouper.atlassian.net/browse/GRP-3597)
- [GRP-3596  
  UI attributeName owners filtering should support filtering on the values that are assigned.](https://grouper.atlassian.net/browse/GRP-3596)
- [GRP-3595  
  improve daily report defaults](https://grouper.atlassian.net/browse/GRP-3595)
- [GRP-3594  
  UI filter features should not clear as frequently as they do](https://grouper.atlassian.net/browse/GRP-3594)
- [GRP-3593  
  Ability to do adds first during a loader job (rather than deletes](https://grouper.atlassian.net/browse/GRP-3593)
- [GRP-3592  
  GrouperProvisioningAttributeNames missing methods to retrieve provisioningMetadataJson and provisioningOwnerStemId](https://grouper.atlassian.net/browse/GRP-3592)[GRP-3591  
  config file npe](https://grouper.atlassian.net/browse/GRP-3591)
- [GRP-3590  
  default for provisioning ldap userSearchFilter throws error and needs docs](https://grouper.atlassian.net/browse/GRP-3590)[GRP-3589  
  default for provisioning ldap userSearchAllFilter](https://grouper.atlassian.net/browse/GRP-3589)
- [GRP-3588  
  default for provisioning ldap groupSearchAllFilter](https://grouper.atlassian.net/browse/GRP-3588)
- [GRP-3587  
  incremental entity attribute job gives error retrieving memberships](https://grouper.atlassian.net/browse/GRP-3587)
- [GRP-3586  
  incremental user attributes job gives error, cannot automatically search for entities](https://grouper.atlassian.net/browse/GRP-3586)
- [GRP-3585  
  usdu failing on same subject identifier on unresolvable subjects](https://grouper.atlassian.net/browse/GRP-3585)
- [GRP-3584  
  membership provisioning screen says "in target no" when it is in target](https://grouper.atlassian.net/browse/GRP-3584)
- [GRP-3583  
  memberships insert on ui does not report correctly that grouper inserted membership](https://grouper.atlassian.net/browse/GRP-3583)
- [GRP-3582  
  full sync on group attribute daemon finds updates on all groups, should be no change](https://grouper.atlassian.net/browse/GRP-3582)
- [GRP-3581  
  the setting when assigning if provisionable for "policy groups only" should be a boolean control (radio or drop down)](https://grouper.atlassian.net/browse/GRP-3581)
- [GRP-3580  
  deprovisioning full and incremental daemon should propagate attributes to attributes](https://grouper.atlassian.net/browse/GRP-3580)
- [GRP-3579  
  only show delete types if other types are false](https://grouper.atlassian.net/browse/GRP-3579)
- [GRP-3578  
  ensure "delete level" works correctly for provisioning framework for groups / entities / memberships](https://grouper.atlassian.net/browse/GRP-3578)
- [GRP-3577  
  option to send error message to WS client if stacks are not sent](https://grouper.atlassian.net/browse/GRP-3577)
- [GRP-3576  
  error with database migration utility](https://grouper.atlassian.net/browse/GRP-3576)
