...
pageId: 48793288
version: 27
lastUpdated: 2026-07-19T00:33:01.504Z
...
- AI Shilen - check with ScottK to see if  [GRP-3547 Grouper Provisioning - OpenLDAP support for empty member attribute is solved](https://grouper.atlassian.net/browse/GRP-3547)
...
- AI Chris look at [GRP-3540](https://grouper.atlassian.net/browse/GRP-3540) [quartz cron should be a required field in daemons (or at least sql sync daemon](https://grouper.atlassian.net/browse/GRP-3540)
- AI Chad - find the notes related to HTTP proxies
- AI Chad - do a GSH template and outline steps for Groovy, Using InteliJ
- AI Chad - follow up w Chris Hubing around [GRP-3408](https://grouper.atlassian.net/browse/GRP-3408)
- AI Chad - Add instructions around  [GRP-3346](https://grouper.atlassian.net/browse/GRP-3346)  for upgrade steps wiki for those using the LITE UI
...
- Worked on two Jiras   
  ...
  - [GRP-3346](https://grouper.atlassian.net/browse/GRP-3346)  get rid of tag library errors in TomEE startup
  - [GRP-2852](https://grouper.atlassian.net/browse/GRP-2852)  Make it harder to accidentally delete an attribute name that is in use

- [GRP-3346](https://grouper.atlassian.net/browse/GRP-3346)
- Can't find library
...
- AI Chad Add instructions around  [GRP-3346](https://grouper.atlassian.net/browse/GRP-3346)  for upgrade steps wiki for those using the LITE UI
- [GRP-2852](https://grouper.atlassian.net/browse/GRP-2852)
...
- Worked on 2 jiras  
  ...
  - [GRP-3542  Grouper Provisioning - ldap dao retrieveMembership](https://grouper.atlassian.net/browse/GRP-3542)
  - [GRP-3547  Grouper Provisioning - OpenLDAP support for empty member attribute](https://grouper.atlassian.net/browse/GRP-3547)
- Retrieve memberships
- Not sure if recalc is using this yet or not
- Chris will work on Framework end of this
- [GRP-3547](https://grouper.atlassian.net/browse/GRP-3547)  Empty member attribute
...
[GRP-3559](https://grouper.atlassian.net/browse/GRP-3559) Refactor UI templates to not depend on the UI

[GRP-3558](https://grouper.atlassian.net/browse/GRP-3558)

[group.properties should support configuration.autocreate.<all_object_types>.*](https://grouper.atlassian.net/browse/GRP-3558)

[GRP-3557](https://grouper.atlassian.net/browse/GRP-3557)

[When user not in WS allowed user group, should return 403 Forbidden instead of 500 Internal Server Error](https://grouper.atlassian.net/browse/GRP-3557)

[GRP-3556](https://grouper.atlassian.net/browse/GRP-3556)

[GSH Templates should skip the show/hide checks/logic if the template has no 'Jexl for showEl' on any inputs.](https://grouper.atlassian.net/browse/GRP-3556)   **This is a performance issue**

[GRP-3555](https://grouper.atlassian.net/browse/GRP-3555)

[211.0: New JIRA: jsmith on first login sees “Added jsmith as a member of the Unknown group”. Probably the Ui Preferences group, do this as root so doesn’t show up in user’s recent actions](https://grouper.atlassian.net/browse/GRP-3555)

[GRP-3554](https://grouper.atlassian.net/browse/GRP-3554)

[add ability to export non base config (not just db only)](https://grouper.atlassian.net/browse/GRP-3554)

[GRP-3553](https://grouper.atlassian.net/browse/GRP-3553)

[installer should use https for training](https://grouper.atlassian.net/browse/GRP-3553)

[GRP-3552](https://grouper.atlassian.net/browse/GRP-3552)

[Edit membership page shows form fields even if the user does not have update privs](https://grouper.atlassian.net/browse/GRP-3552)

[GRP-3551](https://grouper.atlassian.net/browse/GRP-3551)

[export a provisioner config](https://grouper.atlassian.net/browse/GRP-3551)

[GRP-3550](https://grouper.atlassian.net/browse/GRP-3550)

[import config should have a text area](https://grouper.atlassian.net/browse/GRP-3550)

Hard to do check..

[GRP-3549](https://grouper.atlassian.net/browse/GRP-3549)

[import config should let you pick the file (not name correctly)](https://grouper.atlassian.net/browse/GRP-3549)

[GRP-3548](https://grouper.atlassian.net/browse/GRP-3548)

[new loader attributes not being created](https://grouper.atlassian.net/browse/GRP-3548)

[GRP-3547](https://grouper.atlassian.net/browse/GRP-3547)

[Grouper Provisioning - OpenLDAP support for empty member attribute](https://grouper.atlassian.net/browse/GRP-3547)

[GRP-3546](https://grouper.atlassian.net/browse/GRP-3546)

[azure provisioner in new provisioning framework](https://grouper.atlassian.net/browse/GRP-3546)
...
[GRP-3545](https://grouper.atlassian.net/browse/GRP-3545)

[gsh transaction issues with built in shortcuts](https://grouper.atlassian.net/browse/GRP-3545)

**Chris will see if called in context of GSH template, if yes, the exception will flow thru**

[GRP-3544](https://grouper.atlassian.net/browse/GRP-3544)

[edu.internet2.middleware.grouper.*Save API's should have constructor/methods to set the session to use for the operation.](https://grouper.atlassian.net/browse/GRP-3544)

[GRP-3543](https://grouper.atlassian.net/browse/GRP-3543)

[GSH Templates: Show in more actions = FALSE and the item is not shown on the Run Template UI list](https://grouper.atlassian.net/browse/GRP-3543)

[GRP-3542](https://grouper.atlassian.net/browse/GRP-3542)

[Grouper Provisioning - ldap dao retrieveMembership](https://grouper.atlassian.net/browse/GRP-3542)

[GRP-3541](https://grouper.atlassian.net/browse/GRP-3541)

[problem removing attributes with hooks](https://grouper.atlassian.net/browse/GRP-3541)

[GRP-3540](https://grouper.atlassian.net/browse/GRP-3540)

[quartz cron should be a required field in daemons (or at least sql sync daemons)](https://grouper.atlassian.net/browse/GRP-3540)

**Chris will look at**

[GRP-3539](https://grouper.atlassian.net/browse/GRP-3539)

[option to not send exception stack back to WS client](https://grouper.atlassian.net/browse/GRP-3539)

[GRP-3538](https://grouper.atlassian.net/browse/GRP-3538)   grouper should auto create WS group [ws.client.user.group.name](http://ws.client.user.group.name)

[GRP-3408](https://grouper.atlassian.net/browse/GRP-3408)
...
- AI Chad will follow up w Chris Hubing around [GRP-3408](https://grouper.atlassian.net/browse/GRP-3408)
