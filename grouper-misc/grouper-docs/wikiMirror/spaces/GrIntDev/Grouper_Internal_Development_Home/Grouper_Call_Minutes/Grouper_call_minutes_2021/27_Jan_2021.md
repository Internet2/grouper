...
pageId: 48793742
version: 11
lastUpdated: 2026-07-19T00:33:34.912Z
...
- [GRP-3099 subject source wizard](https://grouper.atlassian.net/browse/GRP-3099)
...
[GRP-3101](https://grouper.atlassian.net/browse/GRP-3101)

[add entityAttributes provisioning](https://grouper.atlassian.net/browse/GRP-3101) for Grouper training

[GRP-3100](https://grouper.atlassian.net/browse/GRP-3100)

[add translation type and remote "isTranslation"](https://grouper.atlassian.net/browse/GRP-3100)

[GRP-3099](https://grouper.atlassian.net/browse/GRP-3099)

[subject source wizard](https://grouper.atlassian.net/browse/GRP-3099)

[GRP-3098](https://grouper.atlassian.net/browse/GRP-3098)

[Ability to limit provisioning to specific targets by group](https://grouper.atlassian.net/browse/GRP-3098) - vis

[GRP-3097](https://grouper.atlassian.net/browse/GRP-3097)

[Add LDAP to SQL sync tool](https://grouper.atlassian.net/browse/GRP-3097)

[GRP-3096](https://grouper.atlassian.net/browse/GRP-3096)

[notifications in Grouper](https://grouper.atlassian.net/browse/GRP-3096)

[GRP-3095](https://grouper.atlassian.net/browse/GRP-3095)

[UI sorting of LDAP subject search results from a "free form" search](https://grouper.atlassian.net/browse/GRP-3095)

[GRP-3094](https://grouper.atlassian.net/browse/GRP-3094)

[unescape $newline$ when editing configs in ui](https://grouper.atlassian.net/browse/GRP-3094)

[GRP-3093](https://grouper.atlassian.net/browse/GRP-3093)

[sudo should pass env in container](https://grouper.atlassian.net/browse/GRP-3093)

[GRP-3092](https://grouper.atlassian.net/browse/GRP-3092)

[folder privs more actions button blank](https://grouper.atlassian.net/browse/GRP-3092)

[GRP-3091](https://grouper.atlassian.net/browse/GRP-3091)

[Support unlimited count of favorites](https://grouper.atlassian.net/browse/GRP-3091)

[GRP-3090](https://grouper.atlassian.net/browse/GRP-3090)

[Visualization display new provisioner targets](https://grouper.atlassian.net/browse/GRP-3090)

[GRP-3089](https://grouper.atlassian.net/browse/GRP-3089)

[Advanced Membership UI: Ability to create a group based on the filtered result set.](https://grouper.atlassian.net/browse/GRP-3089)

[GRP-3088](https://grouper.atlassian.net/browse/GRP-3088)

[enable grouper container to work with openshift](https://grouper.atlassian.net/browse/GRP-3088)

[GRP-3087](https://grouper.atlassian.net/browse/GRP-3087)

[aws scim provisioner](https://grouper.atlassian.net/browse/GRP-3087)

[GRP-3086](https://grouper.atlassian.net/browse/GRP-3086)

[Grouper Local Auth ( and the GrouperClient )](https://grouper.atlassian.net/browse/GRP-3086)

[GRP-3085](https://grouper.atlassian.net/browse/GRP-3085)

[Is there a way to send an email to the member who was just added to the group?](https://grouper.atlassian.net/browse/GRP-3085)
