...
pageId: 48793747
version: 13
lastUpdated: 2026-07-19T00:33:35.505Z
...
[GRP-3153](https://grouper.atlassian.net/browse/GRP-3153)

[grouper custom templates via gsh](https://grouper.atlassian.net/browse/GRP-3153)

[GRP-3152](https://grouper.atlassian.net/browse/GRP-3152)

[AttributeDef trace privileges links back to subject page, not attributeDef page](https://grouper.atlassian.net/browse/GRP-3152)

[GRP-3151](https://grouper.atlassian.net/browse/GRP-3151)

[sync grouper from another grouper via sql](https://grouper.atlassian.net/browse/GRP-3151)

[GRP-3150](https://grouper.atlassian.net/browse/GRP-3150)

[when looking at provisioner, have edit button (other buttons too?)](https://grouper.atlassian.net/browse/GRP-3150)

[GRP-3149](https://grouper.atlassian.net/browse/GRP-3149)

[entity group link error should not appear](https://grouper.atlassian.net/browse/GRP-3149)

[GRP-3148](https://grouper.atlassian.net/browse/GRP-3148)

[loader queries should be able to start with "with"](https://grouper.atlassian.net/browse/GRP-3148)

[GRP-3147](https://grouper.atlassian.net/browse/GRP-3147)

[allow loader queries to be longer than 4k](https://grouper.atlassian.net/browse/GRP-3147)

[GRP-3146](https://grouper.atlassian.net/browse/GRP-3146)

[Local entities should sort by display extension instead of name by default](https://grouper.atlassian.net/browse/GRP-3146)

[GRP-3145](https://grouper.atlassian.net/browse/GRP-3145)

[MembershipFinder paging/sorting by membership fields](https://grouper.atlassian.net/browse/GRP-3145)

[GRP-3144](https://grouper.atlassian.net/browse/GRP-3144)

[subject wizard ldap search subject scope has one option](https://grouper.atlassian.net/browse/GRP-3144)

[GRP-3143](https://grouper.atlassian.net/browse/GRP-3143)

[provisioning metadata should not be assigned if no metadata there](https://grouper.atlassian.net/browse/GRP-3143)

[GRP-3142](https://grouper.atlassian.net/browse/GRP-3142)

[deleting an incremental daemon doesnt delete that daemon](https://grouper.atlassian.net/browse/GRP-3142)

[GRP-3141](https://grouper.atlassian.net/browse/GRP-3141)

[if you edit a provisioning daemon config it doesnt show the provisioner config id](https://grouper.atlassian.net/browse/GRP-3141)

[GRP-3140](https://grouper.atlassian.net/browse/GRP-3140)

[grouper instrumentation needs to clear out old server names](https://grouper.atlassian.net/browse/GRP-3140)

[GRP-3139](https://grouper.atlassian.net/browse/GRP-3139)

[ability to “run loader diagnostics” processes in a CI/CD pipeline](https://grouper.atlassian.net/browse/GRP-3139)

[GRP-3138](https://grouper.atlassian.net/browse/GRP-3138)

[add filter to usdu ui](https://grouper.atlassian.net/browse/GRP-3138)

[GRP-3137](https://grouper.atlassian.net/browse/GRP-3137)

[attestation email content (body) should be able to include more details about the group and/or memberships](https://grouper.atlassian.net/browse/GRP-3137)

[GRP-3136](https://grouper.atlassian.net/browse/GRP-3136)

[Allow MembershpFinder max pageSize to be configurable](https://grouper.atlassian.net/browse/GRP-3136)

[GRP-3135](https://grouper.atlassian.net/browse/GRP-3135)

[Better error message for users not allowed to login to Grouper UI](https://grouper.atlassian.net/browse/GRP-3135)

[GRP-3134](https://grouper.atlassian.net/browse/GRP-3134)

[client should show usage if no usage file on classpath](https://grouper.atlassian.net/browse/GRP-3134)

[GRP-3133](https://grouper.atlassian.net/browse/GRP-3133)

[Issue with daemon that deletes invalid provisioning assignments](https://grouper.atlassian.net/browse/GRP-3133)

[GRP-3132](https://grouper.atlassian.net/browse/GRP-3132)

[attributes where subject has attribute_read should not see it in the results of the combobox while finding attributes to assign](https://grouper.atlassian.net/browse/GRP-3132)

[GRP-3131](https://grouper.atlassian.net/browse/GRP-3131)

[folder privs should not show inherited attribute read/update if subject has create](https://grouper.atlassian.net/browse/GRP-3131)

[GRP-3130](https://grouper.atlassian.net/browse/GRP-3130)

[provisioningDoProvision should store the provisionerId if provisionable instead of true/false](https://grouper.atlassian.net/browse/GRP-3130)

[GRP-3129](https://grouper.atlassian.net/browse/GRP-3129)

[view provisioning on subject throws grouper session error](https://grouper.atlassian.net/browse/GRP-3129)

[GRP-3128](https://grouper.atlassian.net/browse/GRP-3128)

[add ldap loader filter (with cache)](https://grouper.atlassian.net/browse/GRP-3128)

[GRP-3127](https://grouper.atlassian.net/browse/GRP-3127)

[add ldap loader lookup by dn (with cache)](https://grouper.atlassian.net/browse/GRP-3127)

[GRP-3126](https://grouper.atlassian.net/browse/GRP-3126)

[add ldap loader lookup by dn](https://grouper.atlassian.net/browse/GRP-3126)

[GRP-3125](https://grouper.atlassian.net/browse/GRP-3125)

[config refresh doesnt work, casts to int when should be long](https://grouper.atlassian.net/browse/GRP-3125)

[GRP-3124](https://grouper.atlassian.net/browse/GRP-3124)

[Ability to limit provisioning to specific targets by group for WS](https://grouper.atlassian.net/browse/GRP-3124)

[GRP-3123](https://grouper.atlassian.net/browse/GRP-3123)

[check certain source for registry subjects after adding (default "jdbc")](https://grouper.atlassian.net/browse/GRP-3123)

[GRP-3122](https://grouper.atlassian.net/browse/GRP-3122)

[provisioning incrementals finds multiple subjects with same matching id, but they are the same](https://grouper.atlassian.net/browse/GRP-3122)

[GRP-3121](https://grouper.atlassian.net/browse/GRP-3121)

[Duo integration does not support more than one Duo environment ( sub account nor multiple accounts ) in configuration structure](https://grouper.atlassian.net/browse/GRP-3121)

[GRP-3120](https://grouper.atlassian.net/browse/GRP-3120)

[convertDnToSpecificValue does not unescape commas](https://grouper.atlassian.net/browse/GRP-3120)

[GRP-3119](https://grouper.atlassian.net/browse/GRP-3119)

[daemon configuration for reports](https://grouper.atlassian.net/browse/GRP-3119)

[GRP-3118](https://grouper.atlassian.net/browse/GRP-3118)

[grouperExternal subject source gets removed](https://grouper.atlassian.net/browse/GRP-3118)

[GRP-3117](https://grouper.atlassian.net/browse/GRP-3117)

[grouper sqs should take in region](https://grouper.atlassian.net/browse/GRP-3117)

[GRP-3116](https://grouper.atlassian.net/browse/GRP-3116)

[UI function to union/complement an id list](https://grouper.atlassian.net/browse/GRP-3116)
