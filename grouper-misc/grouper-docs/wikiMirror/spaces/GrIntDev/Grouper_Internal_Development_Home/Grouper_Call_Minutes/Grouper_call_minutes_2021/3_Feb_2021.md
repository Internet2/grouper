...
pageId: 48793345
version: 5
lastUpdated: 2026-07-12T17:02:59.667Z
...
- [GRP-3115  
  LDAP provisioning dao search operation shouldn't return attributes with no values](https://todos.internet2.edu/browse/GRP-3115)
- [GRP-3114  
  add more descriptive labels to subject source wizard](https://todos.internet2.edu/browse/GRP-3114)[GRP-3113  
  dont delete membership attribute values unless they are supposed to be deleted](https://todos.internet2.edu/browse/GRP-3113)[GRP-3112  
  ldap provisioner has "Test" metadata configured, needs to be removed](https://todos.internet2.edu/browse/GRP-3112)[GRP-3111  
  add provisioning metadata to configuratio](https://todos.internet2.edu/browse/GRP-3111)
- [GRP-3110  
  default logging debug on provisioning to debug](https://todos.internet2.edu/browse/GRP-3110)
- [GRP-3109  
  append settings from log4j_additional.properties](https://todos.internet2.edu/browse/GRP-3109)
- [GRP-3108  
  add container variable GROUPER_SSL_USE_STAPLING](https://todos.internet2.edu/browse/GRP-3108)
- [GRP-3107  
  Azure provisioner supply groupName or mailNickName JEXL via Attribute value/string](https://todos.internet2.edu/browse/GRP-3107)
- [GRP-3106  
  Azure provisioner Unified Groups - support additional extended properties](https://todos.internet2.edu/browse/GRP-3106)
- [GRP-3105  
  the membership attribute should get insert/update/select ability from membership objects/configuration](https://todos.internet2.edu/browse/GRP-3105)
- [GRP-3104  
  Misc --> "All daemon jobs" filter option: List all jobs with a failure status between a Start and End date/time value](https://todos.internet2.edu/browse/GRP-3104)
- [GRP-3103  
  provisioning default values to membership attribute NPE](https://todos.internet2.edu/browse/GRP-3103)[GRP-3102  
  add verbose logging and response code checking starting output to container](https://todos.internet2.edu/browse/GRP-3102)
...
[https://todos.internet2.edu/browse/GRP-3102](https://todos.internet2.edu/browse/GRP-3102)
