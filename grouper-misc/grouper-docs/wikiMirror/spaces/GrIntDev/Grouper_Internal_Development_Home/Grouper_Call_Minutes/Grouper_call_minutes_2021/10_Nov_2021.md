...
pageId: 48793529
version: 5
lastUpdated: 2026-07-12T17:03:13.666Z
...
- [GRP-3694  
  GroupFinder/StemFinder with assignScope also finds alternate names, needs option to exclude](https://todos.internet2.edu/browse/GRP-3694)
- [GRP-3693  
  at end of deep report tell user not to run the generated deep script unless told to by grouper project](https://todos.internet2.edu/browse/GRP-3693)
- [GRP-3692  
  grouper ddl print out should be more obvious](https://todos.internet2.edu/browse/GRP-3692)
- [GRP-3691  
  add command debug to sql provisioner](https://todos.internet2.edu/browse/GRP-3691)
- [GRP-3690  
  migrate scim provisioner to use GrouperHttpClient](https://todos.internet2.edu/browse/GRP-3690)
- [GRP-3689  
  fix command logging for http](https://todos.internet2.edu/browse/GRP-3689)
- [GRP-3688  
  duo provisioner does not update description (provisioning framework)](https://todos.internet2.edu/browse/GRP-3688)
- [GRP-3687  
  duo external system secret key should be password field](https://todos.internet2.edu/browse/GRP-3687)
- [GRP-3686  
  convert pspng to provisioning should take four inputs and use the new format](https://todos.internet2.edu/browse/GRP-3686)
- [GRP-3685  
  provisioning logging does not work](https://todos.internet2.edu/browse/GRP-3685)
- [GRP-3684  
  add "test" button for duo external system](https://todos.internet2.edu/browse/GRP-3684)
- [GRP-3683  
  fix low level logging for ldap](https://todos.internet2.edu/browse/GRP-3683)
- [GRP-3682  
  change grouper report daemon names to be the system name not uuid](https://todos.internet2.edu/browse/GRP-3682)
- [GRP-3681  
  allow groupsave to work on idIndex on update (maybe check if not used)](https://todos.internet2.edu/browse/GRP-3681)
- [GRP-3680  
  zoom column is wrong type](https://todos.internet2.edu/browse/GRP-3680)
- [GRP-3678  
  Unused wiki page to delete](https://todos.internet2.edu/browse/GRP-3678)
- [GRP-3677  
  Improvements to provisioning diagnostics for 2.6.5](https://todos.internet2.edu/browse/GRP-3677)
- [GRP-3676  
  Fix config for usdu.delete.ifAfterDays](https://todos.internet2.edu/browse/GRP-3676)
- [GRP-3675  
  add unicode types to client database api](https://todos.internet2.edu/browse/GRP-3675)
- [GRP-3674  
  keep the oidc library in sync with pac4j](https://todos.internet2.edu/browse/GRP-3674)
