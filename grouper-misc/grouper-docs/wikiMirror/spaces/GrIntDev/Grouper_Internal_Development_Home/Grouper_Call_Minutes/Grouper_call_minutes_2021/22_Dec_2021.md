...
pageId: 48793374
version: 9
lastUpdated: 2026-07-12T17:03:02.382Z
...
- [GRP-3738  
  Allow binary secrets to be stored securely in grouper](https://todos.internet2.edu/browse/GRP-3738)
- [GRP-3737  
  Provisioning attribute propagation fails when policy type is assigned to folder](https://todos.internet2.edu/browse/GRP-3737)
- [GRP-3736  
  Remove old command line USDU](https://todos.internet2.edu/browse/GRP-3736)
- [GRP-3735  
  update loader status description](https://todos.internet2.edu/browse/GRP-3735)
- [GRP-3734  
  GSH templates should be available to show on groups (instead of just folders)](https://todos.internet2.edu/browse/GRP-3734)
- [GRP-3733  
  Support IPv6 Source IP address Filtering in configuration UI](https://todos.internet2.edu/browse/GRP-3733)
- [GRP-3732  
  delete old change log consumer entries](https://todos.internet2.edu/browse/GRP-3732)
- [GRP-3731  
  dont check types table after a certain ddl version or upgrade step version](https://todos.internet2.edu/browse/GRP-3731)
- [GRP-3730  
  Deleting a group should delete the attribute assignments for the member object associated with that group](https://todos.internet2.edu/browse/GRP-3730)
- [GRP-3729  
  entitlement does not get removed](https://todos.internet2.edu/browse/GRP-3729)
- [GRP-3728  
  Update USDU to populate subjectResolutionEligible](https://todos.internet2.edu/browse/GRP-3728)
- [GRP-3727  
  GSH Templates: Allow a gsh template to be used by more than one certain folder](https://todos.internet2.edu/browse/GRP-3727)
- [GRP-3726  
  auto ddl message should be adjusted in 2.6](https://todos.internet2.edu/browse/GRP-3726)
- [GRP-3725  
  config page should show container version and grouper version](https://todos.internet2.edu/browse/GRP-3725)
- [GRP-3724  
  log4j security problem](https://todos.internet2.edu/browse/GRP-3724)
- [GRP-3723  
  add GROUPER_JAVA_HOME env variable](https://todos.internet2.edu/browse/GRP-3723)
- [GRP-3722  
  add container option to not put hardcoded java_home in bashrc](https://todos.internet2.edu/browse/GRP-3722)
- [GRP-3721  
  USDU doesn't process members without memberships but with subjectResolutionDeletedDb=F and subjectResolutionResolvableDb=F](https://todos.internet2.edu/browse/GRP-3721)
- [GRP-3720  
  USDU should remove attribute assignments of members marked as deleted](https://todos.internet2.edu/browse/GRP-3720)
- [GRP-3719  
  "groups i manage" should show read/update groups](https://todos.internet2.edu/browse/GRP-3719)
- [GRP-3718  
  SQL provisioning](https://todos.internet2.edu/browse/GRP-3718)
- [GRP-3717  
  improve performance of property configuration in the UI](https://todos.internet2.edu/browse/GRP-3717)
- [GRP-3716  
  refactor container unit tests for new quickstart](https://todos.internet2.edu/browse/GRP-3716)
