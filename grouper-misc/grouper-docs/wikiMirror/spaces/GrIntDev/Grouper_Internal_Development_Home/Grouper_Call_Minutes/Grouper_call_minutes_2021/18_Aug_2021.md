...
pageId: 48793498
version: 5
lastUpdated: 2026-07-12T17:03:10.815Z
...
[GRP-3570](https://todos.internet2.edu/browse/GRP-3570)

[deprovisioning looks at enabled and disabled memberships](https://todos.internet2.edu/browse/GRP-3570)

[GRP-3569](https://todos.internet2.edu/browse/GRP-3569)

[MembershipFinder should have assignEnabled(true) in API calls that expect enabled memberships](https://todos.internet2.edu/browse/GRP-3569)

[GRP-3568](https://todos.internet2.edu/browse/GRP-3568)

[Subject diagnostics search fields remove default values "someSubjectId" etc.](https://todos.internet2.edu/browse/GRP-3568)

[GRP-3567](https://todos.internet2.edu/browse/GRP-3567)

[Log INFO->DEBUG or remove: SessionInitialiser "resources/grouper/ui-permissions.xml not found. Default permissions apply."](https://todos.internet2.edu/browse/GRP-3567)

[GRP-3566](https://todos.internet2.edu/browse/GRP-3566)

[When user not in WS allowed user group, error message states the policy group is "media.properties penn.uiGroup"](https://todos.internet2.edu/browse/GRP-3566)

[GRP-3565](https://todos.internet2.edu/browse/GRP-3565)

[gsh templates should be able to use attributes for if run or who runs](https://todos.internet2.edu/browse/GRP-3565)

[GRP-3564](https://todos.internet2.edu/browse/GRP-3564)

[implement backend for "LDAP to SQL sync daemon"](https://todos.internet2.edu/browse/GRP-3564)

[GRP-3563](https://todos.internet2.edu/browse/GRP-3563)

[Group DN override does not work with "flat" naming](https://todos.internet2.edu/browse/GRP-3563)

[GRP-3562](https://todos.internet2.edu/browse/GRP-3562)

[Container stop/start corrupts ENV variables containing dollar sign ($)](https://todos.internet2.edu/browse/GRP-3562)

[GRP-3561](https://todos.internet2.edu/browse/GRP-3561)

[Query for grouper_sync_membership doesn't use index](https://todos.internet2.edu/browse/GRP-3561)

[GRP-3560](https://todos.internet2.edu/browse/GRP-3560)

[Re-enable grouperProvisioningDaemon](https://todos.internet2.edu/browse/GRP-3560)

[GRP-3559](https://todos.internet2.edu/browse/GRP-3559)

[Refactor UI templates to not dep](https://todos.internet2.edu/browse/GRP-3559)
