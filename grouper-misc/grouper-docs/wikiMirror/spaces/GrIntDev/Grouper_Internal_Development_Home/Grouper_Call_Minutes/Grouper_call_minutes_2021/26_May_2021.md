...
pageId: 48793882
version: 9
lastUpdated: 2026-07-19T00:33:46.770Z
...
- AI Chris will fix [GRP-3476](https://grouper.atlassian.net/browse/GRP-3476)
...
[GRP-3476](https://grouper.atlassian.net/browse/GRP-3476)

[gsh template outputs null CHRIS WILL WORK ON THIS](https://grouper.atlassian.net/browse/GRP-3476)

[GRP-3475](https://grouper.atlassian.net/browse/GRP-3475)

[Error viewing provisioning details on group when restricting using regex or policy groups](https://grouper.atlassian.net/browse/GRP-3475)

[GRP-3474](https://grouper.atlassian.net/browse/GRP-3474)

[add textarea to template input choice](https://grouper.atlassian.net/browse/GRP-3474)

[GRP-3473](https://grouper.atlassian.net/browse/GRP-3473)

[do not print exceptions in sync objects](https://grouper.atlassian.net/browse/GRP-3473)

[GRP-3472](https://grouper.atlassian.net/browse/GRP-3472)

[provisioning translation should retrieve from link data is not translated from Grouper](https://grouper.atlassian.net/browse/GRP-3472)

[GRP-3471](https://grouper.atlassian.net/browse/GRP-3471)

[allow a provisioner to convert field and attribute nulls to blank](https://grouper.atlassian.net/browse/GRP-3471)

[GRP-3470](https://grouper.atlassian.net/browse/GRP-3470)

[provisioning incremental group sync should cause messages sent before group sync started to be ignored](https://grouper.atlassian.net/browse/GRP-3470)

[GRP-3469](https://grouper.atlassian.net/browse/GRP-3469)

[grouperText : duplicate key](https://grouper.atlassian.net/browse/GRP-3469)

[GRP-3468](https://grouper.atlassian.net/browse/GRP-3468)

[templates can cause error showing folder](https://grouper.atlassian.net/browse/GRP-3468)

[GRP-3467](https://grouper.atlassian.net/browse/GRP-3467)

[alternative status url that is outside of the authenticated path](https://grouper.atlassian.net/browse/GRP-3467)

[GRP-3465](https://grouper.atlassian.net/browse/GRP-3465)

[provisioning mock server in unit tests](https://grouper.atlassian.net/browse/GRP-3465)

[GRP-3464](https://grouper.atlassian.net/browse/GRP-3464)

[PSP-NG should allow the null DN for attributes with DN syntax](https://grouper.atlassian.net/browse/GRP-3464)

[GRP-3463](https://grouper.atlassian.net/browse/GRP-3463)

[Stem should have been created, and was, but still: Problem find stem by name: 'basis:people:roster:class:term-2218:phys:222'](https://grouper.atlassian.net/browse/GRP-3463)

[GRP-3462](https://grouper.atlassian.net/browse/GRP-3462)

[allProvisionedValuesPrefix not stored correctly in database](https://grouper.atlassian.net/browse/GRP-3462)

[GRP-3461](https://grouper.atlassian.net/browse/GRP-3461)

[remove unneeded csrfguard configs](https://grouper.atlassian.net/browse/GRP-3461)

[GRP-3460](https://grouper.atlassian.net/browse/GRP-3460)

[a callback grouper session block, that starts a session, will not be found in static grouper session](https://grouper.atlassian.net/browse/GRP-3460)

[GRP-3459](https://grouper.atlassian.net/browse/GRP-3459)

[running template as root (from non root user), is not working as expected](https://grouper.atlassian.net/browse/GRP-3459)
