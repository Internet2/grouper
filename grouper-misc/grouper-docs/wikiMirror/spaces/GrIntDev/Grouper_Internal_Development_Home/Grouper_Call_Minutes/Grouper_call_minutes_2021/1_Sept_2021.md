...
pageId: 48793318
version: 7
lastUpdated: 2026-07-12T17:02:57.246Z
...
- [GRP-3576  
  error with database migration utility](https://todos.internet2.edu/browse/GRP-3576)[GRP-3575  
  daemons should not show error on daemon screen if they have the schedule: 59 59 23 31 12 ? 2099](https://todos.internet2.edu/browse/GRP-3575)

- [GRP-3574  
  add generic performance monitoring into Grouper](https://todos.internet2.edu/browse/GRP-3574)
- [GRP-3573  
  SFTP / CSV report not honoring removeUnderscoresAndCapitalizeHeaders](https://todos.internet2.edu/browse/GRP-3573)[GRP-3572  
  SFTP: Add proxy support to the connection](https://todos.internet2.edu/browse/GRP-3572)[GRP-3571  
  Grouper Provisioning - ldap dao should throw exceptions if there are update errors](https://todos.internet2.edu/browse/GRP-3571)
