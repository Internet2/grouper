...
pageId: 48793790
version: 8
lastUpdated: 2026-07-19T00:33:40.552Z
...
- [GRP-3496  
  customui azure group id should not be required](https://grouper.atlassian.net/browse/GRP-3496)
- [GRP-3495  
  custom ui should support 100 configs (not 50)](https://grouper.atlassian.net/browse/GRP-3495)
- [GRP-3494  
  error while accessing loader screen as non sysadmin](https://grouper.atlassian.net/browse/GRP-3494)[GRP-3493  
  auto-create loader viewer and editor groups](https://grouper.atlassian.net/browse/GRP-3493)
- [GRP-3492  
  alphabetize goruper loader menu](https://grouper.atlassian.net/browse/GRP-3492)
- [GRP-3491  
  log sql statement example and adjustment](https://grouper.atlassian.net/browse/GRP-3491)
- [GRP-3490  
  pspng config in default is not correct](https://grouper.atlassian.net/browse/GRP-3490)
- [GRP-3489  
  status url should work if logged in as some level of admin (not check source IP).](https://grouper.atlassian.net/browse/GRP-3489)
- [GRP-3488  
  Loader Job Group Display Name not updated](https://grouper.atlassian.net/browse/GRP-3488)
- [GRP-3487  
  NPE with grouperProvisioningOutput](https://grouper.atlassian.net/browse/GRP-3487)
- [GRP-3486  
  Grouper Provisioning - non-provisionable groups recreated when not configured to delete](https://grouper.atlassian.net/browse/GRP-3486)
- [GRP-3485  
  Script from gsh export fail with dollar in attribute value](https://grouper.atlassian.net/browse/GRP-3485)
- [GRP-3484  
  grouper will not start with no db tables](https://grouper.atlassian.net/browse/GRP-3484)
- [GRP-3483  
  add option when converting custom ui attributes to config to not delete old attributes](https://grouper.atlassian.net/browse/GRP-3483)
- [GRP-3482  
  fix DN override UI label and description](https://grouper.atlassian.net/browse/GRP-3482)
- [GRP-3481  
  null pointer on gc sync object when provisioning groups](https://grouper.atlassian.net/browse/GRP-3481).   
  [GRP-3480  
  subject source should be at top of provisioning screen](https://grouper.atlassian.net/browse/GRP-3480)
- [GRP-3479  
  removing config gives wrong history timestamp](https://grouper.atlassian.net/browse/GRP-3479)
- [GRP-3478  
  grouper has issues starting, maybe not running as root session?](https://grouper.atlassian.net/browse/GRP-3478)
- [GRP-3477  
  Bump duo client library from 0.2.1 -> 0.3.0](https://grouper.atlassian.net/browse/GRP-3477)
