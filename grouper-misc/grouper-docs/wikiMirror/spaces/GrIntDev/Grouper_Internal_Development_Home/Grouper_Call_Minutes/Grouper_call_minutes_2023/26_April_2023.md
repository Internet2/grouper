...
pageId: 48793641
version: 15
lastUpdated: 2026-07-19T00:33:28.214Z
...
- [GRP-4720](https://grouper.atlassian.net/browse/GRP-4720) [external system has two 'box' in drop down, do we need to remove old box external system? are they the same?](https://grouper.atlassian.net/browse/GRP-4720)

- Worked on [GRP-4721  
  in box provisioning, if not making changes to entities, then "name" attribute should not be required](https://grouper.atlassian.net/browse/GRP-4721)
- Worked on [GRP-4722  
  translation continue expression should just assign null, not fail](https://grouper.atlassian.net/browse/GRP-4722)
...
- [GRP-4722  
  translation continue expression should just assign null, not fail](https://grouper.atlassian.net/browse/GRP-4722) - VIVEK
- [GRP-4721  
  in box provisioning, if not making changes to entities, then "name" attribute should not be required](https://grouper.atlassian.net/browse/GRP-4721)
- VIVEK  
    
  [GRP-4720  
  external system has two 'box' in drop down, do we need to remove old box external system? are they the same?](https://grouper.atlassian.net/browse/GRP-4720)VIVEK
- [GRP-4719  
  servlet api is not in gsh classpath after tomcat switch](https://grouper.atlassian.net/browse/GRP-4719)
- [GRP-4718  
  add filter term in box provisioner to retrieve an individual user or group](https://grouper.atlassian.net/browse/GRP-4718)
- [GRP-4717  
  forbid base dn in v5 in external system and ldaptive config](https://grouper.atlassian.net/browse/GRP-4717)This will make things faster for BOX
- [GRP-4716  
  ldap provisioning, if user dn is search attribute, then require rdn](https://grouper.atlassian.net/browse/GRP-4716)
- [GRP-4715  
  require user base dn in provisioning in certain circumstances](https://grouper.atlassian.net/browse/GRP-4715)
- [GRP-4714  
  provisioning matching ids blank causes error](https://grouper.atlassian.net/browse/GRP-4714)
- [GRP-4713  
  usdu should fail if max unresolvables is hit](https://grouper.atlassian.net/browse/GRP-4713)
- [GRP-4712  
  gsh daemon job can't run more than once](https://grouper.atlassian.net/browse/GRP-4712)
- Chad closed this one
- [GRP-4711  
  in provisioning metadata, if boolean has default value, just check that radio, dont add "default" option](https://grouper.atlassian.net/browse/GRP-4711)
- [GRP-4710  
  document stem move and group move in table at top of gsh page](https://grouper.atlassian.net/browse/GRP-4710)
- [GRP-4709  
  add this provisioning jexl script example in the jexl editor](https://grouper.atlassian.net/browse/GRP-4709)
- [GRP-4708  
  Provisioning - ldap starts with - groupAttributes without membership DN shouldnt assume subjectId as membership value](https://grouper.atlassian.net/browse/GRP-4708)
- [GRP-4707  
  provisioning issue with start with due to bad build](https://grouper.atlassian.net/browse/GRP-4707)
- [GRP-4706  
  millis load data is off for SFTP to SQL job](https://grouper.atlassian.net/browse/GRP-4706)
- [GRP-4705  
  allow HTML template attestation emails where list of groups can be in arbitrary location](https://grouper.atlassian.net/browse/GRP-4705)
- [GRP-4703  
  improve messaging provisioning 'start with'](https://grouper.atlassian.net/browse/GRP-4703)
- [GRP-4702  
  improve google provisioning 'start with'](https://grouper.atlassian.net/browse/GRP-4702)
- [GRP-4701  
  improve box provisioning 'start with'](https://grouper.atlassian.net/browse/GRP-4701)
- [GRP-4700  
  move messaging sqs, activemq, rabbitmq into grouper core](https://grouper.atlassian.net/browse/GRP-4700)
- [GRP-4699  
  Provisioning - ldap - missing overall description for ldap provisioner](https://grouper.atlassian.net/browse/GRP-4699)
- [GRP-4698  
  Provisioning - ldap - diagnostics doesn't work with entityAttributes](https://grouper.atlassian.net/browse/GRP-4698)
- [GRP-4697  
  End of life OpenSAML jars in libWs folder](https://grouper.atlassian.net/browse/GRP-4697)

[GRP-4696  
Loader jobs summary page shows count -1 if there are any subject problems](https://grouper.atlassian.net/browse/GRP-4696)
