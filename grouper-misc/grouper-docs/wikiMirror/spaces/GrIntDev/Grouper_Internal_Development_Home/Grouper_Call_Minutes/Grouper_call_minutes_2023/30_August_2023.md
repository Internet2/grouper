...
pageId: 48793671
version: 15
lastUpdated: 2026-07-19T00:33:30.888Z
...
- [7 Jiras](https://grouper.atlassian.net/issues/?jql=project%20%3D%20GRP%20AND%20status%20in%20(Resolved%2C%20Closed%2C%20%22Ready%20for%20Release%22)%20AND%20fixVersion%20%3D%204.5.5%20ORDER%20BY%20key%20DESC)
- [In some cases users cannot see folders on UI they have access to (inherited privileges on folders causes this)](https://grouper.atlassian.net/browse/GRP-4904)
- [AWS SCIM provisioning is broken](https://grouper.atlassian.net/browse/GRP-4906)
- [Cannot create group if inherited privileges are not configured correctly](https://grouper.atlassian.net/browse/GRP-4907)
- [Can't provision root stem due to infinite loop](https://grouper.atlassian.net/browse/GRP-4908)
- [Allow change log consumers to specify number of records to process (default 1000) in daemon edit screen](https://grouper.atlassian.net/browse/GRP-4909)
...
- [GRP-4900  
  scim paging should increment startIndex by number of records received (not page size in case server doesnt support it)](https://grouper.atlassian.net/browse/GRP-4900)

Changelog temp issues

- [GRP-4924](https://grouper.atlassian.net/browse/GRP-4924)
...
[****](https://grouper.atlassian.net/projects/GRP/issues/GRP-4921?filter=allissues)[GRP-4921  
google pause after creation time from 10s to 15s since lag in google](https://grouper.atlassian.net/browse/GRP-4921)

- - [GRP-4882  
    TIER instrumentation](https://grouper.atlassian.net/browse/GRP-4882)
