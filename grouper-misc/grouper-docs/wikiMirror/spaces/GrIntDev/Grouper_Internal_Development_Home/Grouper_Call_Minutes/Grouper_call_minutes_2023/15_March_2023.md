...
pageId: 48793366
version: 6
lastUpdated: 2026-07-12T17:03:01.510Z
...
- [GRP-4631  
  do not match or search on membership attribute](https://todos.internet2.edu/browse/GRP-4631)
- [GRP-4630  
  in provisioning do not allow caching of membership attribute](https://todos.internet2.edu/browse/GRP-4630)
- [GRP-4629  
  validation on rabbitmq when using EL](https://todos.internet2.edu/browse/GRP-4629)
- [GRP-4628  
  allow owners for teams groups in azure provisioning](https://todos.internet2.edu/browse/GRP-4628)
- [GRP-4627  
  null pointer in GrouperProvisioningCompare.compareTargetEntities](https://todos.internet2.edu/browse/GRP-4627)
- [GRP-4626  
  cacerts moved in java17](https://todos.internet2.edu/browse/GRP-4626)
- [GRP-4625  
  auto ddl 4.*.* should work](https://todos.internet2.edu/browse/GRP-4625)
- [GRP-4624  
  digital marketplace provisioner loops against mock](https://todos.internet2.edu/browse/GRP-4624)
- [GRP-4623  
  fix audits for jexl script tester](https://todos.internet2.edu/browse/GRP-4623)
- [GRP-4622  
  do not log env vars in container since could be sensitive](https://todos.internet2.edu/browse/GRP-4622)
- [GRP-4621  
  improve provisioning start with for azure](https://todos.internet2.edu/browse/GRP-4621)
- [GRP-4620  
  version does not show in ui for v4](https://todos.internet2.edu/browse/GRP-4620)
- [GRP-4619  
  check for nulls in jexl scripts](https://todos.internet2.edu/browse/GRP-4619)
- [GRP-4618  
  jexl script tester has error](https://todos.internet2.edu/browse/GRP-4618)
- [GRP-4617  
  add 'run report' to report menu for ad hoc runs](https://todos.internet2.edu/browse/GRP-4617)
- [GRP-4616  
  provisioning: validate that the membership attribute is not cached](https://todos.internet2.edu/browse/GRP-4616)
- [GRP-4615  
  NPE in change log temp processor when adding group set if parent doesn't exist](https://todos.internet2.edu/browse/GRP-4615)
- [GRP-4614  
  scim provisioner 404 should mean object doesnt exist (groups/entities/memberships)](https://todos.internet2.edu/browse/GRP-4614)
- [GRP-4613  
  improve logging on vetos](https://todos.internet2.edu/browse/GRP-4613)
- [GRP-4612  
  Remove xml-apis dependency](https://todos.internet2.edu/browse/GRP-4612)
- [GRP-4611  
  grouper is not logging the correct class/method name](https://todos.internet2.edu/browse/GRP-4611)
- [GRP-4610  
  Run OTHER_JOB_syncAllPitTables and OTHER_JOB_syncAllSetTables daily](https://todos.internet2.edu/browse/GRP-4610)
- [GRP-4609  
  allow resize of left navigation panel](https://todos.internet2.edu/browse/GRP-4609)
- [GRP-4608  
  Loader Jobs with External Unique Ids to Support moving group path](https://todos.internet2.edu/browse/GRP-4608)
- [GRP-4607  
  Container startup scripts to check for tomee mounted files and move them to tomcat](https://todos.internet2.edu/browse/GRP-4607)
- [GRP-4606  
  support auto ddl with .*.* for semantic versioning](https://todos.internet2.edu/browse/GRP-4606)
- [GRP-4605  
