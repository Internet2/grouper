...
pageId: 48793623
version: 12
lastUpdated: 2026-07-19T00:33:26.611Z
...
[GRP-4584  
caching by script does not work](https://grouper.atlassian.net/browse/GRP-4584)
...
- [GRP-4583  
  Create wiki page for morphString](https://grouper.atlassian.net/browse/GRP-4583)
...
[GRP-4586](https://grouper.atlassian.net/browse/GRP-4586)

[Subject diagnostics incorrectly printing subject Id for identifier test](https://grouper.atlassian.net/browse/GRP-4586)

- [GRP-4585  
  add a GSH change log consumer. Example is emailing supervisor when someone added to group](https://grouper.atlassian.net/browse/GRP-4585)
- [GRP-4584  
  caching by script does not work](https://grouper.atlassian.net/browse/GRP-4584)
- [GRP-4583  
  Create wiki page for morphString](https://grouper.atlassian.net/browse/GRP-4583)
- [GRP-4582  
  add rate limiting to provisioning](https://grouper.atlassian.net/browse/GRP-4582)
- [GRP-4581  
  membership import does not recognize header row](https://grouper.atlassian.net/browse/GRP-4581)
- [GRP-4580  
  cannot remove 'recent memberships' loader configuration](https://grouper.atlassian.net/browse/GRP-4580)
- [GRP-4579  
  when removing loader configuration, it should give a message about delete and redirect to main group screen](https://grouper.atlassian.net/browse/GRP-4579)
- [GRP-4578  
  errors in configuration of oidc url should be more explicit](https://grouper.atlassian.net/browse/GRP-4578)
- [GRP-4577  
  allow privileges to be read with READ privilege in groups](https://grouper.atlassian.net/browse/GRP-4577)
- [GRP-4576  
  grouper provisioning full sync score should disable if -1](https://grouper.atlassian.net/browse/GRP-4576)
- [GRP-4575  
  SubjectSourceCache.logStats() diagnostics should log at DEBUG level, not WARN](https://grouper.atlassian.net/browse/GRP-4575)
- [GRP-4574  
  store state of hide/show left UI panel in user preferences in DB so persists across refresh or browsers or session.](https://grouper.atlassian.net/browse/GRP-4574)
- [GRP-4573  
  add config in grouper-ui.properties to remove the "hide/show side panel" on left of UI, default to show](https://grouper.atlassian.net/browse/GRP-4573)
- [GRP-4572  
  add sql config id to the sql report](https://grouper.atlassian.net/browse/GRP-4572)
- [GRP-4571  
  email group id in reports show up only if not sending email](https://grouper.atlassian.net/browse/GRP-4571)
- [GRP-4569  
  Attestation API markAsAttested(true) no effect](https://grouper.atlassian.net/browse/GRP-4569)
