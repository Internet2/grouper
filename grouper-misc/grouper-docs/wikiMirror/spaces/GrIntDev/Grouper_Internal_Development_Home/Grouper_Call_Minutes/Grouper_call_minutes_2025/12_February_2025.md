...
pageId: 48793231
version: 16
lastUpdated: 2026-07-12T17:27:31.193Z
...
[https://todos.internet2.edu/browse/GRP-5932](https://todos.internet2.edu/browse/GRP-5932)
...
- [GRP-5994  
  Add property rules.membershipDisabledDateDoNotExtend](https://todos.internet2.edu/browse/GRP-5994)
- [GRP-5986  
  Azure with multiple matching groups gives error "Searched for 1 but retrieved 0 maybe a config is off?"](https://todos.internet2.edu/browse/GRP-5986)
...
- Worked on multiple Jiras including:
  ...
  - [GRP-6006  
    batch up data field assigns (and rows and columns)](https://todos.internet2.edu/browse/GRP-6006)
  - [GRP-6004  
    gsh templates can access source IP address via api and not request object which could be out of scope in thread](https://todos.internet2.edu/browse/GRP-6004)
...
| ****[**GRP-6017********add total count to data provider jobs (rows)**](https://todos.internet2.edu/browse/GRP-6017) |
| --- |

[https://todos.internet2.edu/browse/GRP-5932](https://todos.internet2.edu/browse/GRP-5932)

| - ****[**GRP-6016********Okta Provisioner should ignore entities or memberships that are missing an entity attribute set as required******](https://todos.internet2.edu/browse/GRP-6016) - ****[**GRP-6015********On Group Delete Okta Provisioner should delete it instead of memberships first******](https://todos.internet2.edu/browse/GRP-6015) - ****[**GRP-6014********Allow Okta Incremental Daemon To Process Entities if Required Entity Attribute Is Populated Instead of Wating for the Full Sync******](https://todos.internet2.edu/browse/GRP-6014) - ****[**GRP-6013********Daemon logs change last updated timestamp when log or counts aren't changing******](https://todos.internet2.edu/browse/GRP-6013) - ****[**GRP-6012********Document that entityAttributeResolverSql__{attr} attributes need to be lowercase******](https://todos.internet2.edu/browse/GRP-6012) - ****[**GRP-6011********Filter groups from okta for group type OKTA_GROUP******](https://todos.internet2.edu/browse/GRP-6011) - ****[**GRP-6010********Fix create Function syntax for Oracle******](https://todos.internet2.edu/browse/GRP-6010) - ****[**GRP-6009********increase member subject batch size from 80 to 450******](https://todos.internet2.edu/browse/GRP-6009) - ****[**GRP-6008********batch up abac subject lookups and member object inserts******](https://todos.internet2.edu/browse/GRP-6008) - ****[**GRP-6007********batch up grouper dictionary retrieves and assigns******](https://todos.internet2.edu/browse/GRP-6007) - ****[**GRP-6006********batch up data field assigns (and rows and columns)******](https://todos.internet2.edu/browse/GRP-6006) - [**GRP-6005********error with abac and partial row**](https://todos.internet2.edu/browse/GRP-6005)       - [**GRP-6004********gsh templates can access source IP address via api and not request object which could be out of scope in thread******](https://todos.internet2.edu/browse/GRP-6004) - [**GRP-6003********request is not in scope for externalized text while running in thread******](https://todos.internet2.edu/browse/GRP-6003) - [**GRP-6002********for data field abac sql providers, a null should not store a field value (especially for rows)******](https://todos.internet2.edu/browse/GRP-6002) - [**GRP-6001********make scope in oauth web service external system optional******](https://todos.internet2.edu/browse/GRP-6001) - ****[**GRP-6000********null pointer on connectionBean hides underlying exception******](https://todos.internet2.edu/browse/GRP-6000) - ****[**GRP-5999********Rule pattern "Veto if not eligible due to group" does not run in daemon******](https://todos.internet2.edu/browse/GRP-5999) - ****[**GRP-5998********grouper loader ws properties regex is incorrect - minor issue******](https://todos.internet2.edu/browse/GRP-5998) - ****[**GRP-5997********HookVeto reasonKeys don't get replaced with text in the UI******](https://todos.internet2.edu/browse/GRP-5997) - ****[**GRP-5996********Removing group members shows summary of failure without messages******](https://todos.internet2.edu/browse/GRP-5996) - ****[**GRP-5995********add option in web service external system to send parameters in body instead of url (default true)******](https://todos.internet2.edu/browse/GRP-5995) - ****[**GRP-5994********Add property rules.membershipDisabledDateDoNotExtend******](https://todos.internet2.edu/browse/GRP-5994) - ****[**GRP-5993********Issues deleting data rows******](https://todos.internet2.edu/browse/GRP-5993) - ****[**GRP-5992********Populate data field history tables******](https://todos.internet2.edu/browse/GRP-5992) - ****[**GRP-5991********Improvements to documentation for rules******](https://todos.internet2.edu/browse/GRP-5991) - ****[**GRP-5990********Add RuleUtil method membershipDisabledDateDays()******](https://todos.internet2.edu/browse/GRP-5990) - ****[**GRP-5989********New installs include the jdbc example in subject.properties******](https://todos.internet2.edu/browse/GRP-5989) - ****[**GRP-5988********Rule ThenEnum option to run a gsh script******](https://todos.internet2.edu/browse/GRP-5988) - ****[**GRP-5987********Can't add custom rule to group in UI******](https://todos.internet2.edu/browse/GRP-5987) - ****[**GRP-5986********Azure with multiple matching groups gives error "Searched for 1 but retrieved 0 maybe a config is off?"******](https://todos.internet2.edu/browse/GRP-5986) - ****[**GRP-5985********allow custom ui pages to be anonymous******](https://todos.internet2.edu/browse/GRP-5985) - ****[**GRP-5984********re-order scim settings to be in the appropriate section******](https://todos.internet2.edu/browse/GRP-5984) - ****[**GRP-5983********add scim provisioning membership strategies******](https://todos.internet2.edu/browse/GRP-5983) - ****[**GRP-5982********provisioners cannot load data to table (non adobe)******](https://todos.internet2.edu/browse/GRP-5982) - ****[**GRP-5981********Provisioner UI log should show instanceId (at least once) even with debug objects off******](https://todos.internet2.edu/browse/GRP-5981) - ****[**GRP-5980********Provisioner debug log shows final debugMap in UI message but not in log file******](https://todos.internet2.edu/browse/GRP-5980) - ****[**GRP-5979********Google external system add hints to field descriptions and/or wiki******](https://todos.internet2.edu/browse/GRP-5979) - ****[**GRP-5978********Provisioner "Debug log" option doesn't do much besides log memory usage******](https://todos.internet2.edu/browse/GRP-5978) - ****[**GRP-5977********scim resources node is missing******](https://todos.internet2.edu/browse/GRP-5977) |
| --- |
