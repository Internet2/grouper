---
title: "Grouper rules pattern - Reassign folder privileges if from group"
space: Grouper
pageId: 28554722
version: 8
lastUpdated: 2026-07-01T05:39:47.792Z
url: https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28554722/Grouper+rules+pattern+-+Reassign+folder+privileges+if+from+group
---

[Grouper rules](https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28545173/Grouper+rules)

If a folder is created, and the parent stem CREATE privilege is inherited from a group(s), then remove the individual CREATE/STEM privilege from the created stem, and assign those CREATE/STEM privilege to the stem CREATE group(s). Note, if the user is a wheel or root, then just remove the individual assignment.
