---
title: "Grouper hook which adds link to UI"
space: Grouper
pageId: 28548751
version: 5
lastUpdated: 2026-07-01T05:43:35.097Z
url: https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28548751/Grouper+hook+which+adds+link+to+UI
---
...
public class MembershipHooksImplScreenMessageExample extends MembershipHooks {
  ...
  public static void addMessageToScreen(String message) {
    ...
    // bootstrap alert type can be: "primary", "secondary", "success", "danger", "warning", "info", "light", "dark"
    GrouperUtil.callMethod(grouperUiHookShimClass, "addMessageToScreen", 
        GrouperUtil.toSet(String.class, String.class), GrouperUtil.toSet("primary", message));
...
```
hooks.membership.class=edu.internet2.middleware.grouper.hooks.examples.MembershipHooksImplScreenMessageExample
