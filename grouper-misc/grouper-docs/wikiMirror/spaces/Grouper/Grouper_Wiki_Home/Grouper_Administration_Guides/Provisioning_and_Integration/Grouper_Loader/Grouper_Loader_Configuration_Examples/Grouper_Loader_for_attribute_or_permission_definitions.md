---
title: "Grouper - Loader for attribute or permission definitions"
space: Grouper
pageId: 28555268
version: 23
lastUpdated: 2026-07-12T15:27:11.186Z
url: https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28555268/Grouper+-+Loader+for+attribute+or+permission+definitions
---

[Main Grouper Loader page](https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28545200/Grouper+Loader)

The Grouper Loader can be used to manage [attribute definitions](https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28544741/Grouper+attribute+framework) (for attributes or permissions). You can manage 4 parts of the attribute definition (each is optional, though you should pick one or won't need the Loader):
...
| --- | --- |
| penn:community:employee:org:TOPU:UNIV:UADM:91XX | penn:community:employee:org:TOPU:UNIV:UADM:91XX - Information Systems and Computing Parent |
...
Run the job once via gsh

```
grouperSession = GrouperSession.startRootSession();
attributeDef = AttributeDefFinder.findByName("a:b:c", true);
loaderRunOneJobAttr(attributeDef);
...
