...
Make a request to subscribe the to the Grouper Slack channel [here](https://incommon.org/help/?_ga=2.80660500.2008911115.1711377793-2043315176.1631032843&_gl=1*1oatl85*_ga*MjA0MzMxNTE3Ni4xNjMxMDMyODQz*_ga_8P1JY9SZF0*MTcxMTcyNDIzOC4yMzY3LjEuMTcxMTcyOTkxMi4wLjAuMA..).
...
- **Grouper-Announce** email list, a low-traffic list to receive news and important announcements around security and releases.  
  [https://lists.internet2.edu/sympa/arc/grouper-announce](https://lists.internet2.edu/sympa/arc/grouper-announce/2023-10/)
- **Grouper-Developers** email list, for those interested in discussion of Grouper development plans and issues  
  As of 2022, please use InCommon-Grouper Slack instead of the Grouper-Developers email list or refer to the [roadmap](https://grouper.atlassian.net/wiki/spaces/Grouper/pages/28541781/Grouper+Product+Roadmap)  
  [https://lists.internet2.edu/sympa/arc/grouper-dev](https://lists.internet2.edu/sympa/arc/grouper-dev)
