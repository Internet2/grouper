...
public class GcGrouperSyncLog implements GcSqlAssignPrimaryKey, GcDbVersionable {
  ...
  public GcGrouperSyncLog clone() {
    ...
    //grouperSyncMembership  DONT CLONE
  ...
  public boolean equalsDeep(Object obj) {
    ...
    return new EqualsBuilder()
        ...
        //grouperSyncJob  DONT EQUALS

        .append(this.grouperSyncJobId, other.grouperSyncJobId)
        //grouperSyncMember  DONT EQUALS

        .append(this.grouperSyncMemberId, other.grouperSyncMemberId)
        //grouperSyncMembership  DONT EQUALS

        .append(this.grouperSyncMembershipId, other.grouperSyncMembershipId)
  ...
  public static int deleteBatchByOwnerId(Collection<String> ownerIds, String connectionName, int batchSize) {
    ...
    if (GrouperClientUtils.length(ownerIds) > 0) {
      ...
      connectionName = GcGrouperSync.defaultConnectionName(connectionName);
