...
public class GcStemSave {
   ...
   */
  public GcStemSave assignWsEndpoint(String theWsEndpoint) {
   ...
   * @return this for chaining
   */
  public GcStemSave assignWsUser(String theWsUser) {
   ...
   * @return this for chaining
   */
  public GcStemSave assignWsPass(String theWsPass) {
   ...
   * @return this for chaining
   */
  public GcStemSave assignWsPassEncrypted(String theWsPassEncrypted) {
   ...
   * @return this for chaining
   */
  public GcStemSave assignWsPassFile(File theFile) {
   ...
   * @return this for chaining
   */
  public GcStemSave assignWsPassFileEncrypted(File theFile) {
