/*
 * @author mchyzer
 * $Id: WsTest.java,v 1.1 2008-11-27 14:25:48 mchyzer Exp $
 */
...
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.io.xml.CompactWriter;
...
import edu.internet2.middleware.grouperClient.ext.org.apache.commons.httpclient.HttpClient;
...
import edu.internet2.middleware.grouperClient.ext.org.apache.commons.httpclient.methods.PostMethod;
import edu.internet2.middleware.grouperClient.ext.org.apache.commons.httpclient.methods.StringRequestEntity;
import edu.internet2.middleware.grouperClient.ext.org.apache.commons.httpclient.params.DefaultHttpParams;
...
//    httpClient.getParams().setConnectionManagerTimeout(90000);
   ...
   * 
   */
  public static class GrouperClientWs {
  ...
  public static void main(String[] args) {
    ...
    String subjectIds = GrouperClientUtils.argMapString(argMap, "subjectIds", false);
    List<String> subjectIdsList = GrouperClientUtils.splitTrimToList(subjectIds, ","); 
    String subjectIdentifiers = GrouperClientUtils.argMapString(argMap, "subjectIdentifiers", false);
    List<String> subjectIdentifiersList = GrouperClientUtils.splitTrimToList(subjectIdentifiers, ",");
    String sourceIds = GrouperClientUtils.argMapString(argMap, "sourceIds", false);
    List<String> sourceIdsList = GrouperClientUtils.splitTrimToList(sourceIds, ",");
    boolean replaceAllExisting = GrouperClientUtils.argMapBoolean(argMap, "replaceAllExisting", false, false);
