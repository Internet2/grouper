...
public class GcGroupSave {
   ...
   */
  public GcGroupSave assignWsEndpoint(String theWsEndpoint) {
   ...
   * @return this for chaining
   */
  public GcGroupSave assignWsUser(String theWsUser) {
   ...
   * @return this for chaining
   */
  public GcGroupSave assignWsPass(String theWsPass) {
   ...
   * @return this for chaining
   */
  public GcGroupSave assignWsPassEncrypted(String theWsPassEncrypted) {
   ...
   * @return this for chaining
   */
  public GcGroupSave assignWsPassFile(File theFile) {
   ...
   * @return this for chaining
   */
  public GcGroupSave assignWsPassFileEncrypted(File theFile) {
