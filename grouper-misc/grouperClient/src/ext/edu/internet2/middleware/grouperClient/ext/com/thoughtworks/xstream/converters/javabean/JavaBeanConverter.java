 ...
 */
package edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.converters.javabean;

import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.alias.ClassMapper;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.converters.ConversionException;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.converters.Converter;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.converters.MarshallingContext;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.converters.UnmarshallingContext;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.io.ExtendedHierarchicalStreamWriterHelper;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.io.HierarchicalStreamReader;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.io.HierarchicalStreamWriter;
import edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.mapper.Mapper;
...
public class JavaBeanConverter implements Converter {
    ...
    /**
     * @deprecated As of 1.3, use {@link #JavaBeanConverter(Mapper)} and {@link edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.XStream#aliasAttribute(String, String)}
     */
    ...
    /**
     * @deprecated As of 1.2, use {@link #JavaBeanConverter(Mapper)} and {@link edu.internet2.middleware.grouperClient.ext.com.thoughtworks.xstream.XStream#aliasAttribute(String, String)}
     */
