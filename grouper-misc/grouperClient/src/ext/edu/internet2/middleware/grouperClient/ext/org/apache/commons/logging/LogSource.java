...
import edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.NoOpLog;
 ...
 *
 * @author Rod Waldhoff
 * @version $Id: LogSource.java,v 1.1 2008-11-27 14:25:52 mchyzer Exp $
 */
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.Log4JLogger");
                } else if (jdk14IsAvailable) {
                    setLogImplementation
                            ("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.Jdk14Logger");
                } else {
                    setLogImplementation
                            ("edu.internet2.middleware.grouperClient.ext.org.apache.commons.logging.impl.NoOpLog");
                }
