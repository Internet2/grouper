 ...
 * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken} types) used for
 ...
 * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken} types) and a few
...
public enum CoercionInputShape
{
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#START_ARRAY} to
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#END_ARRAY})
     */
    Array,

    /**
     * Shape of Object values from input (token sequence from
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#START_OBJECT} to
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#END_OBJECT})
     */
    Object,

    /**
     * Shape of integral (non-floating point) numeric values from input (token
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_INT})
     */
    Integer,

    /**
     * Shape of floating point (non-integral) numeric values from input (token
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_NUMBER_FLOAT})
     */
    Float,

    /**
     * Shape of boolean values from input (tokens
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_TRUE} and
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_FALSE})
     */
    Boolean,

    /**
     * Shape of string values from input (tokens
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_STRING})
     */
    String,
     ...
     * generally seen as {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#VALUE_EMBEDDED_OBJECT}.
     */
    Binary,
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#START_ARRAY},
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#END_ARRAY}):
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#START_OBJECT},
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonToken#END_OBJECT}):
     * usually used to allow special coercion into "empty" or {@code null} target type.
     */
    EmptyObject,
