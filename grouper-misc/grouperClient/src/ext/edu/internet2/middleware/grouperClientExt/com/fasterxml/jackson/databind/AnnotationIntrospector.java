...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.annotation.JsonSerialize;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.cfg.MapperConfig;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.BeanPropertyWriter;
    ...
    implements Versioned, java.io.Serializable
{
    ...
    public static class ReferenceProperty
    {
        public enum Type {
             ...
             * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonManagedReference}
             */
            MANAGED_REFERENCE
             ...
             * Usually this can be defined by using
             * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonBackReference}
             */
            ,BACK_REFERENCE
            ;
        }
    ...
    */
     ...
     * which {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonCreator.Mode} to use.
     *<p>
     * NOTE: caller needs to consider possibility of both `null` (no annotation found)
     * and {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonCreator.Mode#DISABLED} (annotation found,
