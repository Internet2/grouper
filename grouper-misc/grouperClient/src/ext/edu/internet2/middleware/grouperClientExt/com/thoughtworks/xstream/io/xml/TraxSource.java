...
public class TraxSource extends SAXSource {
    ...
    /**
     * Sets the SAX InputSource to be used for the Source.  As this implementation only
    ...
    /**
     * Set the XMLReader to be used for the Source.  As this implementation only supports
    ...
    /**
     * Returns the XMLReader to be used for the Source.  This implementation returns a
    ...
    /**
     * Sets the list of objects to marshal.  When dealing with non-text input (such as SAX
