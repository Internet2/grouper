...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.exc.StreamReadException;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.exc.StreamWriteException;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.io.CharacterEscapes;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.io.SegmentedStringWriter;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.type.ResolvedType;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.cfg.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.exc.MismatchedInputException;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.impl.LaissezFaireSubTypeValidator;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.impl.StdSubtypeResolver;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.node.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.ClassUtil;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.RootNameLookup;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.StdDateFormat;
        ...
        java.io.Serializable // as of 2.1
{
    ...
    public Version version() {
        return edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.cfg.PackageVersion.VERSION;
    }
     ...
     *<p>
     * NOTE: when using the default {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.module.SimpleModule}
    ...
    */
     ...
     * have a look at {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair}.
     * 
     * @see edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair
     */
     ...
     * have been annotated with {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonTypeInfo}).
     *<P>
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonTypeInfo}) will have
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder}
     ...
     * for changing {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonParser.Feature}
     * and {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonGenerator.Feature}
     ...
     * construction, see {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.json.JsonMapper#builder}
    ...
    /**
     * Method for changing state of specified {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonParser.Feature}s
    ...
    /**
     * Method for enabling specified {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
    ...
    /**
     * Method for disabling specified {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *<p>
    ...
    /**
     * Method for enabling specified {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *<p>
    ...
    /**
     * Method for disabling specified {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *<p>
     ...
     * raw value ({@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.RawValue}) or basic
     ...
     *  {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.node.ObjectNode}
     ...
     */
    @Deprecated
    public edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
            throws JsonMappingException {
