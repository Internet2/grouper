...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonIncludeProperties;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.TokenStreamFactory;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.cfg.SerializerFactoryConfig;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.impl.ObjectIdWriter;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.impl.UnsupportedTypeSerializer;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.std.MapSerializer;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.std.StdDelegatingSerializer;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.std.ToEmptyObjectSerializer;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.ReferenceType;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.Converter;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.IgnorePropertiesUtil;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.util.NativeImageUtil;
...
ClassUtil.getTypeDescription(beanDesc.getType()), ClassUtil.name(propName)));
     ...
     * by default this is based on {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonIgnoreType}
