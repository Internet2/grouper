...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.PropertyAccessor;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ObjectMapper.DefaultTyping;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.*;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.AccessorNamingStrategy;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.DefaultAccessorNamingStrategy;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.VisibilityChecker;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.NamedType;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.PolymorphicTypeValidator;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.SubtypeResolver;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.node.JsonNodeFactory;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.TypeFactory;
...
//    public B removeAllModules()
    ...
    public B addModule(edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module module)
    {
        _mapper.registerModule(module);
        return _this();
    }

    public B addModules(edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module... modules)
    {
        for (edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module module : modules) {
            addModule(module);
        }
        return _this();
    }

    public B addModules(Iterable<? extends edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module> modules)
    {
        for (edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module module : modules) {
            addModule(module);
        }
     ...
     */
    public static List<edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module> findModules() {
     ...
     * potentially expensive.
     */
    public static List<edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module> findModules(ClassLoader classLoader)
    {
        ArrayList<edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module> modules = new ArrayList<>();
        ServiceLoader<edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module> loader = secureGetServiceLoader(edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module.class, classLoader);
        for (edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.Module module : loader) {
            modules.add(module);
        }
        return modules;
    }
