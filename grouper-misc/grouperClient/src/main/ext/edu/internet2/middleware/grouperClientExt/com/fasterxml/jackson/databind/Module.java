...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.cfg.MutableConfigOverride;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.BeanDeserializerModifier;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.DeserializationProblemHandler;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.Deserializers;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.KeyDeserializers;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.ValueInstantiators;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.introspect.ClassIntrospector;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsontype.NamedType;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.BeanSerializerModifier;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.Serializers;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.TypeFactory;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.TypeModifier;
    ...
    implements Versioned
{
     ...
     * (see {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.MapperFeature#IGNORE_DUPLICATE_MODULE_REGISTRATIONS})
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional
         * {@link TypeModifier} instance, which can augment {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.JavaType}
         * instances constructed by {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.type.TypeFactory}.
         * 
        ...
        /**
         * Method that module can use to register additional {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.deser.ValueInstantiator}s for
