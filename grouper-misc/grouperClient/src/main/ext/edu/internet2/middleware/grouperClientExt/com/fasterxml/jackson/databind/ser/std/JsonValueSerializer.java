...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsonFormatVisitors.JsonStringFormatVisitor;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.ser.BeanSerializer;
 ...
 * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     *
        ...
        throws JsonMappingException
    {
        ...
        return edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
