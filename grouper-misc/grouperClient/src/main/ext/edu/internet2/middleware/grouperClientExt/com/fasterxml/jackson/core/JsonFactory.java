...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.format.InputAccessor;
...
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.util.BufferRecycler;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.util.BufferRecyclers;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.util.DefaultPrettyPrinter;
import edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.util.JacksonFeature;
        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.async.NonBlockingInputFeeder}.
     *
     ...
     * if (and only if) {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.StreamReadFeature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     ...
     * feature,
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET}
     * is enabled).
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
     ...
     * the parser, it will still be managed (i.e. closed if
     * end-of-stream is reacher, or parser close method called)
     * if (and only if) {@link edu.internet2.middleware.grouperClientExt.com.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     * Note: no encoding argument is taken since it can always be
