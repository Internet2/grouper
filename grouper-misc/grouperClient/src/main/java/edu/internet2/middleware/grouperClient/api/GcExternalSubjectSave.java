...
public class GcExternalSubjectSave {
   ...
   */
  public GcExternalSubjectSave assignWsEndpoint(String theWsEndpoint) {
   ...
   * @return this for chaining
   */
  public GcExternalSubjectSave assignWsUser(String theWsUser) {
   ...
   * @return this for chaining
   */
  public GcExternalSubjectSave assignWsPass(String theWsPass) {
   ...
   * @return this for chaining
   */
  public GcExternalSubjectSave assignWsPassEncrypted(String theWsPassEncrypted) {
   ...
   * @return this for chaining
   */
  public GcExternalSubjectSave assignWsPassFile(File theFile) {
   ...
   * @return this for chaining
   */
  public GcExternalSubjectSave assignWsPassFileEncrypted(File theFile) {
