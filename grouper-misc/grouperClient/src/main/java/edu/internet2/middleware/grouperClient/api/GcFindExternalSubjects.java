...
public class GcFindExternalSubjects {
   ...
   */
  public GcFindExternalSubjects assignWsEndpoint(String theWsEndpoint) {
   ...
   * @return this for chaining
   */
  public GcFindExternalSubjects assignWsUser(String theWsUser) {
   ...
   * @return this for chaining
   */
  public GcFindExternalSubjects assignWsPass(String theWsPass) {
   ...
   * @return this for chaining
   */
  public GcFindExternalSubjects assignWsPassEncrypted(String theWsPassEncrypted) {
   ...
   * @return this for chaining
   */
  public GcFindExternalSubjects assignWsPassFile(File theFile) {
   ...
   * @return this for chaining
   */
  public GcFindExternalSubjects assignWsPassFileEncrypted(File theFile) {
