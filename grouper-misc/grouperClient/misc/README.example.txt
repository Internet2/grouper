...
Grouper client institution distribution:
...
1. configure the config file: grouper.client.properties with your credentials
2. make sure you have Java 1.5+ (same as Java 5+)
