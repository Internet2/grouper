 ...
 * $Id$
 */
package edu.internet2.middleware.tierInstrumentationCollector.logging;
 ...
 *
 */
public class TicRequestLog {

  /** logger */
  private static final Log LOG = LogFactory.getLog(TicRequestLog.class);
  ...
  public static void logToRequestLog(String label, Object object) {
    ...
    if (httpServletRequest == null) {
      LOG.error("Why is request null??? " + label + ": " + GrouperClientUtils.toStringForLog(object, 1000), 
  ...
  public static String requestLogString() {
    ...
    return GrouperClientUtils.mapToString(logMap);
