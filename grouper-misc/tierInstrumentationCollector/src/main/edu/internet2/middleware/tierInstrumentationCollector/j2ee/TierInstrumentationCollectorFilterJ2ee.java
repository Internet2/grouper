 ...
 * 
 */
public class TierInstrumentationCollectorFilterJ2ee implements Filter {

  /** logger */
  private static final Log LOG = LogFactory.getLog(TierInstrumentationCollectorFilterJ2ee.class);
  ...
  public static long retrieveRequestStartMillis() {
    ...
    return GrouperClientUtils.longValue(requestStartMillis, 0);
  }
  ...
  public static String retrieveUserPrincipalNameFromRequest() {
    ...
    GrouperClientUtils.assertion(GrouperClientUtils.isNotBlank(principalName),
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    try {
      ...
      request = new TierInstrumentationCollectorHttpServletRequest((HttpServletRequest)request);
