...
public class GrouperDigitalMarketplaceUser {
   ...
   * cache group
   */
  private static ExpirableCache<Boolean, Map<String, GrouperDigitalMarketplaceUser>> retrieveUsersCache = new ExpirableCache<Boolean, Map<String, GrouperDigitalMarketplaceUser>>(120);
