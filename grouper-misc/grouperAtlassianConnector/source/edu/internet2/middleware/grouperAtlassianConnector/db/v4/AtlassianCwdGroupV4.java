 ...
 *
 */
@GcPersistableClass(tableName="groupbase", defaultFieldPersist=GcPersist.persistIfPersistableField)
public class AtlassianCwdGroupV4 implements AtlassianCwdGroup {
  ...
  public String toString() {
    return "AtlassianGroupbaseV4 [id=" + this.id + ", groupName=" + this.groupName + "]";
  }
  ...
  public static Map<String, AtlassianCwdGroup> retrieveGroups() {
    ...
    List<AtlassianCwdGroupV4> resultList = new GcDbAccess().selectList(AtlassianCwdGroupV4.class);
    Map<String, AtlassianCwdGroup> resultMap = new LinkedHashMap<String, AtlassianCwdGroup>();
    for (AtlassianCwdGroupV4 atlassianCwdGroup : resultList) {
  ...
  public void gcSqlAssignNewPrimaryKeyForInsert() {
    ...
    Long maxId = new GcDbAccess().sql("select max(id) from groupbase").select(Long.class);
    if (maxId == null) {
      maxId = 20000L;
    }
    this.setId(maxId + 1);
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AtlassianCwdGroupV4 other = (AtlassianCwdGroupV4) obj;
