...
public class AtlassianCwdGroupV1 implements AtlassianCwdGroup {
  ...
  public static Map<String, AtlassianCwdGroup> retrieveGroups() {
    ...
    List<AtlassianCwdGroupV1> resultList = new GcDbAccess().selectList(AtlassianCwdGroupV1.class);
    Map<String, AtlassianCwdGroup> resultMap = new LinkedHashMap<String, AtlassianCwdGroup>();
    for (AtlassianCwdGroupV1 atlassianCwdGroup : resultList) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AtlassianCwdGroupV1 other = (AtlassianCwdGroupV1) obj;
