...
public class AtlassianCwdMembershipV1 implements AtlassianCwdMembership {
  ...
  public static List<AtlassianCwdMembership> retrieveMemberships() {
    ...
    List<AtlassianCwdMembershipV1> resultList = new GcDbAccess()
      .sql("select * from cwd_membership where membership_type = 'GROUP_USER'")
      .selectList(AtlassianCwdMembershipV1.class);
