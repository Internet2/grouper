...
public class AtlassianCwdMembership implements GcSqlAssignPrimaryKey {
  ...
  public static List<AtlassianCwdMembership> retrieveMemberships() {
    ...
    List<AtlassianCwdMembership> resultList = new GcDbAccess()
      .sql("select * from cwd_membership where membership_type = 'GROUP_USER'")
      .selectList(AtlassianCwdMembership.class);
    return resultList;
  }
