...
public class AtlassianCwdGroupV3 implements AtlassianCwdGroup {
  ...
  public static Map<String, AtlassianCwdGroup> retrieveGroups() {
    ...
    List<AtlassianCwdGroupV3> resultList = new GcDbAccess().selectList(AtlassianCwdGroupV3.class);
    Map<String, AtlassianCwdGroup> resultMap = new LinkedHashMap<String, AtlassianCwdGroup>();
    for (AtlassianCwdGroupV3 atlassianCwdGroup : resultList) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AtlassianCwdGroupV3 other = (AtlassianCwdGroupV3) obj;
  ...
  public Boolean getLocalBoolean() {
    return this.local == null ? null : this.local.equals(1L);
  }
  ...
  public void setLocalBoolean(Boolean local1) {
    this.local = local1 == null ? null : (local1 ? 1L : 0L);
  }
