...
public class AtlassianUserMappingV4 implements AtlassianUserMapping {
  /**
   * @see java.lang.Object#toString()
   */
  @Override
  public String toString() {
    return "AtlassianUserMappingV4 [userKey_id=" + this.userKey + ", username=" + this.username 
  ...
  public static Map<String, AtlassianUserMapping> retrieveUserMappings() {
    ...
    List<AtlassianUserMappingV4> resultList = new GcDbAccess().selectList(AtlassianUserMappingV4.class);
    Map<String, AtlassianUserMapping> resultMap = new LinkedHashMap<String, AtlassianUserMapping>();
    for (AtlassianUserMappingV4 atlassianUserMapping : resultList) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AtlassianUserMappingV4 other = (AtlassianUserMappingV4) obj;
    if (this.userKey == null) {
