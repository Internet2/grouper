...
public class AsasFolderLookup {
   ...
   * @param id1
   */
  public AsasFolderLookup(String name1, String id1) {
   ...
   * @param handleValue1
   */
  public AsasFolderLookup(String name1, String id1, String handleName1, String handleValue1) {
    this.name = name1;
    this.id = id1;
