...
/*
 * @author mchyzer
 * $Id: StandardApiServerJsonIndenter.java,v 1.2 2008-06-05 19:34:04 mchyzer Exp $
 */
 ...
 */
public class StandardApiServerJsonIndenter {
   ...
   * indenter
   */
  public StandardApiServerJsonIndenter(String theJson) {
    if (theJson != null) {
      this.json = StandardApiServerUtils.trimToEmpty(theJson);
    }
  }
