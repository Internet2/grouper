...
package edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph;

import java.math.BigDecimal;
import java.math.BigInteger;

import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.MorphUtils;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.MorpherRegistry;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.BooleanArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.ByteArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.CharArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.DoubleArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.FloatArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.IntArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.LongArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.ObjectArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.array.ShortArrayMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.object.BooleanObjectMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.object.CharacterObjectMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.object.ClassMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.object.NumberMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.object.StringMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.BooleanMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.ByteMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.CharMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.DoubleMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.FloatMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.IntMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.LongMorpher;
import edu.internet2.middleware.tierApiAuthzServerExt.net.sf.ezmorph.primitive.ShortMorpher;
