 ...
 */
package edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.XStreamException;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.ConverterRegistry;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.SingleValueConverterWrapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.BigDecimalConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.BigIntegerConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.BooleanConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.ByteConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.CharConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.DateConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.DoubleConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.FloatConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.IntConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.LongConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.NullConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.ShortConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.StringBufferConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.StringConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.URLConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.ArrayConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.BitSetConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.CharArrayConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.CollectionConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.MapConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.PropertiesConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.TreeMapConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.TreeSetConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.ColorConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.DynamicProxyConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.EncodedByteArrayConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.FileConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.FontConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.GregorianCalendarConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.JavaClassConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.JavaMethodConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.LocaleConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.LookAndFeelConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.SqlDateConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.SqlTimeConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.SqlTimestampConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.TextAttributeConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.ExternalizableConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.ReflectionConverter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.ReflectionProvider;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.SelfStreamingInstanceChecker;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.SerializableConverter;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.ReferenceByIdMarshallingStrategy;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.ReferenceByXPathMarshallingStrategy;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.TreeMarshallingStrategy;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.util.ClassLoaderReference;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.util.CompositeClassLoader;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.util.CustomObjectInputStream;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.core.util.CustomObjectOutputStream;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.io.HierarchicalStreamDriver;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.io.StatefulWriter;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.io.xml.XppDriver;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.AnnotationConfiguration;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.ArrayMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.AttributeAliasingMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.AttributeMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.CachingMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.ClassAliasingMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.DefaultImplementationsMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.DefaultMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.DynamicProxyMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.FieldAliasingMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.ImmutableTypesMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.ImplicitCollectionMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.LocalConversionMapper;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.OuterClassMapper;
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.XStream11XmlFriendlyMapper;
 ...
 * <p/>
 * <p>
 * XStream contains a map of {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.Converter} interface.
 * </p>
 * <p/>
 * <p>
 * <hr>
 ...
 * {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.ReflectionConverter} as the initial default
 * converter.
 * </p>
 * <p/>
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (jvm.loadClass("edu.internet2.middleware.authzStandardApiServerExt.net.sf.cglib.proxy.Enhancer") != null) {
            mapper = buildMapperDynamically(
                     "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.CGLIBMapper",
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.EnumMapper",
    ...
    protected void setupConverters() {
        ...
        if (jvm.loadClass("javax.security.auth.Subject") != null) {
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.SubjectConverter",
        ...
        if (jvm.loadClass("javax.xml.datatype.Duration") != null) {
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.DurationConverter",
        ...
        if (JVM.is14()) {
            ...
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.ThrowableConverter",
                    PRIORITY_NORMAL, new Class[]{Converter.class},
                    new Object[]{reflectionConverter});
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.StackTraceElementConverter",
                    PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.CurrencyConverter",
                    PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.RegexPatternConverter",
                    PRIORITY_NORMAL, new Class[]{Converter.class},
                    new Object[]{reflectionConverter});
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.CharsetConverter",
                    PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            // late bound converters - allows XStream to be compiled on earlier JDKs
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                    null, null);
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                    new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                    new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.StringBuilderConverter", PRIORITY_NORMAL,
                null, null);
            dynamicallyRegisterConverter(
                "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }

        if (jvm.loadClass("edu.internet2.middleware.authzStandardApiServerExt.net.sf.cglib.proxy.Enhancer") != null) {
            dynamicallyRegisterConverter(
                    "edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.CGLIBEnhancedConverter",
    ...
    protected void setupImmutableTypes() {
        ...
        if (JVM.is14()) {
            ...
            Class type = jvm.loadClass("edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.extended.CharsetConverter");
     ...
     * </p>
     *
     * @see #createObjectOutputStream(edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.io.HierarchicalStreamWriter, String)
     * @see #createObjectInputStream(edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
