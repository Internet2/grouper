...
import edu.internet2.middleware.authzStandardApiServerExt.net.sf.ezmorph.array.BooleanArrayMorpher;
...
public final class BooleanArrayMorpher extends AbstractArrayMorpher
{
   ...
   public Object morph( Object array )
   {
      ...
      if( array.getClass()
         ...
         BooleanMorpher morpher = isUseDefault() ? new BooleanMorpher( defaultValue )
               : new BooleanMorpher();
         if( dims == 1 ){
