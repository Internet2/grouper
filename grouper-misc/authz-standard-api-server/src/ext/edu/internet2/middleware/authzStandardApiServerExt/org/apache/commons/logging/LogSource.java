...
import edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.LogSource;
import edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.impl.NoOpLog;
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("edu.internet2.middleware.authzStandardApiServerExt.org.apache.commons.logging.impl.Log4JLogger");
