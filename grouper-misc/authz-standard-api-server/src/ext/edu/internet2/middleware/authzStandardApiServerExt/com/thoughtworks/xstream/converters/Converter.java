 ...
 * should be thrown.</p>
 * <p/>
 * <p>If working with the high level {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.XStream} facade,
 * you can register new converters using the XStream.registerConverter() method.</p>
 * <p/>
 * <p>If working with the lower level API, the
 * {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.ConverterLookup} implementation is
 ...
 * should implement {@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.SingleValueConverter}.
 ...
 * <p/>
 * <p>{@link edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.AbstractCollectionConverter}
 * provides a starting point for objects that hold a collection of other objects
 * (such as Lists and Maps).</p>
 *
 * @author Joe Walnes
 * @see edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.XStream
 * @see edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.ConverterLookup
 ...
 * @see edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.collections.AbstractCollectionConverter
 */
