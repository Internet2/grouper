...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.converters.reflection.ReflectionProviderWrapper;
...
import edu.internet2.middleware.authzStandardApiServerExt.com.thoughtworks.xstream.mapper.CGLIBMapper;
...
public class CGLIBEnhancedConverter extends SerializableConverter {
    ...
    public boolean canConvert(Class type) {
      ...
      try {
        Class.forName("edu.internet2.middleware.authzStandardApiServerExt.net.sf.cglib.proxy.Enhancer");
        enhancerExists = true;
      } catch (Throwable e) {
        //this is ok
      }
