 ...
 *
 */
public class StandardApiServerLog implements Log {
  ...
  public static boolean debugToConsole() {
    ...
    return StandardApiServerUtils.defaultIfNull(debugToConsoleBoolean, false);
  }
   ...
   * @param theLog
   */
  public StandardApiServerLog(Log theLog) {
