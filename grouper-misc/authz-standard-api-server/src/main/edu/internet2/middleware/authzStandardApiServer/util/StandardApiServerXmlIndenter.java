...
/*
 * @author mchyzer
 * $Id: StandardApiServerXmlIndenter.java,v 1.1 2008-11-30 10:57:27 mchyzer Exp $
 */
 ...
 */
public class StandardApiServerXmlIndenter {
   ...
   * indenter
   */
  public StandardApiServerXmlIndenter(String theXml) {
    if (theXml != null) {
