...
public class GuiGroup {
   ...
   */
  public static GuiGroup[] convertGroups(Set<Group> groupSet, boolean includeDetail) {
    if (groupSet == null || groupSet.size() == 0) {
      return null;
    }
    int groupSetSize = groupSet.size();
    GuiGroup[] wsGroupResults = new GuiGroup[groupSetSize];
    int index = 0;
    for (Group group : groupSet) {
      GuiGroup wsGroup = new GuiGroup(group, includeDetail);
   ...
   */
  public GuiGroup(Group group, boolean includeDetail) {
    ...
    if (includeDetail) {
      this.setDetail(new GuiGroupDetail(group));
    }
  }
   ...
   * @return the detail
   */
  public GuiGroupDetail getDetail() {
    return this.detail;
  }
   ...
   */
  public void setDetail(GuiGroupDetail detail1) {
    this.detail = detail1;
  }
