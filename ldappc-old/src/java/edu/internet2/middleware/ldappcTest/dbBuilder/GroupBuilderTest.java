...
public class GroupBuilderTest extends TestCase
{
    ...
    protected void tearDown() 
    {
        ...
        { 
            ...
            {
                System.out.println("DEBUG in GroupBuilderTest, topLevelStem1.getName()=" +  topLevelStem1.getName() );
                System.out.println("DEBUG in GroupBuilderTest at delete, uuid=" + topLevelStem1.getUuid());
                topLevelStem1.delete();
            }
        } 
        catch (StemDeleteException sde)
        {
                System.out.println("DEBUG in GroupBuilderTest in StemDeleteException" + sde.getMessage());
        ...
        */
        ...
        {
            //System.out.println("DEBUG in GroupBuilderTest in GroupNotFoundException: " + gnfe.getMessage());
            // Okay if already deleted.
        }
        catch (GroupDeleteException gde)
        {
            //System.out.println("DEBUG in GroupBuilderTest in GroupDeleteException" + gde.getMessage());
            // Okay if already deleted.
        }
        catch (InsufficientPrivilegeException ipe) 
        {
        ...
        {
            //System.out.println("DEBUG in GroupBuilderTest in StemNotFoundException: " + snfe.getMessage());
            // Okay if already deleted.
        }
        catch (StemDeleteException sde)
        {
        ...
        {
            fail("Insufficent privilege for deleting topLevelStem1 or topLevelGroup1: " + ipe.getMessage());
        }
        finally
        {
            try
    ...
    {
         junit.textui.TestRunner.run(GroupBuilderTest.class);
    }
    ...
    {
        DisplayTest.showRunTitle("testAddNewStemToRootStem", "New top level stem is added then deleted.");
        ...
        try
        {
            ...
            fail("Insufficent privilege for creating stem off of the root stem" + ipe.getMessage());
        }
