...
public class LdappcConfigurationException extends LdappcRuntimeException
{
    ...
    /**
     * Constructs a new configuration exception with the specified detail message. The
     * cause is not initialized, and may subsequently be initialized by a call
     * to {@link java.lang.Throwable#initCause(java.lang.Throwable)}.
     * 
     * @param message
     ...
     * automatically incorporated in this configuration exception's detail message.
     * 
     * @param message
    ...
    /**
     * Constructs a new configuration exception with the specified cause.  The detail
     * message is determined by <code>(cause==null ? null : cause.toString())</code> (which
     * typically contains the class and detail message of cause). This
     * constructor is useful for configuration exceptions that are little more than
     ...
     *            {@link java.lang.Throwable#getCause()} method). (A null value
     *            is permitted, and indicates that the cause is nonexistent or
     *            unknown.) Constructs a new configuration exception with the
