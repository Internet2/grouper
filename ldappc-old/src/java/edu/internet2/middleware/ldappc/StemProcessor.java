...
public class StemProcessor 
{
    ...
    public StemProcessor(GrouperSession grouperSession)
    {
        ...
        {
            ErrorLog.fatal(this.getClass(), "In StemProcessor addStem, grouperSession is NULL.");
        }
    }
    ...
    public Stem addStem(Stem stemBase, String stemExtension, String stemDisplayExtension) 
    {
        ...
        {
            ErrorLog.error(this.getClass(), "Error attempting to to add a stem to an non-existent stem.");
        }
        return stem;
    }
