 ...
 */
public class LdappcRuntimeException extends RuntimeException
{
     ...
     *            method.
     */
    public LdappcRuntimeException(String message)
    {
        super(message);
    }
     ...
     *            unknown.)
     */
    public LdappcRuntimeException(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     *            {@link java.lang.Throwable#getCause()} method). (A null value
     *            is permitted, and indicates that the cause is nonexistent or
     *            unknown.) Constructs a new runtime exception with the
     *            specified cause and a detail message of (cause==null ? null :
     *            cause.toString()) (which typically contains the class and
     *            detail message of cause).
     */
    public LdappcRuntimeException(Throwable cause)
    {
        super(cause);
    }
